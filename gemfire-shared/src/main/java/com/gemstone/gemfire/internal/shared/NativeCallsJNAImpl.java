...
public final class NativeCallsJNAImpl {
  ...
  private static class POSIXNativeCalls extends NativeCalls {
     ...
     * 
     * @param flags
     *          MCL_CURRENT 1 - Lock all pages which are currently mapped into
    ...
    static final int SIGCHLD = 20;
    static final int SIGTSTP = 18;
    static final int SIGTTOU = 21;
    static final int SIGTTIN = 22;
...
//            }
  ...
  private static final class WinNativeCalls extends NativeCalls {
    ...
    public static final class TcpKeepAlive extends Structure {
      ...
      @Override
      protected List<?> getFieldOrder() {
        return Arrays.asList(new String[] { "enabled", "keepalivetime",
            "keepaliveinterval" });
      }
    }
