...
public class ClientHttpRequestJUnitTest extends AbstractWebTestCase {
  ...
  public void testGetURLForGet() throws Exception {
    ...
    request.addRequestParameterValues("author", "Rowling");
    request.addRequestParameterValues("category", "science-fiction");
  ...
  @Test
  public void testGetURLForComplexGet() throws Exception {
    final Link expectedLink = new Link("find", toUri("http://host.domain.com:8080/app/libraries/{name}/books/{author}"), HttpMethod.GET);
    final ClientHttpRequest request = new ClientHttpRequest(expectedLink);

    request.addRequestParameterValues("author", "Rowling");
    request.addRequestParameterValues("category", "science-fiction");
    request.addRequestParameterValues("name", "Boston");
    request.addRequestParameterValues("year", "2007");
  ...
  public void testGetURLForDelete() throws Exception {
    ...
    request.addRequestParameterValues("category", "romance");
  ...
  public void testGetURLForPost() throws Exception {
    ...
    request.addRequestParameterValues("author", "Douglas Adams");
    request.addRequestParameterValues("title", "The Hitchhiker's Guide to the Galaxy");
    request.addRequestParameterValues("year", "1979");
    request.addRequestParameterValues("isbn", "0345453743");
  ...
  public void testGetURLForPut() throws Exception {
    ...
    request.addRequestParameterValues("year", "1983");
  ...
  public void testCreateRequestEntityForPost() throws Exception {
    ...
    request.addRequestParameterValues("author", expectedRequestParameters.getFirst("author"));
    request.addRequestParameterValues("title", expectedRequestParameters.getFirst("title"));
    request.addRequestParameterValues("year", expectedRequestParameters.getFirst("year"));
    request.addRequestParameterValues("isbn", expectedRequestParameters.getFirst("isbn"));
  ...
  public void testCreateRequestEntityOnPut() throws Exception {
    ...
    request.addRequestParameterValues("isbn", "0-123456789");
    request.addRequestParameterValues("category", "science-fiction", "sci-fi", "fiction");

    assertSame(mockBook, request.getContent());
    assertEquals("0-123456789", request.getRequestParameterValue("isbn"));
    assertTrue(request.getRequestParameterValues("category").containsAll(Arrays.asList("science-fiction", "sci-fi", "fiction")));
  ...
  @Test
  public void testSetAndGetRequestParameterValues() throws Exception {
    final Link expectedLink = new Link("put", toUri("http://host.domain.com:8080/app/libraries"), HttpMethod.PUT);
    final ClientHttpRequest request = new ClientHttpRequest(expectedLink);
    ...
    request.addRequestParameterValues("parameterOne", "value");
    request.addRequestParameterValues("parameterTwo", "test", "testing", "tested");

    assertEquals("value", request.getRequestParameterValue("parameterOne"));
    assertEquals(1, request.getRequestParameterValues("parameterOne").size());
    assertEquals("test", request.getRequestParameterValue("parameterTwo"));
    assertEquals(3, request.getRequestParameterValues("parameterTwo").size());
    assertTrue(request.getRequestParameterValues("parameterTwo").containsAll(Arrays.asList("test", "testing", "tested")));

    request.setRequestParameter("parameterTwo", "development");

    assertEquals("development", request.getRequestParameterValue("parameterTwo"));
    assertEquals(1, request.getRequestParameterValues("parameterTwo").size());
    assertTrue(request.getRequestParameterValues("parameterTwo").containsAll(Arrays.asList("development")));
  }
