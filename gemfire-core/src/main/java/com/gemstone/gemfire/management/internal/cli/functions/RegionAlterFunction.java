...
public class RegionAlterFunction extends FunctionAdapter implements InternalEntity {
  ...
  private <K, V> Region<?, ?> alterRegion(Cache cache, RegionFunctionArgs regionAlterArgs) {
    ...
    if (regionAlterArgs.isCloningEnabled() != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - cloning");
    }

    if (regionAlterArgs.getEvictionMax() != null) {
      mutator.getEvictionAttributesMutator().setMaximum(regionAlterArgs.getEvictionMax());
      if (logger != null) logger.fine("Region successfully altered - eviction attributes max");
    }
    ...
    if (newEntryExpirationIdleTime != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - entry idle timeout");
    }
    ...
    if (newEntryExpirationTTL != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - entry TTL");
    }
    ...
    if (newRegionExpirationIdleTime != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - region idle timeout");
    }
    ...
    if (newRegionExpirationTTL != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - region TTL");
    }
    ...
    if (newGatewaySenderIds != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - gateway sender IDs");
    }
    ...
    if (newAsyncEventQueueIds != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - async event queue IDs");
    }
    ...
    if (newCacheListenerNames != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - cache listeners");
    }
    ...
    if (cacheLoader != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - cache loader");
    }
    ...
    if (cacheWriter != null) {
      ...
      if (logger != null) logger.fine("Region successfully altered - cache writer");
    }
