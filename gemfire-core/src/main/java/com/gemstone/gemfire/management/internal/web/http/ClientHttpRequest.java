...
public class ClientHttpRequest implements HttpRequest {
   ...
   */
  public void addRequestParameterValues(final String requestParameterName, final Object... requestParameterValues) {
   ...
   */
  public Object getRequestParameterValue(final String requestParameterName) {
   ...
   */
  public List<Object> getRequestParameterValues(final String requestParameterName) {
