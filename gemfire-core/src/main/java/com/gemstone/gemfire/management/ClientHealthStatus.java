...
public class ClientHealthStatus {
  ...
  public String toString() {
    return "{ClientHealthStatus : clientId = " + clientId + " name = " + name
        + "hostName = " + hostName + " numOfGets = " + numOfGets
        + " numOfPuts = " + numOfPuts + " numOfMisses = " + numOfMisses
        + " numOfCacheListenerCalls = " + numOfCacheListenerCalls
        + " numOfThreads = " + numOfThreads + " processCpuTime = "
        + processCpuTime + " CPUs = " + cpus + " upTime = " + upTime
        + " queueSize = " + queueSize + "}";
  }
}
