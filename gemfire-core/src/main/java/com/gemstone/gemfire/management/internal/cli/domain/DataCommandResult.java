...
public class DataCommandResult implements /*Data*/ Serializable{
    ...
    if(object==null || "<NULL>".equals(object)){
      ...
      try {
        ...
        if (String.class.equals(klass)) {
          ...
          jsonObject = new GfJsonObject(object);
        }
        ...
        while (keys.hasNext()) {
          ...
          if (value != null){           
            ...
            table.accumulate(k, value);            
            //else it is domain object in form of json
          }
        }
      } catch (Exception e) {        
  ...
  public void aggregate(DataCommandResult result) {    
    if(isLocateEntry()){
      ...
      if(result.infoString!=null && !result.infoString.equals(infoString) && !(result.operationCompletedSuccessfully || this.operationCompletedSuccessfully)){
        //append infoString only if differs and when operation not completed successfully
        String newString = result.infoString  + " " + infoString;
