...
public class RegionAttributesData {
   ...
   * 
   * @return True if a Gateway is enabled, false otherwise.
   */
  ...
  /**
   * Returns the ID of the <code>GatewayHub</code> to which events are
   * distributed.
   */
  ...
  public String toString() {
    return "RegionAttributesData [asyncConflationEnabled=" + asyncConflationEnabled + ", cacheListeners="
        ...
        + ", customEntryIdleTimeout=" + customEntryIdleTimeout + ", customEntryTimeToLive=" + customEntryTimeToLive
        + ", dataPolicy=" + dataPolicy + ", diskStoreName=" + diskStoreName + ", diskSynchronous=" + diskSynchronous
        + ", enableOffHeapMemory=" + enableOffHeapMemory + ", entryIdleTimeout=" + entryIdleTimeout
        + ", entryTimeToLive=" + entryTimeToLive + ", gatewayEnabled=" + gatewayEnabled + ", gatewayHubId="
        + gatewayHubId + ", hdfsStoreName=" + hdfsStoreName + ", hdfsWriteOnly=" + hdfsWriteOnly + ", ignoreJTA="
        + ignoreJTA + ", indexMaintenanceSynchronous=" + indexMaintenanceSynchronous + ", initialCapacity="
        + initialCapacity + ", interestPolicy=" + interestPolicy + ", keyConstraintClassName=" + keyConstraintClassName
        + ", loadFactor=" + loadFactor + ", lockGrantor=" + lockGrantor + ", multicastEnabled=" + multicastEnabled
        + ", poolName=" + poolName + ", regionIdleTimeout=" + regionIdleTimeout + ", regionTimeToLive="
        + regionTimeToLive + ", scope=" + scope + ", statisticsEnabled=" + statisticsEnabled
        + ", subscriptionConflationEnabled=" + subscriptionConflationEnabled + ", valueConstraintClassName="
        + valueConstraintClassName + "]";
  }
