...
//    }
  ...
  protected Object delegateToFunctionService(ObjectName objectName,
    ...
    try {
      ...
      if (logger.fineEnabled()) {
        logger.fine(" Exception while Executing Funtion " + e);
      }
      ...
      SystemFailure.checkFailure();
      if (logger.fineEnabled()) {
        logger.fine(" Exception while Executing Funtion " + th);
      }
      return null;
    }
  ...
  private Object invokeBroadcasterMethod(Object proxy, Method method,
    ...
    if (methodName.equals("addNotificationListener")) {
      ...
      Object obj = delegateToFunctionService(objectName,
   ...
   *
   */
  // TODO - Abhishek/Rishi do we need this class/interface?
