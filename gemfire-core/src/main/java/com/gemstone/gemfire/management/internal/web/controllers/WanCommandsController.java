...
public class WanCommandsController extends AbstractCommandsController {
  ...
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.LIST_GATEWAY);
  ...
  @RequestMapping(value = "/gateways/receivers", method = RequestMethod.POST)
  @ResponseBody
  public String createGatewayReceiver(@RequestParam(CliStrings.CREATE_GATEWAYRECEIVER__GROUP) final String[] groups,
                                      @RequestParam(CliStrings.CREATE_GATEWAYRECEIVER__MEMBER) final String[] members,
                                      @RequestParam(CliStrings.CREATE_GATEWAYRECEIVER__STARTPORT) final Integer startPort,
                                      @RequestParam(CliStrings.CREATE_GATEWAYRECEIVER__ENDPORT) final Integer endPort,
                                      @RequestParam(CliStrings.CREATE_GATEWAYRECEIVER__BINDADDRESS) final String bindAddress,
                                      @RequestParam(CliStrings.CREATE_GATEWAYRECEIVER__MAXTIMEBETWEENPINGS) final Integer maximumTimeBetweenPings,
                                      @RequestParam(CliStrings.CREATE_GATEWAYRECEIVER__SOCKETBUFFERSIZE) final Integer socketBufferSize,
                                      @RequestParam(CliStrings.CREATE_GATEWAYRECEIVER__GATEWAYTRANSPORTFILTER) final String[] gatewayTransportFilters)
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.CREATE_GATEWAYRECEIVER);
  ...
  @RequestMapping(value = "/gateways/senders", method = RequestMethod.POST)
  @ResponseBody
  ...
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.CREATE_GATEWAYSENDER);
  ...
  @RequestMapping(value = "/gateways/senders/{id}/pause", method = RequestMethod.POST)
  @ResponseBody
  ...
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.PAUSE_GATEWAYSENDER);

    command.addOption(CliStrings.PAUSE_GATEWAYSENDER__ID, gatewaySenderId);
  ...
  // TODO determine whether Async functionality is required
  @RequestMapping(value = "/gateways/senders/{id}/resume", method = RequestMethod.POST)
  @ResponseBody
  ...
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.RESUME_GATEWAYSENDER__ID);

    command.addOption(CliStrings.RESUME_GATEWAYSENDER__ID, gatewaySenderId);
  ...
  // TODO determine whether Async functionality is required
  @RequestMapping(value = "/gateways/receivers/start", method = RequestMethod.POST)
  @ResponseBody
  ...
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.START_GATEWAYRECEIVER);
  ...
  // TODO determine whether Async functionality is required
  @RequestMapping(value = "/gateways/senders/start", method = RequestMethod.POST)
  @ResponseBody
  ...
  @RequestMapping(value="/gateways/receivers", method= RequestMethod.GET)
  @ResponseBody
  ...
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.STATUS_GATEWAYRECEIVER);
  ...
  @RequestMapping(value="/gateways/senders/{id}", method= RequestMethod.GET)
  @ResponseBody
  ...
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.STATUS_GATEWAYSENDER);

    command.addOption(CliStrings.STATUS_GATEWAYSENDER__ID, gatewaySenderId);
  ...
  @RequestMapping(value = "/gateways/receivers/stop", method = RequestMethod.POST)
  @ResponseBody
  ...
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.STOP_GATEWAYRECEIVER);
  ...
  @RequestMapping(value = "/gateways/senders/{id}/stop", method = RequestMethod.POST)
  @ResponseBody
  public String stopGatewaySender(@PathVariable("id") final String gatewaySenderId,
                                  ...
                                  @RequestParam(value = CliStrings.STOP_GATEWAYRECEIVER__MEMBER, required = false) final String[] members)
  {
    final CommandStringBuilder command = new CommandStringBuilder(CliStrings.STOP_GATEWAYSENDER);

    command.addOption(CliStrings.STOP_GATEWAYSENDER__ID, gatewaySenderId);
