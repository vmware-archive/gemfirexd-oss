	...
	public Map<String, String> getNonDefaultAttributes() {
		...
		if (nonDefaultAttributes == null){
			...
			if (enableGateway != RegionAttributesDefault.ENABLE_GATEWAY) {
				nonDefaultAttributes.put(RegionAttributesNames.ENABLE_GATEWAY, Boolean.toString(enableGateway));
			}
			...
			if (gatewayHubId != null && !gatewayHubId.isEmpty() && !gatewayHubId.equals(RegionAttributesDefault.GATEWAY_HUB_ID)) {
