...
public class FunctionCommands implements CommandMarker {
  ...
  public Result executeFunction(
      ...
      @CliOption(key = CliStrings.EXECUTE_FUNCTION__ONGROUP, 
          unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE, 
          optionContext = ConverterHint.MEMBERGROUP,
          help = CliStrings.EXECUTE_FUNCTION__ONGROUP__HELP) String onGroup,
    ...
    try {
      ...
      if (onRegion != null && onMember != null && onGroup != null) {
        ErrorResultData errorResultData = ResultBuilder.createErrorResultData()
            .setErrorCode(ResultBuilder.ERRORCODE_DEFAULT).addLine(
        ...
        result = ResultBuilder.buildResult(errorResultData);
        return result;
      } else if (onMember != null && onGroup != null) {
        ErrorResultData errorResultData = ResultBuilder.createErrorResultData()
            .setErrorCode(ResultBuilder.ERRORCODE_DEFAULT).addLine(
                CliStrings.EXECUTE_FUNCTION__MSG__OPTIONS);
        result = ResultBuilder.buildResult(errorResultData);
        return result;
      } else if (onRegion != null && onGroup != null) {
        ErrorResultData errorResultData = ResultBuilder.createErrorResultData()
            .setErrorCode(ResultBuilder.ERRORCODE_DEFAULT).addLine(
                CliStrings.EXECUTE_FUNCTION__MSG__OPTIONS);
        result = ResultBuilder.buildResult(errorResultData);
        return result;
      } else if (onRegion != null && onMember != null && onGroup != null) {
        ErrorResultData errorResultData = ResultBuilder.createErrorResultData()
            .setErrorCode(ResultBuilder.ERRORCODE_DEFAULT).addLine(
                CliStrings.EXECUTE_FUNCTION__MSG__OPTIONS);
        result = ResultBuilder.buildResult(errorResultData);
      ...
      if (onRegion == null && onMember == null && onGroup == null) {
        ...
        if (cache.getRegion(onRegion) == null) {
          ...
          if (bean == null) {
            return ResultBuilder
                .createGemFireErrorResult(CliStrings.format(CliStrings.EXECUTE_FUNCTION__MSG__MXBEAN_0_FOR_NOT_FOUND,
                    onRegion));
          } else {
            ...
            if (matchFound == true) {
              ...
              return ResultBuilder
                  .createGemFireErrorResult(CliStrings.format(CliStrings.EXECUTE_FUNCTION__MSG__NO_ASSOCIATED_MEMBER_REGION,  " " + onRegion));
            }
          }
        } else {
      ...
      } else if (onGroup != null) {
        // execute on group members
        Set<DistributedMember> dsMembers = new HashSet<DistributedMember>();
        dsMembers.addAll(cache.getDistributedSystem().getGroupMembers(onGroup));
        ...
        if (dsMembers.size() > 0) {
          ...
          return ResultBuilder.createUserErrorResult(CliStrings.format(
              CliStrings.EXECUTE_FUNCTION__MSG__GROUP_0_HAS_NO_MEMBERS, onGroup));
        }
  ...
  public Result destroyFunction(
      ...
      @CliOption(key = CliStrings.DESTROY_FUNCTION__ONGROUP, 
                 unspecifiedDefaultValue = CliMetaData.ANNOTATION_NULL_VALUE,
                 optionContext = ConverterHint.MEMBERGROUP,
                 help = CliStrings.DESTROY_FUNCTION__ONGROUP__HELP) String group,
  ...
  public static class Interceptor extends AbstractCliAroundInterceptor {
    ...
    public Result preExecution(GfshParseResult parseResult) {
      ...
      String onGroup = paramValueMap.get(CliStrings.DESTROY_FUNCTION__ONGROUP);
