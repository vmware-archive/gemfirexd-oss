...
public class DummyQRegion extends QRegion {
  ...
  public List asList() {
    ...
    Object val = this.entry._getValueRetain((RegionEntryContext) this.getRegion(), true);
  ...
  public Object[] toArray() {
    ...
    Object val = this.entry._getValueRetain((RegionEntryContext) getRegion(), true);
