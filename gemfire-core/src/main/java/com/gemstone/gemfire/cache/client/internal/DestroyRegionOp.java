...
public class DestroyRegionOp {
  ...
  public static void execute(ExecutablePool pool,
                             ...
                             Object callbackArg)
  {
    AbstractOp op = new DestroyRegionOpImpl(pool.getLoggerI18n(), region, eventId, callbackArg);
    pool.execute(op);
  }
  /**
  ...
  private static class DestroyRegionOpImpl extends AbstractOp {
     ...
     */
    public DestroyRegionOpImpl(LogWriterI18n lw,
                     String region,
                     EventID eventId,
                     Object callbackArg) {
      super(lw, MessageType.DESTROY_REGION, callbackArg != null ? 3 : 2);
