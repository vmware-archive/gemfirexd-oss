...
public class CloseConnectionOp {
   ...
   */
  public static void execute(LogWriterI18n logger, Connection con, boolean keepAlive)
    throws Exception
  {
    AbstractOp op = new CloseConnectionOpImpl(logger, keepAlive);
    con.execute(op);
  }
  ...
  private static class CloseConnectionOpImpl extends AbstractOp {
     ...
     */
    public CloseConnectionOpImpl(LogWriterI18n lw, boolean keepAlive)  {
      super(lw, MessageType.CLOSE_CONNECTION, 1);
