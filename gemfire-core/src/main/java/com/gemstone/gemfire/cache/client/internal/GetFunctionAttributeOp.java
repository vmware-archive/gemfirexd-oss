...
public class GetFunctionAttributeOp {
  ...
  public static Object execute(ExecutablePool pool, String functionId) {
    AbstractOp op = new GetFunctionAttributeOpImpl(pool.getLoggerI18n(),
        functionId);
  ...
  static class GetFunctionAttributeOpImpl extends AbstractOp {
    ...
    public GetFunctionAttributeOpImpl(LogWriterI18n lw, String functionId) {
      super(lw, MessageType.GET_FUNCTION_ATTRIBUTES, 1);
