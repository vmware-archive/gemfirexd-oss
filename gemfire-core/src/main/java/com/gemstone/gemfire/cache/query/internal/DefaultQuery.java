...
//  private Pool pool;
  ...
  public static final boolean QUERY_VERBOSE =
  ...
  throws FunctionDomainException, TypeMismatchException, NameResolutionException, QueryInvocationTargetException {
    ...
    try {
      ...
      if (this.cache.getCopyOnRead() && context.isIndexUsed() && result instanceof SelectResults) {
        return new ResultsCollectionCopyOnReadWrapper((SelectResults) result);
      }
      return result;
    }
...
//      throw canceledException;
  ...
  throws FunctionDomainException, TypeMismatchException, NameResolutionException, QueryInvocationTargetException {
    ...
    if (!gfc.isClient()) { // fixes bug 42294
      txMgr = gfc.getCacheTransactionManager();
