...
public final class StructBag extends ResultsBag {
   ...
   */
  protected static class ObjectArrayTHashingStrategy implements TObjectHashingStrategy {
  ...
  public StructBag(StructType structType, CachePerfStats stats) {
    super(new ObjectArrayTHashingStrategy(), stats);
  ...
  public StructBag(Collection c, StructType structType, CachePerfStats stats) {
    super(c, new ObjectArrayTHashingStrategy(), stats);
    if (structType == null) { throw new IllegalArgumentException(LocalizedStrings.StructBag_STRUCTTYPE_MUST_NOT_BE_NULL.toLocalizedString()); }
    this.elementType = structType;
  }
  ...
  public StructBag(int initialCapacity,
    ...
    super(initialCapacity, new ObjectArrayTHashingStrategy(), stats);
    if (structType == null) { throw new IllegalArgumentException(LocalizedStrings.StructBag_STRUCTTYPE_MUST_NOT_BE_NULL.toLocalizedString()); }
    this.elementType = structType;
  }
  ...
  public StructBag(int initialCapacity,
                   ...
                   StructType structType,
                   CachePerfStats stats) {
    super(initialCapacity, loadFactor, new ObjectArrayTHashingStrategy(), stats);
    if (structType == null) { throw new IllegalArgumentException(LocalizedStrings.StructBag_STRUCTTYPE_MUST_NOT_BE_NULL.toLocalizedString()); }
    this.elementType = structType;
  }
  ...
  public boolean add(Object obj) {
    ...
    if (!s.getStructType().equals(this.elementType)) {
  ...
  protected TObjectIntHashMap createMapForFromData() {
    return new TObjectIntHashMap(this.size, new ObjectArrayTHashingStrategy());
  }
  ...
  void createTObjectIntHashMap() {
    this.map = new TObjectIntHashMap(this.size, new ObjectArrayTHashingStrategy());
  }
