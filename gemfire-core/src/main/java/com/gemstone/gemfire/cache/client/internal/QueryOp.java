...
public class QueryOp {
                                      ...
                                      Object[] queryParams)
  {
    ...
    if (queryParams != null && queryParams.length > 0) {
      op = new QueryOpImpl(pool.getLoggerI18n(), queryPredicate, queryParams);
    } else {
      op = new QueryOpImpl(pool.getLoggerI18n(), queryPredicate);      
    }
  ...
  protected static class QueryOpImpl extends AbstractOp {
     ...
     */
    public QueryOpImpl(LogWriterI18n lw, String queryPredicate) {
      super(lw, MessageType.QUERY, 1);
     ...
     * @throws com.gemstone.gemfire.SerializationException if serialization fails
     */
    public QueryOpImpl(LogWriterI18n lw, String queryPredicate, Object[] queryParams) {
      super(lw, MessageType.QUERY_WITH_PARAMETERS, 2 + queryParams.length);
      getMessage().addStringPart(queryPredicate);
     ...
     * @throws com.gemstone.gemfire.SerializationException if serialization fails
     */
    protected QueryOpImpl(LogWriterI18n lw, int msgType, int numParts) {
