...
public class CreateCQOp {
  ...
  {
    AbstractOp op = new CreateCQOpImpl(pool.getLoggerI18n(), cqName, queryStr,
        cqState, isDurable, regionDataPolicy);
  ...
  protected static class CreateCQOpImpl extends AbstractOp {
     ...
     */
    public CreateCQOpImpl(LogWriterI18n lw, String cqName, String queryStr,
        int cqState, boolean isDurable, byte regionDataPolicy) {
      super(lw, MessageType.EXECUTECQ_MSG_TYPE, 5);
     ...
     * @throws com.gemstone.gemfire.SerializationException if serialization fails
     */
    protected CreateCQOpImpl(LogWriterI18n lw, int msgType, int numParts) {
