 ...
 * @since 7.0
 */
public interface AsyncEventListener<K, V> extends CacheCallback {

  /**
   * Process the list of <code>AsyncEvent</code>s. This method will
   * asynchronously be called when events are queued to be processed. The size
   * of the list will be up to batch size events where batch size is defined in
   * the <code>AsyncEventQueueFactory</code>.
   * 
   * @param events
   *          The list of <code>AsyncEvent</code> to process
   * 
