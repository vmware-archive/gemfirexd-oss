...
public class AddPDXEnumOp {
  ...
  public static void execute(ExecutablePool pool, int id,
                             EnumInfo ei)
  {
    AbstractOp op = new AddPdxEnumOpImpl(pool.getLoggerI18n(), id, ei);
    pool.execute(op);;
  }
  ...
  private static class AddPdxEnumOpImpl extends AbstractOp {
     ...
     */
    public AddPdxEnumOpImpl(LogWriterI18n lw, int id, EnumInfo ei) {
      super(lw, MessageType.ADD_PDX_ENUM, 2);
