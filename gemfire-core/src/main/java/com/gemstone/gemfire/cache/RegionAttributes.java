...
public interface RegionAttributes<K,V> {
 ...
 /**
   ...
   * region is modified or asynchronously in a background thread. Default value
   * is true.
   *
   * @since 4.0
   */
   ...
   * @return True if a Gateway is enabled;
   *         false if no Gateway is enabled (default).
   *
   * @since 4.2
   */
  @Deprecated
   ...
   * distributed.
   * @return the id of the <code>GatewayHub</code> to which events are
   * distributed
   *
   * @since 5.1
   */
