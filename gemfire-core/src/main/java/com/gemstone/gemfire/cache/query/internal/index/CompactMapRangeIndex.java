...
public class CompactMapRangeIndex extends AbstractIndex
{
  ...
  private final Map<Object, CompactRangeIndex> mapKeyToValueIndex;
  ...
  CompactMapRangeIndex(String indexName, Region region, String fromClause,
    ...
    this.mapKeyToValueIndex = new ConcurrentHashMap<Object, CompactRangeIndex>(2, 0.75f, 1);
  ...
  private void addSavedMappings(RegionEntry entry) throws IMQException {
    for (Object rangeInd : this.mapKeyToValueIndex.values()) {
      ((CompactRangeIndex)rangeInd).addMapping(entry);
    }
  }
  ...
  public void clearCurrState() {
    for (Object index : this.mapKeyToValueIndex.values()) {
        ((CompactRangeIndex)index).clear();
    }
  }
      ...
      throws TypeMismatchException
  {
    ...
    CompactRangeIndex ri = this.mapKeyToValueIndex.get(mapKey);
    if (ri != null) {
      ...
      RegionEntry entry) throws IMQException
  {
    ...
    CompactRangeIndex rg = this.mapKeyToValueIndex.get(mapKey);
    if (rg == null) {
  ...
  public Map<Object, CompactRangeIndex> getRangeIndexHolderForTesting()
  {
