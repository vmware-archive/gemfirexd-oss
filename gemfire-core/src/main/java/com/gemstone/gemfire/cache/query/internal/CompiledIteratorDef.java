...
public class CompiledIteratorDef extends AbstractCompiledValue {
  ...
  private SelectResults prepareIteratorDef(Object obj, ObjectType elementType, ExecutionContext context)
    ...
    if (obj instanceof Map) {
      ...
      throw new TypeMismatchException(LocalizedStrings.CompiledIteratorDef_THE_EXPRESSION_IN_THE_FROM_CLAUSE_OF_A_SELECT_STATEMENT_WAS_TYPE_0_WHICH_CANNOT_BE_INTERPRETED_AS_A_COLLECTION.toLocalizedString(obj.getClass().getName()));
    }
  }
