...
public class GetDurableCQsOp {
  ...
  {
    AbstractOp op = new GetDurableCQsOpImpl(pool.getLoggerI18n());
  ...
  private static class GetDurableCQsOpImpl extends CreateCQOpImpl {
     ...
     */
    public GetDurableCQsOpImpl(LogWriterI18n lw) {
      super(lw, MessageType.GETDURABLECQS_MSG_TYPE, 1 /*numparts*/);
    }
    @Override
