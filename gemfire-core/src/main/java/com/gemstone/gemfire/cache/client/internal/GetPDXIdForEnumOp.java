...
public class GetPDXIdForEnumOp {
  ...
  public static int execute(ExecutablePool pool,
                             EnumInfo ei)
  {
    AbstractOp op = new GetPDXIdForEnumOpImpl(pool.getLoggerI18n(), ei);
  ...
  private static class GetPDXIdForEnumOpImpl extends AbstractOp {
     ...
     */
    public GetPDXIdForEnumOpImpl(LogWriterI18n lw, EnumInfo ei) {
      super(lw, MessageType.GET_PDX_ID_FOR_ENUM, 1);
