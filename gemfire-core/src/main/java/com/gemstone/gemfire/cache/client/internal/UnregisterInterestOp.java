...
public class UnregisterInterestOp {
  ...
  public static void execute(ExecutablePool pool,
                             ...
                             boolean keepAlive)
  {
    AbstractOp op = new UnregisterInterestOpImpl(pool.getLoggerI18n(), region, key, interestType, isClosing, keepAlive);
  ...
  private static class UnregisterInterestOpImpl extends AbstractOp {
     ...
     */
    public UnregisterInterestOpImpl(LogWriterI18n lw,
                                    String region,
                                    Object key,
                                    int interestType,
                                    boolean isClosing,
                                    boolean keepAlive) {
      super(lw, MessageType.UNREGISTER_INTEREST, 5);
