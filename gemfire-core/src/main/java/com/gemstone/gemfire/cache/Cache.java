...
public interface Cache extends GemFireCache {
  ...
  /**
   * Creates a new <code>GatewayHub</code> with the default configuration.
   *
   * @see com.gemstone.gemfire.cache.util.Gateway
   * @param id The id of the <code>GatewayHub</code>
   * @param port The port of the <code>GatewayHub</code>
   *
   * @deprecated as of GemFire 5.1, use {@link #addGatewayHub} instead.
   * @since 4.2
   */
  @Deprecated
  ...
  /**
   * Creates a new <code>GatewayHub</code> with the default configuration
   * and adds it to the collection of <code>GatewayHub</code>s.
   *
   * @see com.gemstone.gemfire.cache.util.Gateway
   * @param id The id of the <code>GatewayHub</code>
   * @param port The port of the <code>GatewayHub</code>
  ...
  /**
   * Gets the existing <code>GatewayHub</code>.
   *
   * @see com.gemstone.gemfire.cache.util.Gateway
   *
   * @deprecated as of GemFire 5.1, use {@link #getGatewayHubs()}.get(0) instead.
   */
  @Deprecated
  public GatewayHub getGatewayHub();
  
  /**
   * Returns a list of all of the <code>GatewayHub</code>s.
   *
   * @see #addGatewayHub
   *
   * @since 5.1
  ...
  /**
   * Returns a <code>GatewayHub</code> with the given id.
   *
   * @see #addGatewayHub
   * @param id The id of the <code>GatewayHub</code>
   *
