...
public class ClearOp {
  ...
  public static void execute(ExecutablePool pool,
                             ...
                             Object callbackArg)
  {
    AbstractOp op = new ClearOpImpl(pool.getLoggerI18n(), region, eventId, callbackArg);
    pool.execute(op);
  }
  ...
  private static class ClearOpImpl extends AbstractOp {
     ...
     */
    public ClearOpImpl(LogWriterI18n lw,
                       String region,
                       EventID eventId,
                       Object callbackArg) {
      super(lw, MessageType.CLEAR_REGION, callbackArg != null ? 3 : 2);
