...
public class RegisterInstantiatorsOp {
  ...
  public static void execute(ExecutablePool pool,
                             ...
                             EventID eventId)
  {
    AbstractOp op = new RegisterInstantiatorsOpImpl(pool.getLoggerI18n(), instantiators, eventId);
  ...
  public static void execute(ExecutablePool pool,
    ...
    AbstractOp op = new RegisterInstantiatorsOpImpl(pool.getLoggerI18n(),
        holders, eventId);
    pool.execute(op, Integer.MAX_VALUE);
  }
  ...
  private static class RegisterInstantiatorsOpImpl extends AbstractOp {
     ...
     */
    public RegisterInstantiatorsOpImpl(LogWriterI18n lw,
                                       Instantiator[] instantiators,
                                       EventID eventId) {
      super(lw, MessageType.REGISTER_INSTANTIATORS, instantiators.length * 3 + 1);
...
//     // // CALLBACK FOR TESTING PURPOSE ONLY ////
    ...
    public RegisterInstantiatorsOpImpl(LogWriterI18n lw,
        Object[] holders, EventID eventId) {
      super(lw, MessageType.REGISTER_INSTANTIATORS, holders.length * 3 + 1);
