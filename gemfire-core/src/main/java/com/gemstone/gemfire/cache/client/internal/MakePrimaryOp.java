...
public class MakePrimaryOp {
  ...
  {
    AbstractOp op = new MakePrimaryOpImpl(pool.getLoggerI18n(), sentClientReady);
  ...
  private static class MakePrimaryOpImpl extends AbstractOp {
     ...
     */
    public MakePrimaryOpImpl(LogWriterI18n lw, boolean sentClientReady) {
      super(lw, MessageType.MAKE_PRIMARY, 1);
