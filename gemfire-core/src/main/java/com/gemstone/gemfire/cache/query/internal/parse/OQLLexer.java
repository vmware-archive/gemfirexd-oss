...
public OQLLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("all", this), new Integer(68));
	literals.put(new ANTLRHashString("map", this), new Integer(132));
	literals.put(new ANTLRHashString("count", this), new Integer(107));
	literals.put(new ANTLRHashString("sum", this), new Integer(103));
	literals.put(new ANTLRHashString("nvl", this), new Integer(98));
	literals.put(new ANTLRHashString("unique", this), new Integer(102));
	literals.put(new ANTLRHashString("except", this), new Integer(90));
	literals.put(new ANTLRHashString("declare", this), new Integer(62));
	literals.put(new ANTLRHashString("for", this), new Integer(83));
	literals.put(new ANTLRHashString("list", this), new Integer(114));
	literals.put(new ANTLRHashString("min", this), new Integer(104));
	literals.put(new ANTLRHashString("element", this), new Integer(96));
	literals.put(new ANTLRHashString("false", this), new Integer(137));
	literals.put(new ANTLRHashString("abs", this), new Integer(93));
	literals.put(new ANTLRHashString("true", this), new Integer(136));
	literals.put(new ANTLRHashString("bag", this), new Integer(113));
	literals.put(new ANTLRHashString("time", this), new Integer(127));
	literals.put(new ANTLRHashString("define", this), new Integer(63));
	literals.put(new ANTLRHashString("and", this), new Integer(82));
	literals.put(new ANTLRHashString("asc", this), new Integer(78));
	literals.put(new ANTLRHashString("desc", this), new Integer(79));
	literals.put(new ANTLRHashString("select", this), new Integer(66));
	literals.put(new ANTLRHashString("intersect", this), new Integer(92));
	literals.put(new ANTLRHashString("flatten", this), new Integer(97));
	literals.put(new ANTLRHashString("float", this), new Integer(118));
	literals.put(new ANTLRHashString("import", this), new Integer(60));
	literals.put(new ANTLRHashString("exists", this), new Integer(84));
	literals.put(new ANTLRHashString("distinct", this), new Integer(67));
	literals.put(new ANTLRHashString("boolean", this), new Integer(122));
	literals.put(new ANTLRHashString("string", this), new Integer(121));
	literals.put(new ANTLRHashString("group", this), new Integer(74));
	literals.put(new ANTLRHashString("interval", this), new Integer(128));
	literals.put(new ANTLRHashString("orelse", this), new Integer(81));
	literals.put(new ANTLRHashString("where", this), new Integer(72));
	literals.put(new ANTLRHashString("trace", this), new Integer(59));
	literals.put(new ANTLRHashString("first", this), new Integer(100));
	literals.put(new ANTLRHashString("set", this), new Integer(112));
	literals.put(new ANTLRHashString("octet", this), new Integer(124));
	literals.put(new ANTLRHashString("nil", this), new Integer(133));
	literals.put(new ANTLRHashString("avg", this), new Integer(106));
	literals.put(new ANTLRHashString("order", this), new Integer(77));
	literals.put(new ANTLRHashString("long", this), new Integer(116));
	literals.put(new ANTLRHashString("limit", this), new Integer(73));
	literals.put(new ANTLRHashString("mod", this), new Integer(91));
	literals.put(new ANTLRHashString("type", this), new Integer(71));
	literals.put(new ANTLRHashString("undefine", this), new Integer(65));
	literals.put(new ANTLRHashString("in", this), new Integer(70));
	literals.put(new ANTLRHashString("null", this), new Integer(134));
	literals.put(new ANTLRHashString("some", this), new Integer(87));
	literals.put(new ANTLRHashString("to_date", this), new Integer(99));
	literals.put(new ANTLRHashString("short", this), new Integer(115));
	literals.put(new ANTLRHashString("enum", this), new Integer(125));
	literals.put(new ANTLRHashString("timestamp", this), new Integer(129));
	literals.put(new ANTLRHashString("having", this), new Integer(76));
	literals.put(new ANTLRHashString("dictionary", this), new Integer(131));
	literals.put(new ANTLRHashString("char", this), new Integer(120));
	literals.put(new ANTLRHashString("listtoset", this), new Integer(95));
	literals.put(new ANTLRHashString("array", this), new Integer(111));
	literals.put(new ANTLRHashString("union", this), new Integer(89));
	literals.put(new ANTLRHashString("or", this), new Integer(80));
	literals.put(new ANTLRHashString("max", this), new Integer(105));
	literals.put(new ANTLRHashString("from", this), new Integer(69));
	literals.put(new ANTLRHashString("query", this), new Integer(64));
	literals.put(new ANTLRHashString("collection", this), new Integer(130));
	literals.put(new ANTLRHashString("like", this), new Integer(88));
	literals.put(new ANTLRHashString("date", this), new Integer(126));
	literals.put(new ANTLRHashString("byte", this), new Integer(123));
	literals.put(new ANTLRHashString("any", this), new Integer(86));
	literals.put(new ANTLRHashString("is_undefined", this), new Integer(108));
	literals.put(new ANTLRHashString("double", this), new Integer(119));
	literals.put(new ANTLRHashString("int", this), new Integer(117));
	literals.put(new ANTLRHashString("andthen", this), new Integer(85));
	literals.put(new ANTLRHashString("last", this), new Integer(101));
	literals.put(new ANTLRHashString("struct", this), new Integer(110));
	literals.put(new ANTLRHashString("undefined", this), new Integer(135));
	literals.put(new ANTLRHashString("is_defined", this), new Integer(109));
