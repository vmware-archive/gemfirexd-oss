...
//  
  public Statistics createAtomicStatistics(StatisticsType type) {
    return createAtomicStatistics(type, null, 1, 0);
  }
  public Statistics createAtomicStatistics(StatisticsType type, String textId) {
    return createAtomicStatistics(type, textId, 1, 0);
  }

  public Statistics createAtomicStatistics(StatisticsType type, String textId,
      long numericId) {
    return createAtomicStatistics(type, textId, numericId, 1);
  }

  public Statistics createAtomicStatistics(StatisticsType type, String textId,
      long numericId, long uniqueId) {
    Statistics result = new LocalStatisticsImpl(type, textId, numericId, uniqueId, true, 0, null);
    return result;
  }
