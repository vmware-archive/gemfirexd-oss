 ...
 */
public class CachePerfStats implements HashingStats {
  public static final String REGIONPERFSTATS_TEXTID_PREFIX       = "RegionStats-";
  public static final String REGIONPERFSTATS_TEXTID_PR_SPECIFIER = "partition-";
  ...
  protected static final int getInitialImageTransactionsReceivedId;
  ...
  protected static final int txRemoteSuccessLifeTimeId;
  protected static final int txRemoteFailedLifeTimeId;
  protected static final int txRemoteRollbackLifeTimeId;
  protected static final int txRemoteCommitsId;
  protected static final int txRemoteFailuresId;
  protected static final int txRemoteRollbacksId;
  protected static final int txRemoteCommitTimeId;
  protected static final int txRemoteFailureTimeId;
  protected static final int txRemoteRollbackTimeId;
  protected static final int txRemoteCommitChangesId;
  protected static final int txRemoteFailureChangesId;
  protected static final int txRemoteRollbackChangesId;
  ...
  static {
    ...
    final String getInitialImageTransactionsReceivedDesc = "Total number of in-progress transactions received while doing getInitialImage operations.";
    ...
    final String txRemoteSuccessLifeTimeDesc = "The total amount of time, in nanoseconds, spent in a transaction on a remote node before a successful commit. The time measured starts at transaction begin and ends when commit is called on the remote node.";
    final String txRemoteFailedLifeTimeDesc = "The total amount of time, in nanoseconds, spent in a transaction  on a remote node before a failed commit. The time measured starts at transaction begin and ends when commit is called on the remote node.";
    final String txRemoteRollbackLifeTimeDesc = "The total amount of time, in nanoseconds, spent in a transaction  on a remote node before an explicit rollback. The time measured starts at transaction begin and ends when rollback is called on the remote node.";
    final String txRemoteCommitsDesc = "Total number times a transaction commit has succeeded on remote node(s) i.e. commit received from the coordinator.";
    final String txRemoteFailuresDesc = "Total number times a transaction commit has failed on remote node(s) i.e rollback received from the coordinator.";
    final String txRemoteRollbacksDesc = "Total number times a transaction has been explicitly rolled back by the coordinator on this node.";
    final String txRemoteCommitTimeDesc = "The total amount of time, in nanoseconds, spent doing successful transaction commits on the remote nodes.";
    final String txRemoteFailureTimeDesc = "The total amount of time, in nanoseconds, spent doing failed transaction commits on the remote nodes.";
    final String txRemoteRollbackTimeDesc = "The total amount of time, in nanoseconds, spent doing explicit transaction rollbacks on the remote node.";
    final String txRemoteCommitChangesDesc = "Total number of changes made by committed transactions on remote node.";
    final String txRemoteFailureChangesDesc = "Total number of changes lost by failed transactions on remote node.";
    final String txRemoteRollbackChangesDesc = "Total number of changes lost by explicit transaction rollbacks on remote node.";
    ...
    type = f.createType(
      ...
      new StatisticDescriptor[] {
        ...
        f.createIntCounter("getInitialImageTransactionsReceived", getInitialImageTransactionsReceivedDesc, "keys"),
        ...
        f.createIntCounter("txRemoteCommits", txRemoteCommitsDesc, "commits"),
        f.createIntCounter("txRemoteCommitChanges", txRemoteCommitChangesDesc, "changes"),
        f.createLongCounter("txRemoteCommitTime", txRemoteCommitTimeDesc, "nanoseconds", false),
        f.createLongCounter("txRemoteSuccessLifeTime", txRemoteSuccessLifeTimeDesc, "nanoseconds", false),

        f.createIntCounter("txRemoteFailures", txRemoteFailuresDesc, "failures"),
        f.createIntCounter("txRemoteFailureChanges", txRemoteFailureChangesDesc, "changes"),
        f.createLongCounter("txRemoteFailureTime", txRemoteFailureTimeDesc, "nanoseconds", false),
        f.createLongCounter("txRemoteFailedLifeTime", txRemoteFailedLifeTimeDesc, "nanoseconds", false),

        f.createIntCounter("txRemoteRollbacks", txRemoteRollbacksDesc, "rollbacks"),
        f.createIntCounter("txRemoteRollbackChanges", txRemoteRollbackChangesDesc, "changes"),
        f.createLongCounter("txRemoteRollbackTime", txRemoteRollbackTimeDesc, "nanoseconds", false),
        f.createLongCounter("txRemoteRollbackLifeTime", txRemoteRollbackLifeTimeDesc, "nanoseconds", false),
    ...
    getInitialImageTransactionsReceivedId = type.nameToId("getInitialImageTransactionsReceived");
    ...
    txRemoteSuccessLifeTimeId = type.nameToId("txRemoteSuccessLifeTime");
    txRemoteFailedLifeTimeId = type.nameToId("txRemoteFailedLifeTime");
    txRemoteRollbackLifeTimeId = type.nameToId("txRemoteRollbackLifeTime");
    txRemoteCommitsId = type.nameToId("txRemoteCommits");
    txRemoteFailuresId = type.nameToId("txRemoteFailures");
    txRemoteRollbacksId = type.nameToId("txRemoteRollbacks");
    txRemoteCommitTimeId = type.nameToId("txRemoteCommitTime");
    txRemoteFailureTimeId = type.nameToId("txRemoteFailureTime");
    txRemoteRollbackTimeId = type.nameToId("txRemoteRollbackTime");
    txRemoteCommitChangesId = type.nameToId("txRemoteCommitChanges");
    txRemoteFailureChangesId = type.nameToId("txRemoteFailureChanges");
    txRemoteRollbackChangesId = type.nameToId("txRemoteRollbackChanges");
  ...
  public CachePerfStats(StatisticsFactory factory, String name) {
    stats = factory.createAtomicStatistics(type, REGIONPERFSTATS_TEXTID_PREFIX + name);
  }
  ...
  //////////////////////  Accessing Stats  //////////////////////
   ...
   public int getGetInitialImageTransactionsReceived() {
     return stats.getInt(getInitialImageTransactionsReceivedId);
   }
