...
public abstract class UserSpecifiedRegionAttributes<K,V> implements RegionAttributes<K,V>
{
  ...
  /**
   * Whether this region has enable gateway explicitly set
   *
   * @since 4.2
   */
  private boolean hasEnableGateway = false;
  /**
   * Whether this region has gateway hub id explicitly set
   *
   * @since 4.2
   */
  private boolean hasGatewayHubId = false;
  /**
...
/**
   ...
   * @since 7.5
   */
  private boolean hasEnableOffHeapMemory = false;
  ...
  public boolean hasEnableGateway()
  {
    return this.hasEnableGateway;
  }
  public boolean hasGatewayHubId()
  {
    return this.hasGatewayHubId;
  }
  ...
  public boolean hasEnableOffHeapMemory() {
    return this.hasEnableOffHeapMemory;
  }
  ...
  public void setHasEnableGateway(boolean hasEnableGateway)
  {
    this.hasEnableGateway = hasEnableGateway;
  }
  public void setHasGatewayHubId(boolean hasGatewayHubId) {
    this.hasGatewayHubId = true;
  }
  ...
  public void setHasEnableOffHeapMemory(boolean hasEnableOffHeapMemory) {
    this.hasEnableOffHeapMemory = hasEnableOffHeapMemory;
  }
...
//    this.hasValueConstraint = b;
  ...
  private static final int HAS_COUNT = 45;
