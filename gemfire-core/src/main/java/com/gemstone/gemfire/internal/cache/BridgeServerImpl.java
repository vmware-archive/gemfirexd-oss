...
//    setTransactionTimeToLive(other.getTransactionTimeToLive());  not implemented in CacheServer for v6.6
  ...
  public synchronized void stop() {
    ...
    try {
      ...
      cache.getLogger().convertToLogWriterI18n().warning(LocalizedStrings.BridgeServerImpl_CACHESERVER_ERROR_CLOSING_ACCEPTOR_MONITOR, e);
    ...
    // TODO: merge: update for new TX impl
