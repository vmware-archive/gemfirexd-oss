...
public abstract class EnumListenerEvent
  ...
  public static final EnumListenerEvent AFTER_BULK_DML_OP = new AFTER_BULK_DML_OP(); // 18

  public static final EnumListenerEvent TIMESTAMP_UPDATE = new TIMESTAMP_UPDATE(); // 19
  ...
  private static EnumListenerEvent[] instances = new EnumListenerEvent[] {
    ...
    AFTER_REGISTER_DATASERIALIZER, AFTER_TOMBSTONE_EXPIRATION, AFTER_BULK_DML_OP,
    TIMESTAMP_UPDATE
  };
  ...
  private static class AFTER_BULK_DML_OP extends EnumListenerEvent {
    protected AFTER_BULK_DML_OP() {
      super("AFTER_BULK_DML_OP");
    }
   ...
   * <li>18 - AFTER_BULK_DML_OP
   * <li>19 - TIMESTAMP_UPDATE
   * </ul>
   * 
   * @param eventCode
