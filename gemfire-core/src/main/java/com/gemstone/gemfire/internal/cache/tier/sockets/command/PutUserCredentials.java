    ...
    if (isSecureMode) {
      ...
      if (numberOfParts == 1) {
        ...
        try {
          ...
          if (servConn.getSecurityLogger().warningEnabled()) {
            servConn.getSecurityLogger().warning(LocalizedStrings.ONE_ARG,
          ...
          if (servConn.getLogger().warningEnabled()) {
            servConn.getLogger().warning(LocalizedStrings
