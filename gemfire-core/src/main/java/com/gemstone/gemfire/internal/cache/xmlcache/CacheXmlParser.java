...
public class CacheXmlParser extends CacheXml implements ContentHandler {
   ...
   * {@link Cache}, etc.
   *
   * @param logwriter a <code>LogWriterI18n</code> currently meant for testing
   *          purposes
   *
...
//  /**
//   * Parse XML data in the <code>InputStream</code>
//   *
...
//  }
  ...
  /**
   * When a <code>gateway-hub</code> element is first encountered,
   * create a new <code>GatewayHub</code> in the cache.
   *
   * @since 4.2
   */
...
//    stack.push(sender);
  ...
  /**
   * When a <code>gateway</code> element is first encountered, create
   * a new <code>Gateway</code> in the cache.
   *
   * @since 4.2
   */
  ...
  /**
   * When a <code>gateway-endpoint</code> element is first encountered,
   * create a new endpoint for the current <code>Gateway</code>.
   *
   * @since 4.2
   */
  ...
  /**
   * When a <code>gateway-queue</code> element is first encountered,
   * create a new <code>GatewayQueueAttributes</code> for the current
   * <code>Gateway</code>.
   *
   * @since 4.2
   */
  ...
  /**
   * Pop the <code>GatewayHub</code> off the stack and set
   * it in the <code>Cache</code>.
   *
   * @since 4.2
   */
  ...
  /**
   * Pop the <code>Gateway</code> off the stack and add
   * it to the <code>GatewayHub</code>'s known <code>Gateway</code>s.
   *
   * @since 4.2
   */
  ...
  /**
   * When a <code>gateway-listener</code> element is encountered,
   * create a new listener for the current <code>Gateway</code>.
   *
   * @since 5.1
   */
...
//    this.cache.setGatewayConflictResolver((GatewayConflictResolver)d);
  ...
  /**
   * When a <code>hdfs-compaction</code> element is first encountered, we
