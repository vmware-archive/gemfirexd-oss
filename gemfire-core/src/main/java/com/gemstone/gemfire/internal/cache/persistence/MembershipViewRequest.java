...
//      exception = new ReplyException(e);
      ...
      replyMsg.view= view;
      log.fine("MembershipViewRequest returning view " + view + " for region " + this.regionPath);
      if(exception != null) {
  ...
  private static class MembershipViewRequestReplyProcessor extends ReplyProcessor21 {
    ...
    public void process(DistributionMessage msg) {
      if(msg instanceof MembershipViewReplyMessage) {
        ...
        InternalDistributedSystem.getLoggerI18n().fine("MembershipViewReplyProcessor received " + view);
        if(view != null) {
          synchronized(this) {
            this.views.add(view);
          }
