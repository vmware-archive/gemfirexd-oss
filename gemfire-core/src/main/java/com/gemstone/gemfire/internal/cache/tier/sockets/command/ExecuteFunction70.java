...
public class ExecuteFunction70 extends ExecuteFunction66 {
  ...
  protected void executeFunctionOnGroups(Object function, Object args,
    ...
    if (logger.fineEnabled()) {
      logger.fine("Executing Function on Groups: " + Arrays.toString(groups)
          + " all members:" + allMembers + " members are:" + members);
    }
    ...
    if (ignoreFailedMembers) {
      if (logger.fineEnabled()) {
        logger.fine("Function will ignore failed members");
      }
