...
public class AuthorizeRequest {
  ...
  public PutAllOperationContext putAllAuthorize(String regionName, Map map)
  throws NotAuthorizedException {
  ...
  public ExecuteFunctionOperationContext executeFunctionAuthorize(
      String functionName, String region, Set keySet, boolean optimizeForWrite)
      throws NotAuthorizedException {
    ExecuteFunctionOperationContext executeContext = new ExecuteFunctionOperationContext(
        functionName, region, keySet, optimizeForWrite, false);
  ...
  public String toString() {
    return this.id.toString() + ",Principal:"
