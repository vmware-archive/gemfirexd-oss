...
public class MemoryThresholds {
   ...
   * a down event
   */
  private static final double THRESHOLD_THICKNESS = Double.parseDouble(System.getProperty(ResourceManager.THRESHOLD_THICKNESS_PROP,
      "2.00"));
  ...
  private static final double THRESHOLD_THICKNESS_EVICT = Double.parseDouble(System.getProperty(
      ResourceManager.THRESHOLD_THICKNESS_EVICT_PROP, Double.toString(THRESHOLD_THICKNESS)));
