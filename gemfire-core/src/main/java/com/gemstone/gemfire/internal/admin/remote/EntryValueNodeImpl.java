...
//    if (arrayObj != null) (cannot be null) 
    {
      ...
      if (arrayObj instanceof Object[]) {
        ...
        children = new EntryValueNodeImpl[array.length];
        for (int i = 0; i<array.length; i++) {
          children[i] = createFromPrimitive("[" + i + "]", elType, Character.valueOf(array[i]));
        }
        node.fields = children;
        ...
        children = new EntryValueNodeImpl[array.length];
        for (int i = 0; i<array.length; i++) {
          children[i] = createFromPrimitive("[" + i + "]", elType, Byte.valueOf(array[i]));
        }
        node.fields = children;
        ...
        children = new EntryValueNodeImpl[array.length];
        for (int i = 0; i<array.length; i++) {
          children[i] = createFromPrimitive("[" + i + "]", elType, Short.valueOf(array[i]));
        }
        node.fields = children;
      }
    }
