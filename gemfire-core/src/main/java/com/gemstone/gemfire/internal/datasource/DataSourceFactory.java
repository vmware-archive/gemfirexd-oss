...
public class DataSourceFactory  {
  ...
  public static DataSource getSimpleDataSource(Map configMap, List props)
    ...
    if (configs.getJDBCDriver() == null) {
      ...
      if (writer.errorEnabled()) writer.error(LocalizedStrings.DataSourceFactory_DATASOURCEFACTORYGETSIMPLEDATASOURCEJDBC_DRIVER_IS_NOT_AVAILABLE);
    ...
    if (configs.getURL() == null) {
      LogWriterI18n writer = TransactionUtils.getLogWriterI18n();
      if (writer.errorEnabled()) writer.error(LocalizedStrings.DataSourceFactory_DATASOURCEFACTORYGETSIMPLEDATASOURCEURL_STRING_TO_DATABASE_IS_NULL);
    ...
    try {
      ...
      LogWriterI18n writer = TransactionUtils.getLogWriterI18n();
      if (writer.errorEnabled()) writer.error(LocalizedStrings.DataSourceFactory_DATASOURCEFACTORY_GETSIMPLEDATASOURCE_EXCEPTION_WHILE_CREATING_GEMFIREBASICDATASOURCE_EXCEPTION_STRING_0, ex.getLocalizedMessage(), ex);
  ...
  public static ClientConnectionFactoryWrapper getManagedDataSource(
    ...
    if (configs.getMCFClass() == null) {
      LogWriterI18n writer = TransactionUtils.getLogWriterI18n();
      if (writer.errorEnabled()) writer.error(LocalizedStrings.DataSourceFactory_DATASOURCEFACTORYGETMANAGEDDATASOURCEMANAGED_CONNECTION_FACTORY_CLASS_IS_NOT_AVAILABLE);
      ...
      try {
        ...
        LogWriterI18n writer = TransactionUtils.getLogWriterI18n();
        if (writer.errorEnabled()) writer.error(LocalizedStrings.DataSourceFactory_DATASOURCEFACTORYGETMANAGEDDATASOURCE_EXCEPTION_IN_CREATING_MANAGED_CONNECTION_FACTORY_EXCEPTION_STRING_0, ex, null);
  ...
  public static DataSource getPooledDataSource(Map configMap, List props)
    ...
    if (connpoolClassName == null) {
      LogWriterI18n writer = TransactionUtils.getLogWriterI18n();
      if (writer.errorEnabled()) writer.error(LocalizedStrings.DataSourceFactory_DATASOURCEFACTORYGETPOOLEDDATASOURCECONNECTIONPOOLDATASOURCE_CLASS_NAME_FOR_THE_RESOURCEMANAGER_IS_NOT_AVAILABLE);
    ...
    try {
      ...
      LogWriterI18n writer = TransactionUtils.getLogWriterI18n();
      if (writer.errorEnabled()) writer.error(LocalizedStrings.DataSourceFactory_DATASOURCEFACTORY_GETPOOLEDDATASOURCE_EXCEPTION_CREATING_CONNECTIONPOOLDATASOURCE_EXCEPTION_STRING_0, ex, ex);
  ...
  public static DataSource getTranxDataSource(Map configMap, List props)
    ...
    if (xaClassName == null) {
      LogWriterI18n writer = TransactionUtils.getLogWriterI18n();
      if (writer.errorEnabled()) writer.error(LocalizedStrings.DataSourceFactory_DATASOURCEFACTORYGETTRANXDATASOURCEXADATASOURCE_CLASS_NAME_FOR_THE_RESOURCEMANAGER_IS_NOT_AVAILABLE);
    ...
    try {
      ...
      LogWriterI18n writer = TransactionUtils.getLogWriterI18n();
      if (writer.errorEnabled()) writer.error(LocalizedStrings.DataSourceFactory_DATASOURCEFACTORY_GETTRANXDATASOURCE_EXCEPTION_IN_CREATING_GEMFIRETRANSACTIONDATASOURCE__EXCEPTION_STRING_0, ex, ex);
      throw new DataSourceCreateException(exception, ex);
    }
  }
