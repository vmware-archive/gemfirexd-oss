...
//  }
  ...
  protected class ResultsBagIterator implements Iterator {
    final TObjectIntIterator mapIterator = GfshResultsBag.this.map.iterator();
    Object current = null;
...
//      }
  ...
  class SetView extends AbstractSet {
    ...
    public class SetViewIterator implements Iterator {
      ...
      final TObjectIntIterator it = GfshResultsBag.this.map.iterator();
      ...
      public void remove() {
        ...
        synchronized (GfshResultsBag.this.limitLock) {
          if(currentIsNull) {
            ...
            Object key = this.it.key();
            int count = GfshResultsBag.this.map.remove(key);
