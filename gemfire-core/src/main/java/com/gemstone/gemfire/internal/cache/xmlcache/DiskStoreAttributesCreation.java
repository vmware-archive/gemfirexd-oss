...
//  private static final DiskStoreFactory defaultFactory = new DiskStoreFactoryImpl();
  ...
  public DiskStoreAttributesCreation(DiskStoreAttributes attrs) {
    ...
    this.syncWrites = attrs.getSyncWrites();
  ...
  public boolean sameAs(DiskStore other) {
    ...
    if (this.getMaxOplogSizeInBytes() != other.getMaxOplogSize()*1024*1024) {
      throw new RuntimeException(LocalizedStrings.DiskStoreAttributesCreation_MAXOPLOGSIZE_OF_0_IS_NOT_THE_SAME_THIS_1_OTHER_2.toLocalizedString(new Object[] {name, getMaxOplogSizeInBytes()/(1024*1024), other.getMaxOplogSize()}));
    }
  ...
  public void setMaxOplogSize(long maxOplogSize) {
    this.setMaxOplogSizeInBytes(maxOplogSize *1024*1024);
