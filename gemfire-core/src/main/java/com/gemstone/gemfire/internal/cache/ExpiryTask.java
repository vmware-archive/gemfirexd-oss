...
public abstract class ExpiryTask extends SystemTimer.SystemTimerTask {
      ...
      ThreadFactory tf = new ThreadFactory() {
          ...
          public Thread newThread(final Runnable command) {
            ...
            final ThreadGroup group =
              LogWriterImpl.createThreadGroup(name, (LogWriterI18n)null);
  ...
  public final void run2() {
    try {
      ...
      getLoggerI18n().severe(LocalizedStrings.ExpiryTask_EXCEPTION_IN_EXPIRATION_TASK, ex);
    }
  }
      ...
      // @todo grid: do we need to deal with pool exceptions here?
       ...
       if (cause instanceof RegionDestroyedException ||
         ...
         if (logger.fineEnabled()) {
           logger.fine("Exception in expiration task", ex);
         }
  ...
  public LogWriterI18n getLoggerI18n() {
    return getLocalRegion().getCache().getLoggerI18n();
  }
