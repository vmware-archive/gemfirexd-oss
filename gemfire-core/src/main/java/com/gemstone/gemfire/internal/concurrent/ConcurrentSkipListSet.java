 ...
 * http://gee.cs.oswego.edu/cgi-bin/viewcvs.cgi/jsr166/src/jdk7/java/util/concurrent/ConcurrentSkipListSet.java?revision=1.1
 */
 ...
 * creation of the iterator.  They do <em>not</em> throw <code>
 ...
 * @since 1.6
 */
public final class ConcurrentSkipListSet<E>
    ...
    public ConcurrentSkipListSet(Comparator<? super E> comparator) {
        m = new ConcurrentSkipListMap<E, Object>(comparator, false, false);
    }
    ...
    public ConcurrentSkipListSet(SortedSet<E> s) {
        m = new ConcurrentSkipListMap<E, Object>(s.comparator(), false, false);
        addAll(s);
    }
    ...
    <V> ConcurrentSkipListSet(ConcurrentNavigableMap<E, V> m) {
        this.m = (ConcurrentNavigableMap<E, Object>)m;
    }
    ...
    public Object clone() {
        ...
        return new ConcurrentSkipListSet<E>(
            new ConcurrentSkipListMap<E, Object>(this.m));
    }
    ...
    public NavigableSet<E> subSet(E fromElement,
                                  ...
                                  boolean toInclusive) {
	return new ConcurrentSkipListSet<E>
            ((ConcurrentNavigableMap<E, Object>)
	...
	return new ConcurrentSkipListSet<E>(
               (ConcurrentNavigableMap<E, Object>)m.headMap(toElement,
                   inclusive));
    }
    ...
    public NavigableSet<E> tailSet(E fromElement, boolean inclusive) {
        return new ConcurrentSkipListSet<E>(
            (ConcurrentNavigableMap<E, Object>)m.tailMap(fromElement,
                inclusive));
    }
	...
	return new ConcurrentSkipListSet<E>(
               (ConcurrentNavigableMap<E, Object>)m.descendingMap());
    }
}
