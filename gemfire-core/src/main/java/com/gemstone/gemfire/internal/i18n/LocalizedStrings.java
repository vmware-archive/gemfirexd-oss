...
public class LocalizedStrings extends ParentLocalizedStrings {
  ...
  public static final StringId GemFireUtilLauncher_Agent_Usage = new StringIdImpl(5127, "Starts/stops a GemFire JMX Agent, or provides status of a running one");
  public static final StringId SnappyUtilLauncher_Agent_Usage = new StringIdImpl(5127, "Starts/stops a Snappy JMX Agent, or provides status of a running one");
