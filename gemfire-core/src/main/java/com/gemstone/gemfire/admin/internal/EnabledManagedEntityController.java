...
//  private static Object startStopLock = new Object();
  ...
  EnabledManagedEntityController(AdminDistributedSystem system) {
    this.system = system;
    this.threadGroup =
      LogWriterImpl.createThreadGroup("ManagedEntityController threads",
                                      system.getLogWriter().convertToLogWriterI18n());
  }
  ...
  protected String execute(String command,
    ...
    this.system.getLogWriter().convertToLogWriterI18n().info( LocalizedStrings.ManagedEntityController_EXECUTING_REMOTE_COMMAND_0_IN_DIRECTORY_1, new Object[] {command, workingDir});
    Process p = null;
    try {
      ...
      this.system.getLogWriter().convertToLogWriterI18n().severe(LocalizedStrings.ManagedEntityController_WHILE_EXECUTING_0, command, e);
      return null;
    }
    ...
    final LogWriterI18n lwI18n = this.system.getLogWriter().convertToLogWriterI18n();
    lwI18n.info(LocalizedStrings.ManagedEntityController_RESULT_OF_EXECUTING_0_IS_1, new Object[] {command, Integer.valueOf(retCode)});
    lwI18n.info(LocalizedStrings.ManagedEntityController_OUTPUT_OF_0_IS_1, new Object[] {command, output});

    if (retCode != 0 || outputIsError(output)) {
      lwI18n.warning(LocalizedStrings.ManagedEntityController_REMOTE_EXECUTION_OF_0_FAILED, command);
      return null;
    }
