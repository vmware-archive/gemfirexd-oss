...
public class PortfolioPdxVersion1 implements Serializable, PdxSerializable  {

  private int ID;
  public String pkid;
  public PositionPdxVersion1 position1;
  public PositionPdxVersion1 position2;
  ...
  public PositionPdxVersion1 getP1() {
    return position1;
  }

  public PositionPdxVersion1 getP2() {
    return position2;
  }
...
//    GemFireCacheImpl.getInstance().getLoggerI18n().fine(new Exception("DEBUG"));
  ...
  public PortfolioPdxVersion1(int i) {
    ...
    type = "type" + (i % 3);
    position1 = new PositionPdxVersion1(secIds[PositionPdxVersion1.cnt % secIds.length],
        PositionPdxVersion1.cnt * 1000);
    if (i % 2 != 0) {
      position2 = new PositionPdxVersion1(secIds[PositionPdxVersion1.cnt % secIds.length],
          PositionPdxVersion1.cnt * 1000);
    }
    else {
      position2 = null;
    ...
    positions.put(secIds[PositionPdxVersion1.cnt % secIds.length], new PositionPdxVersion1(
        secIds[PositionPdxVersion1.cnt % secIds.length], PositionPdxVersion1.cnt * 1000));
    positions.put(secIds[PositionPdxVersion1.cnt % secIds.length], new PositionPdxVersion1(
        secIds[PositionPdxVersion1.cnt % secIds.length], PositionPdxVersion1.cnt * 1000));
...
//    GemFireCacheImpl.getInstance().getLoggerI18n().fine(new Exception("DEBUG"));
  ...
  public PortfolioPdxVersion1(int i, int j){
    this(i);
    this.position1.portfolioId = j;
    this.position3 = new Object[3];
    for (int k=0; k < position3.length; k++) {
      PositionPdxVersion1 p = new PositionPdxVersion1(secIds[k], (k+1) * 1000);
      p.portfolioId = (k+1);
      this.position3[k] = p;
    }
  }
  ...
  public boolean equals(Object o) {
    if (!(o instanceof PortfolioPdxVersion1)) {
      /*
      GemFireCacheImpl.getInstance().getLoggerI18n().fine("### Not of same type : this :" + 
          this.getClass().getName() + ":" + System.identityHashCode(this.getClass()) + 
          " Other :" + o.getClass().getName() + System.identityHashCode(o.getClass()));
      */
      return false;
    }
    PortfolioPdxVersion1 p2 = (PortfolioPdxVersion1)o;
  ...
  public String toString() {
    String out = this.getClass().getName() + " [ID=" + ID + " status=" + status + " type=" + type
        + " pkid=" + pkid + "\n ";
  ...
  public void fromData(PdxReader in) {
    ...
    this.position1 = (PositionPdxVersion1)in.readObject("position1");
    this.position2 = (PositionPdxVersion1)in.readObject("position2");   
    ...
    //GemFireCacheImpl.getInstance().getLoggerI18n().fine("PdxVersionFromData()", new Exception("DEBUG"));

  }
  
  public void toData(PdxWriter out) {
    out.writeInt("ID", this.ID);
    //out.writeInt("ID", this.ID).markIdentityField("ID");  
