...
public class PdxVersionedQueryObject extends VersionedQueryObject implements PdxSerializable {
  ...
  public PdxVersionedQueryObject() {
    myVersion = "testsVersions/version2/util.PdxVersionedQueryObject";
  }
  ...
  public void toData(PdxWriter writer) {
    Log.getLogWriter().info("In testsVersions/version2/util.PdxVersionedQueryObject.toData, " +
      " calling MyToData...");
    myToData(writer);
  }
  ...
  public void fromData(PdxReader reader) {
    Log.getLogWriter().info("In testsVersions/version2/util.PdxVersionedQueryObject.fromData, " +
      " calling myFromData...");
    myFromData(reader);
  }
