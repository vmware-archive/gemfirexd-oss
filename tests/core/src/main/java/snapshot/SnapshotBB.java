...
public class SnapshotBB extends Blackboard {
  ...
  public static SnapshotBB bbInstance = null;

  // Blackboard creation variables
  static String BB_NAME = "Snapshot_Blackboard";
  ...
  public static final String expectOfflineExceptionKey = "expectOfflineException";

  public static final String regionSnapshotKey = "snapshotKey";
  public static final String diskSnapshot = "diskSnapshot";
  ...
  public static SnapshotBB getBB() {
    if (bbInstance == null) {
      synchronized (SnapshotBB.class) {
        if (bbInstance == null) 
          bbInstance = new SnapshotBB(BB_NAME, BB_TYPE);
      }
    }
    return bbInstance;
  }
   ...
   */
  public SnapshotBB(String name, String type) {
    super(name, type, SnapshotBB.class);
  }
