...
/**
 * A class used to store parameters for the ldap scheme.
 */
public class LdapUserPasswordPrms extends BasePrms {

  public static final String DEFAULT_USERNAME = "gemfire1";
  public static final String DEFAULT_PASSWORD = "gemfire1";
