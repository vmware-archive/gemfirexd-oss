 ...
 *
 */
public class DiskDistributedNoAckAsyncOverflowRegionTest extends DiskDistributedNoAckRegionTestCase {
  
  /** Creates a new instance of DiskDistributedNoAckSyncOverflowRegionTest */
  public DiskDistributedNoAckAsyncOverflowRegionTest(String name) {
    super(name);
  }
  ...
  protected RegionAttributes getRegionAttributes() {
    ...
    factory.setDiskStoreName(getCache().createDiskStoreFactory()
                             ...
                             .setQueueSize(0)
                             .create("DiskDistributedNoAckAsyncOverflowRegionTest")
                             .getName());
