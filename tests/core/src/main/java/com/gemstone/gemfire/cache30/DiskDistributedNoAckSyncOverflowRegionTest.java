 ...
 *
 */
public class DiskDistributedNoAckSyncOverflowRegionTest extends DiskDistributedNoAckRegionTestCase {
  
  /** Creates a new instance of DiskDistributedNoAckSyncOverflowRegionTest */
  public DiskDistributedNoAckSyncOverflowRegionTest(String name) {
    super(name);
  }
  ...
  protected RegionAttributes getRegionAttributes() {
    ...
    factory.setDiskStoreName(getCache().createDiskStoreFactory()
                             ...
                             .create("DiskDistributedNoAckSyncOverflowRegionTest")
                             .getName());
