...
public class ConcurrentSkipListSetJUnitTest extends JSR166TestCase {

    public ConcurrentSkipListSetJUnitTest(String name) {
      super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(ConcurrentSkipListSetJUnitTest.class);
    }
