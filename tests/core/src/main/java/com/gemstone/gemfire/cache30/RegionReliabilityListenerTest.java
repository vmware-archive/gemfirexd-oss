 ...
 * @since 5.0
 */
public class RegionReliabilityListenerTest extends ReliabilityTestCase {
  ...
  public void testRoleGainAndLoss() throws Exception {
    ...
    final RegionRoleListener listener = 
      ...
      public void afterRoleGain(RoleEvent event) {
        RegionReliabilityListenerTest.rolesGain = event.getRequiredRoles();
      }
      public void afterRoleLoss(RoleEvent event) {
        RegionReliabilityListenerTest.rolesLoss = event.getRequiredRoles();
      }
    };
