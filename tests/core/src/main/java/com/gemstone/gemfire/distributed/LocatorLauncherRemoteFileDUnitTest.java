...
public class LocatorLauncherRemoteFileDUnitTest extends LocatorLauncherRemoteDUnitTest {
  ...
  public void testStatusUsingPid() throws Throwable {
    ...
    try {
      ...
      final File pidFile = new File(this.workingDirectory, ProcessType.LOCATOR.getPidFileName());
