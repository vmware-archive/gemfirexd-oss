...
public class MiscellaneousCommandsExportLogsPart3DUnitTest extends
    CliCommandTestBase {
  ...
  public void testExportLogsForGroup() throws IOException {
    ...
    Result cmdResult = misc
        .exportLogsPreprocessing( "./testExportLogsForGroup" + dir, groups, null, logLevel, false, false, start, end, 1);
    ...
    if (cmdResult != null) {
      ...
      getLogWriter().info(
          "testExportLogsForGroup cmdStringRsult=" + cmdStringRsult);      
  ...
  public void testExportLogsForMember() throws IOException {
    ...
    Result cmdResult = misc
        .exportLogsPreprocessing( "./testExportLogsForMember" + dir, null, vm1MemberId, logLevel, false, false, start, end, 1);
    ...
    if (cmdResult != null) {
      String cmdStringRsult = commandResultToString((CommandResult)cmdResult);
      getLogWriter().info(
          "testExportLogsForMember cmdStringRsult=" + cmdStringRsult);
            assertEquals(Result.Status.OK, cmdResult.getStatus());
    } else {
