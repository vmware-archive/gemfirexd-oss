...
public class RangeIndexAPITest extends TestCase {
  ...
  public RangeIndexAPITest(String testName) {
    super(testName);
  }
  
  public static void main(String[] args) {
    junit.textui.TestRunner.run(new TestSuite(RangeIndexAPITest.class));
  }
  ...
  private void bindIterators(ExecutionContext context, String string) throws AmbiguousNameException, TypeMismatchException, NameResolutionException {
    QCompiler compiler = new QCompiler(CacheUtils.getCache().getLoggerI18n());
