...
public class BlockingTimeOutDUnitTest extends DistributedTestCase {
...
//    String lineSep = System.getProperty("\n");
  ...
  public static void testBlockingTimeOut() throws Throwable {
    ...
    AsyncInvocation asyncObj = vm0.invokeAsync(BlockingTimeOutDUnitTest.class,
        "runTest2");
  ...
  public static void runTest1() throws Exception {
    ...
    try {
      ...
      getLogWriter().fine("Success SQLException caught in runTest1: " + e);
      fail("runTest1 SQL Exception caught: " + e);
    }
    catch (Exception e) {
      getLogWriter().fine("Exception caught in runTest1: " + e);
  ...
  public static void runTest2() throws Exception {
    final int MAX_CONNECTIONS = 2;
    getLogWriter().fine("runTest2 sleeping");
    ...
    try {
      for (int count = 0; count < MAX_CONNECTIONS; count++) {
        ...
        getLogWriter().fine("runTest2 :acquired connection #" + count);
      }
    }
    catch (SQLException sqle) {
      getLogWriter().fine("SQLException caught in runTest2: " + sqle);
      fail("failed because of SQL exception : " + sqle);
      sqle.printStackTrace();
    }
    catch (Exception e) {
      getLogWriter().fine("Exception caught in runTest2: " + e);
