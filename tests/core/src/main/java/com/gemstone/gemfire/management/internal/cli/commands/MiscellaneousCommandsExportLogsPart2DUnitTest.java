...
public class MiscellaneousCommandsExportLogsPart2DUnitTest extends
    CliCommandTestBase {
  ...
  //Commented out due to cc failure (bug #47839)
  /*
  public void testExportLogsForLogLevel() throws IOException {
    ...
    Result cmdResult = misc
        .exportLogsPreprocessing( "./testExportLogsForLogLevel" + dir, null, null, logLevel, false, false, start, end, 1);
    ...
    if (cmdResult != null) {
      ...
      getLogWriter().info(
          "testExportLogsForLogLevel cmdStringRsult=" + cmdStringRsult);
  ...
  */
  ...
  public void testExportLogsForLogLevelWithUPTOLOGLEVEL() throws IOException {
    ...
    Result cmdResult = misc
        .exportLogsPreprocessing( "./testExportLogsForLogLevelWithUPTOLOGLEVEL" + dir, null, null, logLevel, true, false, start, end, 1);
    ...
    if (cmdResult != null) {
      String cmdStringRsult = commandResultToString((CommandResult)cmdResult);
      getLogWriter().info(
          "testExportLogsForLogLevelWithUPTOLOGLEVEL cmdStringRsult="
              + cmdStringRsult);
    ...
    FileUtil.delete(new File("testExportLogsForLogLevelWithUPTOLOGLEVEL"
        + dir));
  }
}