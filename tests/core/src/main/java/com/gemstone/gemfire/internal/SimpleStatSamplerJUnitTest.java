...
public class SimpleStatSamplerJUnitTest extends StatSamplerTestCase {
  ...
  public void testSampleRate() throws Exception {
    ...
    DistributedTestCase.waitForCriterion(wc, 20000, 10, true);
  }
  ...
  public void testStop() throws Exception{
    ...
    DistributedTestCase.waitForCriterion(wc, 5000, 10, false);
  ...
  public void testArchiveRolling() throws Exception {
    ...
    DistributedTestCase.waitForCriterion(wc, 4000, 10, true);
  ...
  public void testArchiveRemoval() throws Exception {
    ...
    DistributedTestCase.waitForCriterion(wc, 4*sampleRate, 10, true);
    ...
    DistributedTestCase.waitForCriterion(wc, 10*sampleRate, 10, true);
  }
