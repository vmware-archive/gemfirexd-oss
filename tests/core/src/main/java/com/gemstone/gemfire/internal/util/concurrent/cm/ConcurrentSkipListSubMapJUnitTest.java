...
public class ConcurrentSkipListSubMapJUnitTest extends JSR166TestCase {

    public ConcurrentSkipListSubMapJUnitTest(String name) {
      super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(ConcurrentSkipListSubMapJUnitTest.class);
    }
