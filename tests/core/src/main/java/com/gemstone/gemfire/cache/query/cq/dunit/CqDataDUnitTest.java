...
public class CqDataDUnitTest extends CacheTestCase {
  ...
  /**
   * Test for CQ with ConnectionPool... BridgeWriteR?? Is it definitely needed?.
   * @throws Exception
   */
  public void testCQWithBridgeWriter() throws Exception {
    ...
    // Create CQs.
    cqDUnitTest.createCQ(client, "testCQWithBridgeWriter_2", cqDUnitTest.cqs[0]);  

    // This should pass.
    cqDUnitTest.executeCQ(client, "testCQWithBridgeWriter_2", false, null);
