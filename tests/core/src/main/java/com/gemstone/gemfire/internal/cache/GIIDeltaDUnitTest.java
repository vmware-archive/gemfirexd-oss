...
//  }
  ...
  protected void prepareForEachTest() {
    ...
    // from now on, use P and R as vmhttps://wiki.gemstone.com/display/gfepersistence/DeltaGII+Spec+for+7.5
   ...
   * vm1 becomes offline then restarts. https://wiki.gemstone.com/display/gfepersistence/DeltaGII+Spec+for+7.5
...
//          CCRegion = (LocalRegion)f.create(REGION_NAME);
          ...
          getLogWriter().info("In createDistributedRegion, using hydra.Log.getLogWriter()");
          lr.getLogWriterI18n().info(LocalizedStrings.DEBUG, "In createDistributedRegion, using region.getLogWriterI18n()");
