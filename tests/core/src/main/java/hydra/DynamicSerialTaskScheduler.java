 ...
 */
public class DynamicSerialTaskScheduler
extends SimpleSerialTaskScheduler {
   ...
   *  @param disconnect whether to disconnect from gemfire on exit
   */
  public DynamicSerialTaskScheduler( String name,
                                     Vector tasks,
                                     String purpose,
                                     ClientVmRecord vm,
                                     boolean disconnect ) {
  ...
  /**
   *  Overrides {@link BaseTaskScheduler#executeTasks(long)} to allow current
   *  tasks to complete and to skip executing tasks if the test is failing.
   */
