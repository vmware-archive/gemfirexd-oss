...
public abstract class Workload
{
       ...
       * @param threadId thread id of the calling thread, where the thread ids
       *                 are numbered from 0 to threads-1
       * @param threads total number of threads running the workload
       */
	 ...
	 return null;
       ...
       */
      public abstract void doInsert(DB db, Object threadstate);
       ...
       * synchronized, since each thread has its own threadstate instance.
       */
      public abstract void doTransaction(DB db, Object threadstate);
}
