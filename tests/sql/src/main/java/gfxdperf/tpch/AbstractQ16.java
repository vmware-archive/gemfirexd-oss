...
/**
 * Encapsulates TPC-H Q16.
 */
public abstract class AbstractQ16 extends Query {
...
// TBD
  ...
  public AbstractQ16() {
    ...
    queryName = "Q16";
    query = "TBD";
    throw new PerfTestException("Query 16 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 16 is not yet implemented");
      return sb.toString();
    }
