...
/**
 * Encapsulates TPC-H Q12.
 */
public abstract class AbstractQ12 extends Query {
...
// TBD
  ...
  public AbstractQ12() {
    ...
    queryName = "Q12";
    query = "TBD";
    throw new PerfTestException("Query 12 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 12 is not yet implemented");
      return sb.toString();
    }
