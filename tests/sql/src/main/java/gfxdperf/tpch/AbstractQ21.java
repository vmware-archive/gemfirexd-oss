...
/**
 * Encapsulates TPC-H Q21.
 */
public abstract class AbstractQ21 extends Query {
...
// TBD
  ...
  public AbstractQ21() {
    ...
    queryName = "Q21";
    query = "TBD";
    throw new PerfTestException("Query 21 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 21 is not yet implemented");
      return sb.toString();
    }
