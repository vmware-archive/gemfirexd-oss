...
/**
 * Encapsulates TPC-H Q19.
 */
public abstract class AbstractQ19 extends Query {
...
// TBD
  ...
  public AbstractQ19() {
    ...
    queryName = "Q19";
    query = "TBD";
    throw new PerfTestException("Query 19 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 19 is not yet implemented");
      return sb.toString();
    }
