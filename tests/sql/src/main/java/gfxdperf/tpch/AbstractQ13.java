...
/**
 * Encapsulates TPC-H Q13.
 */
public abstract class AbstractQ13 extends Query {
...
// TBD
  ...
  public AbstractQ13() {
    ...
    queryName = "Q13";
    query = "TBD";
    throw new PerfTestException("Query 13 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 13 is not yet implemented");
      return sb.toString();
    }
