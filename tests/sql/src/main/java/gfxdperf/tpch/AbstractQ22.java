...
/**
 * Encapsulates TPC-H Q22.
 */
public abstract class AbstractQ22 extends Query {
...
// TBD
  ...
  public AbstractQ22() {
    ...
    queryName = "Q22";
    query = "TBD";
    throw new PerfTestException("Query 22 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 22 is not yet implemented");
      return sb.toString();
    }
