...
/**
 * Encapsulates TPC-H Q17.
 */
public abstract class AbstractQ17 extends Query {
...
// TBD
  ...
  public AbstractQ17() {
    ...
    queryName = "Q17";
    query = "TBD";
    throw new PerfTestException("Query 17 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 17 is not yet implemented");
      return sb.toString();
    }
