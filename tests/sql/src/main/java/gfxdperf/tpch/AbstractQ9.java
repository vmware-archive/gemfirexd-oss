...
/**
 * Encapsulates TPC-H Q9.
 */
public abstract class AbstractQ9 extends Query {
...
// TBD
  ...
  public AbstractQ9() {
    ...
    queryName = "Q9";
    query = "TBD";
    throw new PerfTestException("Query 9 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 9 is not yet implemented");
      return sb.toString();
    }
