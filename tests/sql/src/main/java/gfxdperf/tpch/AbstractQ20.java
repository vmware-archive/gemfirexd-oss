...
/**
 * Encapsulates TPC-H Q20.
 */
public abstract class AbstractQ20 extends Query {
...
// TBD
  ...
  public AbstractQ20() {
    ...
    queryName = "Q20";
    query = "TBD";
    throw new PerfTestException("Query 20 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 20 is not yet implemented");
      return sb.toString();
    }
