...
/**
 * Encapsulates TPC-H Q18.
 */
public abstract class AbstractQ18 extends Query {
...
// TBD
  ...
  public AbstractQ18() {
    ...
    queryName = "Q18";
    query = "TBD";
    throw new PerfTestException("Query 18 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 18 is not yet implemented");
      return sb.toString();
    }
