...
/**
 * Encapsulates TPC-H Q10.
 */
public abstract class AbstractQ10 extends Query {
...
// TBD
  ...
  public AbstractQ10() {
    ...
    queryName = "Q10";
    query = "TBD";
    throw new PerfTestException("Query 10 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 10 is not yet implemented");
      return sb.toString();
    }
