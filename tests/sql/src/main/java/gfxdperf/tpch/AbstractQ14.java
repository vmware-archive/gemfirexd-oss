...
/**
 * Encapsulates TPC-H Q14.
 */
public abstract class AbstractQ14 extends Query {
...
// TBD
  ...
  public AbstractQ14() {
    ...
    queryName = "Q14";
    query = "TBD";
    throw new PerfTestException("Query 14 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 14 is not yet implemented");
      return sb.toString();
    }
