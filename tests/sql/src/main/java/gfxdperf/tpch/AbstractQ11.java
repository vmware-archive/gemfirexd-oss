...
/**
 * Encapsulates TPC-H Q11.
 */
public abstract class AbstractQ11 extends Query {
...
// TBD
  ...
  public AbstractQ11() {
    ...
    queryName = "Q11";
    query = "TBD";
    throw new PerfTestException("Query 11 is not yet implemented");
   }
  ...
  public static class Result implements ResultRow {
    ...
    public String toString() {
      ...
      if (true) throw new PerfTestException("Query 11 is not yet implemented");
      return sb.toString();
    }
