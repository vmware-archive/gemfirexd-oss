...
public class PerfTestListAgg {

	public PerfTestListAgg() {

		try {
			String clientConnect = "jdbc:gemfirexd://localhost:1530";
			Connection cxn = DriverManager.getConnection(clientConnect);
...
System.out.println("Table="+table);
			...
			for (int i = 0; i < 1000; ++i) {
				...
				System.out.println("Where:"+whereClause+"   Duration = " + (endTime - startTime));
			}
