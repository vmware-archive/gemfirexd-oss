...
public class ListAggProcedureTest extends TestCase{
	...
	public void testQueryBuilder() {
		...
		assertTrue(query, query.equals("<local> SELECT Fld1,Agg1,Agg2 FROM MyTable ORDER BY Fld1 ASC,Agg1 ASC"));
	...
	public void testProcessInputParametersUseCase2WithWhere() {
		...
		try {
			...
			validateColumn(cols, i, new ColumnDef("Agg1",++i,","),ColumnDef.NONE);
