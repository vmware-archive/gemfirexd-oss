...
public class TestListAgg extends UseCase2Test{
  public static TestListAgg listAggTest;
  
  public static void HydraTask_testListAgg() {
    if (listAggTest == null) {
      listAggTest = new TestListAgg();
    }
    listAggTest.testListAgg();
  }
  
  protected void testListAgg() {
