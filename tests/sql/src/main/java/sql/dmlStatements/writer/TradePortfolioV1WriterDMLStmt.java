...
public class TradePortfolioV1WriterDMLStmt extends TradePortfolioV1DMLStmt {
  ...
  public void update(Connection dConn, Connection gConn, int size) {
    ...
    updateGFETable(gConn, cid, sid, qty, availQty, sub, newCid, newSid, price, data, availSize, whichUpdate);
