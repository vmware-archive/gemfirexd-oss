...
public class TradeOrderTxnInput implements TPCETxnInput {
  ...
  private BigDecimal          requested_price;
  ...
  public void setRequestedPrice(BigDecimal requested_price){
  ...
  public String toString() {
    ...
    + "\nacct_id: " + acct_id
    + "\nis_lifo: " + is_lifo
    + "\nroll_it_back: " + roll_it_back
    + "\ntrade_qty: " + trade_qty
    + "\ntype_is_margin: " + type_is_margin
    + "\ntrade_id: " + trade_id
    + "\nco_name: " + co_name
    + "\nexec_f_name: " + exec_f_name
    + "\nexec_l_name: " + exec_l_name
    + "\nexec_tax_id: " + exec_tax_id
    + "\nissue: " + issue
