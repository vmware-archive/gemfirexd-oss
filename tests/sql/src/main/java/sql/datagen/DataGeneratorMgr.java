...
public class DataGeneratorMgr {
  ...
  public void parseMapperFile(String mapperFile) {
    try {
      Connection conn = sql.GFEDBClientManager.getConnection();
      datagen.parseMapperFile(mapperFile, conn);
    } catch (Exception e) {
      throw new TestException("Error in parsing mapper", e);
    }
  }
