...
public abstract class JpaTransaction implements TPCETxnInterface {
	protected EntityManager entityManager = null;
	protected JpaTxnManager jpaTxnManager = null;
	
	public abstract TPCETxnOutput runTxn (TPCETxnInput txnInput);
}