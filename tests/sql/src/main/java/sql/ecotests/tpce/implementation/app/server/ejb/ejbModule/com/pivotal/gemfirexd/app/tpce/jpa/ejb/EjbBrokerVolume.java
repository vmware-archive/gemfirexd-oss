...
/**
 * Session Bean implementation class EJBBrokerVolume
 */
@Stateless
@LocalBean
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class EjbBrokerVolume extends JpaBrokerVolume implements EjbBrokerVolumeRemote, EjbBrokerVolumeLocal {

	@Resource
	public SessionContext context;
	
    public EjbBrokerVolume() {}
