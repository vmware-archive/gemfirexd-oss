...
public class ASCIICharBlobImportOra extends com.pivotal.gemfirexd.load.Import {
	private static Map<String, String> monthsMap = new HashMap<String, String>();

	public ASCIICharBlobImportOra(String inputFileName, String columnDelimiter,
			...
			if (ansiCharData != null) {
				...
				if (data != null) {
					...
					throw new SQLException(
							"An invalid ASCII Char string '" + ansiCharData
