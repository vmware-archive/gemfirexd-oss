...
//TO Do: It is TradeOrder logic and should be converted to TradeResult,

/**
 * The Java class for the transaction Trade-Order.
 * TPC-E Section 3.3.8.
 * This class emulates the process of completing a stock market
 * trade by Market-Exchange and is invoked by EGenDriverMEE
 */
//To-Do:

public class JpaTradeResult extends JpaTransaction {
    protected TradeResultTxnInput  toTxnInput = null;
    protected TradeResultTxnOutput toTxnOutput = null;
    ...
    public JpaTradeResult() {
    }

    @Override
    public TPCETxnOutput runTxn(TPCETxnInput txnInput) {
        toTxnInput = (TradeResultTxnInput)txnInput;
        toTxnOutput = new TradeResultTxnOutput();
        try {
            invokeFrame1();
