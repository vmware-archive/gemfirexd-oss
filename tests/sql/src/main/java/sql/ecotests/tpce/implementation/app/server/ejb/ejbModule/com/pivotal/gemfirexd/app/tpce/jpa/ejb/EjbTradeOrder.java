...
/**
 * Session Bean implementation class EJBTradeOrder
 */
@Stateless
@LocalBean
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class EjbTradeOrder extends JpaTradeOrder implements EjbTradeOrderRemote, EjbTradeOrderLocal {
	@Resource
	public SessionContext context;
	
    public EjbTradeOrder() {}
