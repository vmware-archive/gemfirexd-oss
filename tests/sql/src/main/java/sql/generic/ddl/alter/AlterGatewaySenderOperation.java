...
public class AlterGatewaySenderOperation extends Operation {

  AlterGatewaySenderOperation(String ddl , Executor executor , DDLAction action){
    super(ddl,executor,action);
  }
  
  public AlterGatewaySenderOperation parse(){
     return this;
  }
