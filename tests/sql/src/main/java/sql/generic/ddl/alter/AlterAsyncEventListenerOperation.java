...
public class AlterAsyncEventListenerOperation extends Operation {

  AlterAsyncEventListenerOperation(String ddl , Executor executor , DDLAction action){
    super(ddl,executor,action);
  }
  
  public AlterAsyncEventListenerOperation parse(){
    return this;
  }
