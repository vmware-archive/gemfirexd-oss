...
public class TradePortfolioV1DiscDMLStmt extends TradePortfolioV1DMLStmt {
  public void insert(Connection dConn, Connection gConn, int size) {
    try {
      ...
      } else if (isOfflineTest && !SQLTest.syncHAForOfflineTest && 
          (te.getMessage().contains("23503") || te.getMessage().contains("23505"))) {
