...
public class SQLRollingUpgradeBridgeTest extends SQLBridgeTest {
  ...
  public static void HydraTask_doDMLOpPauseAndVerify() {
    sqlrubTest.doOperationsAndPauseVerify();
  }
  
  public static void HydraTask_doOperations() {
    sqlrubTest.doOperations();
  }
  ...
  public static void HydraTask_UpgradeController() {
    sqlrubTest.rollUpgradeVMs(true);
  }
  
  public static void HydraTask_UpgradeControllerNoVerify() {
    sqlrubTest.rollUpgradeVMs(false);
  }
  ...
  public static void HydraTask_UpgradeVersion() {
	  sqlrubTest.restartVMs();
  }
  
  private void restartVMs() {
	    List<ClientVmInfo> vms = new ArrayList<ClientVmInfo>();
	    List<ClientVmInfo> allVMs = new ArrayList<ClientVmInfo>();
	    ...
	    do {
	      ClientVmInfo vmInfo = null;
	      // For upgrade we will follow a sequence of locators -> bridge servers.
	      if (allVMs.size() != 0) {
	        vmInfo = allVMs.get(0);
	        allVMs.remove(0);
	      }
