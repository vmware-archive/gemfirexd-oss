...
### RUN GFXD TESTS
runtest $1 5.thin.gfxd.bt  local.gfxd.onehop.conf  pst3.largeobject.thin.sh.5.$2.offheap

runtest $1 5.thin.gfxd.bt  local.gfxd.twohop.conf  pst3.largeobject.thin.5.$2.offheap

runtest $1 5.peer.gfxd.bt  local.peer.conf  pst3.largeobject.peer.5.$2.offheap
