...
### RUN GFXD TESTS
runtest $1 pst1.gfxd.bt     local.gfxd.conf  pst1.sector.thin.9.$2
#runtest $1 pst1.gfxd.16.bt  local.gfxd.conf  pst1.sector.thin.144.$2

#------------------------------------------------------------------------------
#./startup.sh
#./getmysqlconfig.sh
#runtest $1 pst1.mysql.load.bt local.mysql.load.conf pst1.mysql.load
#runtest $1 pst1.mysql.bt local.mysql.conf pst1.mysql
#runtest $1 pst1.mysql.16.bt local.mysql.conf pst1.mysql.16
#runtest $1 pst1.mysql.drop.bt local.mysql.drop.conf pst1.mysql.drop
#./shutdown.sh
