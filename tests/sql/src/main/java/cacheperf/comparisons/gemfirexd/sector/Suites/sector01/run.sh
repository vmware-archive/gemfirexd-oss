...
runtest $1 peerClient.gfxd.more.bt   peerClient.more.local.conf peerClient.gfxd
runtest $1 thinClient.gfxd.bt        thinClient.local.conf      thinClient.gfxd
runtest $1 thinClient.gfxd.more.bt   thinClient.more.local.conf thinClient.gfxd
./startup.sh
runtest $1 thinClient.mysqlc.bt      thinClient.local.conf      thinClient.mysqlc
runtest $1 thinClient.mysqlc.more.bt thinClient.more.local.conf thinClient.mysqlc
./shutdown.sh
