...
CREATE UNIQUE INDEX SECT_CHANNEL_DATA_MATCHING_IDX
...
;
CREATE UNIQUE INDEX SECT_CHANNEL_DATA_HIT_IDX
    ON SECT_CHANNEL_DATA
    (
     CHANNEL_TXN_ID ASC
    )
...
CREATE TABLE DataHints ( client_account varchar(100), client_ref_no varchar(100), company_id varchar(100), value_date timestamp );
