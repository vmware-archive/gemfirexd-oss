    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = (SnappyType::type)ecast258;
          isset_type = true;
        } else {
...
OutputParameter::OutputParameter(const OutputParameter& other259) {
  type = other259.type;
  scale = other259.scale;
...
OutputParameter& OutputParameter::operator=(const OutputParameter& other261) {
  type = other261.type;
  scale = other261.scale;
