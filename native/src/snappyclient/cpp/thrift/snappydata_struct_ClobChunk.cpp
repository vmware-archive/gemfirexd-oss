...
void ClobChunk::__set_lobId(const int32_t val) {
  this->lobId = val;
__isset.lobId = true;
}
...
ClobChunk::ClobChunk(const ClobChunk& other48) {
  chunk = other48.chunk;
  last = other48.last;
  lobId = other48.lobId;
  offset = other48.offset;
...
ClobChunk::ClobChunk( ClobChunk&& other49) noexcept {
  ...
  offset = std::move(other49.offset);
  totalLength = std::move(other49.totalLength);
  __isset = std::move(other49.__isset);
}
ClobChunk& ClobChunk::operator=(const ClobChunk& other50) {
  chunk = other50.chunk;
  last = other50.last;
  lobId = other50.lobId;
  offset = other50.offset;
  totalLength = other50.totalLength;
...
ClobChunk& ClobChunk::operator=(ClobChunk&& other51) noexcept {
  ...
  offset = std::move(other51.offset);
  totalLength = std::move(other51.totalLength);
