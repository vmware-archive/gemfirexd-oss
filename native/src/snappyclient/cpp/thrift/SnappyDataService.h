...
class SnappyDataServiceIf {
 public:
  ...
  virtual void executeCursorUpdate(const int32_t cursorId, const std::vector<CursorUpdateOperation::type> & operations, const std::vector<Row> & changedRows, const std::vector<std::vector<int32_t> > & changedColumnsList, const std::vector<int32_t> & changedRowIndexes, const std::string& token) = 0;
...
class SnappyDataServiceNull : virtual public SnappyDataServiceIf {
 public:
  ...
  void executeCursorUpdate(const int32_t /* cursorId */, const std::vector<CursorUpdateOperation::type> & /* operations */, const std::vector<Row> & /* changedRows */, const std::vector<std::vector<int32_t> > & /* changedColumnsList */, const std::vector<int32_t> & /* changedRowIndexes */, const std::string& /* token */) {
    return;
  }
...
typedef struct _SnappyDataService_executePrepared_args__isset {
  _SnappyDataService_executePrepared_args__isset() : stmtId(false), params(false), outputParams(false), token(false) {}
  bool stmtId :1;
  bool params :1;
  bool outputParams :1;
  bool token :1;
...
typedef struct _SnappyDataService_executePreparedUpdate_args__isset {
  _SnappyDataService_executePreparedUpdate_args__isset() : stmtId(false), params(false), token(false) {}
  bool stmtId :1;
  bool params :1;
  bool token :1;
...
typedef struct _SnappyDataService_executePreparedQuery_args__isset {
  _SnappyDataService_executePreparedQuery_args__isset() : stmtId(false), params(false), token(false) {}
  bool stmtId :1;
  bool params :1;
  bool token :1;
...
typedef struct _SnappyDataService_executePreparedBatch_args__isset {
  _SnappyDataService_executePreparedBatch_args__isset() : stmtId(false), paramsBatch(false), token(false) {}
  bool stmtId :1;
  bool paramsBatch :1;
  bool token :1;
...
typedef struct _SnappyDataService_beginTransaction_result__isset {
  _SnappyDataService_beginTransaction_result__isset() : error(false) {}
  bool error :1;
...
typedef struct _SnappyDataService_beginTransaction_presult__isset {
  _SnappyDataService_beginTransaction_presult__isset() : error(false) {}
  bool error :1;
...
typedef struct _SnappyDataService_prepareCommitTransaction_args__isset {
  _SnappyDataService_prepareCommitTransaction_args__isset() : connId(false), flags(false), token(false) {}
  bool connId :1;
  bool flags :1;
  bool token :1;
} _SnappyDataService_prepareCommitTransaction_args__isset;

class SnappyDataService_prepareCommitTransaction_args {
 public:
  ...
  _SnappyDataService_prepareCommitTransaction_args__isset __isset;
  ...
  bool operator == (const SnappyDataService_prepareCommitTransaction_args & rhs) const
  {
    if (!(connId == rhs.connId))
      return false;
    if (!(flags == rhs.flags))
  ...
  bool operator < (const SnappyDataService_prepareCommitTransaction_args & ) const;
...
class SnappyDataService_prepareCommitTransaction_pargs {
 public:
...
typedef struct _SnappyDataService_prepareCommitTransaction_result__isset {
  _SnappyDataService_prepareCommitTransaction_result__isset() : success(false), error(false) {}
  bool success :1;
  bool error :1;
} _SnappyDataService_prepareCommitTransaction_result__isset;

class SnappyDataService_prepareCommitTransaction_result {
 public:
  ...
  _SnappyDataService_prepareCommitTransaction_result__isset __isset;

  void __set_success(const bool val);

  void __set_error(const SnappyException& val);

  bool operator == (const SnappyDataService_prepareCommitTransaction_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    if (!(error == rhs.error))
  ...
  bool operator < (const SnappyDataService_prepareCommitTransaction_result & ) const;
...
typedef struct _SnappyDataService_prepareCommitTransaction_presult__isset {
  _SnappyDataService_prepareCommitTransaction_presult__isset() : success(false), error(false) {}
  bool success :1;
  bool error :1;
} _SnappyDataService_prepareCommitTransaction_presult__isset;

class SnappyDataService_prepareCommitTransaction_presult {
 public:
  ...
  _SnappyDataService_prepareCommitTransaction_presult__isset __isset;
...
typedef struct _SnappyDataService_closeConnection_args__isset {
  _SnappyDataService_closeConnection_args__isset() : connId(false), token(false) {}
  bool connId :1;
  bool token :1;
...
class SnappyDataServiceClient : virtual public SnappyDataServiceIf {
 ...
 public:
  ...
  void executeCursorUpdate(const int32_t cursorId, const std::vector<CursorUpdateOperation::type> & operations, const std::vector<Row> & changedRows, const std::vector<std::vector<int32_t> > & changedColumnsList, const std::vector<int32_t> & changedRowIndexes, const std::string& token);
  void send_executeCursorUpdate(const int32_t cursorId, const std::vector<CursorUpdateOperation::type> & operations, const std::vector<Row> & changedRows, const std::vector<std::vector<int32_t> > & changedColumnsList, const std::vector<int32_t> & changedRowIndexes, const std::string& token);
...
class SnappyDataServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  SnappyDataServiceProcessor(boost::shared_ptr<SnappyDataServiceIf> iface) :
    ...
    processMap_["prepareCommitTransaction"] = &SnappyDataServiceProcessor::process_prepareCommitTransaction;
