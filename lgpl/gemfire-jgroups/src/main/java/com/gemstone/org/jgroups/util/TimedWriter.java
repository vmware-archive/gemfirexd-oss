...
//
//        if(args.length != 3) {
//            log.error(ExternalStrings.TimedWriter_TIMEDWRITER_LOCAL_HOST_REMOTE_HOST_REMOTE_PORT);
//            return;
//        }
//
//        try {
...
//        }
//        catch(Exception e) {
//            log.error(ExternalStrings.TimedWriter_COULD_FIND_HOST__0, remote);
//            return;
//        }
//
//        while(true) {
...
//                log.error(ExternalStrings.TimedWriter_TIMED_OUT_CREATING_SOCKET);
//            }
//            catch (InterruptedException e) { // GemStoneAddition
//              return; // we're in a main; just get out
//            }
//            catch(Exception io_ex) {
//                log.error(ExternalStrings.TimedWriter_CONNECTION_COULD_NOT_BE_CREATED_RETRYING);
