...
public class JGroupsVersion {
    ...
    public static final byte SQLF_11_ORDINAL = 22;
    public static final byte GFE_75_ORDINAL = 24;
    public static final byte GFXD_14_ORDINAL = 30;
    public static final byte GFXD_20_ORDINAL = 31;

    // this is re-initialized by GemFire Version when it loads
    public static short CURRENT_ORDINAL = 31;
