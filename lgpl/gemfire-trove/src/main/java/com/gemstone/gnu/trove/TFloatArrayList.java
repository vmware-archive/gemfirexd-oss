 ...
 * @version $Id: TFloatArrayList.java,v 1.15 2003/11/09 09:22:22 ericdf Exp $
 */

public class TFloatArrayList implements Serializable, Cloneable {
private static final long serialVersionUID = 4142259042805691586L;
     ...
     * the list.
     * @see #binarySearch(float) for faster searches on sorted lists
     */
     ...
     * @return the first offset of the value, or -1 if it is not in
     * the list.
     * @see #binarySearch(float, int, int) for faster searches on sorted lists
     */
