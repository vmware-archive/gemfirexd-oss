 ...
 * @version $Id: TIntObjectHashMap.java,v 1.15 2003/11/21 17:32:30 ericdf Exp $
 */
public class TIntObjectHashMap extends TIntHash implements Serializable {
    ...
    protected void rehash(int newCapacity) {
        ...
        for (int i = oldCapacity; i-- > 0;) {
          if (oldStates[i] == FULL) {
            ...
            final int index = insertionIndex(k);
            newKeys[index] = k;
    ...
    protected/*GemStoneAddition*/ final class HashProcedure implements TIntObjectProcedure {
        private int h = 0;
