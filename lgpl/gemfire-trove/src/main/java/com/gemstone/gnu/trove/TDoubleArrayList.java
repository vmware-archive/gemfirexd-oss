 ...
 * @version $Id: TDoubleArrayList.java,v 1.15 2003/11/09 09:22:22 ericdf Exp $
 */

public class TDoubleArrayList implements Serializable, Cloneable {

    private static final long serialVersionUID = 7370405796750074843L;
     ...
     * the list.
     * @see #binarySearch(double) for faster searches on sorted lists
     */
     ...
     * @return the first offset of the value, or -1 if it is not in
     * the list.
     * @see #binarySearch(double, int, int) for faster searches on sorted lists
     */
