...
public abstract class THashIterator extends TIterator implements Iterator {
     ...
     * @exception java.util.NoSuchElementException if this is called on an
     * exhausted iterator.
     */
    ...
    // GemStoneAddition
    /** set the value for a THashMap at current index */
    public abstract void setValueAtCurrent(final Object newValue);
} // THashIterator
