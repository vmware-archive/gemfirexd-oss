...
import com.gemstone.gnu.trove.TDoubleObjectHashMap;
import com.gemstone.gnu.trove.TDoubleObjectIterator;
 ...
 * @version $Id: TDoubleObjectHashMapDecorator.java,v 1.4 2004/03/18 15:30:34 ericdf Exp $
 * @since trove 0.1.8
 */
public class TDoubleObjectHashMapDecorator extends AbstractMap implements Map, Cloneable {
     ...
     * Wraps a value
     *
     * @param o a value in the underlying map
