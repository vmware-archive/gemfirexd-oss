 ...
 */
public final class TObjectIntHashMap extends TObjectHash implements Serializable {
private static final long serialVersionUID = 309134146652813984L;
     ...
     * @param tokenIfAbsent
     *          value to return if no previous value was associated with
     *          <tt>key</tt>
     * @return the previous value associated with <tt>key</tt>, or
     *         <tt>tokenIfAbsent</tt> if none was found.
     */
    public int putIfAbsent(Object key, int value, int tokenIfAbsent) {
      final Object oldKey;
     ...
     *
     * @param key an <code>Object</code> value
     * @return the value of <tt>key</tt> or 0 if no such mapping exists.
     */
    ...
    public int hashCode() { // GemStoneAddition
      return 0; // TODO make this more efficient :-)
    }
