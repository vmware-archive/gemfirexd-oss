...
public final class TIntArrayList implements Serializable, Cloneable {
    ...
    private static final long serialVersionUID = -6514945712673108507L;
     ...
     * the list.
     * @see #binarySearch(int) for faster searches on sorted lists
     */
     ...
     * @return the first offset of the value, or -1 if it is not in
     * the list.
     * @see #binarySearch(int, int, int) for faster searches on sorted lists
     */
