...
import com.gemstone.gnu.trove.TObjectDoubleHashMap;
import com.gemstone.gnu.trove.TObjectDoubleIterator;
 ...
 * @version $Id: TObjectDoubleHashMapDecorator.java,v 1.4 2004/03/18 15:30:34 ericdf Exp $
 * @since trove 0.1.8
 */
public class TObjectDoubleHashMapDecorator extends AbstractMap implements Map, Cloneable {
     ...
     * Wraps a key
     *
     * @param o a key in the underlying map
