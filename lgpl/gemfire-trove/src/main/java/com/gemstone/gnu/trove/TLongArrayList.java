...
public final class TLongArrayList implements Serializable, Cloneable {
    ...
    private static final long serialVersionUID = -8774302755765699167L;
    ...
    // GemStoneAddition
    /**
     * Adds the values in the TLongArrayList <tt>vals</tt> to the end of the
     * list, in order.
     *
     * @param vals a <code>TLongArrayList</code> value
     */
    public void add(TLongArrayList vals) {
        add(vals._data, 0, vals._pos);
    }
    ...
    // GemStoneAddition
    /**
     * Adds a subset of the values in the TLongArrayList <tt>vals</tt> to the
     * end of the list, in order.
     *
     * @param vals a <code>TLongArrayList</code> value
     * @param offset the offset at which to start copying
     * @param length the number of values to copy.
     */
    public void add(TLongArrayList vals, int offset, int length) {
        add(vals._data, offset, length);
    }
     ...
     * @return an <code>long</code> value
     */
    public final long getQuick(int offset) {
        return _data[offset];
    }
     ...
     * @param val an <code>long</code> value
     */
    public final void setQuick(int offset, long val) {
        _data[offset] = val;
    }
    ...
    public int binarySearch(long value, int fromIndex, int toIndex) {
        ...
        while (low <= high) {
            int mid = (int)(((long)low + high) >> 1); // GemStoneAddition avoid overflow
     ...
     * the list.
     * @see #binarySearch(long) for faster searches on sorted lists
     */
     ...
     * @return the first offset of the value, or -1 if it is not in
     * the list.
     * @see #binarySearch(long, int, int) for faster searches on sorted lists
     */
