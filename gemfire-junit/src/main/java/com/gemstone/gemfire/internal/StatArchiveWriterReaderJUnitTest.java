...
public class StatArchiveWriterReaderJUnitTest extends TestCase {
  ...
  public StatArchiveWriterReaderJUnitTest(String name) {
    super(name);
  }
  ...
  public void testDoubleCounterOneSample() throws Exception {
    ...
    assertEquals(value, statValues[0].getSnapshotsMostRecent());
    ...
    assertEquals(value, snapshots[0]);
  }
  ...
  public void testIntCounterOneSample() throws Exception {
    ...
    assertEquals(statName, statValues[0].getDescriptor().getName());
    assertEquals(1, statValues[0].getSnapshotsSize());
    assertEquals((double)value, statValues[0].getSnapshotsMostRecent());
    ...
    assertNotNull(snapshots);
    assertEquals(1, snapshots.length);
    assertEquals((double)value, snapshots[0]);
  }
  ...
  public void testLongGaugeOneSample() throws Exception {
    ...
    assertEquals(statName, statValues[0].getDescriptor().getName());
    assertEquals(1, statValues[0].getSnapshotsSize());
    assertEquals(5.0, statValues[0].getSnapshotsMostRecent());
  ...
  public void testLongCounterTwoSamples() throws Exception {
    ...
    assertEquals((double)(value1+value2), statValues[0].getSnapshotsMostRecent());
    ...
    assertEquals((double)value1, snapshots[0]);
    assertEquals((double)(value1+value2), snapshots[1]);
  }
  ...
  public void testWriteAfterSamplingBegins() throws Exception {
    ...
    final File expected = new File(System.getProperty("JTESTS") + File.separator 
        + "com/gemstone/gemfire/internal/StatArchiveWriterReaderJUnitTest_" + testName + "_expected.gfs");
  ...
  public void testDestroyUnallocatedStatisticsThrowsIllegalStateException() throws Exception {
    final String testName = "testDestroyUnallocatedStatisticsThrowsIllegalStateException";
    final String archiveFileName = dir + File.separator + testName + ".gfs";
