...
public static synchronized void closeCache()
 {
  ...
  public static RegionAttributes createRegionAttrsForPR(int red, int localMaxMem, long recoveryDelay)
  {
    ...
    return createRegionAttrsForPR(red, localMaxMem, recoveryDelay, null);
  }
   ...
   * localmaxMemory
   */
  public static RegionAttributes createRegionAttrsForPR(int red, int localMaxMem, long recoveryDelay, EvictionAttributes evictionAttrs)
  {
    ...
    PartitionAttributes prAttr = paf.setRedundantCopies(red)
        .setLocalMaxMemory(localMaxMem).setRecoveryDelay(recoveryDelay).create();
