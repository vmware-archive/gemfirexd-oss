...
public class HDFSRegionOperationsJUnitTest extends TestCase {
  ...
  public void test020GetOperationalData() throws Exception {
    ...
    assertEquals(expectedReadsFromHDFS, stats.getRead().getCount());
    for (int i=0; i<200; i++) {
      assertNull(lr.get(i, null, true, false, false, null, lr.discoverJTA(), null, null, false, false/*allowReadFromHDFS*/));
    }
  ...
  public void test030RemoveOperationalData() throws Exception {
    ...
    for (int i=50; i<100; i++) {
      assertEquals("value"+i, lr.get(i, null, true, false, false, null, lr.discoverJTA(), null, null, false, false/*allowReadFromHDFS*/));
    }
