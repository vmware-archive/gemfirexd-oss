...
import com.gemstone.gemfire.internal.concurrent.ConcurrentSkipListSet;
import com.gemstone.gemfire.util.JSR166TestCase;

public class ConcurrentSkipListSubSetJUnitTest extends JSR166TestCase {

    public ConcurrentSkipListSubSetJUnitTest(String name) {
      super(name);
    }
    ...
    public static Test suite() {
        return new TestSuite(ConcurrentSkipListSubSetJUnitTest.class);
    }
