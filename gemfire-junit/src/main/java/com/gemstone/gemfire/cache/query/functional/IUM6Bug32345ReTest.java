...
public class IUM6Bug32345ReTest extends TestCase{
  ...
  public IUM6Bug32345ReTest(String testName){
    super(testName);
  }
   ...
   public static Test suite(){
    TestSuite suite = new TestSuite(IUM6Bug32345ReTest.class);
    return suite;
  }
 ...
 public void testComparisonBetnWithAndWithoutIndexCreation() throws Exception {
    ...
    for (int i = 0; i < queries.length; i++) {
      ...
      try {
        ...
        System.out.println(Utils.printResult(sr[i][0]));
...
//        System.out.println(valPos2);
   ...
   if ((resType1).equals(resType2)){      
    ...
    if (resSize1==resSize2 || resSize1 != 0){      
        System.out.println("Both Search Results are Non-zero and are of Same Size i.e.  Size= "+resSize1);
   }else {
       fail("FAILED:Search result Type is different in both the cases");   
   }
