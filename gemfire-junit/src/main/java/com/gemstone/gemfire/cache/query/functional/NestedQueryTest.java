...
public class NestedQueryTest extends TestCase {
    ...
    public NestedQueryTest(String testName) {
        super(testName);
    }
    ...
    public void testQueries() throws Exception {
        ...
        for(int i=0;i<queries.length;i++){
            try{
                ...
                query.execute();
                //System.out.println(Utils.printResult(result));
                System.out.println("OK "+queries[i]);
            }catch(Exception e){
                System.out.println("FAILED "+queries[i]);
    ...
    public void testNestedQueriesEvaluation() throws Exception {
        ...
        for (int i = 0; i < queries.length; i++) {
            ...
            try {
                ...
                resSize2 =((r[i][1]).size());
                //                System.out.println("Result Type= "+resType2);
                //                System.out.println("Result Size= "+resSize2);
                set2=((r[i][1]).asSet());
        ...
        for(int j=0;j<=1;j++){
            ...
            if (((r[j][0]).getCollectionType().getElementType()).equals((r[j][1]).getCollectionType().getElementType())){
                System.out.println("Both Search Results are of the same Type i.e.--> "+(r[j][0]).getCollectionType().getElementType());
            }else {
