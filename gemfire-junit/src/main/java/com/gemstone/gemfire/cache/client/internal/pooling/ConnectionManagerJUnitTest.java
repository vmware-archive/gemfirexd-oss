...
public class ConnectionManagerJUnitTest extends TestCase {
  ...
  public void testGet() throws InterruptedException, AllConnectionsInUseException, NoAvailableServersException {
    manager = new ConnectionManagerImpl("pool", factory,endpointManager, 3, 0, -1, -1, logger, logger, 60 * 1000, cancelCriterion, poolStats);
  ...
  public void testPrefill() throws InterruptedException {
    manager = new ConnectionManagerImpl("pool", factory, endpointManager, 10, 2, -1, -1, logger, logger, 60 * 1000, cancelCriterion, poolStats);
    manager.start(background);
    ...
    DistributedTestBase.waitForCriterion(ev, 200, 200, true);
  }
  ...
  public void testInvalidateConnection() throws InterruptedException, AllConnectionsInUseException, NoAvailableServersException {
    manager = new ConnectionManagerImpl("pool", factory, endpointManager, 10, 0, 0L, -1, logger, logger, 60 * 1000, cancelCriterion, poolStats);
    manager.start(background);
  ...
  public void testInvalidateServer() throws InterruptedException, AllConnectionsInUseException, NoAvailableServersException {
    manager = new ConnectionManagerImpl("pool", factory, endpointManager, 10, 0, -1, -1, logger, logger, 60 * 1000, cancelCriterion, poolStats);
    manager.start(background);
...
//  }
  ...
  public void testIdleExpiration() throws InterruptedException, AllConnectionsInUseException, NoAvailableServersException {
    ...
    manager = new ConnectionManagerImpl("pool",  factory, endpointManager, 5, 2, idleTimeout, -1, logger, logger, 60 * 1000, cancelCriterion, poolStats);
    manager.start(background);
  ...
  public void testBug41516() throws InterruptedException, AllConnectionsInUseException, NoAvailableServersException {
    final long idleTimeout = 300;
    manager = new ConnectionManagerImpl("pool",  factory, endpointManager, 2, 1, idleTimeout, -1, logger, logger, 60 * 1000, cancelCriterion, poolStats);
    manager.start(background);
  ...
  public void testLifetimeExpiration() throws InterruptedException, AllConnectionsInUseException, NoAvailableServersException, Throwable {
    ...
    manager = new ConnectionManagerImpl("pool",  factory, endpointManager, 2, 2, -1, lifetimeTimeout, logger, logger, 60 * 1000, cancelCriterion, poolStats);
    manager.start(background);
    ...
    for(int i = 0; i < updaterCount; i++) {
      DistributedTestBase.join(updaters[i], 30 * 1000, null);
    }
...
//     Assert.assertEquals(3,factory.destroys);
  ...
  public void testExchangeConnection() throws Exception {
    manager = new ConnectionManagerImpl("pool",  factory, endpointManager, 2, 0, -1, -1, logger, logger, 60 * 1000, cancelCriterion, poolStats);
    manager.start(background);
