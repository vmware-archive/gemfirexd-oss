 ...
 */
/*
 * MultiRegionIndexUsageTest.java
 *
 ...
 * @author prafulla
 */
public class MultiRegionIndexUsageTest extends TestCase  {
    
    /** Creates a new instance of IUMRSingleRegion */
    public MultiRegionIndexUsageTest(String testName) {
        super(testName);
    }
    ...
    protected void setUp() throws java.lang.Exception {
        try{
            ...
            //            if(!cache.isClosed()){
            //                System.out.println("111111111111 CACHE IS ALREADY OPEN 11111111111111");
            //            }
    ...
    public static Test suite(){
        TestSuite suite = new TestSuite(MultiRegionIndexUsageTest.class);
        return suite;
    }//end of suite
    ...
    public void testChangedFormClauseOrder1() throws Exception {
        System.out.println("------------- testChangedFormClauseOrder1 start------------- ");
...
//            }
            ...
            System.out.println("------------- testChangedFormClauseOrder1 end------------- ");
    ...
    public void _testChangedFormClauseOrder2() throws Exception {
        System.out.println("------------- testChangedFormClauseOrder2 start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
...
//            assertEquals("cityName3", itr.next().toString());
            ...
            System.out.println("------------- testChangedFormClauseOrder2 end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            fail(q.getQueryString());
        }
    ...
    public void testSelectBestIndex1() throws Exception {
        System.out.println("------------- testSelectBestIndex1 start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
        ...
        try{
            ...
            System.out.println("------------- testSelectBestIndex1 end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            fail(q.getQueryString());
        }
    ...
    public void testSelectBestIndex2() throws Exception {
        System.out.println("------------- testSelectBestIndex2 start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
        ...
        try{
            ...
            areResultsMatching(rs,new String[]{sqlStr});
            System.out.println("------------- testSelectBestIndex2 end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            //fail(q.getQueryString());
        }
    ...
    public void testProjectionAttr1() throws Exception {
        System.out.println("------------- testProjectionAttr1 start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
...
//            assertEquals("stateName2", itr.next().toString());
            ...
            System.out.println("------------- testProjectionAttr1 end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            //fail(q.getQueryString());
        }
    ...
    public void testCutDown1() throws Exception {
        System.out.println("------------- testCutDown1 start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
...
//            assertEquals("cityName2", itr.next().toString());
            ...
            areResultsMatching(rs,new String[]{sqlStr});
            System.out.println("------------- testCutDown1 end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            fail(q.getQueryString());
        }
    ...
    public void testSelectAsFromClause() throws Exception {
        System.out.println("------------- testSelectAsFromClause start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
...
//            assertEquals("cityName1", itr.next().toString());
            ...
            areResultsMatching(rs,new String[]{sqlStr});
            System.out.println("------------- testSelectAsFromClause end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            fail(q.getQueryString());
        }
    ...
    public void testSelectAsWhereClause() throws Exception {
        System.out.println("------------- testSelectAsWhereClause start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
...
//            assertEquals("cityName1", itr.next().toString());
            ...
            areResultsMatching(rs,new String[]{sqlStr});
            System.out.println("------------- testSelectAsWhereClause end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            //fail(q.getQueryString());
        }
    ...
    public void testFunctionUse1() throws Exception {
        System.out.println("------------- testFunctionUse1 start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
        ...
        try{
            ...
            areResultsMatching(rs,new String[]{sqlStr});
            System.out.println("------------- testFunctionUse1 end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            //fail(q.getQueryString());
        }
    ...
    public void _testFunctionUse2() throws Exception {
        System.out.println("------------- testFunctionUse2 start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
...
//            assertEquals("stateName", itr.next().toString());
            ...
            areResultsMatching(rs,new String[]{sqlStr});
            System.out.println("------------- testFunctionUse2 end------------- ");
    ...
    public void testFunctionUse3() throws Exception {
        System.out.println("------------- testFunctionUse3 start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
        ...
        try{
            ...
            areResultsMatching(rs,new String[]{sqlStr});
            System.out.println("------------- testFunctionUse3 end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            fail(q.getQueryString());
        }
    ...
    public void testFunctionUse4() throws Exception {
        System.out.println("------------- testFunctionUse4 start------------- ");
        SelectResults rs [] [] = new SelectResults[1][2];
        //Test Case No. IUMR020
        ...
        try{
            ...
            areResultsMatching(rs,new String[]{sqlStr});
            System.out.println("------------- testFunctionUse4 end------------- ");
        }catch (Exception e){
            e.printStackTrace();
            fail(q.getQueryString());
        }
    ...
    //////////main method is just to help the execution in IDE.
