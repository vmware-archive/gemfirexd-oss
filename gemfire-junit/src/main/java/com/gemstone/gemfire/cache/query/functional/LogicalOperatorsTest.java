...
public class LogicalOperatorsTest extends TestCase {
  ...
  public LogicalOperatorsTest(String testName) {
    super(testName);
  }
  ...
  public void testAND() throws Exception {
    ...
    for(int i=0;i<validOperands.length;i++){
      for(int j=0;j<validOperands.length;j++){
        ...
        //System.out.println("LogicalTest "+validOperands[i]+" AND "+validOperands[j]+" = "+result+" "+checkResult("AND", result, validOperands[i], validOperands[j]));
  ...
  public void testOR() throws Exception {
    ...
    for(int i=0;i<validOperands.length;i++){
      for(int j=0;j<validOperands.length;j++){
        ...
        params[1] = validOperands[j];
        Object result = query.execute(params);
        //System.out.println("LogicalTest "+validOperands[i]+" OR "+validOperands[j]+" = "+result+" "+checkResult("OR", result, validOperands[i], validOperands[j]));
  ...
  public void testNOT() throws Exception {
    ...
    for(int i=0;i<validOperands.length;i++){
      ...
      //System.out.println("LogicalTest "+"NOT "+validOperands[i]+" = "+result+" "+checkResult("NOT", result, validOperands[i], null));
