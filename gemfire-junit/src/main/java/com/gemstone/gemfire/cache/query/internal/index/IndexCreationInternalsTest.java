...
public class IndexCreationInternalsTest extends TestCase {
  ...
  public void testLoneProjectionAttributes() throws Exception {
    ...
    compiler = new QCompiler(CacheUtils.getLogger().convertToLogWriterI18n());
  ...
  public void testConcurrentGenerationOfCanonicalizedIteratorNames () {
    ...
    Thread th1 = new Thread ( new Runnable () {
     public void run() {
      IndexCreationInternalsTest.this.childThreadName1=  imgr.putCanonicalizedIteratorNameIfAbsent("index_iter1.coll1");
     }
    ...
    Thread th2 = new Thread ( new Runnable () {
      public void run() {
       IndexCreationInternalsTest.this.childThreadName2=  imgr.putCanonicalizedIteratorNameIfAbsent("index_iter1.coll1");
      }
    ...
    DistributedTestBase.join(th1, 30 * 1000, null);
    DistributedTestBase.join(th2, 30 * 1000, null);
