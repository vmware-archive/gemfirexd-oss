  ...
  public void testPerformanceForRangeQueries() {
    try {
     ...
     /* AttributesFactory factory = new AttributesFactory();
      ...
      r[0][0] = sr;
      t1= ((double)(time)) / numTimesToRun;
      System.out.println("AVG time taken without Index =" + t1);
      ...
      r[0][1] = sr;
      t2= ((double)(time)) / numTimesToRun;
      System.out.println("AVG time taken with Index =" + t2);
...
}//end of BaseLineAndCompareQueryPerfTest
