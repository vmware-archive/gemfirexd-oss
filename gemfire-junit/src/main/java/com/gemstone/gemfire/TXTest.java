...
//          int count = 0;
   ...
   * disabled till non-TX, TX conflict detection is not complete.
   */
  public void DISABLED_TILL_NEW_TX_IMPL_COMPLETE_testJTASynchronization() 
    ...
    this.txMgr.begin();
    {
      ...
      gfTXSync = gfTxMgrImpl.getTXState().getProxy();
    }
    ...
    this.txMgr.begin();
    {
      ...
      TXStateInterface gfTx = gfTxMgrImpl.internalSuspend();
   ...
   * disabled till non-TX, TX conflict detection is not complete.
   */
  public void DISABLED_TILL_NEW_TX_IMPL_COMPLETE_testJTAEnlistment() 
    throws CacheException, 
           javax.transaction.NotSupportedException,
           javax.transaction.RollbackException,
           javax.transaction.SystemException,
  ...
  private static void waitForUpdates(final Index idx, final int expectedUpdates) {
    ...
    DistributedTestBase.waitForCriterion(wc, 15 * 1000, 20, true);
  }
  ...
  public void testTXAndQueries() 
    ...
    final Region aIregion = this.cache.createRegion("TXTest_asyncIndex", 
                                                           af.create());
