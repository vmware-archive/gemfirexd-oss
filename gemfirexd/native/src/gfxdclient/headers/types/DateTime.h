      ...
      namespace client
      {
        namespace types
        {
          ...
          protected:
             ...
             */
            static std::string& toString(const uint16_t year,
          ...
          public:
            ...
            inline time_t getTime() const {
              ...
              else if (sizeof(time_t)
                  >= sizeof(int32_t)&& secs >= INT32_MIN && secs <= INT32_MAX) {
                return (time_t)secs;
              }
              else {
             ...
             */
            static DateTime parseDate(const std::string& str, const bool utc =
                true, const uint32_t columnIndex = 0);
             ...
             *                    which is used in any exception message
             */
            static DateTime parseTime(const std::string& str, const bool utc =
                true, const uint32_t columnIndex = 0);
