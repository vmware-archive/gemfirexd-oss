...
#ifndef GFXD_STRUCT_CLOBCHUNK_H
#define GFXD_STRUCT_CLOBCHUNK_H
...
class ClobChunk {
 public:
  ...
  ClobChunk(const ClobChunk& other) = default;
  ClobChunk& operator=(const ClobChunk& other) = default;

  ClobChunk(ClobChunk&& other) :
      chunk(std::move(other.chunk)), last(other.last), lobId(other.lobId),
      offset(other.offset), totalLength(other.totalLength),
      __isset(other.__isset) {
  }

  void assign(ClobChunk&& other) {
  ...
  ClobChunk& operator=(ClobChunk&& other) {
