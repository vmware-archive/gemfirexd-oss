...
SQLMessage3<const char*, std::exception, const char*> SQLStateMessage::GFXD_NODE_SHUTDOWN_MSG;
SQLMessage3<const char*, std::exception, const char*> SQLStateMessage::DATA_CONTAINER_CLOSED_MSG;
...
void SQLStateMessage::staticInitialize() {
  ...
  GFXD_NODE_SHUTDOWN_MSG.initialize(SQLState::GFXD_NODE_SHUTDOWN, 1, "Node on ",
      " failed with ", " (operation=", ")");
