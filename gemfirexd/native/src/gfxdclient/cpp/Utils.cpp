...
const std::string com::pivotal::gemfirexd::client::EMPTY_STRING;
const std::set<thrift::TransactionAttribute::type> com::pivotal::gemfirexd::client::EMPTY_TX_FLAGS;
const std::map<int32_t, OutputParameter> com::pivotal::gemfirexd::client::EMPTY_OUTPUT_PARAMS;
const std::map<int32_t, thrift::OutputParameter> com::pivotal::gemfirexd::client::EMPTY_OUT_PARAMS;
...
const char* Utils::getSQLTypeName(const thrift::ColumnValue& cv)
{
  switch (cv.getType()) {
    ...
    case thrift::GFXDType::INTEGER:
      return "INTEGER";
    case thrift::GFXDType::JAVA_OBJECT:
      return "JAVA_OBJECT";
    case thrift::GFXDType::JSON_OBJECT:
      return "JSON_OBJECT";
    case thrift::GFXDType::NULLTYPE:
      return "NULL";
    case thrift::GFXDType::PDX_OBJECT:
      return "PDX_OBJECT";
...
void Utils::printFullMessage(const std::exception& stde, std::string& str)
{
...
std::ostream& Utils::printFullMessage(const std::exception& stde,
    std::ostream& out)
{
    ...
    const SQLException& sqle)
{
  ...
  if (sqlState == SQLState::GFXD_NODE_SHUTDOWN.getSQLState()
