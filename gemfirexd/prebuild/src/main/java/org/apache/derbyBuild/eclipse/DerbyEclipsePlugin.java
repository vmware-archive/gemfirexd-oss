 ...
 *   be: com.pivotal.gemfirexd.internal.core_<major>.<minor>.<interim> (example: com.pivotal.gemfirexd.internal.core_10.1.0).
 *
...
public class DerbyEclipsePlugin{
	 ...
	 */
	private static String PLUGIN_PKG="plugin.gemfirexd.core";
	private static String PLUGIN_PKG_NAME="com.pivotal.gemfirexd.internal.core";
	/*
	 * Derby plug-in zip file property and name
	 */
	private static String PLUGIN_ZIP_FILE="plugin.gemfirexd.core.zipfile";
	private static String PLUGIN_ZIP_FILE_NAME="derby_core_plugin";
	/*
	 * Derby plug-in build properties and name
	 */
	private static String PLUGIN_VERSION="plugin.gemfirexd.version";
	private static String PLUGIN_VERSION_BUILD_NUMBER="plugin.gemfirexd.version.build.number";
	...
	private static String part_1="<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"+
				      "<?eclipse version=\"3.0\"?> \n"+
				      "<plugin \n" +
   				      "\t id=\"com.pivotal.gemfirexd.internal.core\" \n" +
