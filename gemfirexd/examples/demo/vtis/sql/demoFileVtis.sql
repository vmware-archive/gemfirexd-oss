...
select *
from table( propertyFileVTI( '/opt/DerbyTrunk/java/engine/com/pivotal/gemfirexd/internal/loc/messages_en.properties' ) ) m_english
where m_english.messageID not in
(
    select m_french.messageID
    from table( propertyFileVTI( '/opt/DerbyTrunk/java/engine/com/pivotal/gemfirexd/internal/loc/messages_fr.properties' ) ) m_french
);
