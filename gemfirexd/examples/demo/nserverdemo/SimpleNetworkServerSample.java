 ...
 * created if not present already and there will be a gemfirexd.log file which
...
public class SimpleNetworkServerSample
{
	...
	/**
	 *  Setting the gemfirexd.drda.startNetworkServer property to true,
	 *  either in the System properties as we do here or in
	 *  the gemfirexd.properties file will cause Network Server to
	 ...
	 * gemfirexd.drda.startNetworkServer. This property can be set as a system property or
	 * or by setting in gemfirexd.properties file.
	 ...
	 * by setting the gemfirexd.drda.portNumber property. By default, the server starts
	 * at port 1527
	 * Server output goes to gemfirexd.log
	 */
	...
	private static void waitForStart() throws Exception
	{
		...
		com.pivotal.gemfirexd.internal.drda.NetworkServerControl server = null;
	 ...
	 * com.pivotal.gemfirexd.jdbc.EmbeddedDriver is already loaded and it need not be loaded again.
	...
	private static String ijUsage()
	{
		...
		ijUsage +=  "\t$ java -Dij.user=me -Dij.password=pw -Dij.protocol=jdbc:derby://localhost:1527/ com.pivotal.gemfirexd.internal.tools.ij\n";
