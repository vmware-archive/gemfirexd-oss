...
/**
 ...
 <P>
 Please note, a file gemfirexd.log is created in the directory you run this program.
	...
	public void startSample(String[] args) throws Exception {
	  ...
	  try  {
		...
		/* Start - In order to start the network server do the following
		   ...
		   Also note, the server logs messages to the file gemfirexd.log in the
		...
		/* Only the JVM that starts the Derby Network Server can obtain an embedded connection
		   ...
		   Also, you need not load the com.pivotal.gemfirexd.jdbc.EmbeddedDriver since it is already loaded when
