...
// GemStone changes BEGIN
    // flags to check if last identity values can be gotten using
    // JDBC Statement/PreparedStatement support
    private boolean _identityValueReadableUsingStatement = false;

    private boolean _identityValueReadableInBatchUsingStatement = false;

    /**
     * flag to indicate that current platform supports adding identity column
     * using ALTER TABLE (only supported by GemFireXD for now)
     */
    private boolean _supportsAddIdentityUsingAlterTable = false;

    /**
     * indicates that the platform has support for getting all DDLs as SQL
     * strings in a single operation
     */
    private boolean _supportsDDLExport = false;

    public final boolean isIdentityValueReadableUsingStatement() {
      return _identityValueReadableUsingStatement;
    }

    public final void setIdentityValueReadableUsingStatement(
        boolean identityValueReadableUsingStmt) {
      _identityValueReadableUsingStatement = identityValueReadableUsingStmt;
    }

    public final boolean isIdentityValueReadableInBatchUsingStatement() {
      return _identityValueReadableInBatchUsingStatement;
    }

    public final void setIdentityValueReadableInBatchUsingStatement(
        boolean identityValueReadableInBatchUsingStmt) {
      _identityValueReadableInBatchUsingStatement =
          identityValueReadableInBatchUsingStmt;
    }
    ...
    public final boolean isAddingIdentityUsingAlterTableSupported() {
      return _supportsAddIdentityUsingAlterTable;
    }

    /**
     * Set the flag for {@link #isAddingIdentityUsingAlterTableSupported()}.
     */
    public final void setSupportsAddIdentityUsingAlterTable(boolean v) {
      _supportsAddIdentityUsingAlterTable = v;
    }
     ...
     */
    public final boolean isDDLExportSupported() {
      return _supportsDDLExport;
    }

    /**
     * Set the flag for {@link #isDDLExportSupported()}.
     */
    public final void setDDLExportSupported(boolean v) {
      _supportsDDLExport = v;
    }
