...
/*
 * Adapted from TestDerbyPlatform for GemFireXD distributed data platform.
 *
 ...
 */
/*
 * Adapted from TestDerbyPlatform.
 *
 * Portions Copyright (c) 2010-2015 Pivotal Software, Inc. All Rights Reserved.
 *
 * Licensed under the Apache License, Version 2.0 (the "License"); you
...
/**
 * Tests the GemFireXD platform.
 */
public class TestGemFireXDPlatform extends TestPlatformBase {

  /**
   * {@inheritDoc}
   */
  protected String getDatabaseName() {
    return GemFireXDPlatform.DATABASENAME;
  }
  ...
  public void testTableConstraints() throws Exception {
    assertEqualsIgnoringWhitespaces(
        ...
        + "  FOREIGN KEY (\"COL_FK_1\", \"COL_FK_2\") "
        + "  REFERENCES \"table1\" (\"COL_PK_2\", \"COL_PK_1\");\n"
        + "ALTER TABLE \"table3\" ADD CONSTRAINT \"testfk\" "
        + "  FOREIGN KEY (\"COL_FK\") REFERENCES \"table2\" (\"COL_PK\");\n",
        getTableConstraintTestDatabaseCreationSql());
  }

  /**
   * Tests the proper escaping of character sequences where GemFireXD requires it.
   */
