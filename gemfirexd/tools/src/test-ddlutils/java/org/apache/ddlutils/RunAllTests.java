...
import org.apache.ddlutils.platform.TestGemFireXDPlatform;
...
// GemStone changes BEGIN
        suite.addTestSuite(TestGemFireXDPlatform.class);
// GemStone changes END
        ...
        if (System.getProperty(TestAgainstLiveDatabaseBase.JDBC_PROPERTIES_PROPERTY) != null)
        {
