...
public class LangScripts_BitDUnit extends DistributedSQLTestBase {

	public LangScripts_BitDUnit(String name) {
	    super(name);
	 }
	
	  public void testLangScript_Bit() throws Exception
	  {
	    ...
	    Object[][] Script_BitUT = {
	      ...
	      //FIXME
	      // Throws colocation exception for partitioned table (even though it is a self-join)
