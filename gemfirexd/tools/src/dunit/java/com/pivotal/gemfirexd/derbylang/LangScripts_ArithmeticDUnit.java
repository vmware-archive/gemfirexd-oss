...
public class LangScripts_ArithmeticDUnit extends DistributedSQLTestBase {
	  
	public LangScripts_ArithmeticDUnit(String name) {
	    super(name);
	 }
	
	  public void testLangScript_ArithmeticTest() throws Exception
	  {
