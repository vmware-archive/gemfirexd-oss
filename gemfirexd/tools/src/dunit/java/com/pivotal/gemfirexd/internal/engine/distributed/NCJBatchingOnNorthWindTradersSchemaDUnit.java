...
public class NCJBatchingOnNorthWindTradersSchemaDUnit extends NCJoinOnNorthWindTradersSchemaDUnit {

  public NCJBatchingOnNorthWindTradersSchemaDUnit(String name) {
    super(name);
  }
