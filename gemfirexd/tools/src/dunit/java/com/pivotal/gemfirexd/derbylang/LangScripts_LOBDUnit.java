...
public class LangScripts_LOBDUnit extends DistributedSQLTestBase {

	public LangScripts_LOBDUnit(String name) {
		super(name);
	  ...
	  public void testLangScript_LOB_NoPartitioning() throws Exception
	  {
	    ...
	    Object[][] Script_LOBUT = {
	      ...
	      { "create table a(blob int, clob int, nclob int)", null },
	      ...
	      { "create table b(blob blob(3K), clob clob(2M))", null },
	      ...
	      { "create table testConst4(c1 long varchar not null, constraint fk foreign key(c1) references testConst3(c1))", "X0Y92" },
	      ...
	      { "create table DB2LIM.FB1(FB1C BLOB(3G))", "42X44" },
	      { "create table DB2LIM.FB2(FB2C BLOB(2049M))", "42X44" },
	      { "create table DB2LIM.FB3(FB3C BLOB(2097153K))", "42X44" },
	      { "create table DB2LIM.FB4(FB4C BLOB(2147483648))", "42X44" },
	      { "create table DB2LIM.GB1(GB1C BLOB(2G))", null },
	      { "create table DB2LIM.GB2(GB2C BLOB(2048M))", null },
	      { "create table DB2LIM.GB3(GB3C BLOB(2097152K))", null },
	      { "create table DB2LIM.GB4(GB4C BLOB(2147483647))", null },
	      { "create table DB2LIM.GB5(GB5C BLOB(1G))", null },
	      { "create table DB2LIM.GB6(GB6C BLOB(2047M))", null },
	      { "create table DB2LIM.GB7(GB7C BLOB(20971521))", null },
	      { "create table DB2LIM.GB8(GB8C BLOB(2147483646))", null },
	      { "drop table DB2LIM.GB5", null },
	      { "drop table DB2LIM.GB6", null },
	      { "drop table DB2LIM.GB7", null },
	      { "drop table DB2LIM.GB8", null },
	      { "create table DB2LIM.GB9(GB9C BLOB)", null },
	      { "create table DB2LIM.GB10(GB10C BINARY LARGE OBJECT)", null },
	      { "drop table DB2LIM.GB9", null },
	      { "drop table DB2LIM.GB10", null },
	      { "create table DB2LIM.FC1(FC1C CLOB(3G))", "42X44" },
	      ...
	      { "create table DB2LIM.GC4(GC4C CLOB(2147483647))", null },
	      { "create table DB2LIM.GC5(GC5C CLOB(1G))", null },
	      { "create table DB2LIM.GC6(GC6C CLOB(2047M))", null },
	      { "create table DB2LIM.GC7(GC7C CLOB(2097151K))", null },
	      { "create table DB2LIM.GC8(GC8C CLOB(2147483646))", null },
	      { "drop table DB2LIM.GC5", null },
	      { "drop table DB2LIM.GC6", null },
	      { "drop table DB2LIM.GC7", null },
	      { "drop table DB2LIM.GC8", null },
	      { "create table DB2LIM.GC9(GC9C CLOB)", null },
	      { "create table DB2LIM.GC10(GC10C CHARACTER LARGE OBJECT)", null },
	      { "create table DB2LIM.GC11(GC11C CHAR LARGE OBJECT)", null },
	      ...
	      { "drop table b", null },
	      { "create table c (colone clob(1K))", null },
