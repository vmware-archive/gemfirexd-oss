...
public class NCJBatchingDefaultColocatedTablesEquiJoinDUnit extends NCJoinDefaultColocatedTablesEquiJoinDUnit {

  public NCJBatchingDefaultColocatedTablesEquiJoinDUnit(String name) {
    super(name);
  }
