...
public class LangScripts_FloatTypesDUnit extends DistributedSQLTestBase {

	public LangScripts_FloatTypesDUnit(String name) {
		super(name);
		// TODO Auto-generated constructor stub
	}

	  public void testLangScript_FloatTypesTest() throws Exception
	  {
		...
		{ "create table tmp (tmpcoldecimal dec(8,4), tmpcolnumeric numeric)", null },
		...
		{ "create table bad (d decimal(11,12))", "42Y43" },
		{ "create table bad (d decimal(0,0))", "42X48" },
		{ "create table bad (d decimal(0))", "42X48" },
		{ "create table bade(d decimal(32))", null },		// GemFireXD allows decimal with precision > 31 up to 128
		{ "create table bade(d decimal(31,32))", "42Y43" },
		{ "create table bade2(d decimal(32,32))", null },
		...
		{ "create table tmp(d decimal(31 ,0))", null },
		...
		{ "drop table tmp", null },
		{ "create table tmp (d decimal(5,2))", null },
		...
		{ "insert into tmp values (-100000000000000)", "22003" },
		{ "drop table tmp", null },
		{ "create table tmp(d dec(1,1))", null },
		...
		{ "drop table tmp", null },
		{ "create table tmp2(d dec(1,1))", null },
		...
		{ "create table tmp(d dec(1,0))", null },
		...
		{ "drop table tmp", null },
		{ "create table tmp (x double)", null },
		{ "insert into tmp values (1)", null },
		...
		{ "drop table tmp", null },
		{ "create table tmp (d decimal)", null },
		...
		{ "drop table tmp", null },
		{ "create table t (i int, l bigint,s smallint, d double precision,r real,dc decimal(10,2))", null },
		...
		//FIXME
		// Throws 'null' stream io exception on partitioned tables
		//{ "select -(dc * 100 / 100e0 ), +(dc * 100e0 / 100 ) from t", new String[][] {
		//	{null,null},{"-10.000000","10.000000"},{"10.000000","-10.000000"},{"0.000000","0.000000"} } },
		...
		{ "create table w (x dec, y long varchar)", null },
		...
		{ "create table t2 (i int, l bigint,	s smallint, d double precision,	r real, dc decimal(10,2))", null },
		...
		{ "drop table t2", null },
		{ "drop table t", null },
		{ "create table t (c1 char(1), d dec(20,4), c2 char(1))", null },
		...
		{ "drop table t", null },
		// Test double
		{ "create table t (i int, s smallint, c char(10), v varchar(50),d double precision)", null },
		...
		{ "drop table t", null },
		// test overflow
		{ "create table s (d double precision, p double)", null },
		...
		{ "drop table s", null },
		{ "create table w (x double precision, y long varchar)", null },
		{ "select x + y from w", "42846" },
		{ "select x - y from w", "42846" },
		{ "select x * y from w", "42846" },
		{ "select x / y from w", "42846" },
		{ "drop table w", null },
		//comparisons
		{ "create table c (i int, s smallint, d double precision, p double precision)", null },
		...
		{ "create table o (c char(10), v varchar(30), dc decimal) replicate", null },
		{ "select d from c,o where d <> dc", new String[0][0] },
		{ "drop table c", null },
		{ "drop table o", null },
		//test a variety of inserts and updates
		{ "create table source (i int, s smallint, c char(10), v varchar(50),	d double precision)", null },
		{ "create table target (p double precision not null)", null },
		...
		{ "create table abcfloat (numtest float(20))", null },
		...
		// Test float
		{ "create table t (d double precision, r real, f float, f1 float(1),	f23 float(23), f24 float(24), f53 float(52))", null },
		...
		{ "insert into t(r) values -3.4021E+38", "22003" },
		{ "create table tt(c char(254))", null },
		...
		{ "drop table t", null },
		{ "drop table tt", null },
		{ "create table t1 (d double precision, r real, f float(-10))", "42X01" },
		{ "create table t2 (d double precision, r real, f float(-1))", "42X01" },
		{ "create table t3 (d double precision, r real, f float(0))", "42X48" },
		{ "create table t4 (d double precision, r real, f float(100))", "42X48" },
		{ "create table t5 (d double precision, r real, f float(53))", "42X48" },
		{ "create table t6 (d double precision, r real, f float(12.3))", "42X49" },
		//Test REAL
		{ "create table t (i int, s smallint, c char(10), v varchar(50),d double precision, r real)", null },
		{ "insert into t values (null, null, null, null, null, null)", null },
		...
		// FIXME
		// These throw 'null' io/eof exceptions on partitioned tables - investigate
		...
		{ "insert into s values (1, 101)", null },
		// FIXME
		// Another null stream exception - looks like REAL datatype is giving partitioned multinode queries trouble
		...
		{ "drop table s", null },
		{ "create table w (x real, y char)", null },
		{ "select x + y from w", "42846" },
		{ "select x - y from w", "42846" },
		{ "select x * y from w", "42846" },
		{ "select x / y from w", "42846" },
		{ "drop table w", null },
		{ "create table c (i int, s smallint, d double precision, r real, l real)", null },
		...
		{ "drop table c", null },
		{ "drop table o", null },
		{ "create table source (i int, s smallint, c char(10), v varchar(50),	d double precision, r real)", null },
		{ "create table target (t real not null)", null },
		...
		{ "insert into source values (1, 2, '3', '4', 5, 6)", null },
		// In a partitioned TARGET table, these failing INSERTs may actually put rows into TARGET
		// even though the while INSERT fails, due to scattering of subquery select/insert
		// Comment out this test for partitioned table scenario
		//{ "insert into target values(null)", "23502" },
		//{ "insert into target select i from source", "23502" },
		//{ "insert into target select s from source", "23502" },
		//{ "insert into target select d from source", "23502" },
		...
		{ "select * from t1", new String[0][0] },
		{ "drop table t1", null },
		{ "create table tiger(d decimal(12,11))", null },
