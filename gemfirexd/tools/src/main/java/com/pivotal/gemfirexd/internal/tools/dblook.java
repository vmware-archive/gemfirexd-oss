/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.tools.dblook
...
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_Alias;
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_Check;
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_GrantRevoke;
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_Index;
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_Jar;
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_Key;
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_Schema;
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_Table;
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_Trigger;
import com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_View;
...
public final class dblook {
	...
	public dblook(String[] args) throws Exception {
        ...
        // Adjust the application in accordance with gemfirexd.ui.locale
		// and gemfirexd.ui.codeset
...
// GemStone changes BEGIN
			else if (sourceDBUrl.startsWith("jdbc:gemfirexd://"))
			/* else if (sourceDBUrl.startsWith("jdbc:derby://")) */
// GemStone changes END
			   derbyDriver = "com.pivotal.gemfirexd.jdbc.ClientDriver";
			else
				derbyDriver = "com.pivotal.gemfirexd.jdbc.EmbeddedDriver";
	    }
	...
	private void prepForDump() throws Exception {
		...
		rs = stmt.executeQuery("VALUES SYSCS_UTIL.GET_DATABASE_PROPERTY" +
