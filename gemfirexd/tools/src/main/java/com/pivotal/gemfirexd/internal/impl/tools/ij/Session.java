/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.tools.ij.Session
...
class Session {
	...
	Session(Connection newConn, String newTag, String newName) {
		...
		try
		{
			...
			isDNC = conn.getMetaData().getDriverName().startsWith("GemFireXD Network Client");
...
// GemStone changes BEGIN
      utilMain.doPrompt(newStatement, out, getTag(multiSessions));
    }
