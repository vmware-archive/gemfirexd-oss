/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.tools.ij.ConnectionEnv
...
// GemStone changes BEGIN
	String getPrompt(boolean newStatement) {
	  String tag = "";
	  if (this.currSession != null) {
	    tag = this.currSession.getTag(this.sessions.size() > 1);
	  }
	  return utilMain.getPrompt(newStatement, tag);
	}
