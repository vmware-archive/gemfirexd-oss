/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.tools.dblook.DB_Index
...
public class DB_Index {
		...
		throws SQLException
	{
		...
		while (rs.next()) {
			...
			StringBuilder createIndexString = createIndex(iName, tableName,
	...
	private static StringBuilder createIndex(String ixName, String tableName,
