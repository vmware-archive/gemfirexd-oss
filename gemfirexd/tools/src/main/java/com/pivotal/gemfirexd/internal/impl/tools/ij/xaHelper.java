/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.tools.ij.xaHelper
...
class xaHelper implements xaAbstractHelper
{
  ...
  xaHelper()
  {
		 ...
		 throws SQLException
	{
		...
		try {
			currentDataSource = (DataSource) (Class.forName("com.pivotal.gemfirexd.internal.jdbc.EmbeddedDataSource").newInstance());
		} catch (Exception e) {
	...
	{
		try {
			currentCPDataSource = (ConnectionPoolDataSource) (Class.forName("com.pivotal.gemfirexd.internal.jdbc.EmbeddedConnectionPoolDataSource").newInstance());
		} catch (Exception e) {
			throw new SQLException(e.toString());
		}
		databaseName = parser.stringValue(dbname.image);
				...
				return (XADataSource) 
					(Class.forName("com.ibm.db2.jcc.DB2XADataSource").newInstance());
                            ...
                            if (JVMInfo.JDK_ID >= JVMInfo.J2SE_16) {
                                ...
                                try {
                                    return (XADataSource)(Class.forName(
                                        "com.pivotal.gemfirexd.internal.jdbc.EmbeddedXADataSource").newInstance());
                                }
                                catch (ClassNotFoundException e) {
                                    //probably it was not compiled with jdbc4.0
                                    //support go ahead with EmbeddedXADataSource
                            ...
                            return (XADataSource)(Class.forName("com.pivotal.gemfirexd.internal.jdbc.EmbeddedXADataSource").newInstance());
                        }
		}
...
// GemStone changes BEGIN
			...
			m.invoke(ds, new Object[] { Boolean.valueOf(value) });
			/* (original code)
