/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.tools.ij
...
public class ij {
		  ...
		  throws UnsupportedEncodingException
  {
	  ...
	  return um.goScript(conn, li, false /*GemStone changes*/);
  }
  ...
  {
	  return com.pivotal.gemfirexd.internal.impl.tools.ij.util.getArg(param, args);
  }

  public static void getPropertyArg(String[] args) throws IOException
  {
	  com.pivotal.gemfirexd.internal.impl.tools.ij.util.getPropertyArg(args);
  }
  ...
  {			
		return com.pivotal.gemfirexd.internal.impl.tools.ij.util.startJBMS();
  }
}
