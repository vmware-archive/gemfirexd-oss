...
import com.pivotal.gemfirexd.internal.impl.store.access.btree.index.*;
        ...
        throws StandardException
    {
        ...
        ScanController scan = 
            tc.openScan(conglomid, false,
                        ...
                        null,
                        search_key, ScanController.GT, null); 
...
// GemStone changes BEGIN
        // base table check:
        if ((base_rowloc1=base_cc.fetch(base_rowloc1, r2, (FormatableBitSet) null, false))==null)
        {
        ...
        for (int i = d_col1.length - 1; i >= 0; i--)
        {
            ...
            ScanController delete_scan = 
                tc.openScan(index_conglomid, false,
                            ...
                            null,
                            template.getRow(), ScanController.GT, null); 
...
// GemStone changes BEGIN
            if (index_cc.fetch(
                    null, RowUtil.EMPTY_ROW, (FormatableBitSet) null, false) == null)
            {
