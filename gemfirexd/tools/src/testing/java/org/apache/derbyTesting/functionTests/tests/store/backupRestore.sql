...
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.distributedsystem.classpath', 'APP.aggjar');
...
connect 'wombat';
select cast (dv(x) as dec(5,2)) from x;
call SYSCS_UTIL.BACKUP_DATABASE_AND_ENABLE_LOG_ARCHIVE_MODE('extinout/mybackup', 1);
insert into x values (1,1),(10,1),(20,1);
insert into x values (1,1),(10,1),(20,1);
insert into x values (1,1),(10,1),(20,1);
insert into x values (1,1),(10,1),(20,1);
