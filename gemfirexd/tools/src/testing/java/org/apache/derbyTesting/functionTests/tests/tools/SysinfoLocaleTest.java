 ...
 * messages according to the default locale and <code>gemfirexd.ui.locale</code>.
 */
public class SysinfoLocaleTest extends BaseTestCase {
     ...
     * gemfirexd.ui.locale to aid debugging.
     *
     ...
     * <code>gemfirexd.ui.locale</code> and default locale
     */
    public static Test suite() {
        ...
        // locale specified by gemfirexd.ui.locale, if it's set. Otherwise, the
     ...
     * @param ui <code>gemfirexd.ui.locale</code> for the test case
    ...
    private static Test createTest(Locale loc, String ui, boolean german) {
        ...
        if (ui != null) {
            prop.setProperty("gemfirexd.ui.locale", ui);
        }
        // always set the encoding so that we can reliably read the output
        prop.setProperty("gemfirexd.ui.codeset", ENCODING);
     ...
     * <code>gemfirexd.ui.locale</code> (happens when the class is loaded).
     */
    private static void runSysinfo() throws Exception {
        final String className = "com.pivotal.gemfirexd.internal.tools.sysinfo";
