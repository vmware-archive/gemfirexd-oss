...
call SYSCS_UTIL.EXPORT_TABLE ('XXXX', 'T1' , 'extinout/t2.dat' , 
                                 null, null, null) ;
...
call SYSCS_UTIL.IMPORT_TABLE ('SESSION', 'TEMP2' , 'extinout/temp1.dat' , 
                                 null, null, null, 0) ;
...
call SYSCS_UTIL.EXPORT_TABLE ('IEP', 'T3' , 'extinout/t3.dat' , 
                                 null, null, null) ;

call SYSCS_UTIL.IMPORT_TABLE ('IEP', 'T3' , 'extinout/t3.dat' , 
                                 null, null, null, 0) ;
select * from t3;
...
call SYSCS_UTIL.IMPORT_DATA('IEP', 'T3' , 'X1, X2, X3', '1,2,3,4', 
                                 'extinout/t3.dat' , 
                                 null, null, null, 0) ;
...
delete from t3 ;
call SYSCS_UTIL.EXPORT_TABLE ('IEP', 'T3' , 'extinout/t3_1.dat' , 
                                  ';', '^', 'utf-16') ;
--import data column names are incorrect
call SYSCS_UTIL.IMPORT_DATA('IEP', 'T3' , 'X1, X2, X3, X4', null, 
                                 'extinout/t3_1.dat' , 
...
call SYSCS_UTIL.EXPORT_QUERY('select * from parent where a < 3' , 'extinout/parent.del' , 
                                 null, null, null) ;
...
CALL SYSCS_UTIL.IMPORT_TABLE('IEP', 'PARENT', 'extinout/parent.del',null, null, null,1);
disconnect c1;
disconnect c2;
