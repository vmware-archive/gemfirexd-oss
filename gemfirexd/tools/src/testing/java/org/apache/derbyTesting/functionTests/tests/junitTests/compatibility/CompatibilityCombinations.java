 ...
 * #-----------------------------
 * # 'gemfirexd.versions' how many. 'gemfirexd.versionN=<descriptive_name>' defines 
 * # names of properties giving the full path to the actual Derby libraries. 
 * gemfirexd.versions=6
 * gemfirexd.version0=10.0.2.1
 * gemfirexd.version1=10.1.1.0
 * gemfirexd.version2=10.1.2.1
 * gemfirexd.version3=10.1.3.1
 * gemfirexd.version4=10.2.2.0
 * gemfirexd.version5=Trunk
 * 
 ...
 * # test.singleServer=5
 * # 5 for gemfirexd.version5, which in this example maps to Trunk
 * #-----------------------------
 ...
 * # test.singleClient=5
 * # for gemfirexd.version5, which in this example maps to Trunk
 #-----------------------------
 * # Use one single jvm version server, optional:
...
public class CompatibilityCombinations extends BaseTestCase
{
   ...
   * Read as e.g <code>test.securityOption=noSecurityManager</code> from the file given by
    ...
    private final static String embeddedDriver = "com.pivotal.gemfirexd.jdbc.EmbeddedDriver";
    private final static String networkServerControl = "com.pivotal.gemfirexd.internal.drda.NetworkServerControl";
  ...
  //////////////////////////////////////////////////////////////
     ...
     *         <li>vmNames[vm] 
     *         </ul>
     *     <li>gemfirexd.versions - number of derby versions each with:
     *         <ul>
     *         <li>"gemfirexd.version"+v 
   ...
   * @throws java.io.IOException .
    ...
    throws IOException
    {
        ...
        singleClient = cp.getProperty("test.singleClient",null); // E.g. 5 for gemfirexd.version5, see property file
        ...
        singleServer = cp.getProperty("test.singleServer",null); // E.g. 5 for gemfirexd.version5, see property file
        ...
        int derbyVersions = Integer.parseInt(cp.getProperty("gemfirexd.versions"));
        // Read the names given for these versions
        derbyVersionNames = new String[derbyVersions];
        for (int v=0;v<derbyVersions;v++)
        {
            derbyVersionNames[v] = cp.getProperty("gemfirexd.version"+v);
            ...
            throws Exception
    {
        ...
        final String[] commandElements = {clientJvm
                , " -Dgemfirexd.infolog.append=true"
                , " -cp ", clientClassPath
                , " " + "com.pivotal.gemfirexd.internal.tools.sysinfo"
                };
        final String[] envElements = {"CLASS_PATH="+clientClassPath
                , "PATH="+VM_Ids[clientVM]+PS+".."+PS+"bin" // "/../bin""
                };
