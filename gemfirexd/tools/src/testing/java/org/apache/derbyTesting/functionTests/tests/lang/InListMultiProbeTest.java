...
public class InListMultiProbeTest extends BaseJDBCTestCase {
    ...
    {
        TestSuite suite = new TestSuite("InListMultiProbeTest");
    ...
    public void testMultiProbing() throws Exception
    {
         ...
         * the string returned by GET_RUNTIMESTATISTICS().  That string
    ...
    class LiteralsStrategy extends QueryStrategy
    {
        ...
        {
            StringBuilder query = new StringBuilder(SELECT_ALL_WHERE_IN);
    ...
    class MarkersStrategy extends QueryStrategy
    {
        ...
        protected int fetchDataRows(String[] ids) throws SQLException
        {
            ...
            // GemStone changes BEGIN
            SanityManager.DEBUG_PRINT("info:sb:","MarkersStrategy:Total Rows " + totalDataRows);
            // GemStone changes END
            return totalDataRows;
        }
    }
    ...
    class MixedIdsStrategy extends QueryStrategy
    {
        ...
        protected int fetchDataRows(String[] ids) throws SQLException
        {
            ...
            stmt.close();
            // GemStone changes BEGIN
            SanityManager.DEBUG_PRINT("info:sb:","MixedIdsStrategy:Total Rows " + totalDataRows);
            // GemStone changes END
            return totalDataRows;
        }
    }
