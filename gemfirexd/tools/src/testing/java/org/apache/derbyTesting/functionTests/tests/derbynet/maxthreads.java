...
public class maxthreads
{
	...
	private static String[] maxthreadsCmd1 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"maxthreads", "0"};
	private static String[] maxthreadsCmd2 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"maxthreads","-1", "-h", "localhost", "-p", "1527"};
	private static String[] maxthreadsCmd3 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"maxthreads", "-12"};
	private static String[] maxthreadsCmd4 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"maxthreads", "2147483647"};
	private static String[] maxthreadsCmd5 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"maxthreads", "9000"};
	private static String[] maxthreadsCmd6 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
			"maxthreads", "a"};
