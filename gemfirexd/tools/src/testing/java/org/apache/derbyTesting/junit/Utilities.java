...
public class Utilities {
     ...
     *         sysinfo
     * @see com.pivotal.gemfirexd.internal.tools.sysinfo#getInfo(java.io.PrintWriter out)
     */
    public static BufferedReader getSysinfoLocally() {
        ...
        com.pivotal.gemfirexd.internal.tools.sysinfo.getInfo(pw);
        pw.flush();
        pw.close();
     ...
     * @see com.pivotal.gemfirexd.internal.drda.NetworkServerControl#getSysinfo()
     */
