...
public class _Suite extends BaseTestCase  {
	...
	public static Test suite() {
		...
		*/
//		FIXME #48136 Disabled StatementJdbc20Test due to SQLNonTransientConnectionException
//		suite.addTest(StatementJdbc20Test.suite());
		/*
        suite.addTest(ClobTest.suite());
        */
		
//  FIXME #48136 Disabled	as BlobUpdatableStreamTest.testUpdatableBlob() fails	
