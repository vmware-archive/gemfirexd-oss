...
public class RunList
{
        ...
        if ((!useprocess) && ((framework !=null) && (framework.startsWith("DerbyNet"))))
        {
            ...
            { 
                String stopCmd = javaCmd + 
                   " com.pivotal.gemfirexd.internal.drda.NetworkServerControl shutdown";
    ...
    */
        ...
        if ( (framework != null) && (framework.length()>0) )
	{
	    ...
	    {
		// skip if the gemfirexd.jar is not in the Classpath
		try {
			Class.forName("com.pivotal.gemfirexd.internal.drda.NetworkServerControl");
