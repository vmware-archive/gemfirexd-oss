...
public class StalePlansTest extends BaseJDBCTestCase {
    ...
    public static Test suite() {
        ...
        props.setProperty("gemfirexd.language.stalePlanCheckInterval", "10");
        props.setProperty("gemfirexd.storage.checkpointInterval", "100000");
...
//GemStone changes END
    ...
    public void testStalePlanCheckIntervalOutOfRange() throws SQLException {
        ...
        assertStatementError("XCY00", stmt,
                             ...
                             "'gemfirexd.language.stalePlanCheckInterval', '2')");
        stmt.close();
    }
