...
public class dbManagerLimits
{
    ...
    try {
			...
			StringBuilder sbTableElements = new StringBuilder();
    ...
    try {
			...
			StringBuilder sbValuesClause = new StringBuilder();
			StringBuilder sbViewColumnNames = new StringBuilder();
			String tempString = new String();
			int i = 0;
    ...
    try {
			...
			Statement s = conn.createStatement();
			StringBuilder sbGroupBy = new StringBuilder("select 1 from v1, v2, v3, v4, v5, v6, v7 group by ");
			StringBuilder sbValuesClause = new StringBuilder();
			StringBuilder sbViewColumnNames = new StringBuilder();
			String tempString = new String();
			...
			for (int j = 1; j < 8; j++) {
				...
				s.executeUpdate(tempString);
				sbViewColumnNames = new StringBuilder();
			}
    ...
    try {
			...
			Statement s = conn.createStatement();
			StringBuilder sbCreateProcParams = new StringBuilder();
			StringBuilder sbExecuteProcParams = new StringBuilder();
			String tempString = new String();
			int i = 0;
