...
call SYSCS_UTIL.COMPRESS_TABLE('SYSCS_DIAG', 'TRANSACTION_TABLE', 1);
call SYSCS_UTIL.INPLACE_COMPRESS_TABLE('SYSCS_DIAG', 'TRANSACTION_TABLE', 1, 1, 1);

-- ensure the old syntax still works until it is deprecated
select xid from new com.pivotal.gemfirexd.internal.diag.TransactionTable() AS t where 1 = 0;
update new com.pivotal.gemfirexd.internal.diag.TransactionTable() set xid = NULL;
delete from new com.pivotal.gemfirexd.internal.diag.TransactionTable() where 1 = 0;
