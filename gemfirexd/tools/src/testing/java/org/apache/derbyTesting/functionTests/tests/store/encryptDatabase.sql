...
values SYSCS_UTIL.GET_DATABASE_PROPERTY('encryptedBootPassword');
...
call SYSCS_UTIL.SET_DATABASE_PROPERTY('bootPassword', 'wrongkey, ');
call SYSCS_UTIL.SET_DATABASE_PROPERTY('bootPassword', 'Thursday');
call SYSCS_UTIL.SET_DATABASE_PROPERTY('bootPassword', 'Thursday , ');
call SYSCS_UTIL.SET_DATABASE_PROPERTY('bootPassword', 'Thursday , short');
call SYSCS_UTIL.SET_DATABASE_PROPERTY('bootPassword', 'Thursdya , derbypwd');
call SYSCS_UTIL.SET_DATABASE_PROPERTY('bootPassword', 'Thursdayx , derbypwd');
call SYSCS_UTIL.SET_DATABASE_PROPERTY('bootPassword', 'xThursday , derbypwd');
...
call SYSCS_UTIL.SET_DATABASE_PROPERTY('bootPassword', 'bbderbypwdx, derbypwdxx ');
...
call SYSCS_UTIL.SET_DATABASE_PROPERTY('encryptionProvider', 'com.pom.aplomb');
