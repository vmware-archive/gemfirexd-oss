...
public final class ImportExportProcedureTest extends BaseJDBCTestCase {
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.EXPORT_TABLE (null, 'EX_EMP' "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_TABLE (null, 'IMP_EMP' "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        // GemStone changes BEGIN   use unordered comparison
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.EXPORT_QUERY('select * from "
            + "ex_emp where id < 105', 'extinout/emp.dat' , null, "
            + "null, null) ");
        assertUpdateCount(cSt, 0);

        cSt = prepareCall(
            " call SYSCS_UTIL.IMPORT_TABLE (null, "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.EXPORT_QUERY('select name , "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_DATA(null, 'IMP_EMP' "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.IMPORT_TABLE (null, 'EX_EMP' "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.EXPORT_TABLE ('APP' , "
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.IMPORT_DATA(null, 'NONCAST', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.EXPORT_TABLE (null, 'TTYPES' "
            + ", 'extinout/ttypes.del' , null, null, null) ");
        assertUpdateCount(cSt, 0);

        cSt = prepareCall(
            " call SYSCS_UTIL.IMPORT_TABLE (null, 'TTYPES' "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.EXPORT_TABLE (null, 'T1' , "
            + "'extinout/t1.del' , null, null, null) ");
        assertUpdateCount(cSt, 0);

        cSt = prepareCall(
            " call SYSCS_UTIL.IMPORT_TABLE (null, 'T1' , "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_TABLE (null, 'NOTABLE' "
            + ", 'extinout/t1.del' , null, null, null, 0) ");
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.IMPORT_DATA(null, 'T1' , 'A' "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_DATA(null, 'NOTABLE' , "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.EXPORT_TABLE (null, "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.EXPORT_QUERY('select "
            + "c1,c3,c4 from table2' , 'extinout/import.del' , "
            + "null, null, null) ");
        assertUpdateCount(cSt, 0);

        cSt = prepareCall(
            " CALL SYSCS_UTIL.IMPORT_DATA(NULL,'TABLE1', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.EXPORT_TABLE(null , 'TABLE2' "
        ...
        cSt = prepareCall(
            "CALL SYSCS_UTIL.IMPORT_TABLE(NULL, 'TABLE1', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "CALL SYSCS_UTIL.IMPORT_TABLE(NULL, 'PARENT', "
        ...
        cSt = prepareCall(
            " CALL SYSCS_UTIL.IMPORT_TABLE(NULL, 'NT1', "
        ...
        cSt = prepareCall(
            " CALL SYSCS_UTIL.IMPORT_TABLE ('APP', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "CALL "
            + "SYSCS_UTIL.EXPORT_QUERY('values(1),(2),(3)','e"
        ...
        cSt = prepareCall(
            " CALL "
            + "SYSCS_UTIL.IMPORT_TABLE('APP','DEST_ALWAYS','e"
        ...
        cSt = prepareCall(
            " CALL "
            + "SYSCS_UTIL.IMPORT_TABLE('APP','DEST_BY_DEFAULT"
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.EXPORT_TABLE ('GROUP', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_TABLE ('GROUP', "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_DATA('Group', 'ORDER' "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.EXPORT_TABLE ('inventory', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_TABLE ('inventory', "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_DATA('INVENTORY', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.EXPORT_TABLE ('IEP', 'T1' , "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.EXPORT_TABLE ('IEP', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.EXPORT_TABLE ('XXXX', 'T1' , "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.IMPORT_TABLE('IEP', 'T1' , "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_TABLE ('IEP', "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_TABLE ('XXXX', 'T1' , "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.EXPORT_TABLE ('SESSION', "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_TABLE ('IEP', 'V1' , "
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.IMPORT_TABLE ('SESSION', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            " call SYSCS_UTIL.EXPORT_TABLE ('IEP', 'T3' , "
            + "'extinout/t3.dat' , null, null, null) ");
        assertUpdateCount(cSt, 0);

        cSt = prepareCall(
            " call SYSCS_UTIL.IMPORT_TABLE ('IEP', 'T3' , "
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_DATA('IEP', 'T3' , "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call SYSCS_UTIL.IMPORT_TABLE ('SYS', "
  ...
  //DERBY-2925: need to delete existing files first.
        ...
        cSt = prepareCall(
            "call "
            + "SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.locks."
            + "waitTimeout', '5')");
        assertUpdateCount(cSt, 0);

        assertStatementError("38000", st, "CALL SYSCS_UTIL.IMPORT_TABLE('IEP', 'PARENT', 'extinout/parent.del',null, null, null,1)");
