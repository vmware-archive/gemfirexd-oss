...
connect 'jdbc:gemfirexd:;mcast-port=0;user=dilbert';
INSERT INTO DST.DEF_SCHEMA_TEST VALUES(USER, CURRENT SCHEMA);
SELECT COUNT(*) FROM DST.DEF_SCHEMA_TEST WHERE NAME_USER = NAME_SCHEMA;
...
create table NOTYPE(i int, b com.pivotal.gemfirexd.internal.vti.VTIEnvironment);
...
-- CALL statement
-- beetle 5252
call com.pivotal.gemfirexd.internal.iapi.db.Factory::getDatabaseOfConnection().dropAllJDBCMetaDataSPSes();
