...
import com.pivotal.gemfirexd.internal.iapi.services.crypto.*;
...
/*
	To run, put the following line in gemfirexd.properties
	gemfirexd.module.test.T_Cipher=org.apache.derbyTesting.unitTests.crypto.T_Cipher
...
public class T_Cipher extends T_Generic
{
	...
	*/
	...
	public String getModuleToTestProtocolName() {
		return com.pivotal.gemfirexd.internal.iapi.reference.Module.CipherFactoryBuilder;
	}
	...
	protected void setupCiphers(String bootPassword) throws T_Fail, StandardException
	{
        ...
        CipherFactoryBuilder cb =  (CipherFactoryBuilder)
            Monitor.startSystemModule(com.pivotal.gemfirexd.internal.iapi.reference.Module.CipherFactoryBuilder);
