...
public abstract class ImportExportBaseTest extends BaseJDBCTestCase {
    ...
    /**
     *  Perform import using SYSCS_UTIL.IMPORT_DATA procedure.
     */
     ...
     * SYSCS_UTIL.EXPORT_TABLE_LOBS_TO_EXTFILE procedure.
     */
    ...
    {
        String expsql = 
            "call SYSCS_UTIL.EXPORT_TABLE_LOBS_TO_EXTFILE" +  
            "(? , ? , ? , ?, ?, ?, ?)";
        PreparedStatement ps = prepareStatement(expsql);
        ps.setString(1, schemaName);
        ps.setString(2, tableName);
    ...
    /**
     * Perform export using 
     * SYSCS_UTIL.EXPORT_QUERY_LOBS_TO_EXTFILE procedure.
     */
     ...
     * SYSCS_UTIL.IMPORT_TABLE_LOBS_FROM_EXTFILE procedure.
     */
    ...
    /**
     *  Perform import using 
     *  SYSCS_UTIL.IMPORT_DATA_LOBS_FROM_EXTFILE procedure.
     */
