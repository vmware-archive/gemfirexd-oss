...
public class T_DaemonService extends T_MultiThreadedIterations 
{
	...
	*/
	...
	protected String getModuleToTestProtocolName() {
		return com.pivotal.gemfirexd.internal.iapi.reference.Module.DaemonFactory;
	}
	...
	*/
	protected void setupTest() throws T_Fail
	{
		...
		try {
			daemonFactory = (DaemonFactory)Monitor.startSystemModule(com.pivotal.gemfirexd.internal.iapi.reference.Module.DaemonFactory);
		} catch (StandardException mse) {
			throw T_Fail.exceptionFail(mse);
		}
		if (daemonFactory == null)
			throw T_Fail.testFailMsg("cannot find daemon factory " + com.pivotal.gemfirexd.internal.iapi.reference.Module.DaemonFactory);
