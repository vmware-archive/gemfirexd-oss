...
public class runtimeinfo
{
	...
	private static String[] RuntimeinfoCmd = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"runtimeinfo"};
	private static String[] RuntimeinfoLocaleCmd = new String[] {"-Duser.language=err",
		"-Duser.country=DE", "com.pivotal.gemfirexd.internal.drda.NetworkServerControl", "runtimeinfo"};
