...
public class userDefMethods
{
    ...
    public static void deleteFromATable() throws SQLException
    {
        ...
        ResultSet rs = s.executeQuery("SELECT c1 from new com.pivotal.gemfirexd.internal.catalog.TriggerOldTransitionRows() AS EQ");
	...
	public static void deleteFromParent() throws SQLException
    {
		...
		sqlstmt = "SELECT a FROM new com.pivotal.gemfirexd.internal.catalog.TriggerOldTransitionRows() AS EQ";
