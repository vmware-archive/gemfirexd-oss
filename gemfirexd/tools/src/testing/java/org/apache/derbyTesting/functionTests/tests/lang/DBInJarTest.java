...
public class DBInJarTest extends BaseJDBCTestCase {
    ...
    public void testConnectDBInJar() throws SQLException
    {
       ...
       // cleanup databases
      File jarreddb = new File(System.getProperty("gemfirexd.system.home") + "/testjardb.jar");
      assertTrue("failed deleting " + jarreddb.getPath(),jarreddb.delete());
      removeDirectory(new File(System.getProperty("gemfirexd.system.home") + "/testjardb" ));
    }
