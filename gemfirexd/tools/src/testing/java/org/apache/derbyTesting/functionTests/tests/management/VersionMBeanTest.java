...
public class VersionMBeanTest extends MBeanTest {
    ...
    public static Test suite() {
         ...
         * of the version MBean are accessible, i.e. both for gemfirexd.jar and
         * gemfirexd.jar. This means that it is assumed that the Network Server
    ...
    private ObjectName getDerbyJarObjectName() 
        ...
        // get a reference to the VersionMBean instance for gemfirexd.jar
        Hashtable<String, String> keyProps = new Hashtable<String, String>();
        keyProps.put("type", "Version");
        keyProps.put("jar", "gemfirexd.jar");
