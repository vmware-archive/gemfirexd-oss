...
call SYSCS_UTIL.SET_DATABASE_PROPERTY('key2', 'eins, zwei, drei');

-- and fetch them
values SYSCS_UTIL.GET_DATABASE_PROPERTY('key1');
values SYSCS_UTIL.GET_DATABASE_PROPERTY('key2');
...
values GET_TABLE_PROPERTY('APP', 'T', 'gemfirexd.storage.pageSize');
drop table T;
...
-- See what the default is first
create table T (i int);
values GET_TABLE_PROPERTY('APP', 'T', 'gemfirexd.storage.minimumRecordSize');
drop table T;
...
-- See what the default is first
create table T (i int);
values GET_TABLE_PROPERTY('APP', 'T', 'gemfirexd.storage.pageReservedSpace');
drop table T;
...
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.distributedsystem.noAutoBoot', 'true');
values SYSCS_UTIL.GET_DATABASE_PROPERTY('gemfirexd.distributedsystem.noAutoBoot');


call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.distributedsystem.noAutoBoot', 'false');
values SYSCS_UTIL.GET_DATABASE_PROPERTY('gemfirexd.distributedsystem.noAutoBoot');

call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.distributedsystem.noAutoBoot', null);
values SYSCS_UTIL.GET_DATABASE_PROPERTY('gemfirexd.distributedsystem.noAutoBoot');
-- Now check some explicit properties
...
values SYSCS_UTIL.GET_DATABASE_PROPERTY('gemfirexd.engineType');
