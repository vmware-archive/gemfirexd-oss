...
public class PreparedStatementTest extends BaseJDBCTestCase {
    ...
    public void testSetRowId() throws SQLException{
        ...
        catch(SQLFeatureNotSupportedException gfxdne) {
    ...
    public void testSetBinaryStreamLengthLessOnBlobTooLong() {
        ...
        try {
            ...
            if (usingEmbedded() ||
                usingDerbyNetClient() ) {
                // GemStone changes BEGIN
                // gemfirexd returns a different (and better) error code
...
// GemStone changes BEGIN
        assertTrue("Exception not an DerbySQLException",
            cause instanceof DerbySQLException);
        /* (original code)
