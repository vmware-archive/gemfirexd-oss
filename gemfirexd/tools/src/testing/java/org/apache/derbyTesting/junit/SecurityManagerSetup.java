...
public final class SecurityManagerSetup extends TestSetup {
	 ...
	 * Location of gemfirexd.jar via com.pivotal.gemfirexd.internal.jdbc.EmbeddedSimpleDataSource
	 * Location of gemfirexd-client.jar via com.pivotal.gemfirexd.internal.jdbc.ClientDataSource
	 * 
	 ...
	 * Jar files:
	 * <BR>
	 * derbyTesting.codejar - URL of gemfirexd.jar,
	 * gemfirexd.jar and gemfirexd-tools.jar, all assumed to be in the
	 * same location.
	 * <BR>
	 * derbyTesting.clientjar - URL of gemfirexd-client.jar
	 * <BR>
	...
	private static boolean determineClasspath()
	{
		...
		URL derby = getURL("com.pivotal.gemfirexd.internal.jdbc.EmbeddedSimpleDataSource");
        if (derby != null)
