...
public class sysinfo
{
	...
	private static String[] SysInfoCmd = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"sysinfo"};
	private static String[] SysInfoLocaleCmd = new String[] {"-Duser.language=err",
		"-Duser.country=DE", "com.pivotal.gemfirexd.internal.drda.NetworkServerControl", "sysinfo"};
