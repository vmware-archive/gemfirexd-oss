...
Set the 'gemfirexd.optimizertest.mode' to 'client' to run this test using the 
DerbyClient against a GemFireXD Network Server running on port 1527
...
To run the test using the DerbyClient against a GemFireXD Network Server running on port 1527
set the 'gemfirexd.optimizertest.mode' System property to 'client' .
