...
// GemStone changes BEGIN
        assertResults
            (
            conn,
            "select getAmount(totalPrice) from orders",
            new String[][]
            {
                 { "9.99000" },
            },
...
// GemStone changes END
     ...
     */
    // FIXME: #48136
    public void DISABLED_test_08_triggerDependencies() throws Exception
    {
        Connection conn = getConnection();
...
// GemStone changes END
    ...
    public void test_09_resultSetMetaData() throws Exception
    {
        ...
        checkRSMD
            (
             ...
             "com.pivotal.gemfirexd.internal.catalog.AliasInfo",
             15,
             java.sql.Types.JAVA_OBJECT,
             "com.pivotal.gemfirexd.internal.catalog.AliasInfo",
             0,
    ...
    public void test_14_systemClasses() throws Exception
    {
        ...
        expectCompilationError( ILLEGAL_UDT_CLASS, "create type java_string external name 'com.pivotal.gemfirexd.internal.iapi.types.XML' language java\n" );
        expectCompilationError( ILLEGAL_UDT_CLASS, "create type java_string external name 'com.pivotal.gemfirexd.internal.Foo' language java\n" );
    }
    private int vetDatatypeCount( Connection conn ) throws Exception
    {
        ...
        int actualTypeCount = com.pivotal.gemfirexd.internal.iapi.types.TypeId.getAllBuiltinTypeIds().length;
