...
public class NetworkServerControlApiTest extends BaseJDBCTestCase {
    ...
    {
        final String nsc = "com.pivotal.gemfirexd.internal.drda.NetworkServerControl";
    ...
    public void testTraceCommands() throws Exception
    {
        ...
        String derbySystemHome = getSystemProperty("gemfirexd.system.home");
        nsctrl.setTraceDirectory(derbySystemHome);
       
        nsctrl.trace(true);
        nsctrl.ping();
        // It asserts the file created due to ping
        // The file name depends on connection number
        // which can change if tests are run in different order
        assertTrue(fileExists(derbySystemHome+"/Server4.trace"));
        nsctrl.trace(false);
    ...
    public void xtestTraceSystemPropertiesNoPermission() throws SQLException{
        ...
        // exception in the gemfirexd.log.
        ...
        assertEquals(getSystemProperty("gemfirexd.drda.traceAll"),"true");
        assertEquals(getSystemProperty("gemfirexd.drda.traceDirectory"),"/");
