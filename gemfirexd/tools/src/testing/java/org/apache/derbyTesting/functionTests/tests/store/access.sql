...
drop table a;
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageSize', '32768');
create table a
    (
        i1      int,
        col00   varchar(384),
...
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageSize', NULL);
...
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageSize', '1024');
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.minimumRecordSize', '1');
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageReservedSpace', '0');
create table testing (a varchar(100));
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageSize', NULL);
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.minimumRecordSize', NULL);
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.minimumRecordSize', NULL);
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageReservedSpace', NULL);
...
drop table t2778;
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageSize', '2048');
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageReservedSpace', '10');
create table t2778 
    (
        col00 char(2),
        col01 char(1),
...
update t2778 --gemfirexd-properties index = a_idx 
    set col10 = 
...
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageReservedSpace', '100');
create table a (a int);
call SYSCS_UTIL.SET_DATABASE_PROPERTY('gemfirexd.storage.pageReservedSpace', NULL);

insert into a values (1);
select numallocatedpages from new com.pivotal.gemfirexd.internal.diag.SpaceTable('A') as a;
