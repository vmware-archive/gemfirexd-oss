...
public class NetServer
{
	...
	private static String NETWORK_SERVER_CLASS_NAME="com.pivotal.gemfirexd.internal.drda.NetworkServerControl";
	...
	m.put("DerbyNetClient", new Object[]
	    {url,                 //prefix
	     "",                                            // suffix
	     "com.pivotal.gemfirexd.jdbc.ClientDriver",           //driver
	     "1527",                                        // port
	     new String[] {NETWORK_SERVER_CLASS_NAME,  //start
			   "start"},                        
	     new String[] {NETWORK_SERVER_CLASS_NAME,  //shutdown
	...
	String homeDirName = homeDir.getCanonicalPath();
        ...
        jvmProps.addElement("gemfirexd.system.home=" + homeDirName);
		jvm.setD(jvmProps);
