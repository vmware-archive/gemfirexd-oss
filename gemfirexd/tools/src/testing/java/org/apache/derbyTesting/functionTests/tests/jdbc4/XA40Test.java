...
import com.pivotal.gemfirexd.internal.iapi.jdbc.BrokeredStatement40;
import com.pivotal.gemfirexd.internal.iapi.jdbc.BrokeredPreparedStatement40;
import com.pivotal.gemfirexd.internal.iapi.jdbc.BrokeredCallableStatement40;
...
public class XA40Test extends BaseJDBCTestCase {
    ...
    public void testCallableStatementPoolable() throws SQLException {
        CallableStatement cs = 
            con.prepareCall("CALL SYSCS_UTIL.BACKUP_DATABASE(?)");
        if (usingEmbedded()) {
