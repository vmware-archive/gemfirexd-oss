 ...
 * (com.pivotal.gemfirexd.internal.impl.io.DirStorageFactory)
 ...
 * gemfirexd.subSubProtocol.<sub protocol name>  For example:
 *
 *  gemfirexd.subSubProtocol.csf=org.apache.derbyTesting.functionTests.
	...
	WritableStorageFactory getRealStorageFactory()
	{
		...
		if( JVMInfo.JDK_ID >= JVMInfo.J2SE_14)
        {
            dirStorageFactoryClass = 
                "com.pivotal.gemfirexd.internal.impl.io.DirStorageFactory4";
        }
        else
        {
            dirStorageFactoryClass = 
