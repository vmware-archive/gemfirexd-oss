...
abstract class MBeanTest extends BaseJDBCTestCase {
    ...
    {
        final ObjectName derbyDomain = new ObjectName("com.pivotal.gemfirexd.internal:*");
     ...
     * key properties. The ObjectName has the domain com.pivotal.gemfirexd.internal, and
        ...
        throws Exception
    {
        ...
        return new ObjectName("com.pivotal.gemfirexd.internal", keyProperties);
    }
