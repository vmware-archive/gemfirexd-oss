...
public class DboPowersTest extends BaseJDBCTestCase
{
    ...
    public void testShutDown() throws SQLException
    {
        ...
        try {
            ...
            //  We return XJ015 for sql state on shutdown, not 08006: see ticket 41296
    ...
    {
        // GemStone changes BEGIN
        // GemFireXD throws a different sql state in exception:
        //    XJ015 (system shutdown) vs. 08006 (db shutdown) in Derby
        //    See ticket 41296
        ...
        case SQLAUTHORIZATION:
            if ("TEST_DBO".equals(user)) {
                ...
                assertSQLState("database shutdown restriction, " +
                               "SQL authorization, not db owner (user is "+user+", owner is TEST_DB0)",
                               "08004", e);
            }
            break;
        default:
    ...
    private void bringDbDown()
    {
        ...
        try {
            ...
            // GemStone changes BEGIN
            // shutdown sqlstate differs, see ticket 41296
            //assertSQLState("database shutdown", "08006", e);
            assertSQLState("database shutdown", "XJ015", e);
            // GemStone changes END
        }
    }
