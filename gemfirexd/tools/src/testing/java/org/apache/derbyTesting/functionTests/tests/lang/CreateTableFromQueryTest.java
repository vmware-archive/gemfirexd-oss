...
public final class CreateTableFromQueryTest extends BaseJDBCTestCase {
    ...
    */
    ...
    public void testInvalidDataType() throws Exception
    {
        ...
        // DECIMAL(44,0)
        assertStatementError("42X71", stmt,
        	"create table t(x) as values 1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890 with no data");
    }
