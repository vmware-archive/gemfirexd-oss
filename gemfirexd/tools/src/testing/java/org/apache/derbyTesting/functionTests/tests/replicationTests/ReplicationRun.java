...
public class ReplicationRun extends BaseTestCase
{
    ...
    final static String networkServerControl = "com.pivotal.gemfirexd.internal.drda.NetworkServerControl";
    ...
    static final String DRIVER_CLASS_NAME = "com.pivotal.gemfirexd.jdbc.ClientDriver";
            ...
            throws Exception
    {
        ...
        String ijClassPath = derbyVersion +FS+ "gemfirexd-client.jar"
                + PS + derbyVersion +FS+ "derbyTesting.jar"
                + PS + derbyVersion +FS+ "gemfirexd-tools.jar";
        String testingClassPath = derbyVersion +FS+ "gemfirexd-client.jar"
                + PS + derbyVersion +FS+ "gemfirexd.jar" // WHY IS THIS NEEDED?
        ...
        if ( replicationTest.indexOf(".sql") >= 0 )
        {
            command = clientJvm
                    ...
                    + " -classpath " + ijClassPath + " com.pivotal.gemfirexd.internal.tools.ij"
                    + " " + replicationTest
                    ;
        }
        else
            ...
            throws Exception
    {
        ...
        String masterClassPath = derbyMasterVersion +FS+ "gemfirexd.jar";
        ...
        /* java -classpath ${MASTER_LIB}/gemfirexd.jar \
         *       com.pivotal.gemfirexd.internal.drda.NetworkServerControl startreplication test \
            ...
            throws InterruptedException
    {
        ...
        String slaveClassPath = derbySlaveVersion +FS+ "gemfirexd.jar";
        ...
        /*
         * java -classpath ${SLAVE_LIB}/gemfirexd.jar com.pivotal.gemfirexd.internal.drda.NetworkServerControl \
    ...
    throws IOException
    {
        ...
        util.DEBUG("gemfirexd.system.home: " + System.getProperty("gemfirexd.system.home"));
        ...
        {
        int sep = classPath.indexOf("gemfirexd.jar"+PS); util.DEBUG("sep: " + sep);
        ...
        derbyProperties = 
                 "gemfirexd.infolog.append=true"+LF
                +"gemfirexd.drda.logConnections=true"+LF
                +"gemfirexd.drda.traceAll=true"+LF;
    ...
    throws Exception
    {
        ...
        if ( host.equalsIgnoreCase("localhost") || localEnv )
        {
            ...
            // util.writeToFile(derbyProperties, dir+FS+"gemfirexd.properties");
        }
        else
        {
            String command = "cd "+masterDatabasePath+FS+masterDbSubPath+";"
                + " rm -rf " + dbName + " gemfirexd.log ij_master;"
                + " rm Server*.trace;"
                /* bootMasterDataBase now does "connect ...;create=true": */
               // + " cp -r " + masterDatabasePath + "/origdb/" + dbName +"/ .;"
                ...
                + " rm -rf " + dbName + " gemfirexd.log ij_slave;"
                + " rm Server*.trace;"
                + " ls -al;"
                ;
            results = 
    ...
    throws Exception
    {
         ...
         * PoC:
         * cd /home/user/Replication/testing/db_slave
         * rm -rf test gemfirexd.log ij_slave
         * cp -r ../db_master/test/ .
         */
        ...
        String command = "cd " + slaveDatabasePath+FS+slaveDbSubPath+";"
                + " rm -rf " + dbName + " ij_slave;" // gemfirexd.log
                // + " rm Server*.trace;"
        ...
        if ( host.equalsIgnoreCase("localhost") || localEnv )
        {
            ...
            // util.cleanDir(slaveDb, true); // true: do delete the db directory itself.
                                          // gemfirexd.log etc will be kept.
            ...
            // util.writeToFile(derbyProperties, slaveDir+FS+"gemfirexd.properties");
        }
        else
        {
            results =
            ...
            throws Exception
    {
        ...
        String serverClassPath = serverVersion + FS+"gemfirexd.jar"
                + PS + serverVersion + FS+"gemfirexd.jar";
        if ( serverHost.equals("localhost") )
        { // Use full classpath when running locally. Can not vary server versions!
        ...
        final String[] commandElements = {serverJvm
                , " -Dgemfirexd.system.home=" + workingDirName
                , " -Dgemfirexd.infolog.append=true"
                // , " -Dgemfirexd.language.logStatementText=true" // Goes into gemfirexd.log: Gets HUGE!
                , " -cp ", serverClassPath
                , " " + networkServerControl
                , " " + command
        ...
        {
            // util.writeToFile(derbyProperties, fullDbDirPath+FS+"gemfirexd.properties");
        }
        ...
        if ( serverHost.equalsIgnoreCase("localhost") )
        {
            ...
            // 2. Master and slave would run in same VM. Mixing gemfirexd.logs!
    ...
    { // Wotk in progress. Not currently used! Only partly tested!
        ...
        System.setProperty("gemfirexd.system.home", fullDbDirPath);
        ...
        // gemfirexd.log for both master and slave ends up in masters system!
