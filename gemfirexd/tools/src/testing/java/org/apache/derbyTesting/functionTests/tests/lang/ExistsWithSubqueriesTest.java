...
public class ExistsWithSubqueriesTest extends BaseJDBCTestCase {
    ...
    //GEMFIRE BEGIN
    //FIXME 
    // This test depends upon CASCADE DELETE to set up the data
    // However, it may be possible to rework it to not use the cascade
    // and to load pertinent data for the test below
    // Comment out as GemFireXD does not support CASCADE DELETE
