...
public class SQLToJUnit
{
    ...
    private void writeJavaLine(StringBuilder lineToWrite,
        StringBuilder followupLine) throws Exception
    {
    ...
    private void writeJDBCCode(StringBuilder stmt,
    ...
    private void writeFailStatement(StringBuilder stmt,
        String stmtName, StringBuilder result, boolean compileTime)
        throws Exception
    {
    ...
    private void writeAssertDDLCount(StringBuilder stmt,
        StringBuilder ddlCount, String stmtName)
        throws Exception
    {
    ...
    private String extractRowCount(StringBuilder sBuf)
        throws Exception
    {
     ...
     */
    private void writeGetCursor(StringBuilder stmt, String indent)
        throws Exception
    {
    ...
    private void writeMaxLenLine(StringBuilder aLine,
        String prefix, String suffix) throws Exception
    {
        ...
        while (aLine.length() > 0)
        {
            ...
            if (pos != -1)
            {
                writeMaxLenLine(new StringBuilder(aLine.substring(0, pos)),
                    prefix, suffix);
                pos++;
            }
    ...
    private void escapeQuotes(StringBuilder aLine)
    {
    ...
    private void collapseQuotes(StringBuilder aLine, char quote)
    {
        if ((aLine == null) || (aLine.length() == 0))
            return;
    ...
    private StringBuilder strip(StringBuilder sBuf, String toStrip)
    {
        if ((toStrip == null) || (toStrip.length() == 0))
            return sBuf;
    ...
    private int getLineType(StringBuilder sBuf)
    {
    ...
    private void writeAssertResultSet(StringBuilder rsAsText)
        throws Exception
    {
     ...
     */
    private String extractSQLState(StringBuilder errString)
        throws Exception
    {
    	String sqlState;
    ...
    private void writeAssertWarning(StringBuilder warnString)
        throws Exception
    {
        String indent = "    ";
    ...
    private void writeQuotedLine(StringBuilder line, String indent)
        throws Exception
    {
        junit.write(indent);
        junit.write("    \"");
     ...
     */
    private boolean getNextIjCommand(StringBuilder aLine)
        throws IOException
    {
