        ...
        throws Exception
	{
        if ( useprocess == true )
        {
    		...
    		try
    		{
                ...
                v.addElement("com.pivotal.gemfirexd.internal.tools.sysinfo");
        ...
        else
        {
            ...
            /*
            pw.println(com.pivotal.gemfirexd.internal.impl.tools.sysinfo.Main.javaSep);
            com.pivotal.gemfirexd.internal.impl.tools.sysinfo.Main.reportCloudscape(pw);
            pw.println(com.pivotal.gemfirexd.internal.impl.tools.sysinfo.Main.jbmsSep);
            com.pivotal.gemfirexd.internal.impl.tools.sysinfo.Main.reportDerby(pw);
            pw.println(com.pivotal.gemfirexd.internal.impl.tools.sysinfo.Main.licSep);
            com.pivotal.gemfirexd.internal.impl.tools.sysinfo.Main.printLicenseFile(pw);
            */
        }
    }
}
