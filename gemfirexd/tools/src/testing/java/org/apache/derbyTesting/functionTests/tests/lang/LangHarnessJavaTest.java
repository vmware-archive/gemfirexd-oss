...
public class LangHarnessJavaTest extends HarnessJavaTest {
    ...
    private static final String[] LANG_TESTS_EMEBDDED=
    {
        ...
        //FIXME GemFireXD throws exception on BLOB concatenate "concateTests",
        //"currentof", //being converted
        //"cursor", //TODO: investigate/convert
        //"dbManagerLimits", //GemStone changes BEGIN errMsg checking is too strict GemStone changes END
        //"deadlockMode",  //GemStone changes BEGIN uses unsupported transaction isolation GemStone changes END
        ...
        //"outparams", //FIXME : GemFireXD allows output parameter to be registered as input
