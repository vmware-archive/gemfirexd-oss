...
call SYSCS_UTIL.IMPORT_TABLE(null, 'T1_EUC_JP' ,
...
call SYSCS_UTIL.EXPORT_TABLE('APP', 'T1_EUC_JP' ,
...
call SYSCS_UTIL.IMPORT_TABLE (null, 'T1_EUC_JP_IMPORT_AS_EUC_JP',
   'extinout/jap_EUC_JP.dump',
   NULL, NULL,
   'EUC_JP', 0);
...
call SYSCS_UTIL.IMPORT_TABLE (null, 'T1_EUC_JP_IMPORT_AS_SJIS',
   'extinout/jap_SJIS.dump',
   NULL, NULL,
   'SJIS', 0);
