 ...
 *      <li>System property <i>gemfirexd.debug.suicideOfLayerBStreaming</i> must be
...
public class SuicideOfStreamingTest
    ...
    public void setUp()
        ...
        insertLobSt.close();
        setSystemProperty("gemfirexd.debug.suicideOfLayerBStreaming", "true");
    }
    ...
    public void tearDown()
            throws Exception {
        removeSystemProperty("gemfirexd.debug.suicideOfLayerBStreaming");
        super.tearDown();
    }
