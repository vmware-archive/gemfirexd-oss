...
public class NetworkServerControlClientCommandTest extends BaseJDBCTestCase {
    ...
    public void testPing() throws Exception {
        ...
        String[] pingCmd1 = new String[] {
                "com.pivotal.gemfirexd.internal.drda.NetworkServerControl", "ping" };
        assertSuccessfulPing(pingCmd1);
      
        String[] pingCmd2 = new String[] {
                "com.pivotal.gemfirexd.internal.drda.NetworkServerControl", "ping", "-h",
                currentHost, "-p", currentPort};
        assertSuccessfulPing(pingCmd2);
        
        String[] pingCmd3 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
        "ping", "-h", currentHost};
        ...
        String[] pingCmd5= new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
        "ping", "-h", currentHost, "-p", "9393"};
        assertFailedPing(pingCmd5,"Could not connect to GemFireXD Network Server");
