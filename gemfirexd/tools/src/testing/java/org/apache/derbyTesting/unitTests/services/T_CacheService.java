...
import com.pivotal.gemfirexd.internal.iapi.services.cache.*;

import com.pivotal.gemfirexd.internal.iapi.services.daemon.*;
	...
	*/
	protected void runTests() throws T_Fail {
		...
		try {
			...
			df = (DaemonFactory) Monitor.startSystemModule(com.pivotal.gemfirexd.internal.iapi.reference.Module.DaemonFactory);
		...
		if (df == null)
			throw T_Fail.testFailMsg(com.pivotal.gemfirexd.internal.iapi.reference.Module.DaemonFactory + " module not started.");
	...
	protected String getModuleToTestProtocolName() {
		return com.pivotal.gemfirexd.internal.iapi.reference.Module.CacheFactory;
	}
