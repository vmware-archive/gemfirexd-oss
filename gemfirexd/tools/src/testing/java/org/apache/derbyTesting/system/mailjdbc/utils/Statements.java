...
public class Statements {
	...
	public static String grantExe1 = "grant execute on procedure SYSCS_UTIL.BACKUP_DATABASE to BACKUP";

	public static String grantExe2 = "grant execute on procedure SYSCS_UTIL.BACKUP_DATABASE_AND_ENABLE_LOG_ARCHIVE_MODE  to BACKUP";

	public static String grantExe3 = "grant execute on procedure SYSCS_UTIL.BACKUP_DATABASE_AND_ENABLE_LOG_ARCHIVE_MODE_NOWAIT to BACKUP";

	public static String grantExe4 = "grant execute on procedure SYSCS_UTIL.DISABLE_LOG_ARCHIVE_MODE to BACKUP";

	public static String grantExe5 = "grant execute on procedure SYSCS_UTIL.INPLACE_COMPRESS_TABLE to BACKUP";
}
