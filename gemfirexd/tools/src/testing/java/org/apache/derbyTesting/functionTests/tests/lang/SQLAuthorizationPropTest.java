...
public class SQLAuthorizationPropTest extends BaseJDBCTestCase {
  ...
  public static Test suite() {
    ...
    Properties props = new Properties();
      ...
      //   NOTE: test is failing on gemfirexd, most likely due to a test harness
      //         issue.  The complete database restart with the revised properties
      //         does not appear to be working properly.  The failure of
      //         grantRevokeAfterSettingSQLAutoProperty also affects the
      //         resetSQLAuthProperty test.
...
//GemStone changes END
   ...
   * This method tests that grant/revoke is not available if
	 * gemfirexd.sql-authorization property is not set.
   *
   * @throws SQLException
   */
   ...
   * This method tests that grant/revoke is available
	 * once gemfirexd.sql-authorization property is set to true.
   *
   * @throws SQLException
   */
  ...
  /**
	 * This method tests that once gemfirexd.sql-authorization property 
   ...
   * test to be valid, it must follow the test method which sets
	 * gemfirexd.sql-authorization property to true.
   *
   * @throws SQLException
   */
  public void resetSQLAuthProperty() throws SQLException {
    Connection conn = getConnection();
        ...
        setDBP.setString(1, "gemfirexd.sql-authorization");
