...
// GemStone changes BEGIN
	...
	public void alignOrderableCache(
			com.pivotal.gemfirexd.internal.iapi.sql.dictionary.ColumnDescriptor columnDescriptor,
			com.pivotal.gemfirexd.internal.engine.store.GemFireContainer container) {
	}

  public String getColumnName() {
    // Return null and EXPLAIN will print the id instead
    return null;
  }
