...
public class timeslice
{
	...
	private static String[] timesliceCmd1 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"timeslice", "0"};
	private static String[] timesliceCmd2 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"timeslice","-1", "-h", "localhost", "-p", "1527"};
	private static String[] timesliceCmd3 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"timeslice", "-12"};
	private static String[] timesliceCmd4 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"timeslice", "2147483647"};
	private static String[] timesliceCmd5 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
		"timeslice", "9000"};
	private static String[] timesliceCmd6 = new String[] {"com.pivotal.gemfirexd.internal.drda.NetworkServerControl",
			"timeslice", "a"};
