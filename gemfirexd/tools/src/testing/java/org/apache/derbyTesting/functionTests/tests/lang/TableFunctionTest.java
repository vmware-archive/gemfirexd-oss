...
//GemStone changes END
        ...
        throws Exception
    {
        ...
        StringBuilder    rowSet = new StringBuilder();
        ...
        StringBuilder    compareRows = new StringBuilder();
        compareRows.append
            (
             "select f.*\n" +
    ...
    public  static  void    prettyPrint( Connection conn, ResultSet rs )
        throws SQLException
    {
        com.pivotal.gemfirexd.internal.tools.JDBCDisplayUtil.DisplayResults
            ( System.out, rs, conn );
    }
    ...
    private String  getOptimizerStats( String query )
        throws Exception
    {
        goodStatement( "CALL SYSCS_UTIL.SET_RUNTIMESTATISTICS(1)" );
        goodStatement( "CALL SYSCS_UTIL.SET_STATISTICS_TIMING(1)" );
        goodStatement( query );

        PreparedStatement   ps = prepareStatement( "values SYSCS_UTIL.GET_RUNTIMESTATISTICS()" );
        ResultSet           rs = ps.executeQuery();
        ...
        goodStatement( "CALL SYSCS_UTIL.SET_STATISTICS_TIMING(0)" );
        goodStatement( "CALL SYSCS_UTIL.SET_RUNTIMESTATISTICS(0)" );
