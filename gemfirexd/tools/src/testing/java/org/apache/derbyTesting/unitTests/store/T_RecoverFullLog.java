...
import com.pivotal.gemfirexd.internal.impl.store.raw.log.*;
...
/**
    ...
    To run, create a gemfirexd.properties file in a new directory with the
	contents

	gemfirexd.module.test.recoverFullLog=org.apache.derbyTesting.unitTests.store.T_RecoverFullLog
