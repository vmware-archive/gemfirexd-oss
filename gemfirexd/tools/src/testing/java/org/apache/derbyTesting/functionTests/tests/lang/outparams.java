...
public class outparams
{
		...
		for (int doSetObject = 0; doSetObject < 3; doSetObject++)
		{
			...
			for (int method = 0; method < outputMethods.length; method++)
			{
				...
				for (int type = 0; type < types.length; type++)
				{
					...
					{
						StringBuilder getbuf = new StringBuilder();
						try
						{
	...
	private static void callSetObject(CallableStatement cs, int arg, int type, StringBuilder strbuf) throws Throwable
	{
	...
	private static void callSetMethod(CallableStatement cs, int arg, int type, StringBuilder strbuf) throws Throwable
	{
		switch (type)	
		{
			case Types.BIT:
	...
	private static void callGetMethod(CallableStatement cs, int arg, int type, int paramType ,StringBuilder strbuf) throws Throwable
	{
		switch (type)	
		{
			case Types.BIT:
	...
	static private void byteArrayToString(byte[] barray, StringBuilder strbuf)
	{
		if (barray == null)
		{
			strbuf.append("null");
