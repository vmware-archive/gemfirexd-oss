...
values SYSCS_UTIL.GET_DATABASE_PROPERTY('gemfirexd.storage.logArchiveMode');
...
values SUBSTR(SYSCS_UTIL.GET_DATABASE_PROPERTY('logDevice'), LOCATE('crwombatlog',SYSCS_UTIL.GET_DATABASE_PROPERTY('logDevice')),11);
select * from t1;
...
values SUBSTR(SYSCS_UTIL.GET_DATABASE_PROPERTY('logDevice'), LOCATE('wombatlog',SYSCS_UTIL.GET_DATABASE_PROPERTY('logDevice')),9);
...
values SUBSTR(SYSCS_UTIL.GET_DATABASE_PROPERTY('logDevice'), LOCATE('wombatlogmoved',SYSCS_UTIL.GET_DATABASE_PROPERTY('logDevice')),14);
...
--values SYSCS_UTIL.GET_DATABASE_PROPERTY('logDevice');
--select * from t1;
--call SYSCS_UTIL.BACKUP_DATABASE_AND_ENABLE_LOG_ARCHIVE_MODE(
--     'extinout/mybackup', 1);
--connect 'wombat;shutdown=true';
