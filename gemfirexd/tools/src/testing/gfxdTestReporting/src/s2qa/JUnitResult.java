...
public class JUnitResult {
  ...
  public JUnitResult(String testcaseName, String scopedTestcaseName,
  ...
  public void setTraceback(String traceback) {
    this.traceback = new StringBuffer(traceback);
  }
  ...
  /*
   * Computes a testcase name that includes the last portion of the
   * package name.
   */
  public void deriveScopedTestcaseName() {
