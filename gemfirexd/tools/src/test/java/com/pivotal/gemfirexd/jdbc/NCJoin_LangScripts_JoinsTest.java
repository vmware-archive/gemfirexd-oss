...
public class NCJoin_LangScripts_JoinsTest extends LangScripts_JoinsTest {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(NCJoin_LangScripts_JoinsTest.class));
  }
  
  public NCJoin_LangScripts_JoinsTest(String name) {
    super(name); 
  }
