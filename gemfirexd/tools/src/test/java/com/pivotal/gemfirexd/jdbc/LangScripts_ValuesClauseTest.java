...
public class LangScripts_ValuesClauseTest extends JdbcTestBase {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(LangScripts_ValuesClauseTest.class));
  }
  
  public LangScripts_ValuesClauseTest(String name) {
    super(name); 
  }
  ...
  public void testLangScript_ValuesClauseWithPartitioning() throws Exception
  {
    ...
    Object[][] Script_ValuesClauseUTPartitioning = {
	// this test is for the values clause functionality
	{ "create table t1 (i int, j int)", null },
     { "create table t2 (k int, l int)", null },
	{ "insert into t2 values (1, 2)", null },
    ...
    // This will fail on the first one that succeeds where it shouldn't
    // or throws unknown exception
    JDBC.SQLUnitTestHelper(stmt,Script_ValuesClauseUTPartitioning);
