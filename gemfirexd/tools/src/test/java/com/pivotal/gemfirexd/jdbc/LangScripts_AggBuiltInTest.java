...
public class LangScripts_AggBuiltInTest extends JdbcTestBase {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(LangScripts_AggBuiltInTest.class));
  }
  
  public LangScripts_AggBuiltInTest(String name) {
    super(name); 
  }

  // This test is the as-is LangScript conversion, without any partitioning clauses
  public void testLangScript_AggBuiltInTestNoPartitioning() throws Exception
  {
	...
	{ "create table t (i int, s smallint, l bigint,	c char(10), v varchar(50), lvc long varchar, d double precision, r real, dt date, t time, ts timestamp, b char(2) for bit data, bv varchar(8) for bit data, lbv long varchar for bit data, dc decimal(5,2))" + getOffHeapSuffix(), null},
	{ "create table empty (i int, s smallint, l bigint, c char(10), v varchar(50), lvc long varchar, d double precision, r real, dt date, t time, ts timestamp, b char(2) for bit data, bv varchar(8) for bit data, lbv long varchar for bit data, dc decimal(5,2))" + getOffHeapSuffix(), null},
	...
	{ "create table t1 (c1 long varchar)" + getOffHeapSuffix(), null },
	...
	{ "create table tmp (x int, y smallint)" + getOffHeapSuffix(), null },
	{ "insert into tmp (x, y) select avg(i), avg(s) from t", null },
	...
	{ "drop table tmp", null },
	{ "create table tmp (x int)" + getOffHeapSuffix(), null },
	...
	{ "drop table tmp", null},
	{ "create table tmp(x double precision, y int)" + getOffHeapSuffix(), null },
	...
	{ "create table tmp (x int, y smallint)" + getOffHeapSuffix(), null },
	{ "insert into tmp (x, y) select count(i), count(c) from t", null },
	...
	{ "create table t (i int, s smallint, l bigint,	c char(10), v varchar(50), lvc long varchar, d double precision, r real, dt date, t time, ts timestamp,	b char(2) for bit data, bv varchar(8) for bit data, lbv long varchar for bit data)" + getOffHeapSuffix(), null },
	{ "create table empty (i int, s smallint, l bigint,	c char(10), v varchar(50), lvc long varchar, d double precision, r real, dt date, t time, ts timestamp,	b char(2) for bit data, bv varchar(8) for bit data, lbv long varchar for bit data)" + getOffHeapSuffix(), null },
	{ "insert into t (i) values (null)", null },
	{ "insert into t (i) values (null)", null },
	...
	{ "drop view v1", null }, 
	{ "create table tmp (x int, y smallint)" + getOffHeapSuffix(), null },
	{ "insert into tmp (x, y) select count(*), count(*) from t", null },
	...
	{ "drop table empty", null },
	// SUM
	{ "create table t (i int, s smallint, l bigint, c char(10), v varchar(50), d double precision, r real, dt date, t time, ts timestamp,	b char(2) for bit data, bv varchar(8) for bit data, dc decimal(5,2))" + getOffHeapSuffix(), null },
	{ "create table empty (i int, s smallint, l bigint, c char(10), v varchar(50), d double precision, r real, dt date, t time, ts timestamp,	b char(2) for bit data, bv varchar(8) for bit data, dc decimal(5,2))" + getOffHeapSuffix(), null },
	{ "insert into t (i) values (null)", null },
	{ "insert into t (i) values (null)", null },
	...
	{ "create table tmp (x int, y smallint)" + getOffHeapSuffix(), null },
	{ "insert into tmp (x, y) select sum(i), sum(s) from t", null },
	...
	{ "drop table tmp", null },
	{ "create table tmp (x double precision)" + getOffHeapSuffix(), null },
	...
	{ "create table tmp (x int, y char(20))" + getOffHeapSuffix(), null },
	{ "insert into tmp (x, y) select max(i), max(c) from t", null },
	...
	{ "create table tmp (x int, y char(20))" + getOffHeapSuffix(), null },
	{ "insert into tmp (x, y) select min(i), min(c) from t", null },
    ...
    JDBC.SQLUnitTestHelper(stmt,Script_AggBuiltInUT);
  }
  
  // This test is the script enhanced with partitioning
  public void testLangScript_AggBuiltInWithPartitioning() throws Exception
  {
    // This form of the aggbuiltin.sql test has partitioning clauses
    Object[][] Script_AggBuiltInUTPartitioning = {
	// create an all types tables
	{ "create table t (i int, s smallint, l bigint,	c char(10), v varchar(50), lvc long varchar, d double precision, r real, dt date, t time, ts timestamp, b char(2) for bit data, bv varchar(8) for bit data, lbv long varchar for bit data, dc decimal(5,2)) partition by column(i)" + getOffHeapSuffix(), null},
	{ "create table empty (i int, s smallint, l bigint, c char(10), v varchar(50), lvc long varchar, d double precision, r real, dt date, t time, ts timestamp, b char(2) for bit data, bv varchar(8) for bit data, lbv long varchar for bit data, dc decimal(5,2)) partition by column(i)" + getOffHeapSuffix(), null},
	{ "insert into t (i) values (null)", null},
	{ "insert into t (i) values (null)", null},
	{ "insert into t values (0, 100, 1000000, 'duplicate', 'this is duplicated', 'also duplicated', 200.0e0, 200.0e0, date('1992-01-01'), time('12:30:30'), timestamp('1992-01-01 12:30:30'), X'12af', x'0000111100001111', X'1234', 111.11)", null},
	{ "insert into t values (0, 100, 1000000, 'duplicate', 'this is duplicated', 'also duplicated', 200.0e0, 200.0e0, date('1992-01-01'), time('12:30:30'), timestamp('1992-01-01 12:30:30'), X'12af', X'0000111100001111', X'1234', 111.11)", null},
	...
	{ "select avg(lbv) from t group by c", "42Y22"},
	// long varchar datatypes too
	{ "create table t1 (c1 long varchar) partition by column(c1)" + getOffHeapSuffix(), null },
	{ "select avg(c1) from t1", "42Y22" },
	{ "drop table t1", null },
	// constants
	{ "select avg('hello') from t", "42Y22" },
	...
	{ "select avg(expr1), avg(expr2) from (select i * s, r * 2 from t) t (expr1, expr2) group by expr2, expr1", new String [][] {
		{"0","200.0"}, {"0","400.0"}, {"100","400.0"}, {null,null} } },
	{ "select distinct avg(i) from t group by i, dt", new String[][] { {"0"},{"1"},{null} } },
	{ "create table tmp (x int, y smallint) partition by column(x)" + getOffHeapSuffix(), null },
	{ "insert into tmp (x, y) select avg(i), avg(s) from t", null },
	{ "select * from tmp", new String [][] { {"0","107"} } },
	{ "insert into tmp (x, y) select avg(i), avg(s) from t group by b", null },
	{ "select * from tmp", new String [][] { {"0","107"}, {"0","107"}, {"0","100"}, {null,null} } },
	{ "drop table tmp", null },
	{ "create table tmp (x int) partition by column(x)" + getOffHeapSuffix(), null },
	{ "insert into tmp values (2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647)", null },
	{ "select avg(x) from tmp", new String [][] { {"2147483647"} } },
	{ "select avg(-(x - 1)) from tmp", new String [][] { {"-2147483646"} } },
	{ "select avg(x) from tmp group by x", new String [][] { {"2147483647"} } },
	{ "select avg(-(x - 1)) from tmp group by x", new String [][] { {"-2147483646"} } },
	{ "drop table tmp", null},
	{ "create table tmp(x double precision, y int) partition by column(x)" + getOffHeapSuffix(), null },
	{ "insert into tmp values (1,1)", null },
	{ "select avg(x) from tmp", new String [][] { {"1.0" } } },
	{ "select avg(x) from tmp group by y", new String [][] { {"1.0"} } },
	{ "insert into tmp values (2,1)", null },
	...
	{ "drop table empty", null },
	// Test the COUNT() aggregate
	{ "create table t (i int, s smallint, l bigint,	c char(10), v varchar(50), lvc long varchar, d double precision, r real, dt date, t time, ts timestamp,	b char(2) for bit data, bv varchar(8) for bit data, lbv long varchar for bit data) partition by column(i)" + getOffHeapSuffix(), null },
	{ "create table empty (i int, s smallint, l bigint,	c char(10), v varchar(50), lvc long varchar, d double precision, r real, dt date, t time, ts timestamp,	b char(2) for bit data, bv varchar(8) for bit data, lbv long varchar for bit data) partition by column(i)" + getOffHeapSuffix(), null },
	{ "insert into t (i) values (null)", null },
	{ "insert into t (i) values (null)", null },
	{ "insert into t values (0, 100, 1000000, 'duplicate', 'this is duplicated', 'also duplicated',  200.0e0, 200.0e0, date('1992-01-01'), time('12:30:30'), timestamp('1992-01-01 12:30:30'),  X'12af', X'0000111100001111', X'ABCD')", null },
	{ "insert into t values (0, 100, 1000000,  'duplicate', 'this is duplicated', 'also duplicated', 200.0e0, 200.0e0, date('1992-01-01'), time('12:30:30'), timestamp('1992-01-01 12:30:30'), X'12af', X'0000111100001111', X'ABCD')", null },
	...
	{ "drop table empty", null },
	// SUM
	{ "create table t (i int, s smallint, l bigint, c char(10), v varchar(50), d double precision, r real, dt date, t time, ts timestamp,	b char(2) for bit data, bv varchar(8) for bit data, dc decimal(5,2)) partition by column(i)" + getOffHeapSuffix(), null },
	{ "create table empty (i int, s smallint, l bigint, c char(10), v varchar(50), d double precision, r real, dt date, t time, ts timestamp,	b char(2) for bit data, bv varchar(8) for bit data, dc decimal(5,2)) partition by column(i)" + getOffHeapSuffix(), null },
	{ "insert into t (i) values (null)", null },
	{ "insert into t (i) values (null)", null },
	{ "insert into t values (0, 100, 1000000, 'duplicate', 'this is duplicated',  200.0e0, 200.0e0, date('1992-01-01'), time('12:30:30'), timestamp('1992-01-01 12:30:30'), X'12af', X'0000111100001111', 111.11)", null },
	{ "insert into t values (0, 100, 1000000, 'duplicate', 'this is duplicated',  200.0e0, 200.0e0, date('1992-01-01'), time('12:30:30'), timestamp('1992-01-01 12:30:30'), X'12af', X'0000111100001111', 111.11)", null },
	...
	//{ "select sum(x) from tmp", "22003"},
	{ "drop table tmp", null },
	{ "create table tmp (x double precision) partition by column(x)" + getOffHeapSuffix(), null },
	{ "insert into tmp values (2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),(2147483647),            (2147483647),(2147483647)", null },
	{ "select sum(x) from tmp", new String [][] { {"1.9327352823E10"} } },
	{ "drop table tmp", null },
	{ "drop table t", null },
	...
	{ "select max(expr1), max(expr2) from (select i * s, c || v from t) t (expr1, expr2) group by expr2, expr1", new String [][] {
		...
		{"100","duplicate this is duplicated"}, {"0","goodbye   this is duplicated"}, {null,null} } },
	{ "select distinct max(i) from t group by i, dt", new String [][] { {"0"}, {"1"}, {null} } },
	{ "create table tmp (x int, y char(20)) partition by column(x)" + getOffHeapSuffix(), null },
	{ "insert into tmp (x, y) select max(i), max(c) from t", null },
	{ "select * from tmp", new String [][] { {"1", "goodbye"} } },
	{ "insert into tmp (x, y) select max(i), max(c) from t group by b", null },
	{ "select * from tmp", new String [][] { {"1", "goodbye"}, {"1","goodbye"}, {"0", "duplicate"}, {null,null} } },
    ...
    // This will fail on the first one that succeeds where it shouldn't
    // or throws unknown exception
    JDBC.SQLUnitTestHelper(stmt,Script_AggBuiltInUTPartitioning);
