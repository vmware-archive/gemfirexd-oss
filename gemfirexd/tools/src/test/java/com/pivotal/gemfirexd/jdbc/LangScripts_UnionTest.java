...
public class LangScripts_UnionTest extends JdbcTestBase {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(LangScripts_UnionTest.class));
  }
  
  public LangScripts_UnionTest(String name) {
    super(name); 
  }
  ...
  public void testLangScript_UnionTestNoPartitioning() throws Exception
  {
	...
	{ "create table t1 (i int, s smallint, d double precision, r real, c10 char(10),c30 char(30), vc10 varchar(10), vc30 varchar(30))" + getOffHeapSuffix(), null },
     { "create table t2 (i int, s smallint, d double precision, r real, c10 char(10),	c30 char(30), vc10 varchar(10), vc30 varchar(30))" + getOffHeapSuffix(), null },
     { "create table dups (i int, s smallint, d double precision, r real, c10 char(10),c30 char(30), vc10 varchar(10), vc30 varchar(30))" + getOffHeapSuffix(), null },
	...
	{ "create table insert_test (i int, s smallint, d double precision, r real,c10 char(10), c30 char(30), vc10 varchar(10), vc30 varchar(30))" + getOffHeapSuffix(), null },
	...
	{ "drop table t1", null },
     { "drop table t2", null },
	{ "create table a (f1 varchar(10))" + getOffHeapSuffix(), null },
     { "create table b (f2 varchar(10))" + getOffHeapSuffix(), null },
     ...
     { "drop table a", null },
     { "drop table b", null },
     { "create table a (f1 int)" + getOffHeapSuffix(), null },
     { "create table b (f2 int)" + getOffHeapSuffix(), null },
     { "insert into b values(1)", null },
     { "select nullif('x','x') as f0, f1 from a union all select nullif('x','x') as f0, nullif(1,1) as f1 from b", new String[][] { {null,null} } },
     { "drop table a", null },
     { "drop table b", null },
	{ "create table o (name varchar(20), ord int)" + getOffHeapSuffix(), null },
     { "create table a (ord int, amount int)" + getOffHeapSuffix(), null },
  ...
  public void testLangScript_UnionWithPartitioning() throws Exception
  {
    ...
    Object[][] Script_UnionUTPartitioning = {
	// this test shows union functionality
	{ "create table t1 (i int, s smallint, d double precision, r real, c10 char(10),c30 char(30), vc10 varchar(10), vc30 varchar(30))" + getOffHeapSuffix(), null },
     { "create table t2 (i int, s smallint, d double precision, r real, c10 char(10),	c30 char(30), vc10 varchar(10), vc30 varchar(30))" + getOffHeapSuffix(), null },
     { "create table dups (i int, s smallint, d double precision, r real, c10 char(10),c30 char(30), vc10 varchar(10), vc30 varchar(30))" + getOffHeapSuffix(), null },
	...
	{ "create table o (name varchar(20), ord int)" + getOffHeapSuffix(), null },
     { "create table a (ord int, amount int)" + getOffHeapSuffix(), null },
     { "create view v1 (vx, vy) as select name, sum(ord) from o where ord > 0 group by name, ord having ord <= ANY (select ord from a)", null },
	//GemFireXD does not support grouping and agg on partition table, throws 0A000
     { "select vx, vy from v1 union select vx, sum(vy) from v1 group by vx, vy having (vy / 2) > 15", "0A000" },
     { "drop view v1", null },
     { "drop table o", null },
     { "drop table a", null },
	{ "create table t1 (i int, j int)" + getOffHeapSuffix(), null },
    ...
    // This will fail on the first one that succeeds where it shouldn't
    // or throws unknown exception
    JDBC.SQLUnitTestHelper(stmt,Script_UnionUTPartitioning);
