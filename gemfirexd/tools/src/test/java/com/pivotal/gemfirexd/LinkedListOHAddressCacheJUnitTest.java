...
public class LinkedListOHAddressCacheJUnitTest extends CollectionBasedOHAddressCacheTestBase {

  @Override
  protected CollectionBasedOHAddressCache createOHAddressCacheInstance() {
