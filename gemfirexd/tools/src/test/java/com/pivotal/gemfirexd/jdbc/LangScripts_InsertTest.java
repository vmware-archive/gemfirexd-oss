...
public class LangScripts_InsertTest extends JdbcTestBase {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(LangScripts_InsertTest.class));
  }
  
  public LangScripts_InsertTest(String name) {
    super(name); 
  }

  // This test is the as-is LangScript conversion, without any partitioning clauses
  public void testLangScript_InsertTestNoPartitioning() throws Exception
  {
	...
	{ "create table t2 (k int, l int)", null },
  ...
  public void testLangScript_InsertWithPartitioning() throws Exception
  {
    // This form of the Insert.sql test turns on partitioning
    Object[][] Script_InsertUTPartitioning = {
	{ "create table t1 (i int, j int)", null },
	{ "create table t2 (k int, l int)", null },
	{ "insert into t2 values (1, 2)", null },
	{ "insert into t2 values (3, 4)", null },
    ...
    // This will fail on the first one that succeeds where it shouldn't
    // or throws unknown exception
    JDBC.SQLUnitTestHelper(stmt,Script_InsertUTPartitioning);
