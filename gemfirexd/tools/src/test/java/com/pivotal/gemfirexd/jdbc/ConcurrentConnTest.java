...
public class ConcurrentConnTest extends JdbcTestBase {

  public static void main(String[] args) {
    TestRunner.run(new TestSuite(ConcurrentConnTest.class));
  }
  ...
  public void testConcConnectionsOne() throws Exception {
    ...
    if (conn1 == null
      ...
      fail("Concurrent connections test one - Failed to open a connection");
    }
