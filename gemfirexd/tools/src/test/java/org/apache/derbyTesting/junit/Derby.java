 ...
 * gemfirexd.jar is on the classpath then the hasXXX() methods
...
public class Derby {
    ...
    public static boolean hasEmbedded()
    {
        ...
        return hasCorrectJar("/gemfirexd.jar",
               "com.pivotal.gemfirexd.internal.authentication.UserAuthenticator");
    }
    /**
    ...
    public static boolean hasTools()
    {
        ...
        return hasCorrectJar("/gemfirexd-tools.jar",
