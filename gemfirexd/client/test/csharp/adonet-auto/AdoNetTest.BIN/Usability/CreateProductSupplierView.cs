...
{
    /// <summary>
    /// Creates and verifies product-supplier view and view data
    /// </summary>
    class CreateProductSupplierView : GFXDTest
    {
        public CreateProductSupplierView(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
        ...
        public override void Run(object context)
        {
            ...
            Relation relation = Relation.PRODUCT_SUPPLIER;
