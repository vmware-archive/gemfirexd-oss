...
{
    /// <summary>
    /// Verfies deleting product records that are bound by a foreign key constraint 
    /// with order detail records. Expects a contraint violation exception
    /// </summary>
    class DeleteProductWithFKeyConstraint : GFXDTest
    {
        public DeleteProductWithFKeyConstraint(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
