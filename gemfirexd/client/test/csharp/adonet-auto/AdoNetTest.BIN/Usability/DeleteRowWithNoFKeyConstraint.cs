...
{
    /// <summary>
    /// Verfies deleting address records that are NOT bound by a foreign key constraint. 
    /// Expects NO contraint violation exception
    /// </summary>
    class DeleteRowWithNoFKeyConstraint : GFXDTest
    {
        public DeleteRowWithNoFKeyConstraint(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
