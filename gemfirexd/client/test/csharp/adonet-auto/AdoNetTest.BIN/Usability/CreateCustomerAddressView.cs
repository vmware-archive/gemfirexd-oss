...
{
    /// <summary>
    /// Creates and verifies customer-address view and view data
    /// </summary>
    class CreateCustomerAddressView : GFXDTest
    {
        public CreateCustomerAddressView(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
        ...
        public override void Run(object context)
        {
            ...
            Relation relation = Relation.CUSTOMER_ADDRESS;
