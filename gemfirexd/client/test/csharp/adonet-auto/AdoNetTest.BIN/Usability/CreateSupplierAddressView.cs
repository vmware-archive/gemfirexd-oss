...
{
    /// <summary>
    /// Creates and verifies suppliers-address view and view data
    /// </summary>
    class CreateSupplierAddressView : GFXDTest
    {
        public CreateSupplierAddressView(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
        ...
        public override void Run(object context)
        {
            ...
            Relation relation = Relation.SUPPLIER_ADDRESS;
