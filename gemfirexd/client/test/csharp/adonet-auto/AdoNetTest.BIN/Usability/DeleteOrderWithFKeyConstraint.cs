...
{
    /// <summary>
    /// Verfies deleting order records that are bound by a foreign key constraint 
    /// with order detail records. Expects a contraint violation exception
    /// </summary>
    class DeleteOrderWithFKeyConstraint : GFXDTest
    {
        public DeleteOrderWithFKeyConstraint(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
