...
{
    /// <summary>
    /// Verifies inserting new records for all DbDefault' tables
    /// </summary>
    class CommitAllTableInsertTransaction : GFXDTest
    {
        public CommitAllTableInsertTransaction(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
