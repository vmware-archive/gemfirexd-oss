...
{
    /// <summary>
    /// Creates and verifies orderdetail-product view and view data
    /// </summary>
    class CreateOrderDetailProductView : GFXDTest
    {
        public CreateOrderDetailProductView(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
        ...
        public override void Run(object context)
        {
            ...
            Relation relation = Relation.ORDERDETAIL_PRODUCT;
