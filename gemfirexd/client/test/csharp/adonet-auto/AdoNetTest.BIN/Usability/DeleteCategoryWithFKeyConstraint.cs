...
{
    /// <summary>
    /// Verfies deleting category records that are bound by a foreign key constraint 
    /// with product records. Expects a contraint violation exception
    /// </summary>
    class DeleteCategoryWithFKeyConstraint : GFXDTest
    {
        public DeleteCategoryWithFKeyConstraint(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
