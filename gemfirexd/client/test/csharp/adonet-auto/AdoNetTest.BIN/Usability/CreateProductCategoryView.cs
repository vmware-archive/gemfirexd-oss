...
{
    /// <summary>
    /// Creates and verifies product-category view and view data
    /// </summary>
    class CreateProductCategoryView : GFXDTest
    {
        public CreateProductCategoryView(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
        ...
        public override void Run(object context)
        {
            ...
            Relation relation = Relation.PRODUCT_CATEGORY;
