...
{
    /// <summary>
    /// Verifies a transaction can be initiated without specifying an isolation 
    /// level
    /// </summary>
    class GFXDTransactionWithoutIsolationLevel : GFXDTest
    {
        public GFXDTransactionWithoutIsolationLevel(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
