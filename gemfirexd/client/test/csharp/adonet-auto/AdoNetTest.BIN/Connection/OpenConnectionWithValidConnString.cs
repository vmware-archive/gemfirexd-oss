...
{
    /// <summary>
    /// Verifies creating and opening a GFXDConnection 
    /// </summary>
    class OpenConnectionWithValidConnString : GFXDTest
    {        
        public OpenConnectionWithValidConnString(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
