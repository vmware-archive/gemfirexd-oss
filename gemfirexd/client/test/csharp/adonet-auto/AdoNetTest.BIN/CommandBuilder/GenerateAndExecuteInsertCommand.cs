...
{
    /// <summary>
    /// Verifies GFXDCommandBuilder correctly compiles the insert command
    /// based on the GFXDCommand object's select command
    /// </summary>
    class GenerateAndExecuteInsertCommand : GFXDTest
    {
        public GenerateAndExecuteInsertCommand(ManualResetEvent resetEvent)
            : base(resetEvent)
        {            
        }
