...
{
    /// <summary>
    /// Attempts to drop a database schema that has been populated. Expects exception 
    /// when attempt is made
    /// </summary>
    class DropSchemaWithExistingTables : GFXDTest
    {
        public DropSchemaWithExistingTables(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
