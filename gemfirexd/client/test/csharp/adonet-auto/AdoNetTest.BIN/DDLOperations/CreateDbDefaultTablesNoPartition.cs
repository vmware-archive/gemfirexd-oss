...
{
    /// <summary>
    /// Create and populate the default commerce database tables with basic create table DDL, 
    /// without partition, replication, etc.
    /// </summary>
    class CreateDbDefaultTablesNoPartition : GFXDTest
    {
        public CreateDbDefaultTablesNoPartition(ManualResetEvent resetEvent)
            : base(resetEvent)
        {   
        }
