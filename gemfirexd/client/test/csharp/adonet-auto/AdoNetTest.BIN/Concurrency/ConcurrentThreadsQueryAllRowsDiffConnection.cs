...
{
    /// <summary>
    /// Performs concurent queries on the same table from different threads using different
    /// connections. Expect no exception and all data records are returned.
    /// </summary>
    class ConcurrentThreadsQueryAllRowsDiffConnection : GFXDTest
    {
        public ConcurrentThreadsQueryAllRowsDiffConnection(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
