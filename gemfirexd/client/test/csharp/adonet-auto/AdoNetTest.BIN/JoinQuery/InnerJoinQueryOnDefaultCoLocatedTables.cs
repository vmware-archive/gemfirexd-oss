...
{
    /// <summary>
    /// Performs inner join query on related tables that are created on default colocation
    /// schema.
    /// </summary>
    class InnerJoinQueryOnDefaultCoLocatedTables : GFXDTest
    {
        public InnerJoinQueryOnDefaultCoLocatedTables(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
