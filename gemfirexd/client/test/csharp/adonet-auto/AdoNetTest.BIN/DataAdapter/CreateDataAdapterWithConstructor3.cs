...
{
    /// <summary>
    /// Verifies creating the GFXDDataAdapter using class's parameterized construtor
    /// with a command string and connection object.
    /// </summary>
    class CreateDataAdapterWithConstructor3 : GFXDTest
    {
        public CreateDataAdapterWithConstructor3(ManualResetEvent resetEvent)
            : base(resetEvent)
        {            
        }
