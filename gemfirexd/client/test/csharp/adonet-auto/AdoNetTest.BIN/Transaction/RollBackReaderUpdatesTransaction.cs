...
{
    /// <summary>
    /// Verifies rolling back transactions involving DataReader updates. This test should fail
    /// until the ReaderUpdatable property and all update methods are re-implemented.
    /// </summary>
    class RollBackReaderUpdatesTransaction : GFXDTest
    {
        public RollBackReaderUpdatesTransaction(ManualResetEvent resetEvent)
            : base(resetEvent)
        {
        }
