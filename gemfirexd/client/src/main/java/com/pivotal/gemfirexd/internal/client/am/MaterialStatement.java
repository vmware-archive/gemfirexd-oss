/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.am.MaterialStatement
...
public interface MaterialStatement {
    ...
    public abstract void writePrepareDescribeOutput_(String sql, Section section, boolean needStatementUUID) throws SqlException;

    public abstract void readPrepareDescribeOutput_() throws SqlException;
    
    public abstract void writeGetStmtUUID(Section section) throws SqlException;
    
    public abstract void readStatementID_() throws SqlException;
