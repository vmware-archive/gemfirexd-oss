/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.NetLogWriter
...
public class NetLogWriter extends com.pivotal.gemfirexd.internal.client.am.LogWriter {
    ...
    public void traceConnectsExit(com.pivotal.gemfirexd.internal.client.am.Connection connection) {
        if (traceSuspended()) {
            return;
        }
    ...
    public void traceConnectsResetExit(com.pivotal.gemfirexd.internal.client.am.Connection connection) {
        if (traceSuspended()) {
            return;
        }
        NetConnection c = (NetConnection) connection;
    ...
    synchronized public void traceProtocolFlow(byte[] buff,
        ...
        if (!loggingEnabled(com.pivotal.gemfirexd.internal.jdbc.ClientDataSource.TRACE_PROTOCOL_FLOWS)) {
            return;
        }
        synchronized (printWriter_) {
