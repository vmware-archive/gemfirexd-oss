/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.am.ColumnMetaData40
...
// GemStone changes BEGIN
    public ColumnMetaData40(final Agent agent) {
      super(agent);
    /* (original code)
...
// GemStone changes END
     ...
     */
// GemStone changes BEGIN
    public ColumnMetaData40(final Agent agent, int upperBound) {
        super(agent, upperBound);
    /* (original code)
