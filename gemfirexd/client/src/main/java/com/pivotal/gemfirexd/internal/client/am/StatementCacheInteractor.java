...
Derby - Class com.pivotal.gemfirexd.internal.client.am.StatementCacheInteractor
...
public final class StatementCacheInteractor {
    ...
    private PreparedStatement createLogicalPreparedStatement(
        ...
        LogicalPreparedStatement logicalPs =
                ClientDRDADriver.getFactory().newLogicalPreparedStatement(
                      physicalConnection.agent_ /* GemStoneAddition */,
                                                    ps, stmtKey, this);
    ...
    private CallableStatement createLogicalCallableStatement(
        ...
        LogicalCallableStatement logicalCs =
                ClientDRDADriver.getFactory().newLogicalCallableStatement(
                      physicalConnection.agent_ /* GemStoneAddition */,
                                                    cs, stmtKey, this);
