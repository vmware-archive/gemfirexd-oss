/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.NetConfiguration
...
import com.pivotal.gemfirexd.internal.client.am.Version;
...
public class NetConfiguration {
    ...
    static final int PRDDTA_ACCT_SUFFIX_LEN_BYTE = 55
        + ClientSharedData.BYTES_PREFIX_CLIENT_VERSION_LENGTH
        + 2 /* version ordinal */ + 4 /* connection property flags */;
