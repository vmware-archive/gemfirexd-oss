/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.ClientDataSource
 ...
 * <pre>
 * com.pivotal.gemfirexd.internal.client.ClientDataSource dataSource = new com.pivotal.gemfirexd.internal.client.ClientDataSource ();
...
public class ClientDataSource extends ClientBaseDataSource implements DataSource {
    ...
    public Connection getConnection(String user, String password) throws SQLException {
        ...
        try
        {
            ...
            return ClientDRDADriver.getFactory().newNetConnection
