/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.am.Lob
            ...
            if (is.read() != -1) {
                ...
                throw new SqlException(
                            ...
                            new ClientMessageId(
                                ...
                                typeDesc,
                                this.columnName /* GemStoneAddition */
                        );
            }
            if (partLength > 0) {
                byteArrays.add(curBytes);
    ...
    throws SQLException {
        if (pos <= 0) {
            throw new SqlException(agent_.logWriter_,
                ...
                new Long(pos)).getSQLException(agent_ /* GemStoneAddition */);
        }
        if (length < 0) {
            throw new SqlException(agent_.logWriter_,
...
// GemStone changes BEGIN
        {
            throw new SqlException(agent_.logWriter_, new ClientMessageId(
                SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent_.connection_
                    .getServerLocation(), "Lob::checkValidity()" },
                    new SqlException(null, new ClientMessageId(
                        SQLState.LOB_OBJECT_INVALID))).getSQLException(agent_);
        }
            /* (original code)
