/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.NetXAConnectionReply
...
public class NetXAConnectionReply extends NetResultSetReply {
    ...
    protected Xid parseXID() throws DisconnectException {
        ...
        return new com.pivotal.gemfirexd.internal.client.ClientXid(formatId, gtrid, bqual);
    }
