/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.am.Configuration
...
public class Configuration {
    ...
    public static int traceLevel__ = com.pivotal.gemfirexd.internal.jdbc.ClientBaseDataSource.TRACE_ALL;
    ...
    public final static String dncDriverName = "GemFireXD Network Client JDBC Driver";
...
// GemStone changes BEGIN
    // for GemFireXD no TX is the default
    public final static int defaultIsolation = java.sql.Connection.TRANSACTION_NONE;
    /* (original code)
