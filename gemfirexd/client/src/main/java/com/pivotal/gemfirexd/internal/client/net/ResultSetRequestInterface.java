/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.ResultSetRequestInterface
...
public interface ResultSetRequestInterface {
    public void writeFetch(NetResultSet resultSet,
                           Section section,
                           int fetchSize) throws com.pivotal.gemfirexd.internal.client.am.SqlException;
    ...
    public void writeScrollableFetch(NetResultSet resultSet,
                                     ...
                                     int orientation,
                                     long rowToFetch,
                                     boolean resetQueryBlocks) throws com.pivotal.gemfirexd.internal.client.am.SqlException;

    public void writePositioningFetch(NetResultSet resultSet,
                                      Section section,
                                      int orientation,
                                      long rowToFetch) throws com.pivotal.gemfirexd.internal.client.am.SqlException;

    public void writeCursorClose(NetResultSet resultSet,
                                 Section section) throws com.pivotal.gemfirexd.internal.client.am.SqlException;
