/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.ClientPooledConnection
...
// concrete class for JDBC3 is ClientPooledConnection30
abstract
// GemStone changes END
public class ClientPooledConnection implements javax.sql.PooledConnection {
    ...
    com.pivotal.gemfirexd.internal.client.am.Connection physicalConnection_ = null;
    com.pivotal.gemfirexd.internal.client.net.NetConnection netPhysicalConnection_ = null;
    com.pivotal.gemfirexd.internal.client.net.NetXAConnection netXAPhysicalConnection_ = null;
    ...
    //@GuardedBy("this")
    com.pivotal.gemfirexd.internal.client.am.LogicalConnection logicalConnection_ = null;

    protected com.pivotal.gemfirexd.internal.client.am.LogWriter logWriter_ = null;
    ...
    public ClientPooledConnection(ClientBaseDataSource ds,
        ...
        try {
            ...
            netPhysicalConnection_ = (com.pivotal.gemfirexd.internal.client.net.NetConnection)
            ClientDRDADriver.getFactory().newNetConnection(
    ...
    public synchronized java.sql.Connection getConnection() throws SQLException {
        ...
        {
            throw se.getSQLException(physicalConnection_ != null
                ? physicalConnection_.agent_ : null /* GemStoneAddition */);
        }
    }
    ...
    private void createLogicalConnection() throws SqlException {
        ...
        if (this.statementCache == null) {
            logicalConnection_ = ClientDRDADriver.getFactory().newLogicalConnection(
                                                        physicalConnection_,
                                                        this);
        } else {
            logicalConnection_ = ClientDRDADriver.getFactory().
