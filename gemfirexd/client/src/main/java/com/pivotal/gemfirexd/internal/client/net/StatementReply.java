/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.StatementReply
...
public class StatementReply extends ConnectionReply {
    ...
    public void readStatementID(StatementCallbackInterface statement)  throws SqlException {
      materialStatementReply_.readStatementID(statement);
      agent_.checkForChainBreakingException_();
    }
