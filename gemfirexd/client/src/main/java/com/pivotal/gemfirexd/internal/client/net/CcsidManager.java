/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.CcsidManager
...
public abstract class CcsidManager {
    ...
    public abstract byte[] convertFromUCS2(String sourceString, com.pivotal.gemfirexd.internal.client.am.Agent agent) throws com.pivotal.gemfirexd.internal.client.am.SqlException;
    ...
    public abstract int convertFromUCS2(String sourceString,
                                        byte[] buffer,
                                        int offset,
                                        com.pivotal.gemfirexd.internal.client.am.Agent agent) throws com.pivotal.gemfirexd.internal.client.am.SqlException;
