/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.Typdef
...
public class Typdef implements java.lang.Cloneable {
    ...
    private static final int[] fdocaTypeToRepresentationMap_ = {
        ...
        /* 0x2E */ 0,
        /* 0x2F */ 0,
        /* 0x30 */ com.pivotal.gemfirexd.internal.client.am.Decimal.PACKED_DECIMAL, /* FDOCA_TYPE_DECIMAL */
        /* 0x31 */ 0,
        /* 0x32 */ 0,
        /* 0x33 */ 0,
        /* 0x34 */ 0,
        ...
        /* 0x46 */ 0,
        /* 0x47 */ 0,
        /* 0x48 */ com.pivotal.gemfirexd.internal.client.am.FloatingPoint.IEEE_754_FLOATING_POINT, /* FDOCA_TYPE_FLOAT_IEEE */
        /* 0x49 */ 0,
        /* 0x4A */ 0,
        /* 0x4B */ 0,
        /* 0x4C */ 0,
    ...
    protected static final FdocaSimpleDataArray[] environmentTables_ = {
        ...
        new FdocaSimpleDataArray(0x08, FdocaConstants.FDOCA_TYPE_FLOAT_IEEE, com.pivotal.gemfirexd.internal.client.am.FloatingPoint.IEEE_754_FLOATING_POINT, NOCCSID, 0, 0, 16, FIXEDLENGTH),
        /* 0x09 null 16-byte bin float */
        new FdocaSimpleDataArray(0x09, FdocaConstants.FDOCA_TYPE_NFLOAT_IEEE, com.pivotal.gemfirexd.internal.client.am.FloatingPoint.IEEE_754_FLOATING_POINT, NOCCSID, 0, 0, 16, FIXEDLENGTH),
        /* 0x0A 8-byte bin float */
        new FdocaSimpleDataArray(0x0A, FdocaConstants.FDOCA_TYPE_FLOAT_IEEE, com.pivotal.gemfirexd.internal.client.am.FloatingPoint.IEEE_754_FLOATING_POINT, NOCCSID, 0, 0, 8, FIXEDLENGTH),
        /* 0x0B null 8-byte bin float */
        new FdocaSimpleDataArray(0x0B, FdocaConstants.FDOCA_TYPE_NFLOAT_IEEE, com.pivotal.gemfirexd.internal.client.am.FloatingPoint.IEEE_754_FLOATING_POINT, NOCCSID, 0, 0, 8, FIXEDLENGTH),
        /* 0x0C 4-byte bin float */
        new FdocaSimpleDataArray(0x0C, FdocaConstants.FDOCA_TYPE_FLOAT_IEEE, com.pivotal.gemfirexd.internal.client.am.FloatingPoint.IEEE_754_FLOATING_POINT, NOCCSID, 0, 0, 4, FIXEDLENGTH),
        /* 0x0D null 4-byte bin float */
        new FdocaSimpleDataArray(0x0D, FdocaConstants.FDOCA_TYPE_NFLOAT_IEEE, com.pivotal.gemfirexd.internal.client.am.FloatingPoint.IEEE_754_FLOATING_POINT, NOCCSID, 0, 0, 4, FIXEDLENGTH),
        /* 0x0E Fixed Decimal */
// GemStone changes BEGIN
        new FdocaSimpleDataArray(0x0E, FdocaConstants.FDOCA_TYPE_DECIMAL,
            com.pivotal.gemfirexd.internal.client.am.Decimal.PACKED_DECIMAL,
            NOCCSID, 0, 0, FdocaConstants.NUMERIC_MAX_PRECISION, DECIMALLENGTH),
        /* (original code)
        new FdocaSimpleDataArray(0x0E, FdocaConstants.FDOCA_TYPE_DECIMAL, com.pivotal.gemfirexd.internal.client.am.Decimal.PACKED_DECIMAL, NOCCSID, 0, 0, 31, DECIMALLENGTH),
        */
...
// GemStone changes BEGIN
        new FdocaSimpleDataArray(0x0F, FdocaConstants.FDOCA_TYPE_NDECIMAL,
            ...
            NOCCSID, 0, 0, FdocaConstants.NUMERIC_MAX_PRECISION, DECIMALLENGTH),
        /* (original code)
        new FdocaSimpleDataArray(0x0F, FdocaConstants.FDOCA_TYPE_NDECIMAL, com.pivotal.gemfirexd.internal.client.am.Decimal.PACKED_DECIMAL, NOCCSID, 0, 0, 31, DECIMALLENGTH),
        */
// GemStone changes END
        /* 0x10 empties */
        null,
