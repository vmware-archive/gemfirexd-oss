/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.OpenSocketAction
...
public class OpenSocketAction implements java.security.PrivilegedExceptionAction {
               ...
               java.security.cert.CertificateException
    {
        ...
        case com.pivotal.gemfirexd.internal.jdbc.ClientBaseDataSource.SSL_BASIC:
            sf = NaiveTrustManager.getSocketFactory();
            break;
        case com.pivotal.gemfirexd.internal.jdbc.ClientBaseDataSource.SSL_PEER_AUTHENTICATION:
            sf = (SocketFactory)SSLSocketFactory.getDefault();
            break;
        case com.pivotal.gemfirexd.internal.jdbc.ClientBaseDataSource.SSL_OFF:
