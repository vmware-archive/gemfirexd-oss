...
import com.pivotal.gemfirexd.thrift.internal.ClientBlob.MemInputStream;
import com.pivotal.gemfirexd.thrift.internal.ClientBlob.MemOutputStream;
...
public class ClientClob extends ClientLobBase implements Clob {
  ...
  ClientClob(ClobChunk firstChunk, ClientService service,
    ...
    super(service, firstChunk.last ? gfxdConstants.INVALID_ID
