/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.am.Cursor
...
// GemStone changes BEGIN
    // cached so that can be checked for validity in case of failover
...
// GemStone changes BEGIN
        this.locatorProcs_ = agent.connection_.locatorProcedureCall();
// GemStone changes END
    }
    ...
    private final java.math.BigDecimal get_DECIMAL(int column) throws SqlException {
        try {
            return com.pivotal.gemfirexd.internal.client.am.Decimal.getBigDecimal(dataBuffer_,
                    columnDataPosition_[column - 1],
    ...
    private final double getDoubleFromDECIMAL(int column) throws SqlException {
        try {
            return com.pivotal.gemfirexd.internal.client.am.Decimal.getDouble(dataBuffer_,
                    columnDataPosition_[column - 1],
                    getColumnPrecision(column - 1),
                    getColumnScale(column - 1));
            ...
            throw new SqlException(agent_.logWriter_, 
                ...
                "double", getColumnLabel(column) /* GemStoneAddition */, e);
        } catch (java.io.UnsupportedEncodingException e) {
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.UNSUPPORTED_ENCODING), 
                "DECIMAL", "double",
    ...
    private final long getLongFromDECIMAL(int column) throws SqlException {
        try {
            return com.pivotal.gemfirexd.internal.client.am.Decimal.getLong(dataBuffer_,
                    columnDataPosition_[column - 1],
                    getColumnPrecision(column - 1),
                    getColumnScale(column - 1));
        } catch (java.lang.IllegalArgumentException e) {
            throw new SqlException(agent_.logWriter_,
                new ClientMessageId (SQLState.LANG_OUTSIDE_RANGE_FOR_DATATYPE),
                "long", getColumnLabel(column) /* GemStoneAddition */, e);
        } catch (java.io.UnsupportedEncodingException e) {
            throw new SqlException(agent_.logWriter_,
                new ClientMessageId (SQLState.UNSUPPORTED_ENCODING), 
                "DECIMAL", "long",
    ...
    private final java.sql.Date getDATE(int column) throws SqlException {
        try {
            return com.pivotal.gemfirexd.internal.client.am.DateTime.dateBytesToDate(dataBuffer_,
                columnDataPosition_[column - 1],
    ...
    private final java.sql.Time getTIME(int column) throws SqlException {
        try {
            return com.pivotal.gemfirexd.internal.client.am.DateTime.timeBytesToTime(dataBuffer_,
                    columnDataPosition_[column - 1],
                    getRecyclableCalendar(),
                    charsetName_[column - 1]);
        } catch (UnsupportedEncodingException e) {
    ...
    private final java.sql.Timestamp getTIMESTAMP(int column) throws SqlException {
        ...
        try {
            return com.pivotal.gemfirexd.internal.client.am.DateTime.timestampBytesToTimestamp(
                dataBuffer_,
                columnDataPosition_[column - 1],
                getRecyclableCalendar(),
                charsetName_[column - 1]);
    ...
    private final java.sql.Timestamp getTimestampFromDATE(int column) throws SqlException {
        try {
            return com.pivotal.gemfirexd.internal.client.am.DateTime.dateBytesToTimestamp(dataBuffer_,
                    columnDataPosition_[column - 1],
                    getRecyclableCalendar(), 
                    charsetName_[column -1]);
        } catch (UnsupportedEncodingException e) {
    ...
    private final java.sql.Timestamp getTimestampFromTIME(int column) throws SqlException {
        try {
            return com.pivotal.gemfirexd.internal.client.am.DateTime.timeBytesToTimestamp(dataBuffer_,
                    columnDataPosition_[column - 1],
                    getRecyclableCalendar(),
                    charsetName_[column -1]);
        } catch (UnsupportedEncodingException e) {
    ...
    private final java.sql.Date getDateFromTIMESTAMP(int column) throws SqlException {
        try {
            return com.pivotal.gemfirexd.internal.client.am.DateTime.timestampBytesToDate(dataBuffer_,
                    columnDataPosition_[column - 1],
                    getRecyclableCalendar(),
                    charsetName_[column -1]);
        } catch (UnsupportedEncodingException e) {
    ...
    private final java.sql.Time getTimeFromTIMESTAMP(int column) throws SqlException {
        try {
            return com.pivotal.gemfirexd.internal.client.am.DateTime.timestampBytesToTime(dataBuffer_,
                    columnDataPosition_[column - 1],
                    getRecyclableCalendar(),
                    charsetName_[column -1]);
        } catch (UnsupportedEncodingException e) {
...
// GemStone changes BEGIN
    ...
    private final byte[] get_UDT_bytes(int column) throws SqlException {
      ...
      if (o instanceof byte[]) {
        ...
        throw getUDTTypeConversionException(column, o, "byte[]");
      }
    }
    ...
    private final SqlException getUDTTypeConversionException(int column,
        Object o, String convertType) {
...
// GemStone changes END
    ...
    private java.util.Calendar getRecyclableCalendar()
    {
        if (recyclableCalendar_ == null)
             recyclableCalendar_ = ClientSharedData.getDefaultCalendar();
...
// GemStone changes BEGIN
        case java.sql.Types.JAVA_OBJECT:
            ...
            throw getUDTTypeConversionException(column, o, "boolean");
// GemStone changes END
        default:
...
// GemStone changes BEGIN
        case java.sql.Types.JAVA_OBJECT:
            ...
            throw getUDTTypeConversionException(column, o, "short");
// GemStone changes END
        default:
            throw new ColumnTypeConversionException(agent_.logWriter_,
...
// GemStone changes BEGIN
        case java.sql.Types.JAVA_OBJECT:
            ...
            throw getUDTTypeConversionException(column, o, "int");
// GemStone changes END
        default:
            throw new ColumnTypeConversionException(agent_.logWriter_,
...
// GemStone changes BEGIN
        case java.sql.Types.JAVA_OBJECT:
            ...
            throw getUDTTypeConversionException(column, o, "long");
// GemStone changes END
        default:
            throw new ColumnTypeConversionException(agent_.logWriter_,
...
// GemStone changes BEGIN
        case java.sql.Types.JAVA_OBJECT:
            ...
            throw getUDTTypeConversionException(column, o, "float");
// GemStone changes END
        default:
            throw new ColumnTypeConversionException(agent_.logWriter_,
...
// GemStone changes BEGIN
        case java.sql.Types.JAVA_OBJECT:
            ...
            throw getUDTTypeConversionException(column, o, "double");
// GemStone changes END
        default:
            throw new ColumnTypeConversionException(agent_.logWriter_,
...
// GemStone changes BEGIN
        case java.sql.Types.JAVA_OBJECT:
            ...
            if (o instanceof java.math.BigDecimal) {
                ...
                return new java.math.BigDecimal(((String)o).trim());
            }
            else if (o instanceof Number) {
                return java.math.BigDecimal.valueOf(((Number)o).longValue());
            }
            throw getUDTTypeConversionException(column, o,
...
// GemStone changes BEGIN
        case java.sql.Types.JAVA_OBJECT:
            ...
            throw getUDTTypeConversionException(column, o, "java.sql.Date");
// GemStone changes END
        default:
            throw new ColumnTypeConversionException(agent_.logWriter_,
...
// GemStone changes BEGIN
        case java.sql.Types.JAVA_OBJECT:
            ...
            if (o instanceof java.sql.Time) {
                ...
                return new java.sql.Time(((java.sql.Timestamp)o).getTime());
            }
            throw getUDTTypeConversionException(column, o, "java.sql.Time");
// GemStone changes END
        default:
            throw new ColumnTypeConversionException(agent_.logWriter_,
        ...
        case java.sql.Types.JAVA_OBJECT:
            ...
            if (o instanceof java.sql.Timestamp) {
              return (java.sql.Timestamp)o;
                ...
                return new java.sql.Timestamp(((java.sql.Time)o).getTime());
            }
            throw getUDTTypeConversionException(column, o,
                "java.sql.Timestamp");
// GemStone changes END
...
// GemStone changes BEGIN
            case java.sql.Types.JAVA_OBJECT:
                return new java.io.ByteArrayInputStream(get_UDT_bytes(column));
// GemStone changes END
            default:
                throw new ColumnTypeConversionException(agent_.logWriter_,
        ...
        switch (jdbcTypes_[column - 1]) {
            ...
            case java.sql.Types.LONGVARBINARY:
                try {
                    ...
                    throw new SqlException(agent_.logWriter_, 
                    		new ClientMessageId (SQLState.UNSUPPORTED_ENCODING), 
                    		"VARBINARY/LONGVARBINARY", "java.io.Reader",
                    		getColumnLabel(column) /* GemStoneAddition */, e);
                }
            case java.sql.Types.BLOB:
                try {
...
// GemStone changes BEGIN
            case java.sql.Types.JAVA_OBJECT:
                ...
                if (o instanceof String) {
                    return new java.io.StringReader((String)o);
                }
                else if (o instanceof byte[]) {
                    try {
                      return new java.io.InputStreamReader(
                          new java.io.ByteArrayInputStream((byte[])o), "UTF-16BE");
                    } catch (java.io.UnsupportedEncodingException e) {
                      throw new SqlException(agent_.logWriter_, new ClientMessageId(
                          SQLState.UNSUPPORTED_ENCODING), "UDT with java type "
                              + o.getClass().getName(), "java.io.Reader",
                              getColumnLabel(column) /* GemStoneAddition */, e);
                    }
                }
                throw getUDTTypeConversionException(column, o, "java.io.Reader");
// GemStone changes END
            default:
                throw new ColumnTypeConversionException(agent_.logWriter_,
