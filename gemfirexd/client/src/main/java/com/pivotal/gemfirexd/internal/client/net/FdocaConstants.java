/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.FdocaConstants
...
// GemStone changes BEGIN
    public static final int NUMERIC_MAX_PRECISION = 127;
    public static final int NUMERIC_DEFAULT_PRECISION = 38;
    public static final int NUMERIC_DEFAULT_SCALE = 0;
// GemStone changes END
}
