/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.NetResultSetRequest
...
public class NetResultSetRequest extends NetStatementRequest
    ...
    private void buildCLSQRY(Section section,
        ...
        /* original code
         * It is not necessary to write the single hop related headers again
        buildPKGNAMCSN(section);
        */
        buildPKGNAMCSN2(section, false);
    ...
    private void buildCoreCNTQRY(Section section,
        ...
        // Gemstone changes BEGIN
        if (section.isThisACopiedSection()) {
          section.setCopiedSection(false, null);
        }
        // Gemstone changes END
