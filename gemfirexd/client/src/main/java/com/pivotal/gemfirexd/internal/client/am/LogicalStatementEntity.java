/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.am.LogicalStatementEntity
...
// GemStone changes BEGIN
    ...
    protected LogicalStatementEntity(final Agent agent,
    ...
    public synchronized void close() throws SQLException {
        if (physicalPs != null) {
            final PreparedStatement temporaryPsRef =
                    (com.pivotal.gemfirexd.internal.client.am.PreparedStatement)physicalPs;
            ...
            try {
                ...
                throw sqle.getSQLException(agent /* GemStoneAddition */);
            }
