/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.am.LogicalCallableStatement40
...
public class LogicalCallableStatement40
     ...
     */
    public LogicalCallableStatement40(final Agent agent, // GemStoneAddition
                                      java.sql.CallableStatement physicalCs,
                                      StatementKey stmtKey,
                                      StatementCacheInteractor cacheInteractor){
        super(agent /* GemStoneAddition */, physicalCs, stmtKey, cacheInteractor);
    }
    ...
    public <T> T unwrap(Class<T> arg0)
        ...
        try {
            ...
            throw new SqlException(
                    ...
                    arg0).getSQLException(agent /* GemStoneAddition */);
        }
    }
