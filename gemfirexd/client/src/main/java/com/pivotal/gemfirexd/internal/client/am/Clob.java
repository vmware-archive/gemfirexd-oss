/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.am.Clob
...
public class Clob extends Lob implements java.sql.Clob {
    ...
    public Clob(Agent agent,
        ...
        if (encoding.equals("ISO-8859-1")) {
            ...
            try {
                ...
                throw new SqlException(agent_.logWriter_,
                    new ClientMessageId(SQLState.UNSUPPORTED_ENCODING),
                    "UnicodeBigUnmarked", "InputStreamReader",
                    columnName /* GemStoneAddition */, e);
            }
    ...
    public Clob(Agent agent, int locator,
        String columnName /* GemStoneAddition */)
    {
        super(agent, false, columnName /* GemStoneAddition */);
        locator_ = locator;
        dataType_ |= LOCATOR;
// GemStone changes BEGIN
        if (SanityManager.TraceClientHA) {
          SanityManager.DEBUG_PRINT(SanityManager.TRACE_CLIENT_HA, "Assigning "
              + "new CLOB with locator " + locator + " for agent " + agent);
        }
// GemStone changes END
    }
    ...
    private Clob(Agent agent,
                 ...
                 String columnName /* GemStoneAddition */) {
        super(agent,
              willBeLayerBStreamed, columnName /* GemStoneAddition */);
    }
...
// GemStone changes BEGIN
          this.locatorProcs_.clobSetString
          /* (original code)
...
// GemStone changes END
        ...
        if(isAsciiStream()) {
            try {
                ...
                throw new SqlException(null, new ClientMessageId(SQLState.IO_ERROR_UPON_LOB_FREE))
