/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.am.ResultSet
...
// GemStone changes END
    ...
    // Gemstone changes BEGIN
    /* original code (removing final as SingleHopResultSet needs to implement this)
...
// GemStone changes BEGIN
        ...
        // convert failure messages during next to X0Z01 (#43498)
        agent = this.agent_;
        if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
            sqle.getErrorCode(), sqle) != FailoverStatus.NONE) {
          throw new SqlException(agent.logWriter_, new ClientMessageId(
              SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                  .getServerLocation(), "ResultSet::next()" }, sqle);
        }
...
// GemStone changes BEGIN
      ...
      if (SanityManager.TraceClientStatement) {
        ...
        SanityManager.DEBUG_PRINT_COMPACT("flowCloseAC_S", null, cid,
            ns, true, null);
      }
      try {
// GemStone changes END
...
// GemStone changes BEGIN
        ...
        if (SanityManager.TraceClientStatement) {
          final long ns = System.nanoTime();
          SanityManager.DEBUG_PRINT_COMPACT("flowCloseAC_E", null, cid,
              ns, false, null);
        }
      }
// GemStone changes END
    ...
    public boolean getBoolean(int column) throws SQLException {
        ...
        {
            throw se.getSQLException(agent_ /* GemStoneAddition */,
                resultSetMetaData_.getColumnLabel(column) /* GemStoneAddition */);
        }
    }
            ...
            if (wasNonNullSensitiveUpdate(column) || isOnInsertRow_) {
                if (isOnInsertRow_ && updatedColumns_[column - 1] == null) {
                    ...
                    result = ((Short) agent_.crossConverters_.setObject(
                            ...
                            updatedColumns_[column - 1],
                            null /* GemStoneAddition */)).shortValue();
                }
            } else {
            ...
            if (wasNonNullSensitiveUpdate(column) || isOnInsertRow_) {
                if (isOnInsertRow_ && updatedColumns_[column - 1] == null) {
                    ...
                    result = ((Integer) agent_.crossConverters_.setObject(
                            ...
                            updatedColumns_[column - 1],
                            null /* GemStoneAddition */)).intValue();
                }
            } else {
            ...
            if (wasNonNullSensitiveUpdate(column) || isOnInsertRow_) {
                if (isOnInsertRow_ && updatedColumns_[column - 1] == null) {
                    ...
                    result = ((Long) agent_.crossConverters_.setObject(
                            ...
                            updatedColumns_[column - 1],
                            null /* GemStoneAddition */)).longValue();
                }
            } else {
            ...
            if (wasNonNullSensitiveUpdate(column) || isOnInsertRow_) {
                if ((isOnInsertRow_ && updatedColumns_[column - 1] == null)) {
                    ...
                    result = ((Float) agent_.crossConverters_.setObject(
                            java.sql.Types.REAL,
                            updatedColumns_[column - 1],
                            null /* GemStoneAddition */)).floatValue();
                }
            } else {
            ...
            if (wasNonNullSensitiveUpdate(column) || isOnInsertRow_) {
                if (isOnInsertRow_ && updatedColumns_[column - 1] == null) {
                    ...
                    result = ((Double) agent_.crossConverters_.setObject(
                            ...
                            updatedColumns_[column - 1],
                            null /* GemStoneAddition */)).doubleValue();
                }
            } else {
            ...
            if (wasNonNullSensitiveUpdate(column)) {
                result =
                        ((java.math.BigDecimal) agent_.crossConverters_.setObject(java.sql.Types.DECIMAL,
                                updatedColumns_[column - 1],
                                null /* GemStoneAddition */)).setScale(scale, java.math.BigDecimal.ROUND_DOWN);
            } else {
                result =
        ...
        try
        {
            ...
            if (wasNonNullSensitiveUpdate(column)) {
                result = (java.sql.Blob) agent_.crossConverters_.setObject(java.sql.Types.BLOB,
                        updatedColumns_[column - 1],
                        resultSetMetaData_.getColumnLabelX(column) /* GemStoneAddition */);
            } else {
    ...
    public java.sql.Ref getRef(int column) throws SQLException {
        try
        {
            ...
            //if (true) { // GemStone commented out dead code
                throw new SqlException(agent_.logWriter_,
                    new ClientMessageId(SQLState.JDBC_METHOD_NOT_IMPLEMENTED));
            /* (GemStone commented out dead code)
            }
            if (agent_.loggingEnabled()) {
...
// GemStone changes BEGIN
      ...
      if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
        ...
        throw new SqlException(agent.logWriter_, new ClientMessageId(
            SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                .getServerLocation(), "ResultSet::beforeFirst()" }, sqle);
      }
      // explicitly invoke disconnectEvent since it has been disabled
      // before the invocation of methods that allow for failover
      if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
      ...
      if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
        ...
        throw new SqlException(agent.logWriter_, new ClientMessageId(
            SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                .getServerLocation(), "ResultSet::afterLast()" }, sqle);
      }
      // explicitly invoke disconnectEvent since it has been disabled
      // before the invocation of methods that allow for failover
      if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
      ...
      if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
        ...
        throw new SqlException(agent.logWriter_, new ClientMessageId(
            SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                .getServerLocation(), "ResultSet::first()" }, sqle);
      }
      // explicitly invoke disconnectEvent since it has been disabled
      // before the invocation of methods that allow for failover
      if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
      ...
      if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
        ...
        throw new SqlException(agent.logWriter_, new ClientMessageId(
            SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                .getServerLocation(), "ResultSet::last()" }, sqle);
      }
      // explicitly invoke disconnectEvent since it has been disabled
      // before the invocation of methods that allow for failover
      if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
        ...
        if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
          ...
          throw new SqlException(agent.logWriter_, new ClientMessageId(
              SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                  .getServerLocation(), "ResultSet::getRow()" }, sqle);
        }
        // explicitly invoke disconnectEvent since it has been disabled
        // before the invocation of methods that allow for failover
        if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
        ...
        if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
          ...
          throw new SqlException(agent.logWriter_, new ClientMessageId(
              SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                  .getServerLocation(), "ResultSet::absolute()" }, sqle);
        }
        // explicitly invoke disconnectEvent since it has been disabled
        // before the invocation of methods that allow for failover
        if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
      ...
      if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
        ...
        throw new SqlException(agent.logWriter_, new ClientMessageId(
            SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                .getServerLocation(), "ResultSet::relative()" }, sqle);
      }
      // explicitly invoke disconnectEvent since it has been disabled
      // before the invocation of methods that allow for failover
      if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
      ...
      if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
        ...
        throw new SqlException(agent.logWriter_, new ClientMessageId(
            SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                .getServerLocation(), "ResultSet::previous()" }, sqle);
      }
      // explicitly invoke disconnectEvent since it has been disabled
      // before the invocation of methods that allow for failover
      if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
        ...
        if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
          ...
          throw new SqlException(agent.logWriter_, new ClientMessageId(
              SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                  .getServerLocation(), "ResultSet::insertRow()" }, sqle);
        }
        // explicitly invoke disconnectEvent since it has been disabled
        // before the invocation of methods that allow for failover
        if (!origDisableDisconnect && sqle instanceof DisconnectException) {
                ...
                if (updatedColumns_[i] != null ||
                    ...
                    if (originalObj == null) {
                        ...
                        preparedStatementForUpdate_.setInput(paramNumber, agent_.crossConverters_.setObject(resultSetMetaData_.types_[i], originalObj,
                            resultSetMetaData_.getColumnLabelX(i + 1) /* GemStoneAddition */));
                    }
                }
            }
        }
...
// GemStone changes BEGIN
        ...
        if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
          ...
          throw new SqlException(agent.logWriter_, new ClientMessageId(
              SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                  .getServerLocation(), "ResultSet::updateRow()" }, sqle);
        }
        // explicitly invoke disconnectEvent since it has been disabled
        // before the invocation of methods that allow for failover
        if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
        ...
        if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
          ...
          throw new SqlException(agent.logWriter_, new ClientMessageId(
              SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                  .getServerLocation(), "ResultSet::deleteRow()" }, sqle);
        }
        // explicitly invoke disconnectEvent since it has been disabled
        // before the invocation of methods that allow for failover
        if (!origDisableDisconnect && sqle instanceof DisconnectException) {
...
// GemStone changes BEGIN
        ...
        if (agent.connection_.doFailoverOnException(sqle.getSQLState(),
          ...
          throw new SqlException(agent.logWriter_, new ClientMessageId(
              SQLState.GFXD_NODE_SHUTDOWN), new Object[] { agent.connection_
                  .getServerLocation(), "ResultSet::refreshRow()" }, sqle);
        }
        // explicitly invoke disconnectEvent since it has been disabled
        // before the invocation of methods that allow for failover
        if (!origDisableDisconnect && sqle instanceof DisconnectException) {
    ...
    public void updateBlob(int columnIndex, java.sql.Blob x) throws SQLException {
        synchronized (connection_) {
            ...
            try {
                ...
                throw se.getSQLException(agent_ /* GemStoneAddition */,
                    resultSetMetaData_.getColumnLabel(columnIndex) /* GemStoneAddition */);
            }
        }
    }
                ...
                updateColumn(columnIndex,
                             agent_.crossConverters_.setObject(
                                    ...
                                    new Blob(agent_, x, (int)length,
                                        resultSetMetaData_.getColumnLabelX(columnIndex) /* GemStoneAddition */)));
            } catch (SqlException se) {
                throw se.getSQLException(agent_ /* GemStoneAddition */,
                    resultSetMetaData_.getColumnLabel(columnIndex) /* GemStoneAddition */);
            }
...
// GemStone changes BEGIN
        ...
        if (SanityManager.TraceClientStatement) {
          final long ns = System.nanoTime();
          cid = SanityManager.getConnectionId(this.connection_);
          SanityManager.DEBUG_PRINT_COMPACT("flowPosFetch_S", null, cid,
              ns, true, null);
        }
// GemStone changes END
        try {
...
// GemStone changes BEGIN
          ...
          if (SanityManager.TraceClientStatement) {
            final long ns = System.nanoTime();
            SanityManager.DEBUG_PRINT_COMPACT("flowPosFetch_E", null, cid,
                ns, false, null);
          }
// GemStone changes END
        }
...
// GemStone changes BEGIN
      ...
      if (SanityManager.TraceClientStatement) {
        final long ns = System.nanoTime();
        cid = SanityManager.getConnectionId(this.connection_);
        SanityManager.DEBUG_PRINT_COMPACT("flowFetch_S", null, cid,
            ns, true, null);
      }
      try {
// GemStone changes END
...
// GemStone changes BEGIN
        ...
        if (SanityManager.TraceClientStatement) {
          final long ns = System.nanoTime();
          SanityManager.DEBUG_PRINT_COMPACT("flowFetch_E", null, cid,
              ns, false, null);
        }
      }
// GemStone changes END
...
// GemStone changes BEGIN
        // for bug #43188 -- unimplemented for client-server
        throw new SqlException(this.agent_.logWriter_, new ClientMessageId(
            SQLState.JDBC_METHOD_NOT_IMPLEMENTED));
// GemStone changes END
    }
    ...
    protected final void checkAndThrowReceivedQueryTerminatingException() throws SqlException {
        ...
        if (!openOnServer_) {
            SqlException sqlException = null;
            int sqlcode = com.pivotal.gemfirexd.internal.client.am.Utils.getSqlcodeFromSqlca(queryTerminatingSqlca_);
            if (sqlcode < 0) {
                sqlException = new SqlException(agent_.logWriter_, queryTerminatingSqlca_);
...
// GemStone changes BEGIN
      ...
      if (SanityManager.TraceClientStatement) {
        final long ns = System.nanoTime();
        cid = SanityManager.getConnectionId(this.connection_);
        SanityManager.DEBUG_PRINT_COMPACT("flowGetRS_S", null, cid,
            ns, true, null);
      }
      try {
// GemStone changes END
...
// GemStone changes BEGIN
        ...
        if (SanityManager.TraceClientStatement) {
          final long ns = System.nanoTime();
          SanityManager.DEBUG_PRINT_COMPACT("flowGetRS_E", null, cid,
              ns, false, null);
        }
      }
// GemStone changes END
    ...
    private SQLException jdbc3MethodNotSupported()
    {
        return new SqlException(agent_.logWriter_,
            new ClientMessageId(SQLState.JDBC_METHOD_NOT_IMPLEMENTED)).
            getSQLException(agent_ /* GemStoneAddition */);
    }
