...
// GemStone changes END
        ...
        default:
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.LANG_DATA_TYPE_SET_MISMATCH),
                "float", Types.getTypeString(targetType), (String)null);
        }
    }
...
// GemStone changes END
        ...
        default:
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.LANG_DATA_TYPE_SET_MISMATCH),
                "double", Types.getTypeString(targetType), (String)null);
        }
    }
...
// GemStone changes END
        ...
        default:
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.LANG_DATA_TYPE_SET_MISMATCH),
                "java.Math.BigDecimal", Types.getTypeString(targetType), (String)null);
        }
    }
    ...
    final Object setObject(int targetType, java.sql.Date source) throws SqlException {
        ...
        default:
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.LANG_DATA_TYPE_SET_MISMATCH),
                "java.sql.Date", Types.getTypeString(targetType), (String)null);
        }
    }
    ...
    final Object setObject(int targetType, java.sql.Time source) throws SqlException {
        ...
        default:
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.LANG_DATA_TYPE_SET_MISMATCH),
                "java.sql.Time", Types.getTypeString(targetType), (String)null);
        }
    }
    ...
    final Object setObject(int targetType, java.sql.Timestamp source) throws SqlException {
        ...
        default:
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.LANG_DATA_TYPE_SET_MISMATCH),
                "java.sql.Timestamp", Types.getTypeString(targetType), (String)null);
        }
    }
    ...
    final Object setObject(int targetDriverType, String source,
    ...
    final Object setObject(int targetType, byte[] source,
          String columnName /* GemStoneAddition */) throws SqlException {
        switch (targetType) {
        case Types.BINARY:
        case Types.VARBINARY:
    ...
    final Object setObject(int targetType, java.io.Reader source, int length,
          String columnName /* GemStoneAddition */) throws SqlException {
        switch (targetType) {
        case Types.CHAR:
        case Types.VARCHAR:
        ...
        default:
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.LANG_DATA_TYPE_SET_MISMATCH),
                "java.io.Reader", Types.getTypeString(targetType), (String)null);
        }
    }
    ...
    final Object setObjectFromCharacterStream(int targetType, java.io.InputStream source, String encoding, int length,
          String columnName /* GemStoneAddition */) throws SqlException {
        switch (targetType) {
        case Types.CHAR:
        case Types.VARCHAR:
    ...
    private final String setStringFromStream(java.io.InputStream is, String encoding, int length,
          String columnName /* GemStoneAddition */) throws SqlException {
        try {
    ...
    final Object setObject(int targetType, java.sql.Blob source) throws SqlException {
        ...
        default:
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.LANG_DATA_TYPE_SET_MISMATCH),
                "java.sql.Blob", Types.getTypeString(targetType), (String)null);
        }
    }

    // Convert from InputStream source to target type
    // In support of PS.setBinaryStream()
    final Object setObjectFromBinaryStream(int targetType, java.io.InputStream source, int length,
          String columnName /* GemStoneAddition */) throws SqlException {
        switch (targetType) {
        case Types.BINARY:
        case Types.VARBINARY:
    ...
    final Object setObject(int targetType, java.sql.Clob source) throws SqlException {
        ...
        default:
            throw new SqlException(agent_.logWriter_, 
                new ClientMessageId (SQLState.LANG_DATA_TYPE_SET_MISMATCH),
                "java.sql.Clob", Types.getTypeString(targetType), (String)null);
        }
    }
    ...
    public final Object setObject(int targetType, Object source,
          String columnName /* GemStoneAddition */) throws SqlException {
        // TODO: PERF: change instanceofs below to class comparison
        if (source == null) {
            return null;
