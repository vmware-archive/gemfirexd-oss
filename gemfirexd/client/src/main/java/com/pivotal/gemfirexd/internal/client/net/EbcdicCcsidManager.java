/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.client.net.EbcdicCcsidManager
...
public class EbcdicCcsidManager extends CcsidManager {
    ...
    public byte[] convertFromUCS2(String sourceString, com.pivotal.gemfirexd.internal.client.am.Agent agent) throws SqlException {
    ...
    public int convertFromUCS2(String sourceString,
                               byte[] buffer,
                               int offset,
                               com.pivotal.gemfirexd.internal.client.am.Agent agent) throws SqlException {
