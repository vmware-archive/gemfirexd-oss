...
#define USER1 "gemfirexduser3"
#define USER2 "gemfirexduser4"

#define PASSWORD1 "gemfirexduser3"
#define PASSWORD2 "gemfirexduser4"
...
BEGIN_TEST(testSQLTablePrivileges)
{
  /* ------------------------------------------------------------------------- */
      ...
      retcode = SQLTablePrivileges(hstmt, NULL, 0, /* Table qualifier */
...
END_TEST(testSQLTablePrivileges)
