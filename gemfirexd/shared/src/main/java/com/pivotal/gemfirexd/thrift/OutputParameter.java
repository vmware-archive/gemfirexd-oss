...
public class OutputParameter implements org.apache.thrift.TBase<OutputParameter, OutputParameter._Fields>, java.io.Serializable, Comparable<OutputParameter> {
  ...
  private _Fields optionals[] = {_Fields.SCALE,_Fields.TYPE_NAME};
   ...
   * @see GFXDType
   */
  public OutputParameter setType(GFXDType type) {
    this.type = type;
    return this;
  }
