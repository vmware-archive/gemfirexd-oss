...
public class UpdateResult implements org.apache.thrift.TBase<UpdateResult, UpdateResult._Fields>, java.io.Serializable, Comparable<UpdateResult> {
  ...
  private _Fields optionals[] = {_Fields.UPDATE_COUNT,_Fields.BATCH_UPDATE_COUNTS,_Fields.GENERATED_KEYS,_Fields.WARNINGS};
  ...
  public UpdateResult setWarnings(GFXDExceptionData warnings) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.batchUpdateCounts = new ArrayList<Integer>(_list332.size);
                for (int _i333 = 0; _i333 < _list332.size; ++_i333)
                {
                  int _elem334;
                  _elem334 = iprot.readI32();
                  struct.batchUpdateCounts.add(_elem334);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.batchUpdateCounts != null) {
        if (struct.isSetBatchUpdateCounts()) {
          oprot.writeFieldBegin(BATCH_UPDATE_COUNTS_FIELD_DESC);
          {
            ...
            for (int _iter335 : struct.batchUpdateCounts)
            {
      ...
      if (struct.isSetBatchUpdateCounts()) {
        {
          ...
          for (int _iter336 : struct.batchUpdateCounts)
          {
