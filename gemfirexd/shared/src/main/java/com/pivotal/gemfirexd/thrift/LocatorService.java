...
public class LocatorService {
  ...
  public interface Iface {
    ...
    public HostAddress getPreferredServer(Set<ServerType> serverTypes, Set<String> serverGroups, Set<HostAddress> failedServers) throws GFXDException, org.apache.thrift.TException;

    public List<HostAddress> getAllServersWithPreferredServer(Set<ServerType> serverTypes, Set<String> serverGroups, Set<HostAddress> failedServers) throws GFXDException, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public HostAddress recv_getPreferredServer() throws GFXDException, org.apache.thrift.TException
    {
    ...
    public List<HostAddress> recv_getAllServersWithPreferredServer() throws GFXDException, org.apache.thrift.TException
    {
  ...
  public static class getPreferredServer_args implements org.apache.thrift.TBase<getPreferredServer_args, getPreferredServer_args._Fields>, java.io.Serializable, Comparable<getPreferredServer_args>   {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set348.size);
                  for (int _i349 = 0; _i349 < _set348.size; ++_i349)
                  {
                    ServerType _elem350;
                    _elem350 = ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem350);
                  }
                  iprot.readSetEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverGroups = new HashSet<String>(2*_set351.size);
                  for (int _i352 = 0; _i352 < _set351.size; ++_i352)
                  {
                    String _elem353;
                    _elem353 = iprot.readString();
                    struct.serverGroups.add(_elem353);
                  }
                  iprot.readSetEnd();
                }
            ...
            case 3: // FAILED_SERVERS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set354 = iprot.readSetBegin();
                  struct.failedServers = new HashSet<HostAddress>(2*_set354.size);
                  for (int _i355 = 0; _i355 < _set354.size; ++_i355)
                  {
                    HostAddress _elem356;
                    _elem356 = new HostAddress();
                    _elem356.read(iprot);
                    struct.failedServers.add(_elem356);
                  }
                  iprot.readSetEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          oprot.writeFieldBegin(SERVER_TYPES_FIELD_DESC);
          {
            ...
            for (ServerType _iter357 : struct.serverTypes)
            {
        ...
        if (struct.serverGroups != null) {
          oprot.writeFieldBegin(SERVER_GROUPS_FIELD_DESC);
          {
            ...
            for (String _iter358 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          oprot.writeFieldBegin(FAILED_SERVERS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter359 : struct.failedServers)
            {
    ...
    private static class getPreferredServer_argsTupleScheme extends TupleScheme<getPreferredServer_args> {
        ...
        if (struct.isSetServerTypes()) {
          {
            ...
            for (ServerType _iter360 : struct.serverTypes)
            {
        ...
        if (struct.isSetServerGroups()) {
          {
            ...
            for (String _iter361 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            ...
            for (HostAddress _iter362 : struct.failedServers)
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TSet _set363 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
            struct.serverTypes = new HashSet<ServerType>(2*_set363.size);
            for (int _i364 = 0; _i364 < _set363.size; ++_i364)
            {
              ServerType _elem365;
              _elem365 = ServerType.findByValue(iprot.readI32());
              struct.serverTypes.add(_elem365);
            }
          }
          struct.setServerTypesIsSet(true);
        }
        if (incoming.get(1)) {
          {
            org.apache.thrift.protocol.TSet _set366 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
            struct.serverGroups = new HashSet<String>(2*_set366.size);
            for (int _i367 = 0; _i367 < _set366.size; ++_i367)
            {
              String _elem368;
              _elem368 = iprot.readString();
              struct.serverGroups.add(_elem368);
            }
          }
          struct.setServerGroupsIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.failedServers = new HashSet<HostAddress>(2*_set369.size);
            for (int _i370 = 0; _i370 < _set369.size; ++_i370)
            {
              HostAddress _elem371;
              _elem371 = new HostAddress();
              _elem371.read(iprot);
              struct.failedServers.add(_elem371);
            }
          }
          struct.setFailedServersIsSet(true);
        }
  ...
  public static class getPreferredServer_result implements org.apache.thrift.TBase<getPreferredServer_result, getPreferredServer_result._Fields>, java.io.Serializable, Comparable<getPreferredServer_result>   {
    ...
    public GFXDException error; // required
    ...
    public getPreferredServer_result(getPreferredServer_result other) {
      ...
      if (other.isSetError()) {
        this.error = new GFXDException(other.error);
      }
    }
    ...
    public GFXDException getError() {
      return this.error;
    }

    public getPreferredServer_result setError(GFXDException error) {
      this.error = error;
      return this;
    }
  ...
  public static class getAllServersWithPreferredServer_args implements org.apache.thrift.TBase<getAllServersWithPreferredServer_args, getAllServersWithPreferredServer_args._Fields>, java.io.Serializable, Comparable<getAllServersWithPreferredServer_args>   {
    ...
    private static class getAllServersWithPreferredServer_argsStandardScheme extends StandardScheme<getAllServersWithPreferredServer_args> {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.serverTypes = new HashSet<ServerType>(2*_set372.size);
                  for (int _i373 = 0; _i373 < _set372.size; ++_i373)
                  {
                    ServerType _elem374;
                    _elem374 = ServerType.findByValue(iprot.readI32());
                    struct.serverTypes.add(_elem374);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerTypesIsSet(true);
            ...
            case 2: // SERVER_GROUPS
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  org.apache.thrift.protocol.TSet _set375 = iprot.readSetBegin();
                  struct.serverGroups = new HashSet<String>(2*_set375.size);
                  for (int _i376 = 0; _i376 < _set375.size; ++_i376)
                  {
                    String _elem377;
                    _elem377 = iprot.readString();
                    struct.serverGroups.add(_elem377);
                  }
                  iprot.readSetEnd();
                }
                struct.setServerGroupsIsSet(true);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
                {
                  ...
                  struct.failedServers = new HashSet<HostAddress>(2*_set378.size);
                  for (int _i379 = 0; _i379 < _set378.size; ++_i379)
                  {
                    HostAddress _elem380;
                    _elem380 = new HostAddress();
                    _elem380.read(iprot);
                    struct.failedServers.add(_elem380);
                  }
                  iprot.readSetEnd();
                }
                struct.setFailedServersIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.serverTypes != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, struct.serverTypes.size()));
            for (ServerType _iter381 : struct.serverTypes)
            {
              oprot.writeI32(_iter381.getValue());
            }
            oprot.writeSetEnd();
          }
          oprot.writeFieldEnd();
        ...
        if (struct.serverGroups != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, struct.serverGroups.size()));
            for (String _iter382 : struct.serverGroups)
            {
        ...
        if (struct.failedServers != null) {
          ...
          {
            oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, struct.failedServers.size()));
            for (HostAddress _iter383 : struct.failedServers)
            {
    ...
    private static class getAllServersWithPreferredServer_argsTupleScheme extends TupleScheme<getAllServersWithPreferredServer_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAllServersWithPreferredServer_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetServerTypes()) {
          {
            oprot.writeI32(struct.serverTypes.size());
            for (ServerType _iter384 : struct.serverTypes)
            {
        ...
        if (struct.isSetServerGroups()) {
          {
            oprot.writeI32(struct.serverGroups.size());
            for (String _iter385 : struct.serverGroups)
            {
        ...
        if (struct.isSetFailedServers()) {
          {
            oprot.writeI32(struct.failedServers.size());
            for (HostAddress _iter386 : struct.failedServers)
            {
  ...
  public static class getAllServersWithPreferredServer_result implements org.apache.thrift.TBase<getAllServersWithPreferredServer_result, getAllServersWithPreferredServer_result._Fields>, java.io.Serializable, Comparable<getAllServersWithPreferredServer_result>   {
    ...
    public getAllServersWithPreferredServer_result setError(GFXDException error) {
      this.error = error;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<HostAddress>(_list396.size);
                  for (int _i397 = 0; _i397 < _list396.size; ++_i397)
                  {
                    HostAddress _elem398;
                    _elem398 = new HostAddress();
                    _elem398.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllServersWithPreferredServer_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (HostAddress _iter399 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (HostAddress _iter400 : struct.success)
            {
  ...
  public static class closeConnection_args implements org.apache.thrift.TBase<closeConnection_args, closeConnection_args._Fields>, java.io.Serializable, Comparable<closeConnection_args>   {
