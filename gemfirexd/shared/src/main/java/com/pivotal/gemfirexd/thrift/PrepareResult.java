...
public class PrepareResult implements org.apache.thrift.TBase<PrepareResult, PrepareResult._Fields>, java.io.Serializable, Comparable<PrepareResult> {
  ...
  private _Fields optionals[] = {_Fields.RESULT_SET_META_DATA,_Fields.WARNINGS};
  ...
  public PrepareResult setWarnings(GFXDExceptionData warnings) {
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case STATEMENT_ID:
      return Integer.valueOf(getStatementId());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.parameterMetaData = new ArrayList<ColumnDescriptor>(_list316.size);
                for (int _i317 = 0; _i317 < _list316.size; ++_i317)
                {
                  ColumnDescriptor _elem318;
                  _elem318 = new ColumnDescriptor();
                  _elem318.read(iprot);
                  struct.parameterMetaData.add(_elem318);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.resultSetMetaData = new ArrayList<ColumnDescriptor>(_list319.size);
                for (int _i320 = 0; _i320 < _list319.size; ++_i320)
                {
                  ColumnDescriptor _elem321;
                  _elem321 = new ColumnDescriptor();
                  _elem321.read(iprot);
                  struct.resultSetMetaData.add(_elem321);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameterMetaData != null) {
        oprot.writeFieldBegin(PARAMETER_META_DATA_FIELD_DESC);
        {
          ...
          for (ColumnDescriptor _iter322 : struct.parameterMetaData)
          {
      ...
      if (struct.resultSetMetaData != null) {
        if (struct.isSetResultSetMetaData()) {
          oprot.writeFieldBegin(RESULT_SET_META_DATA_FIELD_DESC);
          {
            ...
            for (ColumnDescriptor _iter323 : struct.resultSetMetaData)
            {
  ...
  private static class PrepareResultTupleScheme extends TupleScheme<PrepareResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, PrepareResult struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.statementId);
      {
        ...
        for (ColumnDescriptor _iter324 : struct.parameterMetaData)
        {
      ...
      if (struct.isSetResultSetMetaData()) {
        {
          ...
          for (ColumnDescriptor _iter325 : struct.resultSetMetaData)
          {
