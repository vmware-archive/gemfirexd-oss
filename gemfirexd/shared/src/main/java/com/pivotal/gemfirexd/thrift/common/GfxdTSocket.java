 ...
 * @since gfxd 1.0
 */
public final class GfxdTSocket extends TNonblockingTransport implements
    SocketTimeout {

  private static final Logger LOGGER = LoggerFactory
      .getLogger(GfxdTSocket.class.getName());
   ...
   */
  public GfxdTSocket(HostAddress host, boolean blocking, boolean framedWrites,
   ...
   *          options like keepalive and buffer sizes that are not set in params
   */
  public GfxdTSocket(InetAddress hostAddress, int port, boolean blocking,
