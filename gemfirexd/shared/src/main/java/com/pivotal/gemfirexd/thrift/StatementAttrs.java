...
public class StatementAttrs implements org.apache.thrift.TBase<StatementAttrs, StatementAttrs._Fields>, java.io.Serializable, Comparable<StatementAttrs> {
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case RESULT_SET_TYPE:
      return Byte.valueOf(getResultSetType());

    case UPDATABLE:
      return Boolean.valueOf(isUpdatable());

    case HOLD_CURSORS_OVER_COMMIT:
      return Boolean.valueOf(isHoldCursorsOverCommit());

    case REQUIRE_AUTO_INC_COLS:
      return Boolean.valueOf(isRequireAutoIncCols());
    ...
    case LOB_CHUNK_SIZE:
      return Integer.valueOf(getLobChunkSize());

    case MAX_ROWS:
      return Integer.valueOf(getMaxRows());

    case MAX_FIELD_SIZE:
      return Integer.valueOf(getMaxFieldSize());
    ...
    case POSSIBLE_DUPLICATE:
      return Boolean.valueOf(isPossibleDuplicate());

    case POOLABLE:
      return Boolean.valueOf(isPoolable());

    case DO_ESCAPE_PROCESSING:
      return Boolean.valueOf(isDoEscapeProcessing());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.autoIncColumns = new ArrayList<Integer>(_list258.size);
                for (int _i259 = 0; _i259 < _list258.size; ++_i259)
                {
                  int _elem260;
                  _elem260 = iprot.readI32();
                  struct.autoIncColumns.add(_elem260);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.autoIncColumnNames = new ArrayList<String>(_list261.size);
                for (int _i262 = 0; _i262 < _list261.size; ++_i262)
                {
                  String _elem263;
                  _elem263 = iprot.readString();
                  struct.autoIncColumnNames.add(_elem263);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.pendingTransactionAttrs = new HashMap<TransactionAttribute,Boolean>(2*_map264.size);
                for (int _i265 = 0; _i265 < _map264.size; ++_i265)
                {
                  TransactionAttribute _key266;
                  boolean _val267;
                  _key266 = TransactionAttribute.findByValue(iprot.readI32());
                  _val267 = iprot.readBool();
                  struct.pendingTransactionAttrs.put(_key266, _val267);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.autoIncColumns != null) {
        if (struct.isSetAutoIncColumns()) {
          oprot.writeFieldBegin(AUTO_INC_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter268 : struct.autoIncColumns)
            {
      ...
      if (struct.autoIncColumnNames != null) {
        if (struct.isSetAutoIncColumnNames()) {
          oprot.writeFieldBegin(AUTO_INC_COLUMN_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter269 : struct.autoIncColumnNames)
            {
      ...
      if (struct.pendingTransactionAttrs != null) {
        if (struct.isSetPendingTransactionAttrs()) {
          oprot.writeFieldBegin(PENDING_TRANSACTION_ATTRS_FIELD_DESC);
          {
            ...
            for (Map.Entry<TransactionAttribute, Boolean> _iter270 : struct.pendingTransactionAttrs.entrySet())
            {
              oprot.writeI32(_iter270.getKey().getValue());
              oprot.writeBool(_iter270.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class StatementAttrsTupleScheme extends TupleScheme<StatementAttrs> {
      ...
      if (struct.isSetAutoIncColumns()) {
        {
          ...
          for (int _iter271 : struct.autoIncColumns)
          {
      ...
      if (struct.isSetAutoIncColumnNames()) {
        {
          ...
          for (String _iter272 : struct.autoIncColumnNames)
          {
      ...
      if (struct.isSetPendingTransactionAttrs()) {
        {
          ...
          for (Map.Entry<TransactionAttribute, Boolean> _iter273 : struct.pendingTransactionAttrs.entrySet())
          {
            oprot.writeI32(_iter273.getKey().getValue());
            oprot.writeBool(_iter273.getValue());
          }
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatementAttrs struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list274 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.autoIncColumns = new ArrayList<Integer>(_list274.size);
          for (int _i275 = 0; _i275 < _list274.size; ++_i275)
          {
            int _elem276;
            _elem276 = iprot.readI32();
            struct.autoIncColumns.add(_elem276);
          }
        }
        struct.setAutoIncColumnsIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.autoIncColumnNames = new ArrayList<String>(_list277.size);
          for (int _i278 = 0; _i278 < _list277.size; ++_i278)
          {
            String _elem279;
            _elem279 = iprot.readString();
            struct.autoIncColumnNames.add(_elem279);
          }
        }
        struct.setAutoIncColumnNamesIsSet(true);
      }
      ...
      if (incoming.get(16)) {
        {
          org.apache.thrift.protocol.TMap _map280 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
          struct.pendingTransactionAttrs = new HashMap<TransactionAttribute,Boolean>(2*_map280.size);
          for (int _i281 = 0; _i281 < _map280.size; ++_i281)
          {
            TransactionAttribute _key282;
            boolean _val283;
            _key282 = TransactionAttribute.findByValue(iprot.readI32());
            _val283 = iprot.readBool();
            struct.pendingTransactionAttrs.put(_key282, _val283);
          }
        }
        struct.setPendingTransactionAttrsIsSet(true);
      }
