...
public class Decimal implements org.apache.thrift.TBase<Decimal, Decimal._Fields>, java.io.Serializable, Comparable<Decimal> {
...
;
  ...
  public Decimal setMagnitude(byte[] magnitude) {
    setMagnitude(magnitude == null ? (ByteBuffer)null : ByteBuffer.wrap(magnitude));
    return this;
  }
