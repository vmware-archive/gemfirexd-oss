...
public class RowSet implements org.apache.thrift.TBase<RowSet, RowSet._Fields>, java.io.Serializable, Comparable<RowSet> {
  ...
  private _Fields optionals[] = {_Fields.TOKEN,_Fields.SOURCE,_Fields.OFFSET,_Fields.METADATA,_Fields.CURSOR_NAME,_Fields.WARNINGS,_Fields.ROW_IDS_FOR_UPDATE_OR_DELETE};
...
;
  ...
  public RowSet setWarnings(GFXDExceptionData warnings) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rows = new ArrayList<Row>(_list292.size);
                for (int _i293 = 0; _i293 < _list292.size; ++_i293)
                {
                  Row _elem294;
                  _elem294 = new Row();
                  _elem294.read(iprot);
                  struct.rows.add(_elem294);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.metadata = new ArrayList<ColumnDescriptor>(_list295.size);
                for (int _i296 = 0; _i296 < _list295.size; ++_i296)
                {
                  ColumnDescriptor _elem297;
                  _elem297 = new ColumnDescriptor();
                  _elem297.read(iprot);
                  struct.metadata.add(_elem297);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rowIdsForUpdateOrDelete = new ArrayList<Long>(_list298.size);
                for (int _i299 = 0; _i299 < _list298.size; ++_i299)
                {
                  long _elem300;
                  _elem300 = iprot.readI64();
                  struct.rowIdsForUpdateOrDelete.add(_elem300);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.metadata != null) {
        if (struct.isSetMetadata()) {
          oprot.writeFieldBegin(METADATA_FIELD_DESC);
          {
            ...
            for (ColumnDescriptor _iter302 : struct.metadata)
            {
      ...
      if (struct.rowIdsForUpdateOrDelete != null) {
        if (struct.isSetRowIdsForUpdateOrDelete()) {
          oprot.writeFieldBegin(ROW_IDS_FOR_UPDATE_OR_DELETE_FIELD_DESC);
          {
            ...
            for (long _iter303 : struct.rowIdsForUpdateOrDelete)
            {
              oprot.writeI64(_iter303);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
