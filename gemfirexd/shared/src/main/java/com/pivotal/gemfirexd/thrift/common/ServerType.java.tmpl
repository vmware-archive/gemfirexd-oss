...
public enum ServerType implements org.apache.thrift.TEnum {
  ...
  public static final String NETSERVER_GROUP_PREFIX = "__GFXD_NETWORKSERVICE_";
  ...
  public static ServerType findByValue(int value) {
    switch (value) {
      ...
      case 5:
        return THRIFT_LOCATOR_BP_SSL;
      case 6:
        return THRIFT_GFXD_CP;
      case 7:
        return THRIFT_GFXD_BP;
      case 8:
        return THRIFT_GFXD_CP_SSL;
      case 9:
        return THRIFT_GFXD_BP_SSL;
      default:
        return null;
    }
  }
  ...
  public static ServerType getServerType(final boolean isServer,
    ...
    if (isServer) {
      if (useSSL) {
        return useBinaryProtocol ? ServerType.THRIFT_GFXD_BP_SSL
            : ServerType.THRIFT_GFXD_CP_SSL;
      }
      else {
        return useBinaryProtocol ? ServerType.THRIFT_GFXD_BP
  ...
  /**
   * For a server type running Thrift GFXDService, return the corresponding
   * LocatorService type i.e. having same settings for SSL, Compact/Binary
   * protocol etc. If this server type is not a Thrift GFXDService, return null.
   */
  public ServerType getCorrespondingLocatorType() {
    return null;
  }
