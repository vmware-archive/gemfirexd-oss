...
public class OpenConnectionArgs implements org.apache.thrift.TBase<OpenConnectionArgs, OpenConnectionArgs._Fields>, java.io.Serializable, Comparable<OpenConnectionArgs> {
  ...
  private _Fields optionals[] = {_Fields.USER_NAME,_Fields.PASSWORD,_Fields.TOKEN_SIZE,_Fields.USE_STRING_FOR_DECIMAL,_Fields.PROPERTIES};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new HashMap<String,String>(2*_map240.size);
                for (int _i241 = 0; _i241 < _map240.size; ++_i241)
                {
                  ...
                  struct.properties.put(_key242, _val243);
                }
                iprot.readMapEnd();
              }
