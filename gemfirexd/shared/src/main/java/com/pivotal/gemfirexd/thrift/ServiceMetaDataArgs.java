...
public class ServiceMetaDataArgs implements org.apache.thrift.TBase<ServiceMetaDataArgs, ServiceMetaDataArgs._Fields>, java.io.Serializable, Comparable<ServiceMetaDataArgs> {
   ...
   * @see GFXDType
   */
  public GFXDType typeId; // optional
  ...
  private _Fields optionals[] = {_Fields.TOKEN,_Fields.SCHEMA,_Fields.TABLE,_Fields.TABLE_TYPES,_Fields.COLUMN_NAME,_Fields.FOREIGN_SCHEMA,_Fields.FOREIGN_TABLE,_Fields.PROCEDURE_NAME,_Fields.FUNCTION_NAME,_Fields.ATTRIBUTE_NAME,_Fields.TYPE_NAME,_Fields.TYPE_ID};
...
;
   ...
   * @see GFXDType
   */
  public ServiceMetaDataArgs setTypeId(GFXDType typeId) {
    this.typeId = typeId;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableTypes = new ArrayList<String>(_list232.size);
                for (int _i233 = 0; _i233 < _list232.size; ++_i233)
                {
                  String _elem234;
                  _elem234 = iprot.readString();
                  struct.tableTypes.add(_elem234);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tableTypes != null) {
        if (struct.isSetTableTypes()) {
          oprot.writeFieldBegin(TABLE_TYPES_FIELD_DESC);
          {
            ...
            for (String _iter235 : struct.tableTypes)
            {
