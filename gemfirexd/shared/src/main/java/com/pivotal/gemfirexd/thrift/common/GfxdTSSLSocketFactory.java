 ...
 * <p>
 * Modified from {@link TSSLTransportFactory} to add GFXD specific config.
 */
public abstract class GfxdTSSLSocketFactory {

  private GfxdTSSLSocketFactory() {
    // no instance
  }
  ...
  public static SSLContext createSSLContext(SocketParameters params)
    ...
    try {
      ...
      else if (params.isSSLKeyStoreSet()) {
