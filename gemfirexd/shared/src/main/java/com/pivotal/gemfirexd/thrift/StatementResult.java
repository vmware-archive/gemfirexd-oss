...
public class StatementResult implements org.apache.thrift.TBase<StatementResult, StatementResult._Fields>, java.io.Serializable, Comparable<StatementResult> {
  ...
  public GFXDExceptionData warnings; // optional
  ...
  private _Fields optionals[] = {_Fields.RESULT_SET,_Fields.UPDATE_COUNT,_Fields.BATCH_UPDATE_COUNTS,_Fields.PROCEDURE_OUT_PARAMS,_Fields.GENERATED_KEYS,_Fields.WARNINGS,_Fields.PREPARED_RESULT};
  ...
  public StatementResult(StatementResult other) {
    ...
    if (other.isSetWarnings()) {
      this.warnings = new GFXDExceptionData(other.warnings);
    }
  ...
  public GFXDExceptionData getWarnings() {
    return this.warnings;
  }

  public StatementResult setWarnings(GFXDExceptionData warnings) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case WARNINGS:
      if (value == null) {
        ...
        setWarnings((GFXDExceptionData)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.batchUpdateCounts = new ArrayList<Integer>(_list340.size);
                for (int _i341 = 0; _i341 < _list340.size; ++_i341)
                {
                  int _elem342;
                  _elem342 = iprot.readI32();
                  struct.batchUpdateCounts.add(_elem342);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.batchUpdateCounts != null) {
        if (struct.isSetBatchUpdateCounts()) {
          oprot.writeFieldBegin(BATCH_UPDATE_COUNTS_FIELD_DESC);
          {
            ...
            for (int _iter343 : struct.batchUpdateCounts)
            {
  ...
  private static class StatementResultTupleScheme extends TupleScheme<StatementResult> {
      ...
      if (struct.isSetBatchUpdateCounts()) {
        {
          ...
          for (int _iter344 : struct.batchUpdateCounts)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StatementResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list345 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.batchUpdateCounts = new ArrayList<Integer>(_list345.size);
          for (int _i346 = 0; _i346 < _list345.size; ++_i346)
          {
            int _elem347;
            _elem347 = iprot.readI32();
            struct.batchUpdateCounts.add(_elem347);
          }
        }
        struct.setBatchUpdateCountsIsSet(true);
      }
