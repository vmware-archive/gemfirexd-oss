...
public class ServiceMetaData implements org.apache.thrift.TBase<ServiceMetaData, ServiceMetaData._Fields>, java.io.Serializable, Comparable<ServiceMetaData> {
  ...
  public Map<GFXDType,Set<GFXDType>> supportedCONVERT; // required
  ...
  private _Fields optionals[] = {_Fields.EXTRA_NAME_CHARACTERS};
  ...
  public ServiceMetaData(
    ...
    Map<GFXDType,Set<GFXDType>> supportedCONVERT,
    String schemaTerm,
  ...
  public ServiceMetaData(ServiceMetaData other) {
    ...
    if (other.isSetSupportedCONVERT()) {
      Map<GFXDType,Set<GFXDType>> __this__supportedCONVERT = new HashMap<GFXDType,Set<GFXDType>>(other.supportedCONVERT.size());
      for (Map.Entry<GFXDType, Set<GFXDType>> other_element : other.supportedCONVERT.entrySet()) {

        GFXDType other_element_key = other_element.getKey();
        Set<GFXDType> other_element_value = other_element.getValue();

        GFXDType __this__supportedCONVERT_copy_key = other_element_key;

        Set<GFXDType> __this__supportedCONVERT_copy_value = new HashSet<GFXDType>(other_element_value.size());
        for (GFXDType other_element_value_element : other_element_value) {
  ...
  public void putToSupportedCONVERT(GFXDType key, Set<GFXDType> val) {
    if (this.supportedCONVERT == null) {
      this.supportedCONVERT = new HashMap<GFXDType,Set<GFXDType>>();
    }
    this.supportedCONVERT.put(key, val);
  }

  public Map<GFXDType,Set<GFXDType>> getSupportedCONVERT() {
    return this.supportedCONVERT;
  }

  public ServiceMetaData setSupportedCONVERT(Map<GFXDType,Set<GFXDType>> supportedCONVERT) {
    this.supportedCONVERT = supportedCONVERT;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SUPPORTED_CONVERT:
      if (value == null) {
        ...
        setSupportedCONVERT((Map<GFXDType,Set<GFXDType>>)value);
      }
      break;
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ServiceMetaData struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sqlKeywords = new ArrayList<String>(_list138.size);
                for (int _i139 = 0; _i139 < _list138.size; ++_i139)
                {
                  String _elem140;
                  _elem140 = iprot.readString();
                  struct.sqlKeywords.add(_elem140);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.numericFunctions = new ArrayList<String>(_list141.size);
                for (int _i142 = 0; _i142 < _list141.size; ++_i142)
                {
                  String _elem143;
                  _elem143 = iprot.readString();
                  struct.numericFunctions.add(_elem143);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.stringFunctions = new ArrayList<String>(_list144.size);
                for (int _i145 = 0; _i145 < _list144.size; ++_i145)
                {
                  String _elem146;
                  _elem146 = iprot.readString();
                  struct.stringFunctions.add(_elem146);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.systemFunctions = new ArrayList<String>(_list147.size);
                for (int _i148 = 0; _i148 < _list147.size; ++_i148)
                {
                  String _elem149;
                  _elem149 = iprot.readString();
                  struct.systemFunctions.add(_elem149);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dateTimeFunctions = new ArrayList<String>(_list150.size);
                for (int _i151 = 0; _i151 < _list150.size; ++_i151)
                {
                  String _elem152;
                  _elem152 = iprot.readString();
                  struct.dateTimeFunctions.add(_elem152);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.supportedCONVERT = new HashMap<GFXDType,Set<GFXDType>>(2*_map153.size);
                for (int _i154 = 0; _i154 < _map153.size; ++_i154)
                {
                  GFXDType _key155;
                  Set<GFXDType> _val156;
                  _key155 = GFXDType.findByValue(iprot.readI32());
                  {
                    org.apache.thrift.protocol.TSet _set157 = iprot.readSetBegin();
                    _val156 = new HashSet<GFXDType>(2*_set157.size);
                    for (int _i158 = 0; _i158 < _set157.size; ++_i158)
                    {
                      GFXDType _elem159;
                      _elem159 = GFXDType.findByValue(iprot.readI32());
                      _val156.add(_elem159);
                    }
                    iprot.readSetEnd();
                  }
                  struct.supportedCONVERT.put(_key155, _val156);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.transactionDefaults = new HashMap<TransactionAttribute,Boolean>(2*_map160.size);
                for (int _i161 = 0; _i161 < _map160.size; ++_i161)
                {
                  TransactionAttribute _key162;
                  boolean _val163;
                  _key162 = TransactionAttribute.findByValue(iprot.readI32());
                  _val163 = iprot.readBool();
                  struct.transactionDefaults.put(_key162, _val163);
                }
                iprot.readMapEnd();
              }
          ...
          case 46: // ROW_ID_LIFE_TIME
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.rowIdLifeTime = RowIdLifetime.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.supportedFeatures = new HashSet<ServiceFeature>(2*_set164.size);
                for (int _i165 = 0; _i165 < _set164.size; ++_i165)
                {
                  ServiceFeature _elem166;
                  _elem166 = ServiceFeature.findByValue(iprot.readI32());
                  struct.supportedFeatures.add(_elem166);
                }
                iprot.readSetEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.featuresWithParams = new HashMap<ServiceFeatureParameterized,List<Integer>>(2*_map167.size);
                for (int _i168 = 0; _i168 < _map167.size; ++_i168)
                {
                  ServiceFeatureParameterized _key169;
                  List<Integer> _val170;
                  _key169 = ServiceFeatureParameterized.findByValue(iprot.readI32());
                  {
                    org.apache.thrift.protocol.TList _list171 = iprot.readListBegin();
                    _val170 = new ArrayList<Integer>(_list171.size);
                  ...
                  struct.featuresWithParams.put(_key169, _val170);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ServiceMetaData struct) throws org.apache.thrift.TException {
      ...
      if (struct.sqlKeywords != null) {
        oprot.writeFieldBegin(SQL_KEYWORDS_FIELD_DESC);
        {
          ...
          for (String _iter174 : struct.sqlKeywords)
          {
      ...
      if (struct.numericFunctions != null) {
        oprot.writeFieldBegin(NUMERIC_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (String _iter175 : struct.numericFunctions)
          {
      ...
      if (struct.stringFunctions != null) {
        oprot.writeFieldBegin(STRING_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (String _iter176 : struct.stringFunctions)
          {
      ...
      if (struct.systemFunctions != null) {
        oprot.writeFieldBegin(SYSTEM_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (String _iter177 : struct.systemFunctions)
          {
      ...
      if (struct.dateTimeFunctions != null) {
        oprot.writeFieldBegin(DATE_TIME_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (String _iter178 : struct.dateTimeFunctions)
          {
      ...
      if (struct.supportedCONVERT != null) {
        oprot.writeFieldBegin(SUPPORTED_CONVERT_FIELD_DESC);
        {
          ...
          for (Map.Entry<GFXDType, Set<GFXDType>> _iter179 : struct.supportedCONVERT.entrySet())
          {
            oprot.writeI32(_iter179.getKey().getValue());
            {
              oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, _iter179.getValue().size()));
              for (GFXDType _iter180 : _iter179.getValue())
              {
      ...
      if (struct.transactionDefaults != null) {
        oprot.writeFieldBegin(TRANSACTION_DEFAULTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<TransactionAttribute, Boolean> _iter181 : struct.transactionDefaults.entrySet())
          {
            oprot.writeI32(_iter181.getKey().getValue());
            oprot.writeBool(_iter181.getValue());
          }
          oprot.writeMapEnd();
        }
        oprot.writeFieldEnd();
      ...
      if (struct.supportedFeatures != null) {
        oprot.writeFieldBegin(SUPPORTED_FEATURES_FIELD_DESC);
        {
          ...
          for (ServiceFeature _iter182 : struct.supportedFeatures)
          {
      ...
      if (struct.featuresWithParams != null) {
        oprot.writeFieldBegin(FEATURES_WITH_PARAMS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ServiceFeatureParameterized, List<Integer>> _iter183 : struct.featuresWithParams.entrySet())
          {
            oprot.writeI32(_iter183.getKey().getValue());
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, _iter183.getValue().size()));
              for (int _iter184 : _iter183.getValue())
              {
  ...
  private static class ServiceMetaDataTupleScheme extends TupleScheme<ServiceMetaData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ServiceMetaData struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.identifierQuote);
      {
        ...
        for (String _iter185 : struct.sqlKeywords)
        {
      ...
      }
      {
        ...
        for (String _iter186 : struct.numericFunctions)
        {
      ...
      }
      {
        ...
        for (String _iter187 : struct.stringFunctions)
        {
      ...
      }
      {
        ...
        for (String _iter188 : struct.systemFunctions)
        {
      ...
      }
      {
        ...
        for (String _iter189 : struct.dateTimeFunctions)
        {
      ...
      oprot.writeString(struct.searchStringEscape);
      {
        ...
        for (Map.Entry<GFXDType, Set<GFXDType>> _iter190 : struct.supportedCONVERT.entrySet())
        {
          oprot.writeI32(_iter190.getKey().getValue());
          {
            oprot.writeI32(_iter190.getValue().size());
            for (GFXDType _iter191 : _iter190.getValue())
            {
      ...
      oprot.writeBool(struct.catalogAtStart);
      {
        ...
        for (Map.Entry<TransactionAttribute, Boolean> _iter192 : struct.transactionDefaults.entrySet())
        {
          oprot.writeI32(_iter192.getKey().getValue());
          oprot.writeBool(_iter192.getValue());
        }
      }
      oprot.writeI32(struct.rowIdLifeTime.getValue());
      {
        oprot.writeI32(struct.supportedFeatures.size());
        for (ServiceFeature _iter193 : struct.supportedFeatures)
        {
      ...
      }
      {
        ...
        for (Map.Entry<ServiceFeatureParameterized, List<Integer>> _iter194 : struct.featuresWithParams.entrySet())
        {
          oprot.writeI32(_iter194.getKey().getValue());
          {
            oprot.writeI32(_iter194.getValue().size());
            for (int _iter195 : _iter194.getValue())
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ServiceMetaData struct) throws org.apache.thrift.TException {
      ...
      struct.setIdentifierQuoteIsSet(true);
      {
        ...
        struct.sqlKeywords = new ArrayList<String>(_list196.size);
        for (int _i197 = 0; _i197 < _list196.size; ++_i197)
        {
          String _elem198;
          _elem198 = iprot.readString();
          struct.sqlKeywords.add(_elem198);
        }
      }
      struct.setSqlKeywordsIsSet(true);
      {
        ...
        struct.numericFunctions = new ArrayList<String>(_list199.size);
        for (int _i200 = 0; _i200 < _list199.size; ++_i200)
        {
          String _elem201;
          _elem201 = iprot.readString();
          struct.numericFunctions.add(_elem201);
        }
      }
      struct.setNumericFunctionsIsSet(true);
      {
        ...
        struct.stringFunctions = new ArrayList<String>(_list202.size);
        for (int _i203 = 0; _i203 < _list202.size; ++_i203)
        {
          String _elem204;
          _elem204 = iprot.readString();
          struct.stringFunctions.add(_elem204);
        }
      }
      struct.setStringFunctionsIsSet(true);
      {
        ...
        struct.systemFunctions = new ArrayList<String>(_list205.size);
        for (int _i206 = 0; _i206 < _list205.size; ++_i206)
        {
          String _elem207;
          _elem207 = iprot.readString();
          struct.systemFunctions.add(_elem207);
        }
      }
      struct.setSystemFunctionsIsSet(true);
      {
        ...
        struct.dateTimeFunctions = new ArrayList<String>(_list208.size);
        for (int _i209 = 0; _i209 < _list208.size; ++_i209)
        {
          String _elem210;
          _elem210 = iprot.readString();
          struct.dateTimeFunctions.add(_elem210);
        }
      }
      struct.setDateTimeFunctionsIsSet(true);
      struct.searchStringEscape = iprot.readString();
      struct.setSearchStringEscapeIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map211 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.SET, iprot.readI32());
        struct.supportedCONVERT = new HashMap<GFXDType,Set<GFXDType>>(2*_map211.size);
        for (int _i212 = 0; _i212 < _map211.size; ++_i212)
        {
          GFXDType _key213;
          Set<GFXDType> _val214;
          _key213 = GFXDType.findByValue(iprot.readI32());
          {
            org.apache.thrift.protocol.TSet _set215 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
            _val214 = new HashSet<GFXDType>(2*_set215.size);
            for (int _i216 = 0; _i216 < _set215.size; ++_i216)
            {
              GFXDType _elem217;
              _elem217 = GFXDType.findByValue(iprot.readI32());
              _val214.add(_elem217);
            }
          }
          struct.supportedCONVERT.put(_key213, _val214);
        }
      }
      struct.setSupportedCONVERTIsSet(true);
      struct.schemaTerm = iprot.readString();
      ...
      struct.setCatalogAtStartIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map218 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.BOOL, iprot.readI32());
        struct.transactionDefaults = new HashMap<TransactionAttribute,Boolean>(2*_map218.size);
        for (int _i219 = 0; _i219 < _map218.size; ++_i219)
        {
          TransactionAttribute _key220;
          boolean _val221;
          _key220 = TransactionAttribute.findByValue(iprot.readI32());
          _val221 = iprot.readBool();
          struct.transactionDefaults.put(_key220, _val221);
        }
      }
      struct.setTransactionDefaultsIsSet(true);
      struct.rowIdLifeTime = RowIdLifetime.findByValue(iprot.readI32());
      struct.setRowIdLifeTimeIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set222 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.supportedFeatures = new HashSet<ServiceFeature>(2*_set222.size);
        for (int _i223 = 0; _i223 < _set222.size; ++_i223)
        {
          ServiceFeature _elem224;
          _elem224 = ServiceFeature.findByValue(iprot.readI32());
          struct.supportedFeatures.add(_elem224);
        }
      }
      struct.setSupportedFeaturesIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map225 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.LIST, iprot.readI32());
        struct.featuresWithParams = new HashMap<ServiceFeatureParameterized,List<Integer>>(2*_map225.size);
        for (int _i226 = 0; _i226 < _map225.size; ++_i226)
        {
          ServiceFeatureParameterized _key227;
          List<Integer> _val228;
          _key227 = ServiceFeatureParameterized.findByValue(iprot.readI32());
          {
            ...
            _val228 = new ArrayList<Integer>(_list229.size);
          ...
          struct.featuresWithParams.put(_key227, _val228);
        }
      }
      struct.setFeaturesWithParamsIsSet(true);
