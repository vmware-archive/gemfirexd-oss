/**
 * Autogenerated code by Thrift Compiler (0.9.0) moved into the compact
 * representation in {@link com.pivotal.gemfirexd.thrift.common.ThriftRow} class.
 */
...
public final class Row extends com.pivotal.gemfirexd.thrift.common.ThriftRow {
