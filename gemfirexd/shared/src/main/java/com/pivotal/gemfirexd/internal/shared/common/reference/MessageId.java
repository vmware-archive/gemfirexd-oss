/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.shared.common.reference.MessageId
...
public interface MessageId {
	...
	*/
    ...
    String LOG_WAS_IN_DURABILITY_TESTMODE_NO_SYNC = "L020"; // database was running in
                                                            // gemfirexd.system.durability set to test 
    String LOG_DURABILITY_TESTMODE_NO_SYNC_ERR = "L021"; // hint that error could be because 
                                                         // gemfirexd.system.durability was set to test
    ...
    String STORE_DURABILITY_TESTMODE_NO_SYNC = "D013"; // for gemfirexd.system.durability is 
                                                       // set to test
...
//GemStone changes BEGIN
    String CONN_BIND_ADDRESS_ERROR                          = "J135";
    String CONN_INVALID_PORT                                = "J136";
    String CONN_DRDA_ADDRESS_IN_USE_ERR                     = "J137";
//GemStone changes END
	...
	*/
	...
	/*
	** Derby interface in com.pivotal.gemfirexd.internal.iapi.*
