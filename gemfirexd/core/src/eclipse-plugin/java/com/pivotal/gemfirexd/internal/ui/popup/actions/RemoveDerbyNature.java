/*
	...
	Derby - Class com.pivotal.gemfirexd.internal.ui.popup.actions.RemoveDerbyNature
...
*/
package com.pivotal.gemfirexd.internal.ui.popup.actions;

import java.util.ArrayList;
import java.util.List;

import com.pivotal.gemfirexd.internal.ui.common.CommonNames;
import com.pivotal.gemfirexd.internal.ui.common.Messages;
import com.pivotal.gemfirexd.internal.ui.container.DerbyClasspathContainer;
import com.pivotal.gemfirexd.internal.ui.util.DerbyServerUtils;
import com.pivotal.gemfirexd.internal.ui.util.Logger;
import com.pivotal.gemfirexd.internal.ui.util.SelectionUtil;
...
public class RemoveDerbyNature implements IObjectActionDelegate {
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if(currentJavaProject==null){
			currentProject=com.pivotal.gemfirexd.internal.ui.util.SelectionUtil.findSelectedProject(selection);
		}
	}
