...
5) Import the Apache Derby UI project:
   ...
   - Click Next
   - Click Browse and point to the "com.pivotal.gemfirexd.internal.ui" directory (created in 
...
com.pivotal.gemfirexd.internal.plugin.doc for com.pivotal.gemfirexd.internal.ui.
================================================================================
...
1) From within the Plug-in Development perspective, right-click the 
   com.pivotal.gemfirexd.internal.ui project.  Select Export --> Deployable plug-ins and 
   fragments, then the Next button.

2) In the Deployable plug-ins and fragments window select the 
   com.pivotal.gemfirexd.internal.ui project listed in the Available Plug-ins and Fragments 
...
1) From within the Plug-in Development perspective, right-click the
   com.pivotal.gemfirexd.internal.plugin.doc project.  Select Export --> Deployable plug-ins 
   and fragments, then the Next button.

2) In the Deployable plug-ins and fragments window select the 
   com.pivotal.gemfirexd.internal.plugin.doc project listed in the left frame.  In the right 
...
5) Note that the documentation zip files' base directory is
   com.pivotal.gemfirexd.internal.plugin.doc and therefore must be unzipped in the plug-ins
   directory.

To create a single zip file for both UI and Doc plug-ins:

1) From within the Plug-in Development perspective, right-click the
   com.pivotal.gemfirexd.internal.plugin.doc and the com.pivotal.gemfirexd.internal.ui projects.  Select 
