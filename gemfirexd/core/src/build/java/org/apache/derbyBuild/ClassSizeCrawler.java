/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.services.cache.ClassSizeCrawler
 ...
 *<p>
 * java -DWS=<i>work-space</i> [-DclassDir=<i>class-dir</i>] [-Dout=<i>out-file</i> [-Dprefix[.<i>x</i>=<i>package-prefix</i>]] [-Dverbose=true] com.pivotal.gemfirexd.internal.iapi.services.cache.ClassSizeCrawler <i>class-or-interface</i> ...<br>
 *<p>
 ...
 * of com.pivotal.gemfirexd.internal.iapi.types.DataValueDescriptor, and at least one prefix property
 * must be specified
 *<p>
 * The catalog is written as a java source file
 * into <i>out-file</i>, by default
 * <i>work-space</i>/java/com.pivotal.gemfirexd.internal.iapi.services.cache.ClassSizeCatalog.java.
 *<p>
 ...
 * <code>
 * java -DWS=$WS \
 *      -Dprefix.1=com.pivotal.gemfirexd.internal.iapi.types \
 *      com.pivotal.gemfirexd.internal.iapi.services.cache.ClassSizeCrawler \
 *        com.pivotal.gemfirexd.internal.iapi.types.DataValueDescriptor \
 *        java.math.BigDecimal \
 *        com.pivotal.gemfirexd.internal.impl.services.cache.Generic.CachedItem
 *</code>
 *</pre>
 */
public class ClassSizeCrawler
{
    ...
    {
        String[] classAndInterfaceList = {"com.pivotal.gemfirexd.internal.iapi.types.DataValueDescriptor"};
        if(arg.length > 0)
        ...
        String outputFileName =
          System.getProperty( "out", WS + "/java/com.pivotal.gemfirexd.internal.iapi.services.cache.ClassSizeCatalog.java");
        try
        {
            ...
            out.print( "/*\n\n" +
                       ...
                       "   limitations under the License.\n" +
                       " */\n");
            out.print( "package com.pivotal.gemfirexd.internal.iapi.services.cache;\n" +
                       "import java.util.Hashtable;\n" +
