/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.drda.NetworkServerMBeanImpl
 ...
 * <code>com.pivotal.gemfirexd.internal.mbeans.drda.NetworkServerMBean</code>,
 ...
 * 
 * @see com.pivotal.gemfirexd.internal.mbeans.drda.NetworkServerMBean
 */
class NetworkServerMBeanImpl implements NetworkServerMBean {
    ...
    public String getDrdaHost() {
        ...
        String host = getServerProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_HOSTNAME);
        return host;
    }
    
    public boolean getDrdaKeepAlive() {
        checkMonitor();
        String on = getServerProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_KEEPALIVE);
    ...
    public int getDrdaMaxThreads() {
        ...
        String maxThreadsStr = getServerProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_MAXTHREADS);
    ...
    public int getDrdaPortNumber() {
        ...
        String portString = getServerProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_PORTNUMBER);
        try {
    ...
    public String getDrdaSecurityMechanism() {
        ...
        String secmec = getServerProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_SECURITYMECHANISM);
        if (secmec == null) {
    ...
    public String getDrdaSslMode() {
        ...
        String SSLMode = getServerProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_SSL_MODE);
        return SSLMode;
    }
    ...
    public int getDrdaStreamOutBufferSize() {
        ...
        int size = PropertyUtil.getSystemInt(
                com.pivotal.gemfirexd.Property.DRDA_PROP_STREAMOUTBUFFERSIZE, 0);
        return size;
    }
    ...
    public boolean getDrdaTraceAll() {
        ...
        String on = getServerProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_TRACEALL);
        return ("true".equals(on) ? true : false );
    }
    ...
    public String getDrdaTraceDirectory() {
        ...
        traceDirectory = getServerProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_TRACEDIRECTORY);
        if(traceDirectory == null){
            // if traceDirectory is not set, gemfirexd.system.home is default
            traceDirectory = getServerProperty(Property.SYSTEM_HOME_PROPERTY);
        }
        
        // if gemfirexd.system.home is not set, current directory is default
        if (traceDirectory == null) {
     ...
     * 
     * @see com.pivotal.gemfirexd.internal.mbeans.drda.NetworkServerMBean#ping()
    ...
    *  <code>gemfirexd.drda.</code> and may be found in the 
    *  com.pivotal.gemfirexd.internal.iapi.reference.Property class.
    * 
    *  @see com.pivotal.gemfirexd.internal.iapi.reference.Property
