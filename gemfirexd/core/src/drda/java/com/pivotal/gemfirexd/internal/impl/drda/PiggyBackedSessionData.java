/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.drda.PiggyBackedSessionData
...
// GemStone changes BEGIN
  public TXId getTXId() {
    if (conn_ != null) {
      GemFireTransaction gft = (GemFireTransaction)conn_
          .getLanguageConnectionContext().getTransactionCompile();
      if (gft != null) {
        TXStateInterface tx = gft.getActiveTXState();
        if (tx != null) {
