/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.drda.NetworkServerControl
...
/** 
	...
	Connections are logged to gemfirexd.log. 
	Default is off.</LI>
	...
	Default is gemfirexd.system.home, if it is set. 
	Otherwise the default is the current directory.</LI>

	</UL>
	<P>Properties can be set in the gemfirexd.properties file or on the command line.
	Properties on the command line take precedence over properties in the 
	gemfirexd.properties file.  Arguments on the command line take precedence
	over properties. 
	The following is a list of properties that can be set for 
	NetworkServerControl:

	<UL><LI>gemfirexd.drda.portNumber=&lt;port number>: This property 
	indicates which port should be used for the Network Server. </LI>

	<LI>gemfirexd.drda.host=&lt;host name  or ip address >: This property 
	indicates the ip address to which NetworkServerControl should connect 

	<LI>gemfirexd.drda.traceDirectory=&lt;trace directory>: This property 
	indicates where to put trace files. </LI>

	<LI>gemfirexd.drda.traceAll=true:  This property turns on tracing for
	all sessions. Default is tracing is off.</LI>

	<LI>gemfirexd.drda.logConnections=true:  This property turns on logging
	of connections. Default is connections are not logged.</LI>

	<LI>gemfirexd.drda.minThreads=&lt;value>: If this property
	is set, the &lt;value> number of threads will be created when the Network Server is
	booted. </LI>

	<LI>gemfirexd.drda.maxThreads=&lt;value>: If this property
	...
	<LI>gemfirexd.drda.timeSlice=&lt;milliseconds>: If this property
    ...
    <LI>gemfirexd.drda.sslMode=&lt;sslmode&gt: This property sets the SSL
    mode of the server.
...
<P><B>Examples.</B>
	...
	<PRE> 
	java com.pivotal.gemfirexd.internal.drda.NetworkServerControl shutdown -p 1621
	</PRE>

	<P>This is an example of turning tracing on for session 3
	<PRE>
	java com.pivotal.gemfirexd.internal.drda.NetworkServerControl  trace on -s 3 
	</PRE>

	<P>This is an example of starting and then shutting down the network 
	   server on port 1621 on machine myhost   
	<PRE>
	java com.pivotal.gemfirexd.internal.drda.NetworkServerControl  start -h myhost -p 1621
	java com.pivotal.gemfirexd.internal.drda.NetworkServerControl  shutdown -h myhost -p 1621
	</PRE>
...
public class NetworkServerControl{
	...
	private final static String DERBYNET_JAR = "gemfirexd.jar";
	 ...
	 * and the default port(1527) unless gemfirexd.drda.portNumber and 
	 * gemfirexd.drda.host are set.
	 * <P><PRE>
	 ...
	 *  is to use the gemfirexd.drda.startNetworkServer property in 
	...
	{
	    String val =serverImpl.getCurrentProperties().getProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_MAXTHREADS);
	...
	{
		String val  =
			serverImpl.getCurrentProperties().getProperty(com.pivotal.gemfirexd.Property.DRDA_PROP_TIMESLICE);
		return Integer.parseInt(val);
	}
        ...
        throws Exception
    {
        ...
        // trace file.
        //
        if ( PropertyUtil.getSystemProperty( com.pivotal.gemfirexd.Property.DRDA_PROP_TRACEDIRECTORY ) == null )
        { System.setProperty( com.pivotal.gemfirexd.Property.DRDA_PROP_TRACEDIRECTORY, PropertyUtil.getSystemProperty( Property.SYSTEM_HOME_PROPERTY ) ); }
    ...
    /**
     *<p>
     * Find the url of the library directory which holds gemfirexd.jar.
     * </p>
     */
