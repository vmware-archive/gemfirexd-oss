 ...
 * <code>sqlfire.</code> prefixed {@link Attribute} properties.
 * 
 * @author soubhikc
 * 
 */
...
public interface Property {
   ...
   * <BR>
   * 
   * Define {sqlfire.auth-ldap-search-base} property for limiting the
   ...
   * searching if property {sqlfire.auth-ldap-search-base} is
   * configured. <BR>
   * <BR>
   * If ldap server doesn't allow anonymous bind, define
   * {sqlfire.auth-ldap-search-dn} and
   * {sqlfire.auth-ldap-search-pw} properties, which will be
   * preferred over anonymous user while binding to ldap server for searching.
   * 
   */
  // TODO mention about searchFilter and sqlfire.user. prefix mapping of DN.
   ...
   * in ${sqlfire.system.home} if set, otherwise ${user.dir}
   */
   ...
   * <BR>
   * if sqlfire.drda.securityMechanism is set to a valid mechanism, then
   * the Network Server accepts only connections which use that
   * security mechanism. No other types of connections are accepted.
   * <BR>
   * if the sqlfire.drda.securityMechanism is not set at all, then the
   * Network Server accepts any connection which uses a valid
   * security mechanism.
   * <BR> 
   * E.g sqlfire.drda.securityMechanism=USER_ONLY_SECURITY
   ...
   */
  public final static String DRDA_PROP_SECURITYMECHANISM = "sqlfire.drda.securityMechanism";
  ...
  public final static String DRDA_PROP_SSL_MODE = "sqlfire.drda.sslMode";
   ...
   */
      public final static String DRDA_PROP_PORTNUMBER = "sqlfire.drda.portNumber";

  public final static String DRDA_PROP_HOSTNAME = "sqlfire.drda.host";
   ...
   *
   */
  public final static String DRDA_PROP_STREAMOUTBUFFERSIZE = "sqlfire.drda.streamOutBufferSize";
   ...
   */
  public final static String DRDA_PROP_KEEPALIVE = "sqlfire.drda.keepAlive";
   ...
   *<BR>
   * Default: if the sqlfire.system.home property has been set,
   * it is the default. Otherwise, the default is the current directory.
   */
      public final static String DRDA_PROP_TRACEDIRECTORY = "sqlfire.drda.traceDirectory";
   ...
   * Default: false
   */
      public final static String DRDA_PROP_TRACEALL = "sqlfire.drda.traceAll";

  public final static String DRDA_PROP_TRACE = "sqlfire.drda.trace";
   ...
   * Default: false
   */
  public final static String DRDA_PROP_LOGCONNECTIONS = "sqlfire.drda.logConnections";
   ...
   * <BR>
   * 
   * Use the sqlfire.drda.minThreads property to set the minimum number of
   ...
   * Default: 1
   */
  public final static String DRDA_PROP_MINTHREADS = "sqlfire.drda.minThreads";
   ...
   * <BR>
   * 
   * Use the sqlfire.drda.maxThreads property to set a maximum number of
   ...
   * by using the <code>sqlfire.drda.timeslice</code> property to determine when
   ...
   * Default: 0
   */
  public final static String DRDA_PROP_MAXTHREADS = "sqlfire.drda.maxThreads";
   ...
   * <BR>
   * 
   * Use the sqlfire.drda.timeSlice property to set the number of milliseconds
   * that each connection will use before yielding to another connection. This
   * property is relevant only if the sqlfire.drda.maxThreads property is set to
   ...
   * Default: 0
   */
  public final static String DRDA_PROP_TIMESLICE = "sqlfire.drda.timeSlice";

  /**
   * sqlfire.drda.maxIdleTime
   * 
   * <BR>
   * 
   ...
   */
  public final static String SIGNALS_NOT_LOGGED = "sqlfire.signals.notlogged";
