...
public abstract class RowLocationStatsRegionEntry extends VMStatsRegionEntry implements
RowLocation, Sizeable {

  public RowLocationStatsRegionEntry(RegionEntryContext context, Object value) {
    super(context, value);
  }
