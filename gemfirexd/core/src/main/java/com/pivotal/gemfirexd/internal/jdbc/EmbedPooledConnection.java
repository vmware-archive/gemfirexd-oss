/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.jdbc.EmbedPooledConnection
...
class EmbedPooledConnection implements javax.sql.PooledConnection, BrokeredConnectionControl
{
	...
	*/
	...
	final Connection getNewCurrentConnectionHandle() {
		Connection applicationConnection = currentConnectionHandle =
			((com.pivotal.gemfirexd.internal.jdbc.Driver20) (realConnection.getLocalDriver())).newBrokeredConnection(this);
	...
	*/
     ...
     * com.pivotal.gemfirexd.internal.jdbc.EmbedPooledConnection40
  ...
  // Dummy JDBC 4.0 methods so can compile with JDK 1.6
