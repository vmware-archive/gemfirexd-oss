...
public class StringUtil 
{
	...
	*/
	...
	{
// GemStone changes BEGIN
	  // moved to ClientSharedUtils to enable both client and server
	  // code to use it
	  return ClientSharedUtils.toHexString(data, offset, length);
	  /* (original code)
...
// GemStone changes BEGIN
	  // moved to ClientSharedUtils to enable both client and server
	  // code to use it
	  return ClientSharedUtils.fromHexString(s, offset, length);
	  /* (original code)
		if ((length%2) != 0)
			return null;
...
// GemStone changes END
	...
	*/
	...
	{
// GemStone changes BEGIN
	  // moved to SharedUtils to enable both client and server
	  // code to use it
	  return SharedUtils.SQLToUpperCase(s);
	  /* (original code)
...
// GemStone changes END
    ...
    static String quoteString(String source, char quote) {
        // moved to ShardUtils since also useful for clients
        return SharedUtils.quoteString(source, quote);
        /* (original code)
