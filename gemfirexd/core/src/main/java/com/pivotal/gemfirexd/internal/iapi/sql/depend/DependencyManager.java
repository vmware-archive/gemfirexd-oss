/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.sql.depend.DependencyManager
...
public interface DependencyManager {
	...
	/**
		...
		@param lcc		The LanguageConnectionContext
                ...
                @return List        list of dependencies invalidated
		@exception StandardException thrown if unable to make it invalid
	 */
//GemStone changes BEGIN added retun type as List
	List invalidateFor(Provider p, int action, LanguageConnectionContext lcc)
