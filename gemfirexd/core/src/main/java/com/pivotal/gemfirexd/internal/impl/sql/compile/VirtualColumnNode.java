/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.VirtualColumnNode
...
// GemStone changes BEGIN
       ...
       throws StandardException 
    {
        ...
        if(remapToNew) {
          VirtualColumnNode newVC = (VirtualColumnNode) getNodeFactory().getNode(
                                            C_NodeTypes.VIRTUAL_COLUMN_NODE,
                                            getSourceResultSet(), // source result set.
                                            resultColumn,
    ...
    public boolean hasExpression() {
      return sourceColumn.hasExpression();
    }
    
    // Virtual columns are not base table columns and are not get-convertable via GFEResultSet
    // Override ValueNode to return false here ... even if the virtual column doesn't contain an expression
    ...
    public String findSourceSchemaName() {
      return sourceColumn.findSourceSchemaName();
    }
    ...
    public String findSourceTableName() {
      return sourceColumn.findSourceTableName();
    }
    ...
    public String findSourceColumnName() {
      return sourceColumn.findSourceColumnName();
    }
