/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.raw.data.BaseContainerHandle
    ...
    implements RawContainerHandle, Observer 
{
	...
	public void removePage(Page page) throws StandardException
	{
		if (!active)
		{
			...
			throw StandardException.newException(
                    SQLState.DATA_CONTAINER_CLOSED, GemFireStore.getMyId(), "");
		}
	...
	*/
	...
	// Useful with indexes, returns the container id on which index is created.
	/**
        @see ContainerHandle#getBaseId
	 */
