/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.io.StorageFactory
...
package com.pivotal.gemfirexd.internal.io;
 ...
 * tied to a StorageFactory implementation class via the gemfirexd.subSubProtocol.<i>xxx</i> system property. So,
 * to use StorageFactory implementation class MyStorageFactory with database myDB you would set the system
 * property "gemfirexd.subSubProtocol.mysf=MyStorageFactory" and use the URL "jdbc:derby:mysf:myDB" to
