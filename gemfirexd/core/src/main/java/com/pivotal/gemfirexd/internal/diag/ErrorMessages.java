/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.diag.ErrorMessages
 ...
 * <PRE> SELECT* FROM NEW com.pivotal.gemfirexd.internal.diag.ErrorMessages() AS EQ; </PRE>
...
public final class ErrorMessages extends VTITemplate implements VTICosting, java.security.PrivilegedAction  {
	...
	public final Object run() {
		InputStream msg = getClass().getResourceAsStream("/com/pivotal/gemfirexd/internal/loc/m" + msgFile + "_en.properties");
		msgFile = 0;
		return msg;
