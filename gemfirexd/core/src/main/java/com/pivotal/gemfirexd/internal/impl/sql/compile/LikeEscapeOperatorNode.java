/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.LikeEscapeOperatorNode
...
public final class LikeEscapeOperatorNode extends TernaryOperatorNode
{
    ...
    */
        ...
        throws StandardException
    {
        ...
        if (!(leftOperand.requiresTypeFromContext() && !leftOperand.isParameterizedConstantNode()) && 
        ...
        if (leftOperand.getTypeId() != null && leftOperand.getTypeId().isJSONTypeId()) 
        {
            throw StandardException.newException(
                SQLState.LANG_DB2_FUNCTION_INCOMPATIBLE, "LIKE", "FUNCTION");
        }
        ...
        if ((rightOperand != null) && 
            !(rightOperand.requiresTypeFromContext() && !rightOperand.isParameterizedConstantNode()) && 
        ...
        */
        if (!receiver.getTypeId().isStringTypeId() || 
            receiver.getTypeId().isJSONTypeId())
        {
            throw StandardException.newException(
                SQLState.LANG_DB2_FUNCTION_INCOMPATIBLE, "LIKE", "FUNCTION");
        }
        ...
        throws StandardException 
    {
        ...
        StaticMethodCallNode methodCall = (StaticMethodCallNode)
            getNodeFactory().getNode(
                ...
                methodName,
                "com.pivotal.gemfirexd.internal.iapi.types.Like",
                getContextManager());
...
//  GemStone changes BEGIN
    ...
    //to be implmented correctly for the LikeEscapeOperatorNode
    @Override
    public QueryInfo computeQueryInfo(QueryInfoContext qic) throws StandardException {
      //return new ComparisonQueryInfo(this.leftOperand.computeQueryInfo(qic),this.receiver.computeQueryInfo(qic),this.operatorType);
      
      //Since Like Operator is not going to contribute to nodes prunning at this point,
       ...
       throws StandardException 
    {
        ...
        // rightOperand not required as it carries 'escape character' 
    ...
    {
      // RECEIVER LIKE LEFTOPERAND, not the other way around!
       return receiver.printExplainInfo() + " LIKE " + leftOperand.printExplainInfo();
    }
    
    @Override
    public String ncjGenerateSql() {
      return receiver.ncjGenerateSql() + " LIKE " + leftOperand.ncjGenerateSql();
    }
//  GemStone changes END
}
