/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.PropertyConglomerate
...
Conglomerate:
<OL>
<LI>Column 0 is the UTF key "gemfirexd.defaultPropertyName".
...
class PropertyConglomerate
{
		...
		throws StandardException
	{
      ...
      // GemStone changes BEGIN
                ...
                conglomProperties.put(GfxdConstants.REGION_ATTRIBUTES_KEY,
                    af.create());
                ...
                // use some unique name, id will be substituted once we have a
                // conglom id
