...
/**
 * If this class is regenerated, redo the changes marked between 
 * "//GemStone changes BEGIN" and "//GemStone changes END".<BR><BR>
 * 
 * 
...
public interface CharStream {
   ...
   */
  String GetImage(int jjmatchedKind);
   ...
   *
   *   {
   *      String t = GetImage(int jjmatchedKind);
