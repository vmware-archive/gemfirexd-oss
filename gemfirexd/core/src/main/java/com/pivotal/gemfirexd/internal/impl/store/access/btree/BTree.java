/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.btree.BTree
...
public abstract class BTree extends GenericConglomerate
{
    ...
    or branch).  Equal to 'gemfirexd.access.btreeMaxRowPerPage'.  Used by tests
	...
	*/
	public static final String PROPERTY_MAX_ROWS_PER_PAGE_PARAMETER = 
        (SanityManager.DEBUG ?  "gemfirexd.access.btreeMaxRowPerPage" : null);
	...
	**/
	...
	@see com.pivotal.gemfirexd.internal.iapi.store.access.conglomerate.Conglomerate#drop
	...
	**/
	...
	This must be done by a concrete implementation.
	@see com.pivotal.gemfirexd.internal.iapi.store.access.conglomerate.Conglomerate#open
