...
public class GfxdSetGatewayConflictResolverMessage extends AbstractGfxdReplayableMessage {
  ...
  public void execute() throws StandardException {
    ...
    try {
      ...
      if (logger.infoEnabled()) {
        logger.info("GfxdSetGatewayConflictResolverMessage: Executing with fields as: "
            + this.toString());
      }
      CallbackProcedures.addGfxdGatewayConflictResolverLocally(
          this.implementation, this.initInfoStr);
    } catch (Exception ex) {
      if (logger.fineEnabled()) {
        logger.fine("GfxdSetGatewayConflictResolverMessage#execute: exception encountered", ex);
      }
  ...
  public byte getGfxdID() {
    return GfxdSetGatewayConflictResolverMessage.SET_GATEWAY_CONFLICT_RESOLVER_MSG;
  }
  ...
  public String getSQLStatement() {
    ...
    return sb.append("CALL SYS.ATTACH_GATEWAY_CONFLICT_RESOLVER('")
