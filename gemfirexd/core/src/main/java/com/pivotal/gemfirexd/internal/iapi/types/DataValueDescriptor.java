/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.types.DataValueDescriptor
...
// GemStone changes BEGIN
  DataSerializableFixedID, RegionKey, BinaryComparable
// GemStone changes END
{
...
// GemStone changes BEGIN
  ...
  /**
   * Optimized read from a byte array at specified offset
   * 
   * @param inBytes
   ...
   * byte so as to return the same value as that method would on the result of
   * {@link #writeBytes} without actually creating a byte array.
   */
