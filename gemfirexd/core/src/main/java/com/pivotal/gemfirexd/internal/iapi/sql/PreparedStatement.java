/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.sql.PreparedStatement
	...
	extends Dependent
{
	 ...
	 */
	void rePrepare(LanguageConnectionContext lcc, Activation a) 
	 ...
	 */
	Activation	getActivation(LanguageConnectionContext lcc, boolean scrollable, String statementText) throws StandardException;
// GemStone changes BEGIN
	/**
	 ...
	 * @param popStmntCntxt boolean indicating whether StatementContext
   *                       should be popped out or not
	 * @param accountInProgress TODO
	 ...
	 */
        ResultSet execute(Activation activation,
            ...
            boolean popStmntCntxt, boolean accountInProgress)
        throws StandardException;
// GemStone changes END
	...
	*/
	...
	// GemStone changes BEGIN
	/**
	 * Get the statement statistic object associated with
	 * this prepared statement.
	 */
        public StatementStats getStatementStats();

        /**
         * Associate a statement statistics object with this
         * prepared statement.
         * 
         * @param st
         */
        void setStatementStats(StatementStats st);
