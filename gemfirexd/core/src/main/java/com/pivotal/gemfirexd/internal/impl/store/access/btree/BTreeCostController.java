/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.btree.BTreeCostController
...
<p>
@see com.pivotal.gemfirexd.internal.iapi.store.access.TransactionController#openStoreCost
    ...
    implements StoreCostController
{
	 ...
	 * @exception  StandardException  Standard exception policy.
     *
	 * @see com.pivotal.gemfirexd.internal.iapi.store.access.RowUtil
     **/
        ...
        throws StandardException
    {
        ...
        try
        {
            ...
            double cost = 
                getFetchFromFullKeyCost(scanColumnList, access_type, null);
