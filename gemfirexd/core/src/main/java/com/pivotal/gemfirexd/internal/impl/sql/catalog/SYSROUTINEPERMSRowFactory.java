/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.catalog.SYSROUTINEPERMSRowFactory
...
public class SYSROUTINEPERMSRowFactory extends PermissionsCatalogRowFactory
{
 ...
 // GemStone changes BEGIN
    public static final int LDAP_GROUP_NAME = 6;
...
// GemStone changes END
	...
	public ExecRow makeRow(TupleDescriptor td, TupleDescriptor parent) throws StandardException
	{
        ...
        String ldapGroup = null; // GemStone addition
        ...
        else
        {
            ...
            ldapGroup = rpd.getLdapGroup(); // GemStone addition
        }
        ...
        // GemStone addition
        row.setColumn(LDAP_GROUP_NAME, new SQLChar(ldapGroup));
        return row;
    } // end of makeRow
...
// GemStone changes BEGIN
        DataValueDescriptor ldapDVD = row.getColumn(LDAP_GROUP_NAME);
        routinePermsDesc.setLdapGroup(
            ldapDVD != null ? ldapDVD.getString() : null);
// GemStone changes END
        ...
        throws StandardException
    {
         return new SystemColumn[] {
             ...
             SystemColumnImpl.getIdentifierColumn("LDAPGROUP", true) // GemStone addition
         };
    }
