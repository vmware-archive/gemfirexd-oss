/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.RAMTransaction
    ...
    implements XATransactionController, TransactionManager
{
 ...
 // GemStone changes END
    ...
    DataValueDescriptor[]           stopKeyValue,
// GemStone changes BEGIN
    int                             stopSearchOperator, Activation activation)
// GemStone changes END
        throws StandardException
	{
        return(
	...
	public ScanController openCompiledScan(
	        ...
	        throws StandardException
	  {
	     ...
	     throw new AssertionError("Open compiled scan should never be called on " +
	     		" RAMTransaction");
	  }
	// Gemstone changes END.
...
// GemStone changes BEGIN
	public DatabaseInstant commit()
	/* (original derby code) public void commit() */
// GemStone changes END
		throws StandardException
	{
...
// GemStone changes BEGIN
  ...
  public long createSort(Properties implParameters, ExecRow template,
    ...
    return createSort(implParameters, template != null ? template.getRowArray()
        : null, columnOrdering, sortObserver, alreadyInOrder, estimatedRows,
        estimatedRowSize);
  }
// GemStone changes END
}
