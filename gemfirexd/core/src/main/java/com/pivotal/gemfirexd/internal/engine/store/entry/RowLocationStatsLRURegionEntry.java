...
public abstract class RowLocationStatsLRURegionEntry extends
    VMStatsLRURegionEntry implements RowLocation, Sizeable {

  public RowLocationStatsLRURegionEntry(RegionEntryContext context, Object value) {
    super(context, value);
  }
