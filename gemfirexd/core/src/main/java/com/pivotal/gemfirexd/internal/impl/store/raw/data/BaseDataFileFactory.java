/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.raw.data.BaseDataFileFactory
...
import com.pivotal.gemfirexd.internal.impl.store.raw.data.AllocationActions;
...
import com.pivotal.gemfirexd.internal.impl.store.raw.data.DirectActions;
import com.pivotal.gemfirexd.internal.impl.store.raw.data.LoggableActions;
import com.pivotal.gemfirexd.internal.impl.store.raw.data.PageActions;
        ...
        throws StandardException 
    {
		...
		CacheFactory cf = (CacheFactory) 
            Monitor.startSystemModule(
                com.pivotal.gemfirexd.internal.iapi.reference.Module.CacheFactory);
        ...
        // If gemfirexd.system.durability=test then set flags to disable sync of
            ...
            PropertyUtil.getSystemProperty(Property.DURABILITY_PROPERTY)))
        {
            ...
            // log message stating that gemfirexd.system.durability
