/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.services.i18n.MessageService
...
public final class MessageService {
	...
	public static ResourceBundle getBundleForLocale(Locale locale, String msgId) {
		try {
			return MessageService.getBundleWithEnDefault("com.pivotal.gemfirexd.internal.loc.m"+hashString50(msgId), locale);
	...
	/**
	  Method used by GemFireXD Network Server to get localized message
...
// GemStone changes BEGIN
			arguments = ClientSharedUtils.getZeroLenObjectArray();
			/* (original code)
