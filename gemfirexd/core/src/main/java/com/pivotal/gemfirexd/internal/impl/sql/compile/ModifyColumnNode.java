/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.ModifyColumnNode
...
// GemStone changes BEGIN
			else if (this.setAutoIncrement) {
			  return ColumnInfo.MODIFY_COLUMN_AUTOINCREMENT;
			}
// GemStone changees END
			else
