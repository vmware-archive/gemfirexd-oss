/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.jdbc.EmbeddedXADataSource
...
//						ra = (ResourceAdapter) database.getResourceAdapter();
			  ...
			  GemFireStore memStore;
                          if (ra == null && (memStore = GemFireStore.getBootedInstance()) != null) {
                            ra = (ResourceAdapter)memStore.getDatabase().getResourceAdapter();
                          }
			  // GemStone changes END
				if (ra == null)
