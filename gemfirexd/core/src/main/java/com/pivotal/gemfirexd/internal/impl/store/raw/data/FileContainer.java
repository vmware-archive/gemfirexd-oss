/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.raw.data.FileContainer
    ...
    extends BaseContainer implements Cacheable, TypedFormat
{
		...
		if (onDiskChecksum != checksum.getValue())
		{
			...
			throw dataFactory.markCorrupt
				(StandardException.newException(
                    ...
                    com.pivotal.gemfirexd.internal.iapi.util.StringUtil.hexDump(a)));
		}
	...
	*/
		 ...
		 throws StandardException
	{
        ...
        // rollforward recovery or if gemfirexd.storage.patchInitPageRecoverError 
        // is set to true.
