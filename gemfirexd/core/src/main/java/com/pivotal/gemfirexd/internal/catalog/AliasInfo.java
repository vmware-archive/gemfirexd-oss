/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.catalog.AliasInfo
...
//Gemstone changes Begin
	public static final char ALIAS_TYPE_RESULT_PROCESSOR_AS_CHAR              = 'R';
	public static final String ALIAS_TYPE_RESULT_PROCESSOR_AS_STRING          = "R";
	
	public static final char ALIAS_NAME_SPACE_RESULT_PROCESSOR_AS_CHAR          = 'R';
	public static final String ALIAS_NAME_SPACE_RESULT_PROCESSOR_AS_STRING      = "R";
//Gemstone changes End	
	...
	//GemStone changes BEGIN
	/**
	 * Return the underlying schema name of a synonym.
	 * 
	 * @return sysnonymSchema
	 */
	public String getSynonymSchema();
	
	/**
	 * Return the underlying table name of a synonym.
	 * 
	 * @return sysnonymTable
	 */
