/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.execute.InsertVTIResultSet
...
// GemStone changes BEGIN
		  Object stmt = vtiRS.getVTIConstructor().invoke(activation);
		  if (stmt instanceof PreparedStatement) {
		    ps = (PreparedStatement)stmt;
		    rs = null;
		  }
		  else {
		    rs = (ResultSet)stmt;
