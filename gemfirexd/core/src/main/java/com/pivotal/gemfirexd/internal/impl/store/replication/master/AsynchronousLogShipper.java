/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.replication.master.AsynchronousLogShipper
...
public class AsynchronousLogShipper extends Thread implements
     ...
     * gemfirexd.replication.minLogShippingInterval
     * @see #MIN
     */
     ...
     * gemfirexd.replication.maxLogShippingInterval
     * @see #MAX
     */
     ...
     * the log file (typically gemfirexd.log)
     */
