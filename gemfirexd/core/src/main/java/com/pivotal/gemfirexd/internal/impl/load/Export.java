/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.load.Export
...
public class Export extends ExportAbstract{
	...
	/**
	 * EXPORT_TABLE  system Procedure from ij or from a Java application
    ...
    /**
     * EXPORT_TABLE_LOBS_TO_EXTFILE system procedure from ij 
	...
	/**
	 * EXPORT_QUERY  system Procedure from ij or from a Java application
    ...
    /**
     * EXPORT_QUERY_LOBS_TO_EXTFILE system Procedure from ij 
     * or from a Java application invokes this method to perform 
