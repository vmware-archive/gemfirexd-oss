/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.jdbc.EmbedClob
...
public final class EmbedClob extends ConnectionChild implements Clob,
...
// GemStone changes END
{
     ...
     */
    public /* GemStone changed to public: protected */ EmbedClob(EmbedConnection con, DataValueDescriptor dvd)
        throws StandardException
    {
        super(con);
        ...
        if (storeStream == null) {
            try {
// GemStone changes BEGIN
                clob = new TemporaryClob(Attribute.GFXD_DBNAME,
                /* (original code)
...
// GemStone changes BEGIN
    ...
    public Object replace() throws IOException {
      ...
      try {
        String s = getSubString(1L, (int)length());
        final int slen = s.length();
        if (slen > 0) {
          char[] chars = ResolverUtils.getInternalChars(s, slen);
