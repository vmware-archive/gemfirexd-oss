/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.services.stream.HeaderPrintWriter
...
// GemStone changes BEGIN
	...
	/**
	 * Return the severity level beyond which exceptions will be printed
	 * to this logger.
	 */
	public int getLogSeverityLevel();

	/** Whether the stack trace of exception should be logged or not. */
