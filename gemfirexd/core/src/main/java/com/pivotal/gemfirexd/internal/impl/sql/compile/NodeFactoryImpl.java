/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.NodeFactoryImpl
...
public class NodeFactoryImpl extends NodeFactory implements ModuleControl, ModuleSupportable
{
			...
			throws StandardException
	{
		switch (nodeType)
		{
          ...
          case C_NodeTypes.JSON_CONSTANT_NODE:
...
//GemStone changes BEGIN
                  case C_NodeTypes.PARAMETERIZED_CONSTANT_NODE:
                        return C_NodeNames.PARAMETERIZED_CONSTANT_NODE_NAME;		  			  	
//GemStone changes END
		  ...
		  case C_NodeTypes.DISTINCT_NODE:
	          ...
	          case C_NodeTypes.NCJ_PULL_NODE:
                        return C_NodeNames.NCJ_PULL_NODE_NAME;
...
// GemStone changes BEGIN
          case C_NodeTypes.DISTRIBUTION_DEFINTION_NODE:
             return C_NodeNames.DISTRIBUTION_DEFINITION_NODE_NAME; 
          case C_NodeTypes.DISTRIBUTED_PROCEDURE_CALL_NODE:
            return C_NodeNames.DISTRIBUTED_PROCEDURE_CALL_NODE_NAME;
          case C_NodeTypes.PROCEDURE_PROCESSOR_NODE:
            return C_NodeNames.PROCEDURE_PROCESSOR_NODE_NAME;
          case C_NodeTypes.CREATE_DISK_STORE_NODE:
            return C_NodeNames.CREATE_DISKSTORE_NODE_NAME;
          case C_NodeTypes.DROP_DISK_STORE_NODE:
            return C_NodeNames.DROP_DISKSTORE_NODE_NAME;
          case C_NodeTypes.CREATE_HDFS_STORE_NODE:
              return C_NodeNames.CREATE_HDFSSTORE_NODE_NAME;
          case C_NodeTypes.DROP_HDFS_STORE_NODE:
              return C_NodeNames.DROP_HDFSSTORE_NODE_NAME;
          case C_NodeTypes.ALTER_HDFS_STORE_NODE:
            return C_NodeNames.ALTER_HDFSSTORE_NODE_NAME;
          case C_NodeTypes.CREATE_GATEWAY_SENDER_NODE:
            return C_NodeNames.CREATE_GATEWAY_SENDER_NODE_NAME;
          case C_NodeTypes.CREATE_ASYNC_EVENT_LISTENER_NODE:
            return C_NodeNames.CREATE_ASYNC_EVENT_LISTENER_NODE_NAME;
          case C_NodeTypes.CREATE_GATEWAY_RECEIVER_NODE:            
            return C_NodeNames.CREATE_GATEWAY_RECEIVER_NODE_NAME;
          case C_NodeTypes.DROP_GATEWAY_SENDER_NODE:
              return C_NodeNames.DROP_GATEWAY_SENDER_NODE_NAME;
          case C_NodeTypes.DROP_ASYNC_EVENT_LISTENER_NODE:
              return C_NodeNames.DROP_ASYNC_EVENT_LISTENER_NODE_NAME;
          case C_NodeTypes.DROP_GATEWAY_RECEIVER_NODE:
              return C_NodeNames.DROP_GATEWAY_RECEIVER_NODE_NAME;
          case C_NodeTypes.EXPLAIN_NODE:
            return C_NodeNames.EXPLAIN_NODE_NAME;
          case C_NodeTypes.OR_LIST_NODE:
            return C_NodeNames.OR_LIST_NODE_NAME;
// GemStone changes END            
		  // WARNING: WHEN ADDING NODE TYPES HERE, YOU MUST ALSO ADD
...
//Gemstone changes Begin
		if (aliasType != AliasInfo.ALIAS_TYPE_SYNONYM_AS_CHAR
		    ...
		    && aliasType != AliasInfo.ALIAS_TYPE_RESULT_PROCESSOR_AS_CHAR)
//Gemstone changes End		  
		{
        	int lastPeriod;
