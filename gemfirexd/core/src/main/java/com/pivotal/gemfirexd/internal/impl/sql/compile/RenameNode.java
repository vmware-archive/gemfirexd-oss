/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.RenameNode
...
// GemStone changes BEGIN
			        TableName old = (TableName)oldObjectName;
			  	this.init(old);	  
				this.oldObjectName = old.tableName;
				this.newObjectName = (String)newObjectName;
...
// GemStone changes BEGIN
			sd = getSchemaDescriptor(this.getSchemaNameIfExplicitlySet());
// GemStone changes END
