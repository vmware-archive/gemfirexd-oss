...
public abstract class RowLocationThinRegionEntry extends VMThinRegionEntry implements
RowLocation, Sizeable {
  protected RowLocationThinRegionEntry(RegionEntryContext context, Object value) {
    super(context, value);
  }
