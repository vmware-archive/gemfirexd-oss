/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.execute.TriggerEventActivator
...
class TriggerEventActivator
{
	 ...
	 * @param cleanupOnError 
	 *
	 * @exception StandardException on unexpected error
	 */
	void cleanup(final boolean cleanupOnError) throws StandardException
	{
		if (tec != null)
		{
			tec.cleanup(cleanupOnError);
		}
	}
}
