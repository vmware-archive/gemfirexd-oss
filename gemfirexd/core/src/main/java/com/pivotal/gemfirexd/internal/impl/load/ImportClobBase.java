/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.load.ImportClobBase
...
class ImportClobBase implements java.sql.Clob {
     ...
     */
    public ImportClobBase(ImportLobFile lobFile, long position, long length) 
        throws IOException 
	{
  ...
  // GemStone changes BEGIN
  // JDBC 4.0 methods so will compile with JDK 1.6 compiler
  public void free()
  throws SQLException {
