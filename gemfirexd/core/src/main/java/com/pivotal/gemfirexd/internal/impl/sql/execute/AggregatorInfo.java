/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.execute.AggregatorInfo
...
public class AggregatorInfo implements Formatable 
{
	...
	*/
	...
	boolean accumulateDistinctValues;
	boolean hasComplexExpression;
	 ...
	 * @param rd	the result description
         * @param accumulateDistinctValues 
         *              whether aggregate distinct values or not.  
         * @param hasComplexExpression 
         *              whether aggregate is on an expression or simple column.
	 *
	 */
	public AggregatorInfo
	(
	...
	)
	{
		...
		this.rd 			= rd;
		//GemStone changes BEGIN
		this.accumulateDistinctValues = accumulateDistinctValues;
	...
	public int getOutputColNum()
	{
        ...
        public void setOutputColNum(int col)
        {
                outputColumn = col;
        }
	/**
	...
	public String toString()
	{
		if (SanityManager.DEBUG)
		{
			return "AggregatorInfo = Name: "+ aggregateName +
				...
				"\n\tDistinct: " + isDistinct +
                                "\n\tAccumulateDistinctValues: " + accumulateDistinctValues +
				"\n" + rd;
		}
		else
		{
...
// GemStone changes BEGIN
        public AggregatorInfo getClone() {
          return new AggregatorInfo(
                            this.aggregateName,
                            this.aggregatorClassName,
                            this.inputColumn,  
                            this.outputColumn,
                            this.aggregatorColumn,
                            this.isDistinct,
                            this.rd,
                            this.accumulateDistinctValues, 
                            this.hasComplexExpression
                     );
        }
        
        public void setInputColNum(int col)
        {
                inputColumn = col;
        }
        
        public boolean isAccumulateDistinctValues() {
           return accumulateDistinctValues;  
        }
