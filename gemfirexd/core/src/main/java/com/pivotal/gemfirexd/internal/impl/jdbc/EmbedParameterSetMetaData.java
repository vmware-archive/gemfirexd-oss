/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.jdbc.EmbedParameterSetMetaData
 ...
 * @see com.pivotal.gemfirexd.internal.iapi.jdbc.EngineParameterMetaData
 * @see com.pivotal.gemfirexd.internal.iapi.jdbc.EnginePreparedStatement
 */
public class EmbedParameterSetMetaData implements EngineParameterMetaData
    ...
    */
    ...
    private void checkPosition(int parameterIndex) throws SQLException {
      ...
      // Dummy methods for JDBC 4.0 so will compile with JDK 1.6
