/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.store.raw.RawStoreFactory
...
public interface RawStoreFactory extends Corruptable {
	...
	*/
	...
	Equal to 'gemfirexd.storage.pageCacheSize'
	*/
	public static final String PAGE_CACHE_SIZE_PARAMETER = 
        "gemfirexd.storage.pageCacheSize";
	...
	*/
	...
	/** Property name for the number of open files to maintain associated with
        ...
        Equal to 'gemfirexd.storage.fileCacheSize'
	*/
	public static final String CONTAINER_CACHE_SIZE_PARAMETER = 
        "gemfirexd.storage.fileCacheSize";
	...
	*/
	public static final String PRE_ALLOCATE_PAGE = 
        "gemfirexd.storage.pagePerAllocate";
	...
	*/
    ...
    public static final String DB_ENCRYPTION_STATUS =
        "gemfirexd.storage.databaseEncryptionStatus";
    ...
    */
	...
	public static final String KEEP_TRANSACTION_LOG = 
        "gemfirexd.storage.keepTransactionLog";
	...
	public static final String PATCH_INITPAGE_RECOVER_ERROR = 
        "gemfirexd.storage.patchInitPageRecoverError";


	/** module name */
	public static final String MODULE = 
        "com.pivotal.gemfirexd.internal.iapi.store.raw.RawStoreFactory";
	...
	*/
	...
	/**
		...
		@see Transaction
		@see com.pivotal.gemfirexd.internal.iapi.services.context.Context
	...
	*/
	...
	/**
	  @see com.pivotal.gemfirexd.internal.iapi.store.access.AccessFactory#getTransactionInfo
	 */
	...
	*/
	...
	/**
		...
		@see com.pivotal.gemfirexd.internal.iapi.services.crypto.CipherProvider#encrypt
		@exception StandardException Standard Derby Error Policy
	 */
	...
	/**
		...
		@see com.pivotal.gemfirexd.internal.iapi.services.crypto.CipherProvider#decrypt
		@exception StandardException Standard Derby Error Policy
	 */
