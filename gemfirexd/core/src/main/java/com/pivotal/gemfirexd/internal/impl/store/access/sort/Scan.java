/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.sort.Scan
...
// GemStone changes BEGIN
  public int fetchNextGroup(ExecRow[] row_array, RowLocation[] rowloc_array,
      Object[] indexKeys, int[] nodeVersions, int[] scanKeyGroupID,
      LocalRegion[] dataRegions) throws StandardException {
  ...
  public void fetchWithoutQualify(ExecRow destRow) throws StandardException {
    fetchWithoutQualify(destRow.getRowArray());
  }
