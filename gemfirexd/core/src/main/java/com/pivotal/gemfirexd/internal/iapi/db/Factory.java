/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.db.Factory
 ...
 *		CALL com.pivotal.gemfirexd.internal.iapi.db.Factory::
 *				getDatabaseOfConnection().checkpoint();
 *  </PRE>
 *  <LI>
 *  In a server-side JDBC method.
 *  <PRE>
 *		import com.pivotal.gemfirexd.internal.iapi.db.*;
 *
 *		...
 *
 *	// checkpoint the database
...
public class Factory
{
	...
	**/
	public static com.pivotal.gemfirexd.internal.database.Database getDatabaseOfConnection()
		throws SQLException
	{
