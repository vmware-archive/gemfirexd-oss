/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.raw.data.D_DiagnosticUtil
...
public class D_DiagnosticUtil
{
     ...
     *
       ...
       EXTERNAL NAME
       'com.pivotal.gemfirexd.internal.impl.store.raw.data.D_DiagnosticUtil.diag_conglomid_print'
     ...
     *     diag_conglomid('msgdb', 19);
       ...
       RETURNS VARCHAR(32000) RETURNS NULL ON NULL INPUT
       EXTERNAL NAME
       'com.pivotal.gemfirexd.internal.impl.store.raw.data.D_DiagnosticUtil.diag_conglomid'
       LANGUAGE JAVA PARAMETER STYLE JAVA;
