...
public abstract class RowLocationStatsDiskLRURegionEntry extends
    VMStatsDiskLRURegionEntry implements RowLocation, Sizeable {
  public RowLocationStatsDiskLRURegionEntry(RegionEntryContext context,
      Object value) {
    super(context, value);
  }
