/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.catalog.DD_Version
		...
		*/
        ...
        if (fromMajorVersionNumber == DataDictionary.DD_VERSION_CS_10_0)
        {
            ...
            bootingDictionary.create_10_1_system_procedures(
                tc, 
                newlyCreatedRoutines, bootingDictionary.getSystemUtilSchemaDescriptor().getUUID());
        }
...
// GemStone change BEGIN
		while ( heapScan.fetchNext(heapRow) )
        {
 			heapLocation = heapScan.fetchLocation( heapLocation );
// GemStone change END
