/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.types.WorkHorseForCollatorDatatypes
...
final class WorkHorseForCollatorDatatypes  
{
								...
								throws StandardException
	{
		...
		likeResult = Like.like(stringData.getCharArray(true), 
				stringData.getLength(), 
				((SQLChar)pattern).getCharArray(true), 
				pattern.getLength(), 
				null, 
				0,
			...
			DataValueDescriptor escape)	throws StandardException
	{
		...
		likeResult = Like.like(stringData.getCharArray(true), 
				...
				((SQLChar)pattern).getCharArray(true), 
				pattern.getLength(), 
				((SQLChar)escape).getCharArray(true), 
				escape.getLength(),
				collatorForCharacterDatatypes);
