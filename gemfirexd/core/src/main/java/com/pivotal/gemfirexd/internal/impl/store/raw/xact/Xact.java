/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.raw.xact.Xact
...
//     }
	...
	*/
	public long addAndLoadStreamContainer(long segmentId, Properties tableProperties, RowSource rowSource, ByteBuffer rwBuffer)
		throws StandardException {
		...
		if (SanityManager.DEBUG) {
			...
			if (SanityManager.TraceMemoryLeak) {
				...
				if (savePoints.size() > 20)
					System.out.println("TraceMemoryLeak:Xact:savepoints " + savePoints.size());
			}
		}
...
// GemStone changes BEGIN
	...
	*/
	 ...
	 **/
// GemStone changes BEGIN
	public Object createXATransactionFromLocalTransaction(
	/* (original derby code) public void createXATransactionFromLocalTransaction( */
