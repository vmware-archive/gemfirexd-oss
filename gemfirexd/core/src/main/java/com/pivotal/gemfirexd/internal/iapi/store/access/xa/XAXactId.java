/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.store.access.xa.XAXactId
...
package com.pivotal.gemfirexd.internal.iapi.store.access.xa;
...
public class XAXactId extends GlobalXact implements Xid
{
	...
	// 1+2+1+2+1+9+1+1+1
		...
		StringBuilder hexdump = new StringBuilder(maxLength);
		hexdump.append(COLON).
			...
			append(com.pivotal.gemfirexd.internal.iapi.util.StringUtil.toHexString(global_id, 0, global_id.length)).append(COLON).
			append(com.pivotal.gemfirexd.internal.iapi.util.StringUtil.toHexString(branch_id, 0, branch_id.length)).append(COLON);
	...
	// n...n
		...
		global_id = com.pivotal.gemfirexd.internal.iapi.util.StringUtil.fromHexString(xactIdString, start, (end-start));
	...
	// m...m
		...
		branch_id = com.pivotal.gemfirexd.internal.iapi.util.StringUtil.fromHexString(xactIdString, start, (end-start));
