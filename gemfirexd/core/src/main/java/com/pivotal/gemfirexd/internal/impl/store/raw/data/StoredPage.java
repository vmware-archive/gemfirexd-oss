/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.raw.data.StoredPage
...
import com.pivotal.gemfirexd.internal.impl.store.raw.data.PageVersion;
import com.pivotal.gemfirexd.internal.impl.store.raw.data.RawField;
...
import com.pivotal.gemfirexd.internal.impl.store.raw.data.StoredFieldHeader;
...
{ 
	...
	*/
     ...
     *
     * @see com.pivotal.gemfirexd.internal.impl.store.raw.data.BasePage#releaseExclusive
     *
     **/
	...
	*/
		...
		throws StandardException 
    {
		...
		int columnListSize = columnList.getLength();
...
*/
	...
	*/
    ...
    {
		return com.pivotal.gemfirexd.internal.iapi.util.StringUtil.hexDump(data);
    }
