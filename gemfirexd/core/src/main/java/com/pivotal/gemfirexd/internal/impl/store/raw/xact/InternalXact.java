/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.raw.xact.InternalXact
...
public class InternalXact extends Xact  
{
	...
	*/
	/**
		...
		@see com.pivotal.gemfirexd.internal.iapi.store.raw.xact.RawTransaction#recoveryRollbackFirst
	*/
	@edu.umd.cs.findbugs.annotations.SuppressWarnings(value="NM_VERY_CONFUSING")
