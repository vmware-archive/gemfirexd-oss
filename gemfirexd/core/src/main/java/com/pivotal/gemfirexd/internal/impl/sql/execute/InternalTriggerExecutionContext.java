/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.execute.InternalTriggerExecutionContext
...
public class InternalTriggerExecutionContext implements TriggerExecutionContext, ExecutionStmtValidator
{
	...
	*/
	...
	void clearTrigger() throws StandardException
	{
		...
		{
			afterResultSet.close(false);
			afterResultSet = null;
		}
		if (beforeResultSet != null)
		{
			beforeResultSet.close(false);
	 ...
	 */
	protected void cleanup(final boolean cleanupOnError)
		throws StandardException
	{
		...
		*/	
		if (afterResultSet != null)
		{
			afterResultSet.close(cleanupOnError);
			afterResultSet = null;
		}
		if (beforeResultSet != null)
		{
			beforeResultSet.close(cleanupOnError);
			beforeResultSet = null;
		}
