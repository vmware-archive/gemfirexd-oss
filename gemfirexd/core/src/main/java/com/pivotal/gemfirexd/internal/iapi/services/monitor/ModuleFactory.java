/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.services.monitor.ModuleFactory
...
public interface ModuleFactory
{
	...
	*/
     ...
     * to the set of properties in the file gemfirexd.properties.
     */
	...
	*/
	...
	/**
		Start all services identified by gemfirexd.service.*
	...
	*/
	 ...
	 */
	public com.pivotal.gemfirexd.internal.iapi.services.uuid.UUIDFactory getUUIDFactory();
	 ...
	 */
    public com.pivotal.gemfirexd.internal.iapi.services.timer.TimerFactory getTimerFactory();

// GemStone changes BEGIN
    public boolean inShutdown();

    public String setJVMProperty(String key, String value);

    public String clearJVMProperty(String key);
