/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.HashJoinStrategy
...
// GemStone changes BEGIN
		// never try hash join for indexes
		cd = innerTable.getCurrentAccessPath()
		    .getConglomerateDescriptor();
		if (cd != null && cd.isIndex()) {
		  optimizer.trace(Optimizer.HJ_SKIP_INDEX, 0, 0, 0.0, null);
		  return false;
		}
