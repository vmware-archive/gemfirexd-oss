/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.services.io.ArrayInputStream
...
public final class ArrayInputStream extends InputStream implements LimitObjectInput {
	...
	public ArrayInputStream(byte[] data) {
		super();
		setData(data);
		oi = new com.pivotal.gemfirexd.internal.iapi.services.io.FormatIdInputStream(this);
	}
