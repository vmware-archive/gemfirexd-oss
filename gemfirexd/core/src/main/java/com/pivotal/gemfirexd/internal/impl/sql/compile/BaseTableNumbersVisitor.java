/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.BaseTableNumbersVisitor
 ...
 * table.
 */
public class BaseTableNumbersVisitor extends VisitorAdaptor
{
	...
	/**
	 * @see com.pivotal.gemfirexd.internal.iapi.sql.compile.Visitor#visit
	 */
	...
	/**
	 * @see com.pivotal.gemfirexd.internal.iapi.sql.compile.Visitor#skipChildren
	 */
	...
	/**
	 * @see com.pivotal.gemfirexd.internal.iapi.sql.compile.Visitor#stopTraversal
	 */
...
// GemStone changes BEGIN
	...
	static final class TableNumbersState {
	  ...
	  TableNumbersState(final JBitSet tableMap, final int columnNumber) {
	    this.tableMap = tableMap;
	...
	public Object getAndResetDeltaState() {
	  if (this.origTableMap != null) {
	    final TableNumbersState deltaState = new TableNumbersState(
	        this.tableMap, this.columnNumber);
	...
	public Visitable mergeDeltaState(final Object delta,
	  ...
	  final TableNumbersState deltaState = (TableNumbersState)delta;
