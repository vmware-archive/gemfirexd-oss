/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.catalog.types.BaseTypeIdImpl
    ...
    ********************************************************/
    ...
    public int getTypeFormatId()
    {
        ...
        else
        {
            ...
            else if ( "JSON".equals( unqualifiedName ) ) { return StoredFormatIds.JSON_TYPE_ID_IMPL; }
    ...
    private void setTypeIdSpecificInstanceVariables()
    {
        switch (getTypeFormatId())
        {
          ...
          case StoredFormatIds.JSON_TYPE_ID_IMPL:
            schemaName = null;
            unqualifiedName = TypeId.JSON_NAME;
            JDBCTypeId = JDBC40Translation.JSON;
//            JDBCTypeId = Types.OTHER;
            break;
