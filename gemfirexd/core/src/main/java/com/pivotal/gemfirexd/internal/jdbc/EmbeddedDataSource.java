/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.jdbc.EmbeddedDataSource
...
/** 
  ...
  <LI><B><code>createDatabase</code></B> (String): <I>Optional</I>
	...
	<PRE> 
	*
	* import com.pivotal.gemfirexd.internal.jdbc.*;
	*
				...
				javax.sql.DataSource
{
  ...
  //xaJNDI test so we can compare the 2 data sources.
    ...
    return false;
        ...
        public int hashCode() {
          ...
          if ((s = dataSourceName) != null) {
            h = (31 * h) + s.hashCode();
          }
          if ((s = createDatabase) != null) {
            h = (31 * h) + s.hashCode();
          }
          if ((s = shutdownDatabase) != null) {
            h = (31 * h) + s.hashCode();
          }
          if ((s = connectionAttributes) != null) {
            h = (31 * h) + s.hashCode();
          }
          return h;
        }
  ...
  // Dummy methods for JDBC 4.0 so will compile with JDK 1.6 compiler
