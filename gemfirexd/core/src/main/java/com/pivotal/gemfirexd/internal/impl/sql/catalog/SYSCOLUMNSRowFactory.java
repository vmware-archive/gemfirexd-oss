/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.catalog.SYSCOLUMNSRowFactory
...
// GemStone changes BEGIN
			...
			colID = Integer.valueOf(column.getPosition());
			/* (original code)
...
// GemStone changes END
		...
		row.setColumn(SYSCOLUMNS_IS_GENERATED_BY_DEFAULT, new SQLBoolean(isGeneratedByDefault));
					...
					throws StandardException
	{
		...
		*/
		...
		isGeneratedByDefault = row.getColumn(SYSCOLUMNS_IS_GENERATED_BY_DEFAULT).getBoolean();
		...
		colDesc = new ColumnDescriptor(columnName, columnNumber,
                            ...
                            autoincValue,isGeneratedByDefault);
		return colDesc;
	}
        ...
        throws StandardException
	{
        ...
        return new SystemColumn[] {
            ...
            SystemColumnImpl.getJavaColumn("COLUMNDATATYPE",
                "com.pivotal.gemfirexd.internal.catalog.TypeDescriptor", false),
            ...
            SystemColumnImpl.getColumn("IS_GENERATED_BY_DEFAULT", Types.BOOLEAN, true),
