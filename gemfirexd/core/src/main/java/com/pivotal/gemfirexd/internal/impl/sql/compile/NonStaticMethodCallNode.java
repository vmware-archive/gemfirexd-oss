/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.NonStaticMethodCallNode
...
//            System.out.println("\ttypeid = "+((ValueNode)receiver).getTypeServices().getTypeId());
			...
			throws StandardException
	{
		...
		if (receiver instanceof SQLToJavaValueNode)
		{
			...
			if (SQLValue.requiresTypeFromContext() && !SQLValue.isParameterizedConstantNode())
			{
	...
	protected int getOrderableVariantType() throws StandardException
	{
		...
		if (receiverVariant > Qualifier.SCAN_INVARIANT) {
			...
			if (receiver.getJavaTypeName().equals("com.pivotal.gemfirexd.internal.iapi.db.TriggerExecutionContext"))
