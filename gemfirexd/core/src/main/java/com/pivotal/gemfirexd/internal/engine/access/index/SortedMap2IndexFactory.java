...
/**
 * Factory for creating in-memory secondary indexes based on the
 * ConcurrentSkipListMap.
 * 
 * @author yjing
 */
public class SortedMap2IndexFactory extends MemConglomerateFactory {

  private static final String FORMATUUIDSTRING =
    "C6CEEEF1-DAD3-11d0-BB01-0060973F0942";

  public SortedMap2IndexFactory() {
    super(FORMATUUIDSTRING, GfxdConstants.LOCAL_SORTEDMAP_INDEX_TYPE, "BTREE",
        ConglomerateFactory.LOCAL_SORTEDMAP_FACTORY_ID);
  }
