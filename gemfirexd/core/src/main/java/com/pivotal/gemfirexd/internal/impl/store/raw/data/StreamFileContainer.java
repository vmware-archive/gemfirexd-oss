/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.raw.data.StreamFileContainer
...
import com.pivotal.gemfirexd.internal.impl.store.raw.data.DecryptInputStream;
...
public class StreamFileContainer implements TypedFormat, PrivilegedExceptionAction<Object>
{
     ...
     *     prop.put("gemfirexd.storage.streamFileBufferSize", "");
     *     cc.getContainerProperties(prop);
     *
     *     System.out.println(
     *         "stream table's buffer size = " + 
     *         prop.getProperty("gemfirexd.storage.streamFileBufferSize");
     * }
     *
        ...
        throws StandardException 
    {
		...
		try 
        {
			...
			Object[] row = rowSource.getNextRowFromRowSource().getRowArray();
