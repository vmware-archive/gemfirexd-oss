/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.TableOperatorNode
  ...
  public boolean needsSpecialRCLBinding()
	...
	@Override
        public void eliminateUnUsedColumns(ResultColumnList parentResultColumn,
          ...
          resultColumns = resultColumns.eliminateUnUsedColumns(parentResultColumn,
              finder);
          leftResultSet.eliminateUnUsedColumns(resultColumns, finder);
          rightResultSet.eliminateUnUsedColumns(resultColumns, finder);
        }

	@Override
        protected FromBaseTable ncjGetOnlyOneFBTNode() throws StandardException {
	  // Should return null if more than one child
          return null;
        }
	// GemStone changes END
}
