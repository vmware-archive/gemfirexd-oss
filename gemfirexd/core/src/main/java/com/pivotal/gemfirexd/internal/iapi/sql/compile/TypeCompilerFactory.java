/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.sql.compile.TypeCompilerFactory
...
{
	public static final String MODULE = "com.pivotal.gemfirexd.internal.iapi.sql.compile.TypeCompilerFactory";
