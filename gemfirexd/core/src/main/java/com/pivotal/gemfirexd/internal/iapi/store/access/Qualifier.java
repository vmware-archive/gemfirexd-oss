/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.store.access.Qualifier
...
public interface Qualifier
{
	...
	/* Return the name of the column, used during EXPLAIN
	 * to print out the column name of this qualifier in the scan properties
	 */
	...
	void reinitialize();
// GemStone changes BEGIN
  void alignOrderableCache(com.pivotal.gemfirexd.internal.iapi.sql.dictionary
      .ColumnDescriptor columnDescriptor, com.pivotal.gemfirexd.internal.engine.store.GemFireContainer container) throws StandardException;
// GemStone changes END
}
