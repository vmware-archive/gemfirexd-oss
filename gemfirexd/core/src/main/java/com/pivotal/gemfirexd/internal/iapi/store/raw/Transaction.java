/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.store.raw.Transaction
...
public interface Transaction {
	...
	*/
	public long addAndLoadStreamContainer(
			long segmentId, Properties tableProperties, RowSource rowSource, ByteBuffer rwBuffer)
		throws StandardException;
...
// GemStone changes BEGIN
	...
	/* (original derby code) void createXATransactionFromLocalTransaction( */
// GemStone changes END
    int                     format_id,
    byte[]                  global_id,
    byte[]                  branch_id)
