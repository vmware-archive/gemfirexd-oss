/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.sql.compile.Optimizable
...
public interface Optimizable {
	...
	/*void pullOptPredicates(OptimizablePredicateList optimizablePredicates)
			throws StandardException;*/
	void pullOptPredicates(OptimizablePredicateList optimizablePredicates, JBitSet outerTables)
            throws StandardException;
	...
	/**
	 * 
	 * Should the scan opening be deferred to the first invocation of getNextRowCore()
	 * 
	 * @param delay true if delaying of scan opening is needed
	 */
	void delayScanOpening(boolean delay);
	
	void getTablesReferencedByRestrictionLists(JBitSet referencedTables);

	/**
	 * The number of partitioning columns of this optimizable.
	 * 
	 * @return -1 for a non-partitioned region.
	 */
	int getNumPartitioningCols() throws StandardException;

	/**
	 * Returns the underlying table optimizable.
	 * @return
	 * @throws StandardException
	 */
	Optimizable getBaseTable() throws StandardException;
	
        /**
         * Checks whether colocation is defined with <code>other</code> optimizable.
         * 
         * @param other
         * @return true if colocation was defined during table creation.
         * @throws StandardException 
         */
	boolean isColocatedWith(Optimizable other) throws StandardException;

	/**
	 * To avoid elaborate Optimizable description.
