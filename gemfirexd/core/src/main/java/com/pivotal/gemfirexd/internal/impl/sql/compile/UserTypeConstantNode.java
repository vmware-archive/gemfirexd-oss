/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.UserTypeConstantNode
...
//         }
	...
	private boolean isInfinityVal = false;
	
	public void setInfinity(boolean isInfinity) {
	  this.isInfinityVal = isInfinity;  
	}
	
	public boolean isInfinityValue() {
	  return this.isInfinityVal;
	}
