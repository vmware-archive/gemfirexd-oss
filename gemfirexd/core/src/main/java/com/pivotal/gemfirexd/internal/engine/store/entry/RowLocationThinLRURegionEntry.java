...
public abstract class RowLocationThinLRURegionEntry extends
    VMThinLRURegionEntry implements RowLocation, Sizeable {

  public RowLocationThinLRURegionEntry(RegionEntryContext context, Object value) {
    super(context, value);
  }
