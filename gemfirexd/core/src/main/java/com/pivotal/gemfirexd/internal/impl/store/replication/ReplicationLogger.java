/*
   ...
   Derby - Class
   com.pivotal.gemfirexd.internal.impl.store.replication.ReplicationLogger
...
public class ReplicationLogger {
    ...
    /** Whether or not to print log messages to gemfirexd.log. Defaults to
     * true, but can be set to false with derby property
     * "gemfirexd.replication.verbose=false".
     */
     ...
     * log (usually gemfirexd.log) provided that verbose
    ...
    /**
     * Print a text to the log (usually gemfirexd.log), provided that
     * verbose is true.
