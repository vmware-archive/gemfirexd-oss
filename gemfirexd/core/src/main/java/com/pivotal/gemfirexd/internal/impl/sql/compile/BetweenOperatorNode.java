/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.BetweenOperatorNode
...
//        GemStone changes BEGIN
            ...
            public QueryInfo computeQueryInfo(QueryInfoContext qic) throws StandardException {
              //return new ComparisonQueryInfo(this.leftOperand.computeQueryInfo(qic),this.rightOperandList.computeQueryInfo(qic),-1);
//            Since Between  Operator is not going to contribute to nodes prunning at this point,
