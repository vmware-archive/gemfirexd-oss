/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.heap.HeapScan
...
import com.pivotal.gemfirexd.internal.impl.store.access.conglomerate.GenericScanController;
    ...
    extends GenericScanController implements ScanManager
{
	...
	**/
    ...
    /**
     * @see com.pivotal.gemfirexd.internal.iapi.store.access.ScanController#positionAtRowLocation
     */
...
// GemStone changes END
  ...
  // Gemstone changes BEGIN
  public int fetchNextGroup(ExecRow[] row_array,
                            RowLocation[] rowloc_array,
                            Object[] indexKeys,
                            int[] nodeVersions, int[] scanKeyGroupID,
                            LocalRegion[] dataRegions)
  throws StandardException {
