/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.execute.TemporaryRowHolderImpl
 ...
 */
//GemStone changes BEGIN
//made public for GemFireInsertResultSet
public
...
// GemStone changes END
	...
	{
		this(activation, properties, DEFAULT_OVERFLOWTHRESHOLD, isUniqueStream,
			 false);
	}
	...
	private ExecRow cloneRow(ExecRow inputRow)
	{
		...
		ValueRow cloned = ((ValueRow) inputRow).cloneMe();
		...
		throws StandardException
	{
      ...
      // GemStone changes END
		...
		//Gemstone change BEGINS
			destRowLocation = cc.insertAndFetchLocation(inputRow.getRowArray(), destRowLocation);
			//Gemstone change End
	...
	private boolean isRowAlreadyExist(ExecRow inputRow) throws  StandardException
	{
		...
		rlColumn = inputRow.getLastColumn();
