/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.jdbc.StoreStreamClob
...
final class StoreStreamClob
     ...
     *      {@link com.pivotal.gemfirexd.internal.iapi.services.io.FormatIdInputStream} with
     *      an ${link com.pivotal.gemfirexd.internal.impl.store.raw.data.OverflowInputStream}
     ...
     * @see com.pivotal.gemfirexd.internal.iapi.services.io.FormatIdInputStream
     * @see com.pivotal.gemfirexd.internal.impl.store.raw.data.OverflowInputStream
     */
    ...
    public long getByteLength()
        ...
        long byteLength = 0;
        try {
            this.conChild.setupContextStack(false);
    ...
    private static SQLException noStateChangeLOB(Throwable t) {
        ...
        return com.pivotal.gemfirexd.internal.impl.jdbc.EmbedResultSet.noStateChangeException(t,
