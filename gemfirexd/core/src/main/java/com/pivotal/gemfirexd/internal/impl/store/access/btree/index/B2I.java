/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.btree.index.B2I
...
public class B2I extends BTree
{
  ...
  **/
  ...
  FormatableBitSet                         scanColumnList,
    ...
    int                             stopSearchOperator,
    StaticCompiledOpenConglomInfo   static_info,
    DynamicCompiledOpenConglomInfo  dynamic_info, FunctionContext fc)
      throws StandardException
  {
    throw new AssertionError("Open scan with local data set can never be called" +
    		"on B2I");
