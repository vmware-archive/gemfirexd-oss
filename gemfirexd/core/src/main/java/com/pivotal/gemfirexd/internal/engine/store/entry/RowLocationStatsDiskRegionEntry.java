...
public abstract class RowLocationStatsDiskRegionEntry extends
    VMStatsDiskRegionEntry implements RowLocation, Sizeable {
  public RowLocationStatsDiskRegionEntry(RegionEntryContext context,
      Object value) {
    super(context, value);
  }
