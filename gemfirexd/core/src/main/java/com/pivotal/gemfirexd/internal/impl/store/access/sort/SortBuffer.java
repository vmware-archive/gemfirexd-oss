/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.sort.SortBuffer
...
// GemStone changes BEGIN
                // never exit in GemFireXD
                SanityManager.THROWASSERT("ERROR: " + error);
                /* (original code)
                System.exit(1);
                */
