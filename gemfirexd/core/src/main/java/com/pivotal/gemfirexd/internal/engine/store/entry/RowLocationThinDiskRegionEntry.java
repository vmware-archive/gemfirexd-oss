...
public abstract class RowLocationThinDiskRegionEntry extends
    VMThinDiskRegionEntry implements RowLocation, Sizeable {

  public RowLocationThinDiskRegionEntry(RegionEntryContext context, Object value) {
    super(context, value);
  }
