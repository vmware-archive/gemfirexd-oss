/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.FromSubquery
...
// GemStone changes BEGIN
                ...
                accept(viewHasGroupBy);
                if (viewHasGroupBy.isThrowUnsupportedException()) {
                  throw StandardException.newException(SQLState.NOT_IMPLEMENTED,
                      " View or FROM-subquery with GroupBy and Partitioned Table");
                }
// GemStone changes END
  ...
  public void eliminateUnUsedColumns(ResultColumnList parentResultColumn, CollectAndEliminateColumnsVisitor finder)
      throws StandardException {
       subquery.eliminateUnUsedColumns(parentResultColumn, finder);
