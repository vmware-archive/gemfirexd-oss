/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.sort.UniqueWithDuplicateNullsMergeSort
...
final class UniqueWithDuplicateNullsMergeSort extends MergeSort {
     ...
     */
    protected int compare(ExecRow r1, ExecRow r2)
    throws StandardException {
        ...
        for (int i = 0; i < colsToCompare; i++) {
            ...
            if ((r = r1.compare(r2, colid, nullsLow))
            != 0) {
                ...
                if (r1.isNull(colid) == RowFormatter.OFFSET_AND_WIDTH_IS_NULL)
                    nonull = false;
            }
        }
