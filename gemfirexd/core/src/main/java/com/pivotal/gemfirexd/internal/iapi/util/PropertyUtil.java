/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.util.PropertyUtil
...
// GemStone changes BEGIN
			// normalize user names (#48377)
			if (tmpKey.startsWith(Property.USER_PROPERTY_PREFIX)
			    //SQLF:BC
			    || tmpKey.startsWith(Property.SQLF_USER_PROPERTY_PREFIX)
			    ) {
			  try {
			    tmpKey = IdUtil.getDBUserId(tmpKey, true);
