/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.types.DataValueFactory
...
// GemStone changes Begin
         final public static RowLocation  DUMMY = (RowLocation)VMLocalRowLocationThinRegionEntryHeap
             .getEntryFactory().createEntry(null, "dummy", "dummy");
// GemStone changes END
        ...
        StringDataValue getJSONDataValue(String value, StringDataValue previous) throws StandardException;
        StringDataValue getJSONDataValue(String value, StringDataValue previous,
            int collationType) throws StandardException;
    ...
    // ------ CHAR
        ...
        StringDataValue         getNullJSON(StringDataValue dataValue);
        StringDataValue         getNullJSON(StringDataValue dataValue,
            int collationType)
        throws StandardException;
        ...
        //GemStone changes BEGIN
        /**
         * Get a SQL DVDSet with a SQL null value. If the supplied value
         * is null then get a new value, otherwise set it to null and return 
         * that value.
         *
         * @exception StandardException         Thrown on error
         */
        UserDataValue getNullDVDSet(UserDataValue dataValue);
        //GemStone changes END
}
