/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.FKConstraintDefinitionNode
...
public final class FKConstraintDefinitionNode extends ConstraintDefinitionNode
{
	...
	{
//Gemstone changes Begin
		if(this.refActionDeleteRule!=StatementType.RA_NOACTION 
			&& this.refActionDeleteRule!=StatementType.RA_RESTRICT) {
			throw StandardException.newException(SQLState.UNSUPPORTED_DELETE_RULE);
		}
//Gemstone changes End		
