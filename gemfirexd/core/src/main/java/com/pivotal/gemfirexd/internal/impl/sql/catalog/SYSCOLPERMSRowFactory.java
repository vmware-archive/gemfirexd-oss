/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.catalog.SYSCOLPERMSRowFactory
...
import com.pivotal.gemfirexd.internal.catalog.Statistics;
...
class SYSCOLPERMSRowFactory extends PermissionsCatalogRowFactory
{
    ...
    /* private GemStone change */ static final int GRANTEE_COL_NUM = 2;
        ...
        throws StandardException
    {
        return new SystemColumn[] {
           ...
           SystemColumnImpl.getJavaColumn("COLUMNS",
                   "com.pivotal.gemfirexd.internal.iapi.services.io.FormatableBitSet", false)    
        };
    }
