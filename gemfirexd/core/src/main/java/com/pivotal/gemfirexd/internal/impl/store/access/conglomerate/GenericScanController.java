/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.conglomerate.GenericScanController
...
// GemStone changes END
        ...
        throws StandardException
    {
        ...
        if (SanityManager.DEBUG)
        {
            if (init_scanColumnList != null)
            {
				...
				// length.
				required_cols.grow(init_scanColumnList.getLength());
    ...
    **/
    ...
    /**
	@see com.pivotal.gemfirexd.internal.iapi.store.access.ScanController#delete
	**/
    ...
    **/
    ...
    /**
	@see com.pivotal.gemfirexd.internal.iapi.store.access.ScanController#replace
	**/
	...
	**/
    ...
    /**
     * @see com.pivotal.gemfirexd.internal.iapi.store.access.ScanController#isHeldAfterCommit
     */
...
// GemStone change BEGIN
	...
	@see com.pivotal.gemfirexd.internal.iapi.store.access.ScanController#fetchLocation

	@exception  StandardException  Standard exception policy.
	**/
	public RowLocation fetchLocation(RowLocation templateLocation)
		throws StandardException
	{
        throw StandardException.newException(
                SQLState.BTREE_UNIMPLEMENTED_FEATURE);
	...
	public void upgradeCurrentRowLocationLockToWrite()
	    throws StandardException {
	  throw StandardException.newException(
	      SQLState.BTREE_UNIMPLEMENTED_FEATURE);
	}

	public void releaseCurrentRowLocationReadLock()
	    throws StandardException {
	  throw StandardException.newException(
	      SQLState.BTREE_UNIMPLEMENTED_FEATURE);
	}
