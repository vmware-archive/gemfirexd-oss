/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.catalog.SYSTRIGGERSRowFactory
...
public class SYSTRIGGERSRowFactory extends CatalogRowFactory
{
	...
	) throws StandardException
	{
		...
		// 12th column is REFERENCEDCOLUMNS user type com.pivotal.gemfirexd.internal.catalog.ReferencedColumns
        ...
        throws StandardException
	{
        return new SystemColumn[] {
            ...
            SystemColumnImpl.getJavaColumn("REFERENCEDCOLUMNS",
                    "com.pivotal.gemfirexd.internal.catalog.ReferencedColumns", true),
            SystemColumnImpl.getColumn("TRIGGERDEFINITION",
                    Types.LONGVARCHAR, true, TypeId.LONGVARCHAR_MAXWIDTH),
