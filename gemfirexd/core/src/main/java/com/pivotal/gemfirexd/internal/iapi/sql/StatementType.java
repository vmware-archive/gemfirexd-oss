/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.sql.StatementType
...
public interface StatementType
{
    ...
    public static final int DISTRIBUTED_PROCEDURE_CALL = -1;
    public static final int CALL_STATEMENT = -2;
