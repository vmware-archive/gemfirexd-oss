/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.sort.MergeSortInfo
...
/**
  ...
  @see com.pivotal.gemfirexd.internal.iapi.store.access.SortController#getSortInfo()
...
// GemStone changes BEGIN
    public MergeSortInfo(String sortType, int numRowsInput, int numRowsOutput,
        int numMergeRuns, TIntArrayList mergeRunsSize, int numComparisons) {
        // copy perfomance state out of sort, to get a fixed set of stats
        stat_sortType               = sortType;
        // stat_estimMemUsed           = sort.estimatedMemoryUsed;
        stat_numRowsInput           = numRowsInput;
        stat_numRowsOutput          = numRowsOutput;
        stat_numMergeRuns           = numMergeRuns;
        stat_mergeRunsSize          = mergeRunsSize;
        stat_numComparisons         = numComparisons;
    }
...
// GemStone changes END
		...
		throws StandardException
    {
        ...
        prop.put(MessageService.getTextMessage(
            SQLState.STORE_RTS_NUM_ROW_COMPARISONS),
            Integer.toString(stat_numComparisons));
        return(prop);
    }
}
