/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.IntersectNode
...
// GemStone changes BEGIN
        isOperatorDistinct = this.all;
    }

    /**
     * isOperatorDistinct
     * Record original state of "all" 
     */
    private boolean isOperatorDistinct;

    public String getOperatorNameWithDistinct()
    {
      if (isOperatorDistinct) {
        return getOperatorName() + "ALL";
      } else {
...
// GemStone changes END
								...
								throws StandardException
	{
        ...
        if( orderByList != null)
        {
            ...
            for( int i = 0; i < orderByListSize; i++)
            {
                ...
                OrderedColumn orderByColumn = orderByList.getOrderedColumn(i);
    ...
    /**
     * @see com.pivotal.gemfirexd.internal.iapi.sql.compile.Optimizable#estimateCost
     */
