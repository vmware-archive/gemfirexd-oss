/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.services.uuid.UUIDFactory
...
public interface UUIDFactory 
{
	...
	**/
 	...
 	//GemStone changes BEGIN
        /**
         * Create a new UUID based on distributed statementID. The resulting object is guaranteed to be unique
         ...
         * @author soubhikc
         **/
        public UUID createUUID(long baseid, int sequence);
