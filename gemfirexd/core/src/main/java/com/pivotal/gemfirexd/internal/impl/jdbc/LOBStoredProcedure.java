/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.jdbc.LOBStoredProcedure
...
public class LOBStoredProcedure {
    ...
    public static int CLOBCREATELOCATOR() throws SQLException {
        ...
        EngineLOB clob = (EngineLOB)conn.createClob();
...
// GemStone changes END
    ...
    public static int BLOBCREATELOCATOR() throws SQLException {
        final EmbedConnection conn = getEmbedConnection();
        EngineLOB blob = (EngineLOB)conn.createBlob();
