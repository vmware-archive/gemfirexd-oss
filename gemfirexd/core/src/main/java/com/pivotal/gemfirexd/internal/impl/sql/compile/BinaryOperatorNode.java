/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.BinaryOperatorNode
...
//      GemStone changes END
			...
			throws StandardException
	{
		...
		if (leftOperand.requiresTypeFromContext())
		{
			...
			*/
			if ((rightOperand.requiresTypeFromContext() && !rightOperand.isParameterizedConstantNode() 
			    &&   !leftOperand.isParameterizedConstantNode()  ) )
			{
...
// GemStone changes BEGIN
        ...
        public String printExplainInfo()
        {
          // Print parenthesis for readability of nested binary ops
           return "("+leftOperand.printExplainInfo() + " " + operator + " " + rightOperand.printExplainInfo()+")";
        }        
        ...
        public String ncjGenerateSql() {
          ...
          if (rightSQL == null || leftSQL == null
              || rightSQL.equalsIgnoreCase("false")
              || leftSQL.equalsIgnoreCase("false")) {
            return null;
          }
