/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.catalog.types.IndexDescriptorImpl
...
/** @see com.pivotal.gemfirexd.internal.iapi.sql.dictionary.IndexRowGenerator */
...
// GemStone changes BEGIN
		return isUnique || isUniqueWithDuplicateNulls;
		/* (original code)
		return isUnique;
		*/
...
// GemStone changes BEGIN
		...
		return Integer.valueOf(getKeyColumnPosition(
		    heapColumnPosition.intValue()));
		/* (original code)
