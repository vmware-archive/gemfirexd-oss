/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.vti.IQualifyable
...
public interface IQualifyable {
	...
	*/
	public void setQualifiers(VTIEnvironment vtiEnvironment, com.pivotal.gemfirexd.internal.iapi.store.access.Qualifier[][] qualifiers)
		throws SQLException;
}
