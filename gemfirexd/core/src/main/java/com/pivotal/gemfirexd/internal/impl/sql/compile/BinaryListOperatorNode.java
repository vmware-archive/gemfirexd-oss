/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.BinaryListOperatorNode
...
//      GemStone changes BEGIN
           ...
           throws StandardException 
        {
            ...
            for (int i = 0, sz = rightOperandList.size(); i < sz; i++)
            {
               ValueNode e = (ValueNode)rightOperandList.elementAt(i);
        ...
        {
          // Either a between or an in list
          String explainStr = leftOperand.printExplainInfo() + " " + operator + " ";
          // Iterate through valuenodelist, printing out each one
          for (int index = 0; index < rightOperandList.size(); index++)
          {
                  ValueNode               valueNode;
                  valueNode = (ValueNode) rightOperandList.elementAt(index);
                  explainStr += valueNode.printExplainInfo() + " ";
          }
          return explainStr;
        }
