/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.store.access.AccessFactory
...
public interface AccessFactory
{
	...
	public static final String MODULE = 
        "com.pivotal.gemfirexd.internal.iapi.store.access.AccessFactory";
  ...
  throws StandardException;
	...
	TransactionController getTransaction(ContextManager cm , long connectionID)
	  throws StandardException;
 ...
 * @see AccessFactory#getTransaction
   */
     ...
     *     com.pivotal.gemfirexd.internal.iapi.db API
     **************************************************************************
     */
