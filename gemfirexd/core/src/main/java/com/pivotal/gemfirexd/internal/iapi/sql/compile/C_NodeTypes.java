/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.sql.compile.C_NodeTypes
...
//GemStone changes BEGIN
        /* originally // 79 available */
	static final int PARAMETERIZED_CONSTANT_NODE = 79;
...
//GemStone changes BEGIN
        /*originally // 117 is available */
	static final int DISTRIBUTION_DEFINTION_NODE=117;
//GemStone changes END	
...
//GemStone changes BEGIN
	/*originally 128 is available */
	static final int EXPLAIN_NODE = 128;
//GemStone changes BEGIN
	...
	static final int NCJ_PULL_NODE = 145;
...
// GemStone changes BEGIN
	static final int DISTRIBUTED_PROCEDURE_CALL_NODE = 152;
	static final int PROCEDURE_PROCESSOR_NODE = 153;
// GemStone changes END
 ...
 // GemStone changes BEGIN
    static final int OR_LIST_NODE = 158;
    // 159 - 183 available
    /* (original code)
	// 158 - 183 available
    */
// GemStone changes END
  ...
  //for rename table/column/index
    ...
    static final int JSON_CONSTANT_NODE = 204;
...
// GemStone changes BEGIN
    static final int CREATE_DISK_STORE_NODE= 222;    
    static final int DROP_DISK_STORE_NODE= 223;
    static final int CREATE_GATEWAY_SENDER_NODE= 224;
    static final int CREATE_ASYNC_EVENT_LISTENER_NODE= 225;
    static final int CREATE_GATEWAY_RECEIVER_NODE= 226;
    static final int DROP_GATEWAY_SENDER_NODE= 227;
    static final int DROP_ASYNC_EVENT_LISTENER_NODE= 228;
    static final int DROP_GATEWAY_RECEIVER_NODE= 229;
    static final int CREATE_HDFS_STORE_NODE= 231;
    static final int DROP_HDFS_STORE_NODE= 232;
    static final int ALTER_HDFS_STORE_NODE= 233;
// GemStone changes END
	// OFFSET, FETCH FIRST node
	static final int ROW_COUNT_NODE = 230;

	// Final value in set, keep up to date!
    //static final int FINAL_VALUE =  ROW_COUNT_NODE;
    static final int FINAL_VALUE = ALTER_HDFS_STORE_NODE;
