/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.jdbc.ClobUpdatableReader
...
// GemStone changes BEGIN
              if (!(internalClob instanceof StoreStreamClob))
// GemStone changes END
    ...
    private void init(LOBInputStream stream, long skip) 
        ...
        streamReader = new UTF8Reader (stream, 0, stream.length (), 
                                        conChild, 
// GemStone changes BEGIN
                                        conChild != null ? conChild
                                            .getConnectionSynchronization() : stream);
                                /* (original code)
