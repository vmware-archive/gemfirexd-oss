/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.jdbc.EmbedConnection40
...
import com.pivotal.gemfirexd.internal.iapi.jdbc.FailedProperties40;
...
//  GemStone changes BEGIN
    public EmbedConnection40(
        ...
        Properties info,
        long id,
        long incomingId, boolean isRemote)
        throws SQLException {
        super(driver, url, info, id, incomingId, isRemote);
    }
//  GemStone changes BEGIN
    /*
     *-------------------------------------------------------
  ...
  // GemStone changes BEGIN
  // already fixed this in superclass for JDBC 4.0
    /**
