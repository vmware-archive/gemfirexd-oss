...
public final class GfxdThriftServerSelector extends TServer {
  ...
  private final Logger LOGGER = LoggerFactory
      .getLogger(GfxdThriftServerSelector.class.getName());
  ...
  public void serve() {
    ...
    while (!this.stopped) {
      try {
        GfxdTSocket client = (GfxdTSocket)serverTransport_.accept();
   ...
   * threads. See {@link GfxdThriftServerSelector} class comments for details.
   */
  protected final class SelectorProcess implements Runnable {
    ...
    @Override
    public void run() {
      final ExecutorService executorService = GfxdThriftServerSelector.this.executorService;
