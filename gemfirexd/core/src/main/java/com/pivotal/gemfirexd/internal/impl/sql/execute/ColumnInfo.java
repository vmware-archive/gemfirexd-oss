/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.execute.ColumnInfo
...
import com.pivotal.gemfirexd.internal.iapi.services.io.FormatableLongHolder;
...
// GemStone changes BEGIN
	...
	public static final int MODIFY_COLUMN_AUTOINCREMENT = 8;
// GemStone changes END
	// CONSTRUCTORS
...
// GemStone changes BEGIN
		this.hasAutoIncInc = hasAutoIncInc;
