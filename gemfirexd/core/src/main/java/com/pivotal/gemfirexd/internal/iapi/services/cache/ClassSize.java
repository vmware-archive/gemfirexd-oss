/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.services.cache.ClassSize
    ...
    static
    {
        try
        {
            catalog = (java.util.Hashtable)
              Class.forName( "com.pivotal.gemfirexd.internal.iapi.services.cache.ClassSizeCatalog").newInstance();
        }
        catch( Exception e){};
