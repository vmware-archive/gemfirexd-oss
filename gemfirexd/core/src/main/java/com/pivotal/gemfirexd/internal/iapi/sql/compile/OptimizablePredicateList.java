/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.iapi.sql.compile.OptimizablePredicateList
...
public interface OptimizablePredicateList 
{
	 ...
	 * @param optTable	An Optimizable for the table in question
	 * 
	 * @param pushDeemedNonpushables Whether to try and push the "unpushable" predicates
	 * like dependent subqueries further down
	 *
	 * @exception StandardException		Thrown on error
	 */
	void pushUsefulPredicates(Optimizable optTable, boolean pushDeemedNonpushables)
				throws StandardException;
...
// GemStone changes BEGIN
	...
	/**
	 * Determines whether both table's partitioning column(s) are supplied
	 * as join predicates joined with AND condition.
	 * 
	 * @param src
	 * @param target
	 * @return true if both tables are colocated.
	 * @throws StandardException 
	 */
	public int setColocatedWith(Optimizable src, Optimizable target) throws StandardException;
// GemStone changes END
}
