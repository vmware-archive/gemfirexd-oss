/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.AggregateDefinition
 ...
 *
 * @see com.pivotal.gemfirexd.internal.catalog.TypeDescriptor
 */
interface AggregateDefinition
{
	...
	public	DataTypeDescriptor getAggregator(DataTypeDescriptor inputType,
							StringBuilder aggregatorClassName, boolean isAvg)
