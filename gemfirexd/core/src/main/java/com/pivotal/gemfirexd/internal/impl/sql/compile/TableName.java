/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.TableName
...
// GemStone changes BEGIN
  /**
   * Get the full table name (with the schema name). If Schema passed is null ,
   * it will get resolved with the default schema
   * 
   * @return Full table name as a String
   */
  public String getFullTableName() {
    return com.pivotal.gemfirexd.internal.engine.Misc.getFullTableName(
        this.schemaName, this.tableName, this.lcc);
  }

  public String getFullTableNameAsRegionPath() {
    return com.pivotal.gemfirexd.internal.engine.Misc.getRegionPath(
        this.schemaName, this.tableName, this.lcc);
  }
        /* (original derby code)
	/**
