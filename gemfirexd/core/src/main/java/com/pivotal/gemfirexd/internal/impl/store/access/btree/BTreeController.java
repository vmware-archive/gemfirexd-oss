/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.store.access.btree.BTreeController
...
public class BTreeController extends OpenBTree implements ConglomerateController
{
	...
	**/
     ...
     *     System.out.println(
     *         "table's page size = " + 
     *         prop.getProperty("gemfirexd.storage.pageSize");
     * }
     *
     ...
     *
	 * @see com.pivotal.gemfirexd.internal.iapi.store.access.conglomerate.Conglomerate#load
     **/
	public long load(
    TransactionManager      xact_manager,
...
// GemStone change BEGIN
    ...
    public RowLocation fetch(RowLocation loc, ExecRow row,
        FormatableBitSet validColumns, boolean faultIn) throws StandardException {
      throw (StandardException.newException(SQLState.BTREE_UNIMPLEMENTED_FEATURE));
    }
    ...
    /**
     * Insert a row into the conglomerate, and store its location in the provided
     * template row location.
     * 
