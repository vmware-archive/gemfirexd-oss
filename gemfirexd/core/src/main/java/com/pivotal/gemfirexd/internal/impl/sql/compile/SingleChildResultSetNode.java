/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.SingleChildResultSetNode
...
public abstract class SingleChildResultSetNode extends FromTable
{
			...
			throws StandardException
	{
		if (childResult instanceof Optimizable)
		{
			((Optimizable) childResult).pullOptPredicates(optimizablePredicates, outerTables);
		}
	}
	...
	// GemStone changes BEGIN
        ...
        protected FromBaseTable ncjGetOnlyOneFBTNode() throws StandardException {
          return this.childResult.ncjGetOnlyOneFBTNode();
        }
