/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.diag.SpaceTable
...
/**
	...
	<PRE> select * from new com.pivotal.gemfirexd.internal.diag.SpaceTable('MYSCHEMA','MYTABLE') t; </PRE>
    If the schema name is not supplied, the default schema is used.
    <PRE> select * from new com.pivotal.gemfirexd.internal.diag.SpaceTable('MYTABLE') t; </PRE>
