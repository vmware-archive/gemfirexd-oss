/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.compile.IsNullNode
...
//      GemStone changes BEGIN
        ...
        public QueryInfo computeQueryInfo(QueryInfoContext qic) throws StandardException {
          //return new ComparisonQueryInfo(this.operand.computeQueryInfo(qic),null,-1 /* this.operator.equals("is not null")?RelationalOperator.IS_NOT_NULL_RELOP :RelationalOperator.IS_NULL_RELOP*/);
