/*
   ...
   Derby - Class com.pivotal.gemfirexd.internal.impl.sql.execute.MultiProbeTableScanResultSet
...
// GemStone changes BEGIN
      this(conglomId, scoci, activation, (ExecRow)resultRowAllocator
          ...
          sameStartStopPosition, qualifiers, probingVals, sortRequired,
          tableName, userSuppliedOptimizerOverrides, indexName, isConstraint,
          forUpdate, colRefItem != -1 ? (FormatableBitSet)(activation
              .getSavedObject(colRefItem)) : null,
          indexColItem, lockMode, tableLocked, isolationLevel, oneRowScan,
          optimizerEstimatedRowCount, optimizerEstimatedCost, 
        //GemStone changes BEGIN
          delayScanOpening,optimizeOffHeap, indexAccesesBaseTable,
    ...
    MultiProbeTableScanResultSet(long conglomId,
        ...
        boolean optimizeOffHeap, boolean indexAccesesBaseTable,
        boolean supportsMoveToNextKey )
            throws StandardException
    {
// GemStone changes END
